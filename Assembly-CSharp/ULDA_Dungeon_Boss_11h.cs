...
public class ULDA_Dungeon_Boss_11h : ULDA_Dungeon
{
	...
	protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
	{
		...
		if (emoteType == EmoteType.START)
		{
			...
			{
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_ULDA_BOSS_11h_Male_Mech_IntroBrannResponse_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
			}
			else
			{
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		case 101:
			...
			break;
		case 102:
			yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_11h_Male_Mech_PlayerLargeMech_01);
			break;
		default:
	...
	protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
		{
			...
			case "GVG_110":
			case "DAL_064":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_11h_Male_Mech_PlayerDrBoom_01);
				break;
			case "ULD_184":
			case "LOOT_347":
			case "LOOT_412":
			...
			case "LOOT_389":
			case "DAL_417":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_11h_Male_Mech_PlayerKobold_01);
				break;
			}
		}
	}
	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
		{
			...
			{
			case "CS2_029":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_11h_Male_Mech_BossFireball_01);
				break;
			case "CS2_032":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_11h_Male_Mech_BossFlamestrike_01);
				break;
			case "ULD_253":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_11h_Male_Mech_BossTombWarden_01);
				break;
			}
		}
	}
