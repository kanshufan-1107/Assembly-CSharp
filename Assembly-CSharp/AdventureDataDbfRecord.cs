...
public class AdventureDataDbfRecord : DbfRecord
{
	...
	public override object GetVar(string name)
	{
		return name switch
		{
			...
			"DUNGEON_CRAWL_SAVE_HERO_USING_HERO_DB_ID" => m_dungeonCrawlSaveHeroUsingHeroDbId, 
	...
	public override Type GetVarType(string name)
	{
		return name switch
		{
			...
			"DUNGEON_CRAWL_SAVE_HERO_USING_HERO_DB_ID" => typeof(bool), 
	...
	{
		AdventureDataDbfAsset dbfAsset = DbfShared.GetAssetBundle().LoadAsset(resourcePath, typeof(AdventureDataDbfAsset)) as AdventureDataDbfAsset;
		if (dbfAsset == null)
		{
			records = new List<T>();
