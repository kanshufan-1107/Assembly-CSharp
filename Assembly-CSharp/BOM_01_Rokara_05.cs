...
public class BOM_01_Rokara_05 : BoM_01_Rokara_Dungeon
{
	...
	protected override IEnumerator HandleStartOfTurnWithTiming(int turn)
	{
		...
		case 3:
			...
			break;
		case 7:
			yield return MissionPlayVO(enemyActor, VO_Story_Hero_Golem_Male_Mech_Story_Rokara_Mission5ExchangeB_01);
			break;
		case 15:
			if (HeroPowerIsBrukan)
			{
			...
			break;
		case 19:
			yield return MissionPlayVO(enemyActor, VO_Story_Hero_Golem_Male_Mech_Story_Rokara_Mission5ExchangeE_01);
			break;
		}
	}
}
