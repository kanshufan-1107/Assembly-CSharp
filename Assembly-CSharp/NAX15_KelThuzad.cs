...
public class NAX15_KelThuzad : NAX_MissionEntity
{
		...
		if (!m_hurryLinePlayed && !m_enemySpeaking)
		{
			...
			if (currentPlayer.IsFriendlySide() && !currentPlayer.GetHeroCard().HasActiveEmoteSound())
			{
				...
				Actor enemyActor = GameState.Get().GetOpposingSidePlayer().GetHeroCard()
					.GetActor();
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_NAX15_01_HURRY_31.prefab:552de9d45281f0a47a4a9cb9645c98f6", Notification.SpeechBubbleDirection.TopRight, enemyActor));
			}
		}
	}
	...
	public override void HandleRealTimeMissionEvent(int missionEvent)
	{
		if (missionEvent == 1)
		{
			AssetReference assetReference = "KelThuzad_StealTurn.prefab:7630c436593404790a4a948dc219f537";
			if (!AssetLoader.Get().InstantiatePrefab(assetReference, OnStealTurnSpellLoadAttempted))
			{
				OnStealTurnSpellLoadAttempted(assetReference, null, null);
			}
		}
	}

	private void OnStealTurnSpellLoadAttempted(AssetReference assetRef, GameObject go, object callbackData)
	{
		if (go == null)
		{
		...
		else
		{
			...
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_NAX15_01_PHASE2_ALT_11.prefab:2f066d9f9a49df94cafa065e79d7ebdf", Notification.SpeechBubbleDirection.TopRight, enemyActor));
		}
	}
	...
	protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
	{
		...
		case EmoteType.GREETINGS:
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_NAX15_01_EMOTE_HELLO_26.prefab:9ed2ae3873b199146819291cfaa396e5", Notification.SpeechBubbleDirection.TopRight, enemyActor));
			break;
		case EmoteType.WELL_PLAYED:
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_NAX15_01_EMOTE_WP_25.prefab:57f0f617dc85a1441a6fe68fe570347c", Notification.SpeechBubbleDirection.TopRight, enemyActor));
			break;
		case EmoteType.OOPS:
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_NAX15_01_EMOTE_OOPS_29.prefab:0d497df4f2aced741bbba13ac2912d58", Notification.SpeechBubbleDirection.TopRight, enemyActor));
			break;
		case EmoteType.SORRY:
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_NAX15_01_EMOTE_SORRY_28.prefab:c7086f87dd8a03e489d1f19339942794", Notification.SpeechBubbleDirection.TopRight, enemyActor));
			break;
		case EmoteType.THANKS:
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_NAX15_01_EMOTE_THANKS_27.prefab:72955d7b668a26d4581ac52bf0ed03d0", Notification.SpeechBubbleDirection.TopRight, enemyActor));
			break;
		case EmoteType.THREATEN:
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_NAX15_01_EMOTE_THREATEN_30.prefab:983b1fb96a8525041945d5b41475599f", Notification.SpeechBubbleDirection.TopRight, enemyActor));
			break;
		case EmoteType.WOW:
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_KT_HEIGAN2_55.prefab:f465a1b0b2312764f92f4d86160c9dac", Notification.SpeechBubbleDirection.TopRight, enemyActor));
			break;
		case EmoteType.START:
			...
			case "HERO_01":
			case "HERO_01b":
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_NAX15_01_RESPOND_GARROSH_15.prefab:48cc88124901a3447b86a466a761f3a9", Notification.SpeechBubbleDirection.TopRight, enemyActor));
				break;
			case "HERO_02":
			case "HERO_02d":
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_NAX15_01_RESPOND_THRALL_17.prefab:ccc75bb0ed1ff104bbd9a85820ff5afe", Notification.SpeechBubbleDirection.TopRight, enemyActor));
				break;
			case "HERO_03":
			case "HERO_03b":
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_NAX15_01_RESPOND_VALEERA_18.prefab:c9de6754f5d117a4d8fbdb6c7b7871e9", Notification.SpeechBubbleDirection.TopRight, enemyActor));
				break;
			case "HERO_04":
			case "HERO_04d":
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_NAX15_01_RESPOND_UTHER_14.prefab:1079fbad87857364a95f558df2e47102", Notification.SpeechBubbleDirection.TopRight, enemyActor));
				break;
			case "HERO_05":
			case "HERO_05b":
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_NAX15_01_RESPOND_REXXAR_19.prefab:5b09a5dd8bedd5d4b854e38878b48e80", Notification.SpeechBubbleDirection.TopRight, enemyActor));
				break;
			case "HERO_06":
			case "HERO_06c":
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_NAX15_01_RESPOND_MALFURION_ALT_21.prefab:609de8d4162f0894da2c05b14473b6e7", Notification.SpeechBubbleDirection.TopRight, enemyActor));
				break;
			case "HERO_07":
			case "HERO_07c":
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_NAX15_01_RESPOND_GULDAN_22.prefab:b28117d69d646014bb3a8ec39d5cc388", Notification.SpeechBubbleDirection.TopRight, enemyActor));
				break;
			case "HERO_08":
			case "HERO_08c":
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_NAX15_01_RESPOND_JAINA_23.prefab:0434b865495ab2f45a36cef7be6b4ebc", Notification.SpeechBubbleDirection.TopRight, enemyActor));
				break;
			case "HERO_09":
			case "HERO_09c":
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_NAX15_01_RESPOND_ANDUIN_24.prefab:10a05fc478fe371419a859b464b13b3e", Notification.SpeechBubbleDirection.TopRight, enemyActor));
				break;
			}
			break;
		}
