...
public class ULDA_Dungeon_Boss_49h : ULDA_Dungeon
{
	...
	protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
	{
		...
		if (emoteType == EmoteType.START)
		{
			...
			{
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_ULDA_BOSS_49h_Male_Wyrmtongue_IntroResponse_Reno_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
			}
			else
			{
	...
	protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
		{
			...
			{
			case "ULDA_040":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_49h_Male_Wyrmtongue_PlayerTriggerSackofLamps_01);
				break;
			case "ULD_188":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_49h_Male_Wyrmtongue_PlayerTrigger_Golden_Scarab_01);
				break;
			case "ULD_450":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_49h_Male_Wyrmtongue_PlayerTrigger_Vilefiend_01);
				break;
			}
		}
	}
	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
		{
			...
			{
			case "ULD_162":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_49h_Male_Wyrmtongue_BossTriggerEVILRecruiter_01);
				break;
			case "DAL_413":
			case "DAL_613":
			case "DAL_741":
			...
			case "DAL_739":
			case "ULD_616":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_49h_Male_Wyrmtongue_BossTriggerLackey_01);
				break;
			case "ULD_165":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_49h_Male_Wyrmtongue_BossTriggerRiftcleaver_01);
				break;
			}
		}
	}
