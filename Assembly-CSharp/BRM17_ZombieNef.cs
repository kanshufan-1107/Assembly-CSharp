...
public class BRM17_ZombieNef : BRM_MissionEntity
{
	...
	protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
	{
		...
		if ((uint)(emoteType - 1) <= 5u)
		{
			...
			case "BRMA17_2":
			case "BRMA17_2H":
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_BRMA17_1_RESPONSE_85.prefab:c7bbc928438b13241bde42c6578ad5c8", Notification.SpeechBubbleDirection.TopRight, enemyActor));
				break;
			case "BRMA17_3":
			case "BRMA17_3H":
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("OnyxiaBoss_EmoteResponse_1.prefab:69d9315cbeeddd34b889fe59faa4c480", Notification.SpeechBubbleDirection.TopRight, enemyActor));
				break;
			}
		}
	}
	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		case "BRMA17_4":
			if (!m_cardLinePlayed && !m_inOnyxiaState)
			{
				...
				yield return Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_BRMA17_1_CARD_86.prefab:d433af8d96634ae42877ecfd242f93bb", Notification.SpeechBubbleDirection.TopRight, enemyActor));
		...
		case "BRMA17_5H":
			if (!m_heroPowerLinePlayed)
			{
				...
				yield return Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_BRMA17_1_HERO_POWER_87.prefab:e0f77b0064ea8164e92e8982694d89a7", Notification.SpeechBubbleDirection.TopRight, enemyActor));
			}
			break;
		}
	}
	...
	protected override IEnumerator HandleStartOfTurnWithTiming(int turn)
	{
		...
		if (turn == 1)
		{
			m_nefActor = enemyActor;
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_BRMA17_1_TURN1_79.prefab:d9c859c6074049d479898c0582940383", Notification.SpeechBubbleDirection.TopRight, enemyActor));
		}
		yield break;
	}
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		case 1:
		{
			...
			GameState.Get().SetBusy(busy: true);
			int linkedID = GameState.Get().GetGameEntity().GetTag(GAME_TAG.LINKED_ENTITY);
			yield return HideRuneTrayAndLoanerBanner(linkedID);
			...
			enemyActor = GameState.Get().GetOpposingSidePlayer().GetHeroCard()
				.GetActor();
			yield return Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("OnyxiaBoss_Start_1.prefab:572ad57bf5b75434b8243fe0c9b5b262", Notification.SpeechBubbleDirection.TopRight, enemyActor));
			GameState.Get().SetBusy(busy: false);
			yield break;
		}
		case 3:
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_BRMA17_1_DEATHWING_88.prefab:525f210af61d16b49b3b20fba2c2cd8c", Notification.SpeechBubbleDirection.TopRight, enemyActor));
			yield break;
		case 4:
		...
		case 13:
			...
			GameState.Get().SetBusy(busy: true);
			yield return Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_BRMA17_1_TRANSFORM1_80.prefab:82475f6129d5587448c3aa398a77c580", Notification.SpeechBubbleDirection.TopRight, enemyActor));
			GameState.Get().SetBusy(busy: false);
			yield break;
		case 14:
			break;
		...
		yield return Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_BRMA17_1_TRANSFORM2_81.prefab:d064be3da78c0f5449db24a40f9a609b", Notification.SpeechBubbleDirection.TopRight, enemyActor));
	}
}
