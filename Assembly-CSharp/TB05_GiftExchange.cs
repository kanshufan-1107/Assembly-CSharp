	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		case 1:
			if (FirstGiftVO.Length > 0)
			{
				...
				GiftSpawnedPopup = NotificationManager.Get().CreatePopupText(UserAttentionBlocker.NONE, popUpPos, TutorialEntity.GetTextScale() * popupScale, GameStrings.Get(textID), convertLegacyPosition: false);
