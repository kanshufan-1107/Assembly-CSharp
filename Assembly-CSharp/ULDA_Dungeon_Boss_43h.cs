...
public class ULDA_Dungeon_Boss_43h : ULDA_Dungeon
{
	...
	protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
	{
		...
		if (emoteType == EmoteType.START)
		{
			...
			{
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_ULDA_BOSS_43h_Female_Human_IntroElise_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
			}
			else
			{
	...
	protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
		{
			...
			{
			case "GIL_548":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_43h_Female_Human_PlayerBookofSpecters_01);
				break;
			case "ULDA_006":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_43h_Female_Human_PlayerBookoftheDeadTreasure_01);
				break;
			case "ULD_172":
			case "ULD_707":
			case "ULD_715":
			case "ULD_717":
			case "ULD_718":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_43h_Female_Human_PlayerPlague_01);
				break;
			}
		}
	}
	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
		{
			...
			{
			case "ICC_407":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_43h_Female_Human_BossGnomeferatu_01);
				break;
			case "EX1_309":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_43h_Female_Human_BossSiphonSoul_01);
				break;
			case "BOT_263":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_43h_Female_Human_BossSoulInfusion_01);
				break;
			}
		}
	}
