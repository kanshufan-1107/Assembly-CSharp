...
public class ULDA_Dungeon_Boss_06h : ULDA_Dungeon
{
	...
	protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
	{
		...
		if (emoteType == EmoteType.START)
		{
			...
			{
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_ULDA_BOSS_06h_Male_Pandaren_IntroBrannRespose_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
			}
			else
			{
	...
	protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
		{
			...
			{
			case "ULD_709":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_06h_Male_Pandaren_PlayerTrigger_Armored_Goon_01);
				break;
			case "CFM_672":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_06h_Male_Pandaren_PlayerTrigger_Madam_Goya_01);
				break;
			case "ULD_229":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_06h_Male_Pandaren_PlayerTrigger_Mischief_Maker_01);
				break;
			}
		}
	}
	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		if (!(cardID == "ULD_326t"))
		{
			if (cardID == "ULD_708")
			{
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_06h_Male_Pandaren_BossTrigger_Livewire_Lance_01);
			}
		}
		else
		{
			yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_06h_Male_Pandaren_BossTrigger_Mirage_Blade_01);
		}
	}
}
