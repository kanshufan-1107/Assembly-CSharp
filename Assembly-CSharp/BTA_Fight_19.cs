...
public class BTA_Fight_19 : BTA_Dungeon_Heroic
{
	...
	protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
	{
		...
		{
			if (playerHeroCardID == "HERO_10" || playerHeroCardID == "HERO_10a")
			{
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_BTA_BOSS_19h_Male_Demon_Mission_Fight_19_BossStartIllidan_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
			}
			else
			{
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_BTA_BOSS_19h_Male_Demon_Mission_Fight_19_BossStart_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
			}
		}
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		{
		case 115:
			yield return PlayAndRemoveRandomLineOnlyOnce(enemyActor, m_missionEventTrigger115Lines);
			break;
		case 500:
	...
	protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
		{
			...
			{
			case "BT_196":
				yield return PlayLineAlways(enemyActor, VO_BTA_BOSS_19h_Male_Demon_Mission_Fight_19_Hero_Kelidan_01);
				break;
			case "BT_730":
			case "BT_140":
			case "BT_715":
			...
			case "BT_726":
			case "CFM_609":
				yield return PlayLineOnlyOnce(enemyActor, VO_BTA_BOSS_19h_Male_Demon_Mission_Fight_19_Hero_FelOrc_01);
				break;
			case "BT_850":
				yield return PlayLineAlways(enemyActor, VO_BTA_BOSS_19h_Male_Demon_Mission_Fight_19_Hero_Magtheridon_01);
				break;
			}
		}
	}
	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
		{
			...
			case "BT_737":
			case "BT_729":
				yield return PlayLineAlways(enemyActor, VO_BTA_BOSS_19h_Male_Demon_Mission_Fight_19_Hero_Warden_01);
				break;
			case "EX1_301":
				yield return PlayLineAlways(enemyActor, VO_BTA_BOSS_19h_Male_Demon_Mission_Fight_19_Boss_Riftcleaver_01);
				break;
			case "ULD_258":
				yield return PlayLineAlways(enemyActor, VO_BTA_BOSS_19h_Male_Demon_Mission_Fight_19_Boss_GrimRally_01);
				break;
			}
		}
	}
