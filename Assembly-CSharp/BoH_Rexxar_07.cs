...
public class BoH_Rexxar_07 : BoH_Rexxar_Dungeon
{
	...
	public override IEnumerator DoActionsBeforeDealingBaseMulliganCards()
	{
		...
		yield return PlayLineAlways(enemyActor, VO_Story_Hero_Daelin_Male_Human_Story_Rexxar_Mission7Intro_01);
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		case 504:
			GameState.Get().SetBusy(busy: true);
			yield return PlayLineAlways(enemyActor, VO_Story_Hero_Daelin_Male_Human_Story_Rexxar_Mission7Loss_01);
			GameState.Get().SetBusy(busy: false);
			break;
		default:
	...
	protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
	{
		...
		{
			Actor m_Cairne = GetFriendlyActorByCardId("Story_02_Cairne");
			if (m_Cairne != null)
			{
				yield return PlayLineAlways(m_Cairne, VO_Story_Minion_Cairne_Male_Tauren_Story_Rexxar_Mission7ExchangeC_01);
			}
	...
	protected override IEnumerator HandleStartOfTurnWithTiming(int turn)
	{
		...
		case 13:
			...
			break;
		case 15:
			yield return PlayLineAlways(enemyActor, VO_Story_Hero_Daelin_Male_Human_Story_Rexxar_Mission7ExchangeE_01);
			break;
		case 19:
			yield return PlayLineAlways(enemyActor, VO_Story_Hero_Daelin_Male_Human_Story_Rexxar_Mission7ExchangeF_01);
			break;
		}
	}
