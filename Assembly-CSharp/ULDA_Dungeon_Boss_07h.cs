...
public class ULDA_Dungeon_Boss_07h : ULDA_Dungeon
{
	...
	protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
	{
		...
		if (emoteType == EmoteType.START)
		{
			...
			{
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_ULDA_BOSS_07h_Female_Kobold_IntroElise_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
			}
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		{
		case 101:
			yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_07h_Female_Kobold_BossAttackHero_01);
			break;
		case 102:
			yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_07h_Female_Kobold_BossAttackMinionKill_01);
			break;
		default:
	...
	protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
		{
			...
			{
			case "DAL_354":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_07h_Female_Kobold_PlayerAcornbearer_01);
				break;
			case "ICC_054":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_07h_Female_Kobold_PlayerSpreadingPlague_01);
				break;
			case "EX1_571":
			case "DAL_256":
			case "DAL_256ts":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_07h_Female_Kobold_PlayerForestsAid_PlayerForceofNature_01);
				break;
			}
		}
	}
	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		if (!(cardID == "ULD_134"))
		{
			if (cardID == "CS2_012")
			{
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_07h_Female_Kobold_BossBiteSwipe_01);
			}
		}
		else
		{
			yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_07h_Female_Kobold_BossBEES_01);
		}
	}
}
