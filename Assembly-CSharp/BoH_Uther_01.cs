...
public class BoH_Uther_01 : BoH_Uther_Dungeon
{
	...
	public override IEnumerator DoActionsBeforeDealingBaseMulliganCards()
	{
		...
		yield return PlayLineAlways(enemyActor, VO_Story_03_Alonsus_Male_Human_Story_Uther_Mission1Intro_01);
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		case 502:
			GameState.Get().SetBusy(busy: true);
			yield return PlayLineAlways(friendlyActor, VO_Story_Hero_Uther_Male_Human_Story_Uther_Mission1Victory_01);
			GameState.Get().SetBusy(busy: false);
			break;
		case 504:
	...
	protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
	{
		...
		if (!(cardID == "CS1_112"))
		{
			if (cardID == "GIL_134")
			{
				yield return PlayLineOnlyOnce(enemyActor, VO_Story_03_Alonsus_Male_Human_Story_Uther_Mission1ExchangeD_01);
			}
		}
		else
		{
			yield return PlayLineOnlyOnce(enemyActor, VO_Story_03_Alonsus_Male_Human_Story_Uther_Mission1ExchangeE_01);
		}
	}
