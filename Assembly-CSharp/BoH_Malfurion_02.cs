...
public class BoH_Malfurion_02 : BoH_Malfurion_Dungeon
{
	...
	public override IEnumerator DoActionsBeforeDealingBaseMulliganCards()
	{
		...
		yield return MissionPlayVO(enemyActor, VO_Story_Hero_Mannoroth_Male_Demon_Story_Malfurion_Mission2Intro_01);
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		{
		case 507:
			yield return PlayLineAlways(enemyActor, VO_Prologue_Mannoroth_Male_Demon_Prologue_Mission3_Loss_01);
			break;
		case 504:
			GameState.Get().SetBusy(busy: true);
	...
	protected override IEnumerator HandleStartOfTurnWithTiming(int turn)
	{
		...
		case 5:
			...
			break;
		case 7:
			yield return PlayLineAlways(enemyActor, VO_Story_Hero_Mannoroth_Male_Demon_Story_Malfurion_Mission2ExchangeC_01);
