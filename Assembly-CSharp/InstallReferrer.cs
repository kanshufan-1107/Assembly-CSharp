...
public class InstallReferrer
{
	...
	public bool RequestAsync(AndroidJavaObject context, ReferrerReceivedCallback callback)
	{
		...
		{
			using (AndroidJavaObject installReferrer = new AndroidJavaObject("com.blizzard.telemetry.sdk.platform.InstallReferrer"))
			{
				installReferrer.Call("RequestReferrer", context, new ReferrerCallback(callback));
			}
			return true;
		}
