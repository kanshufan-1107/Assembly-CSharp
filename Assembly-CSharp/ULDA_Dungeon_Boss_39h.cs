...
public class ULDA_Dungeon_Boss_39h : ULDA_Dungeon
{
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		{
		case 110:
			yield return PlayBossLine(enemyActor, VO_ULDA_BOSS_39h_Male_PlagueLord_BossMomentumSwing_01);
			break;
		case 111:
			yield return PlayRandomLineAlways(enemyActor, m_BossMurlocNoiseLines);
			break;
		case 103:
			yield return PlayRandomLineAlways(enemyActor, m_HeroPower1TriggerLines);
			break;
		case 104:
			yield return PlayRandomLineAlways(enemyActor, m_HeroPower2Lines);
			break;
		case 105:
			yield return PlayRandomLineAlways(enemyActor, m_HeroPower3Lines);
			break;
		case 101:
			GameState.Get().SetBusy(busy: true);
			yield return PlayBossLine(enemyActor, VO_ULDA_BOSS_39h_Male_PlagueLord_PhaseChange1_01);
			GameState.Get().SetBusy(busy: false);
			break;
		case 102:
			GameState.Get().SetBusy(busy: true);
			yield return PlayBossLine(enemyActor, VO_ULDA_BOSS_39h_Male_PlagueLord_PhaseChange2_01);
			GameState.Get().SetBusy(busy: false);
			break;
		case 109:
			yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_39h_Male_PlagueLord_PlayerTriggerMurloc_01);
			break;
		default:
	...
	protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
		{
			...
			{
			case "NEW1_017":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_39h_Male_PlagueLord_PlayerTriggerHungryCrab_01);
				break;
			case "ULD_707":
			case "ULD_715":
			case "ULD_717":
			case "ULD_718":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_39h_Male_PlagueLord_PlayerTriggerPlague_01);
				break;
			case "ULD_172":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_39h_Male_PlagueLord_PlayerTriggerPlagueofMurlocs_01);
				break;
			case "ULD_003":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_39h_Male_PlagueLord_PlayerTriggerZephrys_01);
				break;
			}
		}
	}
	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		{
		case "LOOT_060":
			yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_39h_Male_PlagueLord_BossTriggerCrushingHand_01);
			break;
		case "ULD_289":
			yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_39h_Male_PlagueLord_BossTriggerFishflinger_01);
			break;
		case "ULD_723":
			yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_39h_Male_PlagueLord_BossTriggerMurmy_01);
			break;
		case "CFM_310":
			yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_39h_Male_PlagueLord_BossTriggerPhase1CallintheFinishers_01);
			break;
		case "LOE_113":
			yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_39h_Male_PlagueLord_BossTriggerPhase1EveryfinisAwesome_01);
			break;
		case "ULD_716":
			yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_39h_Male_PlagueLord_BossTriggerPhase1TiptheScales_01);
			break;
		case "ULDA_BOSS_39p3":
		case "ULDA_BOSS_39px3":
		{
			...
			if (GameState.Get().GetFriendlySidePlayer().GetHero()
				.GetCardId() == "ULDA_Reno")
			{
				yield return PlayLineOnlyOnce(playerActor, VO_ULDA_Reno_Male_Human_BossVeshPhase3HeroPower_01);
			}
			break;
		}
		}
