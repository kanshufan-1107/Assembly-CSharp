...
public class LOOT_Dungeon_BOSS_20h : LOOT_Dungeon
{
	...
	protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
	{
		...
		{
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_LOOTA_BOSS_20h_Male_Earthen_Intro_01.prefab:b1712d4e38816874f82613e4fa8060e2", Notification.SpeechBubbleDirection.TopRight, enemyActor));
		}
		else if (MissionEntity.STANDARD_EMOTE_RESPONSE_TRIGGERS.Contains(emoteType))
		{
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_LOOTA_BOSS_20h_Male_Earthen_EmoteResponse_01.prefab:b77df03627d7c2f449aa626db3255011", Notification.SpeechBubbleDirection.TopRight, enemyActor));
		}
	}
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		case 101:
		{
			...
			if (m_StatueDestroyedLines.Count != 0 && chanceVO >= randomNum)
			{
