...
public class BTA_Prologue_Fight_04 : BTA_Prologue_Dungeon
{
	...
	protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
	{
		...
		{
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_Prologue_Cenarius_Male_Demigod_Prologue_Cenarius_EmoteResponse_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
		}
	}
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		case 501:
			...
			yield return PlayLineAlways(enemyActor, VO_Prologue_Cenarius_Male_Demigod_Prologue_Cenarius_VictoryDenied_01);
	...
	public IEnumerator PlayVictoryLines()
	{
		Actor friendlyActor = GameState.Get().GetFriendlySidePlayer().GetHero()
			...
			.GetActor();
		GameState.Get().SetBusy(busy: true);
		yield return PlayLineAlways(friendlyActor, VO_TB_Hero_Illidan2_Male_NightElf_Prologue_Mission4_Victory01_01);
	...
	protected override IEnumerator HandleStartOfTurnWithTiming(int turn)
	{
		...
		case 5:
			...
			break;
		case 6:
			yield return PlayLineAlways(enemyActor, VO_Prologue_Cenarius_Male_Demigod_Prologue_Mission4_Turn2_01_01);
			break;
		case 7:
		...
		case 10:
			...
			break;
		case 11:
			yield return PlayLineAlways(enemyActor, VO_Prologue_Cenarius_Male_Demigod_Prologue_Mission4_Loss_01);
			break;
		}
	}
