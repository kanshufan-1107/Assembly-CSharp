...
public class GamePresenceField
{
	...
	public const uint TRADITIONAL_TUTORIAL_COMPLETED = 15u;
	...
	public const uint DEPRECATED_FIRESIDE_GATHERING_INFO = 25u;

	public const uint PARTY_ID = 26u;

	public const uint ACHIEVEMENT_COMPLETED = 27u;

	public const uint BATTLEGROUNDS_TUTORIAL_COMPLETE = 28u;

	public const uint MERCENARIES_TUTORIAL_COMPLETE = 29u;

	public const uint DEMON_HUNTER_LEVEL = 30u;

	public const uint DEATH_KNIGHT_LEVEL = 31u;

	public static uint[] TransientStatusFields => new uint[8] { 17u, 19u, 20u, 21u, 23u, 24u, 26u, 1u };
	...
	public static string GetFieldName(uint fieldId)
	{
		return fieldId switch
		{
			...
			12u => "WarlockLevel", 
			13u => "WarriorLevel", 
			30u => "DemonHunterLevel", 
			31u => "DeathKnightLevel", 
			14u => "GainMedal", 
			15u => "TutorialBeaten", 
			16u => "CollectionEvent", 
			17u => "Status", 
			...
			24u => "DeckValidity", 
			26u => "PartyId", 
			27u => "AchievementCompleted", 
			28u => "BattlegroundsTutorialComplete", 
			29u => "MercenariesTutorialBountyComplete", 
			_ => fieldId.ToString(), 
		};
	}
	...
	public static string GetFieldValue(PresenceUpdate update)
	{
		...
		if (update.programId == BnetProgramId.HEARTHSTONE && update.groupId == 2)
		{
