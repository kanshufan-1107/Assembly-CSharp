...
public class LOOT_Dungeon_BOSS_54h : LOOT_Dungeon
{
	...
	protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
	{
		...
		{
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_LOOTA_BOSS_54h_Female_Human_Intro_01.prefab:fc331202e4398374c87ba5e467990a7a", Notification.SpeechBubbleDirection.TopRight, enemyActor));
		}
		else if (MissionEntity.STANDARD_EMOTE_RESPONSE_TRIGGERS.Contains(emoteType))
		{
			if (GameState.Get().GetTurn() >= 12)
			{
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_LOOTA_BOSS_54h_Female_Human_DefeatPlayer_01.prefab:f710812544c073044b59f063537fe205", Notification.SpeechBubbleDirection.TopRight, enemyActor));
			}
			else
			{
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_LOOTA_BOSS_54h_Female_Human_EmoteResponse_01.prefab:30a58ef54493277458e6f40e10808e73", Notification.SpeechBubbleDirection.TopRight, enemyActor));
			}
		}
	}
