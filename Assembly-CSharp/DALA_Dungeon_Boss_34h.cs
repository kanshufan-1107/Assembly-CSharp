...
public class DALA_Dungeon_Boss_34h : DALA_Dungeon
{
	...
	{
		base.PreloadAssets();
		List<string> soundFiles = new List<string> { CarouselGryphon_DALA_Boss_34h_Death, CarouselGryphon_DALA_Boss_34h_Emote_01, CarouselGryphon_DALA_Boss_34h_Emote_02, CarouselGryphon_DALA_Boss_34h_Emote_03, CarouselGryphon_DALA_Boss_34h_Start, CarouselGryphon_DALA_Boss_34h_Taunt };
