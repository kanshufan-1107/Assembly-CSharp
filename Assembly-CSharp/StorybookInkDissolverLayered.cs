...
public class StorybookInkDissolverLayered : MonoBehaviour
{
	...
	private void Update()
	{
		...
		{
			float dissolvePreviousCycles = dissolveOffsetTime / DissolveAnimationSpeed;
			float dissolve2PreviousCycles = dissolve2OffsetTime / Dissolve2AnimationSpeed;
			float dissolve3PreviousCycles = dissolve3OffsetTime / Dissolve3AnimationSpeed;
			if (Time.time >= matDissolveStartTime + dissolvePreviousCycles)
			{
			...
			if (Time.time >= matDissolve2StartTime + dissolve2PreviousCycles)
			{
			...
			if (Time.time >= matDissolve3StartTime + dissolve3PreviousCycles)
			{
