...
public class RewardChestContentsDbfRecord : DbfRecord
{
	...
	{
		RewardChestContentsDbfAsset dbfAsset = DbfShared.GetAssetBundle().LoadAsset(resourcePath, typeof(RewardChestContentsDbfAsset)) as RewardChestContentsDbfAsset;
		if (dbfAsset == null)
		{
			records = new List<T>();
