...
public class ULDA_Dungeon_Boss_14h : ULDA_Dungeon
{
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		{
		case 102:
			yield return PlayAndRemoveRandomLineOnlyOnce(enemyActor, m_HeroPowerPlayShuffledWeaponsLines);
			break;
		case 101:
			yield return PlayAndRemoveRandomLineOnlyOnce(enemyActor, m_HeroPowerTriggerLines);
			break;
		case 103:
			yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_14h_Female_Sethrak_PlayerDestroyWeapon_01);
			break;
		default:
	...
	protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
	{
		...
		if (!(cardID == "LOOT_542"))
		{
			if (cardID == "TRL_156")
			{
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_14h_Female_Sethrak_PlayerStolenSteel_01);
			}
		}
		else
		{
			yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_14h_Female_Sethrak_PlayerKingsbane_01);
		}
	}
	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		if (!(cardID == "CS2_074"))
		{
			if (cardID == "TRL_156")
			{
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_14h_Female_Sethrak_BossStolenSteel_01);
			}
		}
		else
		{
			yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_14h_Female_Sethrak_BossPoisonWeapon_01);
		}
	}
}
