...
public class LOOT_Dungeon_BOSS_05h : LOOT_Dungeon
{
	...
	protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
	{
		...
		{
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_LOOTA_BOSS_05h_Male_Kobold_Intro_01.prefab:e1c7c45689b6591498aa76348e5a70f4", Notification.SpeechBubbleDirection.TopRight, enemyActor));
		}
		else if (MissionEntity.STANDARD_EMOTE_RESPONSE_TRIGGERS.Contains(emoteType))
		{
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_LOOTA_BOSS_05h_Male_Kobold_EmoteResponse_01.prefab:2934b191f5c48084f8ca1946cd1c12af", Notification.SpeechBubbleDirection.TopRight, enemyActor));
		}
	}
	...
	protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()))
		{
			...
			if (cardID == "LOOTA_838")
			{
				yield return PlayEasterEggLine(enemyActor, "VO_LOOTA_BOSS_05h_Male_Kobold_EventBoomBots_01.prefab:3c88fbc01e9f5554282c392c82596c29");
			}
		}
	}
}
