...
public class DALA_Dungeon_Boss_22h : DALA_Dungeon
{
	...
	protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
	{
		...
		{
			if (playerHeroCardID != "DALA_Tekahn" && playerHeroCardID != "DALA_Chu" && playerHeroCardID != "DALA_Rakanishu" && playerHeroCardID != "DALA_George" && playerHeroCardID != "DALA_Barkeye")
			{
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		case 101:
			...
			break;
		case 102:
			yield return PlayAndRemoveRandomLineOnlyOnce(enemyActor, m_PlayerBattleCry);
			break;
		case 103:
			yield return PlayAndRemoveRandomLineOnlyOnce(enemyActor, m_PlayerLegendary);
			break;
		case 104:
			yield return PlayAndRemoveRandomLineOnlyOnce(enemyActor, m_PlayerSilence);
			break;
		case 105:
	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
		{
			...
			if (cardID == "DAL_735")
			{
				yield return PlayLineOnlyOnce(enemyActor, VO_DALA_BOSS_22h_Female_Pandaren_BossDalaranLibrarian_02);
			}
		}
	}
}
