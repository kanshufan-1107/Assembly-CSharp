...
public class BTA_Prologue_Fight_01 : BTA_Prologue_Dungeon
{
	...
	protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
	{
		...
		{
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_Prologue_Azzinoth_Male_Demon_Prologue_Azzinoth_EmoteResponse_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
		}
	}
	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		if (!(cardID == "Prologue_ChaosNova"))
		{
			...
			{
				yield return PlayLineAlways(friendlyActor, VO_TB_Hero_Illidan2_Male_NightElf_Prologue_Mission1_Illidan2_01);
			}
		}
		else
		{
			yield return PlayLineAlways(friendlyActor, VO_TB_Hero_Illidan2_Male_NightElf_Prologue_Mission1_Illidan3_01);
		}
	}
	...
	protected override IEnumerator HandleStartOfTurnWithTiming(int turn)
	{
		...
		case 1:
			...
			break;
		case 2:
			yield return PlayLineAlways(enemyActor, VO_Prologue_Azzinoth_Male_Demon_Prologue_Mission1_Turn2_01);
			break;
		case 4:
			yield return PlayLineAlways(enemyActor, VO_Prologue_Azzinoth_Male_Demon_Prologue_Mission1_ExchangeA_01_01);
			yield return PlayLineAlways(friendlyActor, VO_TB_Hero_Illidan2_Male_NightElf_Prologue_Mission1_ExchangeA_02_01);
			break;
		case 6:
			yield return PlayLineAlways(enemyActor, VO_Prologue_Azzinoth_Male_Demon_Prologue_Mission1_ExchangeB_01_01);
		...
		case 7:
			...
			break;
		case 11:
			yield return PlayLineAlways(enemyActor, VO_Prologue_Azzinoth_Male_Demon_Prologue_Mission1_Loss_01);
			break;
		}
	}
}
