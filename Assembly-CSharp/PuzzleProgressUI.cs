...
public class PuzzleProgressUI : MonoBehaviour
{
	...
	public void UpdateProgressValues(int puzzleProgress, int totalPuzzleProgress)
	{
		...
		m_ProgressText.Text = GameStrings.Format("GAMEPLAY_PROGRESS_X_OF_Y", puzzleProgress, totalPuzzleProgress);
	}
	...
	public void UpdateText(Entity puzzleEntity)
	{
		...
		m_ProgressText.Text = GameStrings.Format("GAMEPLAY_PROGRESS_X_OF_Y", m_currentPuzzleProgress, m_totalPuzzleProgress);
