...
public class MobileChatLogUI : IChatLogUI
{
	...
	{
		string prefabName = (UniversalInputManager.UsePhoneUI ? "MobileChatFrames_phone.prefab:044c4b3ec33f4454c9a95d6a9ee52552" : "MobileChatFrames.prefab:1b0605e4925ea4424a53e7b000ad961f");
		GameObject go = AssetLoader.Get().InstantiatePrefab(prefabName);
		if (go != null)
		{
			m_chatFrames = go.GetComponent<ChatFrames>();
