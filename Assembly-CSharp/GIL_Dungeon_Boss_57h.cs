...
public class GIL_Dungeon_Boss_57h : GIL_Dungeon
{
	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		{
			string randomLine = PopRandomLineWithChance(m_ShallowGraveLines);
			if (randomLine != null)
			{
	...
	protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
	{
		...
		{
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_GILA_BOSS_57h_Male_Undead_Intro_01.prefab:1a6f17bfc76f9394d9c8b14be96ab554", Notification.SpeechBubbleDirection.TopRight, enemyActor));
		}
		else if (MissionEntity.STANDARD_EMOTE_RESPONSE_TRIGGERS.Contains(emoteType))
		{
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_GILA_BOSS_57h_Male_Undead_EmoteResponse_01.prefab:97d1e8fe0b6eb4442ad6dd62c05b3c42", Notification.SpeechBubbleDirection.TopRight, enemyActor));
		}
	}
	...
	protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
	{
		...
		if (!(cardID == "GILA_BOSS_57t"))
		{
			if (cardID == "GILA_804")
			{
				yield return PlayLineOnlyOnce(enemyActor, "VO_GILA_BOSS_57h_Male_Undead_EventPlayHolyBook_01.prefab:94d128a9b83ee8a4394ceba5bd81cd24");
			}
			yield break;
		}
		string randomLine = PopRandomLineWithChance(m_ShallowGraveLines);
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		case 101:
		{
			string randomLine = PopRandomLineWithChance(m_HeroPowerLines);
			if (randomLine != null)
			{
				yield return PlayLineOnlyOnce(enemyActor, randomLine);
			}
		...
		case 102:
			yield return PlayLineOnlyOnce(enemyActor, "VO_GILA_BOSS_57h_Male_Undead_EventDesecrate_01.prefab:28b7a7c0c5932194c9980c623cc01749");
			break;
		case 103:
			yield return PlayLineOnlyOnce(enemyActor, "VO_GILA_BOSS_57h_Male_Undead_EventDesecrate_02.prefab:f2a501707071b9748ba4dbf8acc5e9f7");
			break;
		case 104:
			yield return PlayLineOnlyOnce(enemyActor, "VO_GILA_BOSS_57h_Male_Undead_EventDesecrate_03.prefab:84180e6550c55be41b1346590343db9f");
			break;
		case 105:
			yield return PlayLineOnlyOnce(enemyActor, "VO_GILA_BOSS_57h_Male_Undead_EventDesecrate_04.prefab:71118bc8f937ac344a206a50a50908f8");
			break;
		}
	}
}
