...
public class DALA_Dungeon_Boss_73h : DALA_Dungeon
{
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		{
		case 101:
			yield return PlayLineOnlyOnce(enemyActor, VO_DALA_BOSS_73h_Male_Tauren_PlayerShamanSpell_01);
			break;
		case 102:
			yield return PlayLineOnlyOnce(enemyActor, VO_DALA_BOSS_73h_Male_Tauren_PlayerTotem_02);
			break;
		case 103:
			yield return PlayLineOnlyOnce(enemyActor, VO_DALA_BOSS_73h_Male_Tauren_PlayerVoltron_01);
			break;
		case 104:
			yield return PlayAndRemoveRandomLineOnlyOnce(enemyActor, m_PlayerWindfury);
			break;
		default:
	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
		{
			...
			if (cardID == "DAL_742")
			{
				yield return PlayLineOnlyOnce(enemyActor, VO_DALA_BOSS_73h_Male_Tauren_BossWhirlwindTempest_01);
			}
		}
	}
}
