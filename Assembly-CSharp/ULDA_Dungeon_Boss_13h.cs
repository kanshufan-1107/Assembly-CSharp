...
public class ULDA_Dungeon_Boss_13h : ULDA_Dungeon
{
	...
	protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
	{
		...
		if (emoteType == EmoteType.START)
		{
			...
			{
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_ULDA_BOSS_13h_Male_Gnoll_IntroBrannResponse_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
			}
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		if (missionEvent == 101)
		{
			yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_13h_Male_Gnoll_BossSnakeTrapTrigger_01);
		}
		else
		{
	...
	protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
		{
			...
			{
			case "ULD_154":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_13h_Male_Gnoll_BossHyenaAlpha_01);
				break;
			case "DAL_371":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_13h_Male_Gnoll_BossMarkedShot_01);
				break;
			case "GIL_826":
			case "UNG_086":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_13h_Male_Gnoll_PlayerBaku_GiantAnaconda_01);
				break;
			case "EX1_554":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_13h_Male_Gnoll_PlayerSnakeTrap_01);
				break;
			}
		}
	}
