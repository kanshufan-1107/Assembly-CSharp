...
public class TRL_Dungeon_Boss_200h : TRL_Dungeon
{
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		{
		case 1001:
			yield return PlayLineOnlyOnce(enemyActor, VO_TRLA_200h_Male_Troll_ShrineComesBack_01);
			break;
		case 1002:
			yield return PlayLineOnlyOnce(enemyActor, VO_TRLA_200h_Male_Troll_ShrineComesBack_02);
			break;
		case 1003:
			yield return PlayLineOnlyOnce(enemyActor, VO_TRLA_200h_Male_Troll_ShrineComesBack_03);
			break;
		case 1004:
			yield return PlayLineOnlyOnce(enemyActor, VO_TRLA_200h_Male_Troll_ShrineDoesThing_01);
			break;
		case 1005:
	...
	protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()))
		{
			...
			if (cardID == "TRL_316")
			{
				yield return PlayLineOnlyOnce(enemyActor, VO_TRLA_200h_Male_Troll_Play_Janalai_01);
			}
		}
	}
