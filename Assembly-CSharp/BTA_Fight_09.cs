...
public class BTA_Fight_09 : BTA_Dungeon
{
	...
	public override IEnumerator DoActionsBeforeDealingBaseMulliganCards()
	{
		...
		yield return PlayLineAlways(friendlyActor, VO_BTA_01_Female_NightElf_Mission_Fight_09_PlayerStart_01);
	...
	protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
	{
		...
		{
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_BTA_BOSS_09h_Female_Naga_Mission_Fight_09_Emote_Response_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
		}
	}
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		case 100:
			GameState.Get().SetBusy(busy: true);
			yield return PlayLineAlways(enemyActor, VO_BTA_BOSS_09h_Female_Naga_Mission_Fight_09_VictoryA_01);
			GameState.Get().SetBusy(busy: false);
			break;
		case 101:
			yield return PlayLineAlways(enemyActor, VO_BTA_BOSS_09h_Female_Naga_Mission_Fight_09_Boss_ConchguardWarlord_01);
			break;
		case 505:
			yield return PlayRandomLineAlways(friendlyActor, m_missionEventTrigger101_Lines);
			break;
		case 507:
			yield return PlayRandomLineAlways(enemyActor, m_VO_BTA_BOSS_09h_Female_Naga_Mission_Fight_09_HeroPower_Lines);
			break;
		case 500:
	...
	protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
		{
			...
			{
			case "BT_036":
				yield return PlayLineAlways(enemyActor, VO_BTA_BOSS_09h_Female_Naga_Mission_Fight_09_Hero_CoordinatedStrike_01);
				break;
			case "BT_175":
				yield return PlayLineAlways(enemyActor, VO_BTA_BOSS_09h_Female_Naga_Mission_Fight_09_Hero_TwinSlice_01);
				break;
			case "BT_752":
				yield return PlayLineAlways(enemyActor, VO_BTA_BOSS_09h_Female_Naga_Mission_Fight_09_Hero_Blur_01);
				break;
			}
		}
	}
	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
		{
			...
			{
			case "BT_100":
				yield return PlayLineAlways(enemyActor, VO_BTA_BOSS_09h_Female_Naga_Mission_Fight_09_Boss_SerpentShrinePortal_01);
				break;
			case "BT_110":
				yield return PlayLineAlways(enemyActor, VO_BTA_BOSS_09h_Female_Naga_Mission_Fight_09_Boss_Torrent_01);
				break;
			case "BT_355":
				yield return PlayLineAlways(enemyActor, VO_BTA_BOSS_09h_Female_Naga_Mission_Fight_09_Boss_WrathscaleNaga_01);
				break;
			case "BT_761t":
				yield return PlayLineAlways(enemyActor, VO_BTA_BOSS_09h_Female_Naga_Mission_Fight_09_Boss_ConchguardWarlord_01);
				break;
