...
public class ULDA_Dungeon_Boss_20h : ULDA_Dungeon
{
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		{
		case 102:
			yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_20h_Male_Ghost_BossTriggerWeapon_01);
			break;
		case 101:
	...
	protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
		{
			...
			{
			case "ULD_253":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_20h_Male_Ghost_PlayerTrigger_Tomb_Warden_01);
				break;
			case "ULD_275":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_20h_Male_Ghost_PlayerTrigger_Bone_Wraith_01);
				break;
			case "ULD_145":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_20h_Male_Ghost_PlayerTrigger_Brazen_Zealot_01);
				break;
			}
		}
	}
	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
		{
			...
			if (cardID == "ULD_207")
			{
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_20h_Male_Ghost_BossTriggerAncestralGuardian_01);
			}
		}
	}
}
