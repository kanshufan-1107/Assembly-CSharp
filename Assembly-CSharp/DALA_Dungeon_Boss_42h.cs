...
public class DALA_Dungeon_Boss_42h : DALA_Dungeon
{
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		{
		case 101:
			yield return PlayLineOnlyOnce(enemyActor, VO_DALA_BOSS_42h_Male_Mech_PlayerPogohopper_01);
			break;
		case 102:
			yield return PlayLineOnlyOnce(enemyActor, VO_DALA_BOSS_42h_Male_Mech_PlayerPogohopper2_01);
			break;
		default:
	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
		{
			...
			if (cardID == "BOT_283")
			{
				yield return PlayLineOnlyOnce(enemyActor, VO_DALA_BOSS_42h_Male_Mech_BossPogohopper_01);
			}
		}
	}
}
