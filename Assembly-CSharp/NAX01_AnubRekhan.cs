	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		if (!(cardId == "NAX1_04"))
		{
			if (cardId == "NAX1_05" && !m_locustSwarmLinePlayed)
			{
				...
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_NAX1_01_CARD_02.prefab:ed8f928f8289afd4b964eea03bf348fa", Notification.SpeechBubbleDirection.TopRight, enemyActor));
			}
		}
		else if (!m_heroPowerLinePlayed)
		{
			m_heroPowerLinePlayed = true;
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_NAX1_01_HP_03.prefab:acb19fa6cb04b424b950583d2e71293e", Notification.SpeechBubbleDirection.TopRight, enemyActor));
		}
	}
}
