...
public class ICC_04_Sindragosa : ICC_MissionEntity
{
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		if (!m_playedLines.Contains(missionEventName))
		{
			...
			case 110:
				...
				yield return PlayLineOnlyOnce(enemyActor, "VO_ICC04_Sindragosa_Female_Dragon_PlayerPlaysMinion_02.prefab:ea852ea6a4e59da479ffaff920b02d89");
				break;
			case 102:
				m_playedLines.Add(missionEventName);
				GameState.Get().SetBusy(busy: true);
				yield return PlayLineOnlyOnce(enemyActor, "VO_ICC04_Sindragosa_Female_Dragon_UnchainedMagic_02.prefab:5407a8811fc337e4b9568258f2f586ec");
				GameState.Get().SetBusy(busy: false);
				break;
			case 103:
				m_playedLines.Add(missionEventName);
				GameState.Get().SetBusy(busy: true);
				yield return PlayLineOnlyOnce(enemyActor, "VO_ICC04_Sindragosa_Female_Dragon_UnchainedMagic_04.prefab:4edcfb445a8569a4f8952f68eb82f9dc");
				GameState.Get().SetBusy(busy: false);
				break;
			case 104:
				m_playedLines.Add(missionEventName);
				...
				break;
			case 106:
				yield return PlayLineOnlyOnce(enemyActor, "VO_ICC04_Sindragosa_Female_Dragon_BreathNoRoomLeft_01.prefab:2fbd9d2b20a240742ad7204aaa8f0f58");
				break;
			case 108:
				yield return PlayLineOnlyOnce(enemyActor, "VO_ICC04_Sindragosa_Female_Dragon_SecondBreath_01.prefab:de6055ac3730d8f4aac6cd124780e00e");
				break;
			case 109:
				yield return PlayBossLine(enemyActor, "VO_ICC04_Sindragosa_Female_Dragon_Death_01.prefab:3d8e08533b9f43f4abe38d847f1b4c44");
				break;
			case 111:
				yield return PlayBossLine(enemyActor, "VO_ICC04_Sindragosa_Female_Dragon_Bounce_01.prefab:39ba1793378a6d244bcad2e2aedc94d9");
				break;
			}
		}
	}
	...
	protected override IEnumerator HandleGameOverWithTiming(TAG_PLAYSTATE gameResult)
	{
		...
		{
			yield return new WaitForSeconds(5f);
			string voLine = "VO_ICC04_LichKing_Male_Human_Lose_01.prefab:50ad5afed627fb84d8b7bd6984a60c58";
