...
public class GIL_Dungeon_Boss_44h : GIL_Dungeon
{
	...
	protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
	{
		...
		{
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_GILA_BOSS_44h_Male_Troll_Intro_01.prefab:9dd32ba7833dcfd44840ca37fba0b27b", Notification.SpeechBubbleDirection.TopRight, enemyActor));
		}
		else if (MissionEntity.STANDARD_EMOTE_RESPONSE_TRIGGERS.Contains(emoteType))
		{
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_GILA_BOSS_44h_Male_Troll_EmoteResponse_01.prefab:058769cea8ad45d4da1351f69ff6a0dd", Notification.SpeechBubbleDirection.TopRight, enemyActor));
		}
	}
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		case 101:
		{
			string randomLine = PopRandomLineWithChance(m_BossHeal);
			if (randomLine != null)
			{
		...
		case 102:
		{
			string randomLine = PopRandomLineWithChance(m_PlayerHeal);
			if (randomLine != null)
			{
				yield return PlayLineOnlyOnce(enemyActor, randomLine);
			}
	...
	protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()))
		{
			...
			if (cardID == "GILA_506t")
			{
				yield return PlayEasterEggLine(enemyActor, "VO_GILA_BOSS_44h_Male_Troll_EventPlaysBandages_01.prefab:a37d44a72287bbb48abe47ac1092dc61");
			}
		}
	}
}
