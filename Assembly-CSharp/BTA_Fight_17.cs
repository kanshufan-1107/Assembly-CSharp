...
public class BTA_Fight_17 : BTA_Dungeon
{
	...
	public override IEnumerator DoActionsBeforeDealingBaseMulliganCards()
	{
		...
		yield return PlayLineAlways(enemyActor, VO_BTA_BOSS_17h_Male_NightElf_Mission_Fight_17_BossStart_01);
	...
	protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
	{
		...
		{
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_BTA_BOSS_17h_Male_NightElf_Mission_Fight_17_Emote_Response_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
		}
	}
	...
	protected IEnumerator PlayFollowupQuote()
	{
		Actor friendlyActor = GameState.Get().GetFriendlySidePlayer().GetHero()
			...
			.GetActor();
		GameState.Get().SetBusy(busy: true);
		yield return PlayLineAlways(friendlyActor, VO_BTA_01_Female_NightElf_Mission_Fight_17_Verse8B_01);
		GameState.Get().SetBusy(busy: false);
	}
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		case 101:
			PlayFollowupQuote();
			GameState.Get().SetBusy(busy: true);
			yield return PlayLineAlways(friendlyActor, VO_BTA_01_Female_NightElf_Mission_Fight_17_Verse8A_01);
			GameState.Get().SetBusy(busy: false);
		...
		case 103:
			GameState.Get().SetBusy(busy: true);
			yield return PlayLineAlways(friendlyActor, VO_BTA_01_Female_NightElf_Mission_Fight_17_Verse8E_01);
			GameState.Get().SetBusy(busy: false);
			break;
		case 104:
			GameState.Get().SetBusy(busy: true);
		...
		case 501:
			GameState.Get().SetBusy(busy: true);
			yield return PlayLineAlways(friendlyActor, VO_BTA_01_Female_NightElf_Mission_Fight_17_EpilogueA_01);
	...
	protected override IEnumerator HandleStartOfTurnWithTiming(int turn)
	{
		...
		{
		case 1:
			yield return PlayLineAlways(enemyActor, VO_BTA_BOSS_17h_Male_NightElf_Mission_Fight_17_Verse0A_01);
			yield return PlayLineAlways(friendlyActor, VO_BTA_01_Female_NightElf_Mission_Fight_17_Verse0B_01);
			break;
		case 3:
			yield return PlayLineAlways(enemyActor, VO_BTA_BOSS_17h_Male_NightElf_Mission_Fight_17_Verse1_01);
			break;
		case 5:
			yield return PlayLineAlways(friendlyActor, VO_BTA_01_Female_NightElf_Mission_Fight_17_Verse2_01);
			break;
		case 7:
			yield return PlayLineAlways(enemyActor, VO_BTA_BOSS_17h_Male_NightElf_Mission_Fight_17_Verse3_01);
			break;
		case 9:
			yield return PlayLineAlways(friendlyActor, VO_BTA_01_Female_NightElf_Mission_Fight_17_Verse4_01);
			break;
		case 11:
			yield return PlayLineAlways(enemyActor, VO_BTA_BOSS_17h_Male_NightElf_Mission_Fight_17_Verse5_01);
			break;
		case 13:
			yield return PlayLineAlways(friendlyActor, VO_BTA_01_Female_NightElf_Mission_Fight_17_Verse6_01);
			break;
		case 15:
			yield return PlayLineAlways(enemyActor, VO_BTA_BOSS_17h_Male_NightElf_Mission_Fight_17_Verse7_01);
			break;
		case 18:
			m_DisableIdle = true;
			break;
