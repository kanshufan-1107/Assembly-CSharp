...
public class BoH_Uther_07 : BoH_Uther_Dungeon
{
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		{
		case 504:
			yield return PlayLineAlways(enemyActor, VO_Story_Hero_MalGanis_Male_Demon_Story_Uther_Mission7Loss_01);
			break;
		case 501:
			GameState.Get().SetBusy(busy: true);
	...
	protected override IEnumerator HandleStartOfTurnWithTiming(int turn)
	{
		...
		{
		case 1:
			yield return PlayLineAlways(enemyActor, VO_Story_Hero_MalGanis_Male_Demon_Story_Uther_Mission7ExchangeA_01);
			yield return PlayLineAlways(friendlyActor, VO_Story_Hero_Uther_Male_Human_Story_Uther_Mission7ExchangeA_01);
			break;
		case 7:
			yield return PlayLineAlways(enemyActor, VO_Story_Hero_MalGanis_Male_Demon_Story_Uther_Mission7ExchangeB_01);
			yield return PlayLineAlways(friendlyActor, VO_Story_Hero_Uther_Male_Human_Story_Uther_Mission7ExchangeB_01);
			break;
		case 12:
			yield return PlayLineAlways(enemyActor, VO_Story_Hero_MalGanis_Male_Demon_Story_Uther_Mission7ExchangeC_01);
			break;
		}
	}
