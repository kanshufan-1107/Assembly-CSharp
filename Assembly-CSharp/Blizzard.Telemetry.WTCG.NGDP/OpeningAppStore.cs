...
public class OpeningAppStore : IProtoBuf
{
	...
	public bool HasVersionInStore;

	private string _VersionInStore;
	...
	public string VersionInStore
	{
		get
		{
			return _VersionInStore;
		}
		set
		{
			_VersionInStore = value;
			HasVersionInStore = value != null;
		}
	}
	...
	public override int GetHashCode()
	{
		...
		if (HasVersionInStore)
		{
			hash ^= VersionInStore.GetHashCode();
		}
		return hash;
	}
	...
	{
		if (!(obj is OpeningAppStore other))
		{
			return false;
		}
		...
		if (HasVersionInStore != other.HasVersionInStore || (HasVersionInStore && !VersionInStore.Equals(other.VersionInStore)))
		{
			return false;
		}
		return true;
	...
	{
		OpeningAppStore instance = new OpeningAppStore();
	...
	public static OpeningAppStore Deserialize(Stream stream, OpeningAppStore instance, long limit)
	{
		...
		while (true)
		{
			...
			case 37:
				...
				continue;
			case 42:
				instance.VersionInStore = ProtocolParser.ReadString(stream);
				continue;
			default:
			{
	...
	public static void Serialize(Stream stream, OpeningAppStore instance)
	{
		...
		if (instance.HasVersionInStore)
		{
			stream.WriteByte(42);
			ProtocolParser.WriteBytes(stream, Encoding.UTF8.GetBytes(instance.VersionInStore));
		}
	}
	...
	public uint GetSerializedSize()
	{
		...
		{
			size++;
			uint byteCount5 = (uint)Encoding.UTF8.GetByteCount(VersionInStore);
