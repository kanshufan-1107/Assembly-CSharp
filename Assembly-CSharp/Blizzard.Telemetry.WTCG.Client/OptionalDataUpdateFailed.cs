...
public class OptionalDataUpdateFailed : IProtoBuf
{
	...
	{
		if (!(obj is OptionalDataUpdateFailed other))
		{
			return false;
		}
	...
	public static OptionalDataUpdateFailed Deserialize(Stream stream, OptionalDataUpdateFailed instance)
	{
		return Deserialize(stream, instance, -1L);
	}

	public static OptionalDataUpdateFailed DeserializeLengthDelimited(Stream stream)
	{
		OptionalDataUpdateFailed instance = new OptionalDataUpdateFailed();
		DeserializeLengthDelimited(stream, instance);
		return instance;
	}

	public static OptionalDataUpdateFailed DeserializeLengthDelimited(Stream stream, OptionalDataUpdateFailed instance)
	{
	...
	public static OptionalDataUpdateFailed Deserialize(Stream stream, OptionalDataUpdateFailed instance, long limit)
	{
	...
	public static void Serialize(Stream stream, OptionalDataUpdateFailed instance)
	{
