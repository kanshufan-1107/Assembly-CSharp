...
public class OptionalDataUpdateFinished : IProtoBuf
{
	...
	{
		if (!(obj is OptionalDataUpdateFinished other))
		{
			return false;
		}
	...
	public static OptionalDataUpdateFinished Deserialize(Stream stream, OptionalDataUpdateFinished instance)
	{
		return Deserialize(stream, instance, -1L);
	}

	public static OptionalDataUpdateFinished DeserializeLengthDelimited(Stream stream)
	{
		OptionalDataUpdateFinished instance = new OptionalDataUpdateFinished();
		DeserializeLengthDelimited(stream, instance);
		return instance;
	}

	public static OptionalDataUpdateFinished DeserializeLengthDelimited(Stream stream, OptionalDataUpdateFinished instance)
	{
	...
	public static OptionalDataUpdateFinished Deserialize(Stream stream, OptionalDataUpdateFinished instance, long limit)
	{
	...
	public static void Serialize(Stream stream, OptionalDataUpdateFinished instance)
	{
