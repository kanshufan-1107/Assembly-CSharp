...
public class AttributionLaunch : IProtoBuf
{
	...
	{
		if (!(obj is AttributionLaunch other))
		{
			return false;
		}
		...
		if (HasCounter != other.HasCounter || (HasCounter && !Counter.Equals(other.Counter)))
		{
			return false;
		}
		return true;
	...
	{
		AttributionLaunch instance = new AttributionLaunch();
	...
	public uint GetSerializedSize()
	{
		...
		{
			size++;
			size += ProtocolParser.SizeOfUInt64((ulong)Counter);
		}
		return size;
	}
}
