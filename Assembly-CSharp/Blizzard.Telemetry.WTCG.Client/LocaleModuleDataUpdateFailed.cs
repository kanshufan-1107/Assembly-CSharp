...
public class LocaleModuleDataUpdateFailed : IProtoBuf
{
	...
	{
		if (!(obj is LocaleModuleDataUpdateFailed other))
		{
			return false;
		}
	...
	public static LocaleModuleDataUpdateFailed Deserialize(Stream stream, LocaleModuleDataUpdateFailed instance)
	{
		return Deserialize(stream, instance, -1L);
	}

	public static LocaleModuleDataUpdateFailed DeserializeLengthDelimited(Stream stream)
	{
		LocaleModuleDataUpdateFailed instance = new LocaleModuleDataUpdateFailed();
		DeserializeLengthDelimited(stream, instance);
		return instance;
	}

	public static LocaleModuleDataUpdateFailed DeserializeLengthDelimited(Stream stream, LocaleModuleDataUpdateFailed instance)
	{
	...
	public static LocaleModuleDataUpdateFailed Deserialize(Stream stream, LocaleModuleDataUpdateFailed instance, long limit)
	{
	...
	public static void Serialize(Stream stream, LocaleModuleDataUpdateFailed instance)
	{
