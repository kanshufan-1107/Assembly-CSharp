...
public class DeviceMuteChanged : IProtoBuf
{
	...
	{
		if (!(obj is DeviceMuteChanged other))
		{
			return false;
		}
		...
		if (HasMuted != other.HasMuted || (HasMuted && !Muted.Equals(other.Muted)))
		{
			return false;
		}
		return true;
	...
	{
		DeviceMuteChanged instance = new DeviceMuteChanged();
