...
public class LocaleOptionalDataUpdateStopped : IProtoBuf
{
	...
	{
		if (!(obj is LocaleOptionalDataUpdateStopped other))
		{
			return false;
		}
	...
	public static LocaleOptionalDataUpdateStopped Deserialize(Stream stream, LocaleOptionalDataUpdateStopped instance)
	{
		return Deserialize(stream, instance, -1L);
	}

	public static LocaleOptionalDataUpdateStopped DeserializeLengthDelimited(Stream stream)
	{
		LocaleOptionalDataUpdateStopped instance = new LocaleOptionalDataUpdateStopped();
		DeserializeLengthDelimited(stream, instance);
		return instance;
	}

	public static LocaleOptionalDataUpdateStopped DeserializeLengthDelimited(Stream stream, LocaleOptionalDataUpdateStopped instance)
	{
	...
	public static LocaleOptionalDataUpdateStopped Deserialize(Stream stream, LocaleOptionalDataUpdateStopped instance, long limit)
	{
	...
	public static void Serialize(Stream stream, LocaleOptionalDataUpdateStopped instance)
	{
