...
public class AttributionItemTransaction : IProtoBuf
{
	...
	{
		if (!(obj is AttributionItemTransaction other))
		{
			return false;
		}
	...
	{
		AttributionItemTransaction instance = new AttributionItemTransaction();
	...
	public uint GetSerializedSize()
	{
		...
		{
			size++;
			uint byteCount104 = (uint)Encoding.UTF8.GetByteCount(ItemId);
