...
public class DeckPickerToCollection : IProtoBuf
{
	...
	{
		if (!(obj is DeckPickerToCollection other))
		{
			return false;
		}
	...
	{
		DeckPickerToCollection instance = new DeckPickerToCollection();
	...
	{
		instance.Path_ = Path.DECK_PICKER_BUTTON;
		while (true)
		{
