...
public class ThirdPartyUserIdUpdated : IProtoBuf
{
	...
	{
		if (!(obj is ThirdPartyUserIdUpdated other))
		{
			return false;
		}
		...
		if (HasValidChange != other.HasValidChange || (HasValidChange && !ValidChange.Equals(other.ValidChange)))
		{
			return false;
		}
		return true;
	...
	{
		ThirdPartyUserIdUpdated instance = new ThirdPartyUserIdUpdated();
