...
public class BoxProductBannerClicked : IProtoBuf
{
	...
	{
		if (!(obj is BoxProductBannerClicked other))
		{
			return false;
		}
	...
	public static BoxProductBannerClicked Deserialize(Stream stream, BoxProductBannerClicked instance)
	{
		return Deserialize(stream, instance, -1L);
	}

	public static BoxProductBannerClicked DeserializeLengthDelimited(Stream stream)
	{
		BoxProductBannerClicked instance = new BoxProductBannerClicked();
		DeserializeLengthDelimited(stream, instance);
		return instance;
	}

	public static BoxProductBannerClicked DeserializeLengthDelimited(Stream stream, BoxProductBannerClicked instance)
	{
	...
	public static BoxProductBannerClicked Deserialize(Stream stream, BoxProductBannerClicked instance, long limit)
	{
		while (true)
		{
	...
	public static void Serialize(Stream stream, BoxProductBannerClicked instance)
	{
