...
public class LocaleDataUpdateStopped : IProtoBuf
{
	...
	{
		if (!(obj is LocaleDataUpdateStopped other))
		{
			return false;
		}
	...
	public static LocaleDataUpdateStopped Deserialize(Stream stream, LocaleDataUpdateStopped instance)
	{
		return Deserialize(stream, instance, -1L);
	}

	public static LocaleDataUpdateStopped DeserializeLengthDelimited(Stream stream)
	{
		LocaleDataUpdateStopped instance = new LocaleDataUpdateStopped();
		DeserializeLengthDelimited(stream, instance);
		return instance;
	}

	public static LocaleDataUpdateStopped DeserializeLengthDelimited(Stream stream, LocaleDataUpdateStopped instance)
	{
	...
	public static LocaleDataUpdateStopped Deserialize(Stream stream, LocaleDataUpdateStopped instance, long limit)
	{
	...
	public static void Serialize(Stream stream, LocaleDataUpdateStopped instance)
	{
