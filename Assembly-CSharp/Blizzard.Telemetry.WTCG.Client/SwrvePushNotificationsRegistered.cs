...
public class SwrvePushNotificationsRegistered : IProtoBuf
{
	...
	{
		if (!(obj is SwrvePushNotificationsRegistered other))
		{
			return false;
		}
	...
	public static SwrvePushNotificationsRegistered Deserialize(Stream stream, SwrvePushNotificationsRegistered instance)
	{
		return Deserialize(stream, instance, -1L);
	}

	public static SwrvePushNotificationsRegistered DeserializeLengthDelimited(Stream stream)
	{
		SwrvePushNotificationsRegistered instance = new SwrvePushNotificationsRegistered();
		DeserializeLengthDelimited(stream, instance);
		return instance;
	}

	public static SwrvePushNotificationsRegistered DeserializeLengthDelimited(Stream stream, SwrvePushNotificationsRegistered instance)
	{
	...
	public static SwrvePushNotificationsRegistered Deserialize(Stream stream, SwrvePushNotificationsRegistered instance, long limit)
	{
		while (true)
		{
	...
	public static void Serialize(Stream stream, SwrvePushNotificationsRegistered instance)
	{
