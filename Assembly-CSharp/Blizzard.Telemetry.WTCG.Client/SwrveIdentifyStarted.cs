...
public class SwrveIdentifyStarted : IProtoBuf
{
	...
	{
		if (!(obj is SwrveIdentifyStarted other))
		{
			return false;
		}
	...
	public static SwrveIdentifyStarted Deserialize(Stream stream, SwrveIdentifyStarted instance)
	{
		return Deserialize(stream, instance, -1L);
	}

	public static SwrveIdentifyStarted DeserializeLengthDelimited(Stream stream)
	{
		SwrveIdentifyStarted instance = new SwrveIdentifyStarted();
		DeserializeLengthDelimited(stream, instance);
		return instance;
	}

	public static SwrveIdentifyStarted DeserializeLengthDelimited(Stream stream, SwrveIdentifyStarted instance)
	{
	...
	public static SwrveIdentifyStarted Deserialize(Stream stream, SwrveIdentifyStarted instance, long limit)
	{
		while (true)
		{
	...
	public static void Serialize(Stream stream, SwrveIdentifyStarted instance)
	{
