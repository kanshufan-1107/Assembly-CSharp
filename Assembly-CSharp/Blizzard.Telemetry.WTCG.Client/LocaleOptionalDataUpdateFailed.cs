...
public class LocaleOptionalDataUpdateFailed : IProtoBuf
{
	...
	{
		if (!(obj is LocaleOptionalDataUpdateFailed other))
		{
			return false;
		}
	...
	public static LocaleOptionalDataUpdateFailed Deserialize(Stream stream, LocaleOptionalDataUpdateFailed instance)
	{
		return Deserialize(stream, instance, -1L);
	}

	public static LocaleOptionalDataUpdateFailed DeserializeLengthDelimited(Stream stream)
	{
		LocaleOptionalDataUpdateFailed instance = new LocaleOptionalDataUpdateFailed();
		DeserializeLengthDelimited(stream, instance);
		return instance;
	}

	public static LocaleOptionalDataUpdateFailed DeserializeLengthDelimited(Stream stream, LocaleOptionalDataUpdateFailed instance)
	{
	...
	public static LocaleOptionalDataUpdateFailed Deserialize(Stream stream, LocaleOptionalDataUpdateFailed instance, long limit)
	{
	...
	public static void Serialize(Stream stream, LocaleOptionalDataUpdateFailed instance)
	{
