...
public class LocaleModuleDataUpdateFinished : IProtoBuf
{
	...
	{
		if (!(obj is LocaleModuleDataUpdateFinished other))
		{
			return false;
		}
	...
	public static LocaleModuleDataUpdateFinished Deserialize(Stream stream, LocaleModuleDataUpdateFinished instance)
	{
		return Deserialize(stream, instance, -1L);
	}

	public static LocaleModuleDataUpdateFinished DeserializeLengthDelimited(Stream stream)
	{
		LocaleModuleDataUpdateFinished instance = new LocaleModuleDataUpdateFinished();
		DeserializeLengthDelimited(stream, instance);
		return instance;
	}

	public static LocaleModuleDataUpdateFinished DeserializeLengthDelimited(Stream stream, LocaleModuleDataUpdateFinished instance)
	{
	...
	public static LocaleModuleDataUpdateFinished Deserialize(Stream stream, LocaleModuleDataUpdateFinished instance, long limit)
	{
	...
	public static void Serialize(Stream stream, LocaleModuleDataUpdateFinished instance)
	{
	...
	public uint GetSerializedSize()
	{
		...
		{
			size++;
			uint byteCount5 = (uint)Encoding.UTF8.GetByteCount(ModuleName);
