...
public class BlizzardCheckoutPurchaseCompletedSuccess : IProtoBuf
{
	...
	{
		if (!(obj is BlizzardCheckoutPurchaseCompletedSuccess other))
		{
			return false;
		}
	...
	{
		BlizzardCheckoutPurchaseCompletedSuccess instance = new BlizzardCheckoutPurchaseCompletedSuccess();
