...
public class ModuleDataUpdateStopped : IProtoBuf
{
	...
	{
		if (!(obj is ModuleDataUpdateStopped other))
		{
			return false;
		}
	...
	public static ModuleDataUpdateStopped Deserialize(Stream stream, ModuleDataUpdateStopped instance)
	{
		return Deserialize(stream, instance, -1L);
	}

	public static ModuleDataUpdateStopped DeserializeLengthDelimited(Stream stream)
	{
		ModuleDataUpdateStopped instance = new ModuleDataUpdateStopped();
		DeserializeLengthDelimited(stream, instance);
		return instance;
	}

	public static ModuleDataUpdateStopped DeserializeLengthDelimited(Stream stream, ModuleDataUpdateStopped instance)
	{
	...
	public static ModuleDataUpdateStopped Deserialize(Stream stream, ModuleDataUpdateStopped instance, long limit)
	{
	...
	public static void Serialize(Stream stream, ModuleDataUpdateStopped instance)
	{
