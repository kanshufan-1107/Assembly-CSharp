...
public class AccountMergeResult : IProtoBuf
{
	...
	{
		if (!(obj is AccountMergeResult other))
		{
			return false;
		}
	...
	public static AccountMergeResult Deserialize(Stream stream, AccountMergeResult instance)
	{
		return Deserialize(stream, instance, -1L);
	}

	public static AccountMergeResult DeserializeLengthDelimited(Stream stream)
	{
	...
	public static AccountMergeResult DeserializeLengthDelimited(Stream stream, AccountMergeResult instance)
	{
	...
	public static AccountMergeResult Deserialize(Stream stream, AccountMergeResult instance, long limit)
	{
		instance.Result = MergeResult.SUCCESS;
		while (true)
		{
			...
			case 18:
				...
				continue;
			case 24:
				instance.Result = (MergeResult)ProtocolParser.ReadUInt64(stream);
				continue;
			case 32:
	...
	public static void Serialize(Stream stream, AccountMergeResult instance)
	{
