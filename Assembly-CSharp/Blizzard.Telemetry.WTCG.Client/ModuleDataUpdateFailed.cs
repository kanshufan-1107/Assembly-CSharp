...
public class ModuleDataUpdateFailed : IProtoBuf
{
	...
	{
		if (!(obj is ModuleDataUpdateFailed other))
		{
			return false;
		}
	...
	public static ModuleDataUpdateFailed Deserialize(Stream stream, ModuleDataUpdateFailed instance)
	{
		return Deserialize(stream, instance, -1L);
	}

	public static ModuleDataUpdateFailed DeserializeLengthDelimited(Stream stream)
	{
		ModuleDataUpdateFailed instance = new ModuleDataUpdateFailed();
		DeserializeLengthDelimited(stream, instance);
		return instance;
	}

	public static ModuleDataUpdateFailed DeserializeLengthDelimited(Stream stream, ModuleDataUpdateFailed instance)
	{
	...
	public static ModuleDataUpdateFailed Deserialize(Stream stream, ModuleDataUpdateFailed instance, long limit)
	{
	...
	public static void Serialize(Stream stream, ModuleDataUpdateFailed instance)
	{
