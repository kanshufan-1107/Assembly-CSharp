...
public class SwrveAppInitialized : IProtoBuf
{
	...
	{
		if (!(obj is SwrveAppInitialized other))
		{
			return false;
		}
	...
	public static SwrveAppInitialized Deserialize(Stream stream, SwrveAppInitialized instance)
	{
		return Deserialize(stream, instance, -1L);
	}

	public static SwrveAppInitialized DeserializeLengthDelimited(Stream stream)
	{
		SwrveAppInitialized instance = new SwrveAppInitialized();
		DeserializeLengthDelimited(stream, instance);
		return instance;
	}

	public static SwrveAppInitialized DeserializeLengthDelimited(Stream stream, SwrveAppInitialized instance)
	{
	...
	public static SwrveAppInitialized Deserialize(Stream stream, SwrveAppInitialized instance, long limit)
	{
		while (true)
		{
	...
	public static void Serialize(Stream stream, SwrveAppInitialized instance)
	{
