...
public class SwrveRemoteNotificationReceived : IProtoBuf
{
	...
	{
		if (!(obj is SwrveRemoteNotificationReceived other))
		{
			return false;
		}
	...
	public static SwrveRemoteNotificationReceived Deserialize(Stream stream, SwrveRemoteNotificationReceived instance)
	{
		return Deserialize(stream, instance, -1L);
	}

	public static SwrveRemoteNotificationReceived DeserializeLengthDelimited(Stream stream)
	{
		SwrveRemoteNotificationReceived instance = new SwrveRemoteNotificationReceived();
		DeserializeLengthDelimited(stream, instance);
		return instance;
	}

	public static SwrveRemoteNotificationReceived DeserializeLengthDelimited(Stream stream, SwrveRemoteNotificationReceived instance)
	{
	...
	public static SwrveRemoteNotificationReceived Deserialize(Stream stream, SwrveRemoteNotificationReceived instance, long limit)
	{
		while (true)
		{
	...
	public static void Serialize(Stream stream, SwrveRemoteNotificationReceived instance)
	{
