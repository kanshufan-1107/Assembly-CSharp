...
public class SwrveDeviceTokenObtained : IProtoBuf
{
	...
	{
		if (!(obj is SwrveDeviceTokenObtained other))
		{
			return false;
		}
	...
	public static SwrveDeviceTokenObtained Deserialize(Stream stream, SwrveDeviceTokenObtained instance)
	{
		return Deserialize(stream, instance, -1L);
	}

	public static SwrveDeviceTokenObtained DeserializeLengthDelimited(Stream stream)
	{
		SwrveDeviceTokenObtained instance = new SwrveDeviceTokenObtained();
		DeserializeLengthDelimited(stream, instance);
		return instance;
	}

	public static SwrveDeviceTokenObtained DeserializeLengthDelimited(Stream stream, SwrveDeviceTokenObtained instance)
	{
	...
	public static SwrveDeviceTokenObtained Deserialize(Stream stream, SwrveDeviceTokenObtained instance, long limit)
	{
		while (true)
		{
	...
	public static void Serialize(Stream stream, SwrveDeviceTokenObtained instance)
	{
	...
	public uint GetSerializedSize()
	{
		...
		{
			size += 2;
			uint byteCount40 = (uint)Encoding.UTF8.GetByteCount(DeviceToken);
