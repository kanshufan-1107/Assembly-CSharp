...
public class SwrveOpenedByPushNotification : IProtoBuf
{
	...
	{
		if (!(obj is SwrveOpenedByPushNotification other))
		{
			return false;
		}
	...
	public static SwrveOpenedByPushNotification Deserialize(Stream stream, SwrveOpenedByPushNotification instance)
	{
		return Deserialize(stream, instance, -1L);
	}

	public static SwrveOpenedByPushNotification DeserializeLengthDelimited(Stream stream)
	{
		SwrveOpenedByPushNotification instance = new SwrveOpenedByPushNotification();
		DeserializeLengthDelimited(stream, instance);
		return instance;
	}

	public static SwrveOpenedByPushNotification DeserializeLengthDelimited(Stream stream, SwrveOpenedByPushNotification instance)
	{
	...
	public static SwrveOpenedByPushNotification Deserialize(Stream stream, SwrveOpenedByPushNotification instance, long limit)
	{
		while (true)
		{
	...
	public static void Serialize(Stream stream, SwrveOpenedByPushNotification instance)
	{
