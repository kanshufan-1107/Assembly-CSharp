...
public class ThirdPartyPurchaseSubmitResponseDeviceNotification : IProtoBuf
{
	...
	{
		if (!(obj is ThirdPartyPurchaseSubmitResponseDeviceNotification other))
		{
			return false;
		}
	...
	{
		ThirdPartyPurchaseSubmitResponseDeviceNotification instance = new ThirdPartyPurchaseSubmitResponseDeviceNotification();
