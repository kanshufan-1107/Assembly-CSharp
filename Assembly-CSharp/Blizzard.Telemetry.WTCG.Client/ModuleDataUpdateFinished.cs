...
public class ModuleDataUpdateFinished : IProtoBuf
{
	...
	{
		if (!(obj is ModuleDataUpdateFinished other))
		{
			return false;
		}
	...
	public static ModuleDataUpdateFinished Deserialize(Stream stream, ModuleDataUpdateFinished instance)
	{
		return Deserialize(stream, instance, -1L);
	}

	public static ModuleDataUpdateFinished DeserializeLengthDelimited(Stream stream)
	{
		ModuleDataUpdateFinished instance = new ModuleDataUpdateFinished();
		DeserializeLengthDelimited(stream, instance);
		return instance;
	}

	public static ModuleDataUpdateFinished DeserializeLengthDelimited(Stream stream, ModuleDataUpdateFinished instance)
	{
	...
	public static ModuleDataUpdateFinished Deserialize(Stream stream, ModuleDataUpdateFinished instance, long limit)
	{
	...
	public static void Serialize(Stream stream, ModuleDataUpdateFinished instance)
	{
