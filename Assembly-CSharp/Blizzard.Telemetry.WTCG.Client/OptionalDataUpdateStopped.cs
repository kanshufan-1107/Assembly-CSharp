...
public class OptionalDataUpdateStopped : IProtoBuf
{
	...
	{
		if (!(obj is OptionalDataUpdateStopped other))
		{
			return false;
		}
	...
	public static OptionalDataUpdateStopped Deserialize(Stream stream, OptionalDataUpdateStopped instance)
	{
		return Deserialize(stream, instance, -1L);
	}

	public static OptionalDataUpdateStopped DeserializeLengthDelimited(Stream stream)
	{
		OptionalDataUpdateStopped instance = new OptionalDataUpdateStopped();
		DeserializeLengthDelimited(stream, instance);
		return instance;
	}

	public static OptionalDataUpdateStopped DeserializeLengthDelimited(Stream stream, OptionalDataUpdateStopped instance)
	{
	...
	public static OptionalDataUpdateStopped Deserialize(Stream stream, OptionalDataUpdateStopped instance, long limit)
	{
	...
	public static void Serialize(Stream stream, OptionalDataUpdateStopped instance)
	{
