...
public class LocaleOptionalDataUpdateFinished : IProtoBuf
{
	...
	{
		if (!(obj is LocaleOptionalDataUpdateFinished other))
		{
			return false;
		}
	...
	public static LocaleOptionalDataUpdateFinished Deserialize(Stream stream, LocaleOptionalDataUpdateFinished instance)
	{
		return Deserialize(stream, instance, -1L);
	}

	public static LocaleOptionalDataUpdateFinished DeserializeLengthDelimited(Stream stream)
	{
		LocaleOptionalDataUpdateFinished instance = new LocaleOptionalDataUpdateFinished();
		DeserializeLengthDelimited(stream, instance);
		return instance;
	}

	public static LocaleOptionalDataUpdateFinished DeserializeLengthDelimited(Stream stream, LocaleOptionalDataUpdateFinished instance)
	{
	...
	public static LocaleOptionalDataUpdateFinished Deserialize(Stream stream, LocaleOptionalDataUpdateFinished instance, long limit)
	{
	...
	public static void Serialize(Stream stream, LocaleOptionalDataUpdateFinished instance)
	{
