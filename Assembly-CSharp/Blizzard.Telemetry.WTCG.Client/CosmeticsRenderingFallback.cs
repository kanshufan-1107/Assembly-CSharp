...
public class CosmeticsRenderingFallback : IProtoBuf
{
	...
	{
		if (!(obj is CosmeticsRenderingFallback other))
		{
			return false;
		}
	...
	public static CosmeticsRenderingFallback Deserialize(Stream stream, CosmeticsRenderingFallback instance)
	{
		return Deserialize(stream, instance, -1L);
	}

	public static CosmeticsRenderingFallback DeserializeLengthDelimited(Stream stream)
	{
		CosmeticsRenderingFallback instance = new CosmeticsRenderingFallback();
		DeserializeLengthDelimited(stream, instance);
		return instance;
	}

	public static CosmeticsRenderingFallback DeserializeLengthDelimited(Stream stream, CosmeticsRenderingFallback instance)
	{
	...
	public static CosmeticsRenderingFallback Deserialize(Stream stream, CosmeticsRenderingFallback instance, long limit)
	{
		while (true)
		{
	...
	public static void Serialize(Stream stream, CosmeticsRenderingFallback instance)
	{
