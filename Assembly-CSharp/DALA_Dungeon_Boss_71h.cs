...
public class DALA_Dungeon_Boss_71h : DALA_Dungeon
{
	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
		{
			...
			{
			case "EX1_571":
				yield return PlayLineOnlyOnce(enemyActor, VO_DALA_BOSS_71h_Female_NightElf_BossForceOfNature_01);
				break;
			case "EX1_158":
				yield return PlayLineOnlyOnce(enemyActor, VO_DALA_BOSS_71h_Female_NightElf_BossSoulOfTheForest_01);
				break;
			case "TRL_341":
				yield return PlayLineOnlyOnce(enemyActor, VO_DALA_BOSS_71h_Female_NightElf_BossTreeSpeaker_01);
				break;
			}
		}
	}
