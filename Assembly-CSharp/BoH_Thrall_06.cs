...
public class BoH_Thrall_06 : BoH_Thrall_Dungeon
{
	...
	public override IEnumerator DoActionsBeforeDealingBaseMulliganCards()
	{
		...
		yield return MissionPlayVO(enemyActor, VO_Story_Hero_Deathwing_Male_Dragon_Story_Thrall_Mission6Intro_01);
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		case 507:
			GameState.Get().SetBusy(busy: true);
			yield return PlayLineAlways(enemyActor, VO_Story_Hero_Deathwing_Male_Dragon_Story_Thrall_Mission6Loss_01);
			GameState.Get().SetBusy(busy: false);
			break;
		case 103:
			GameState.Get().SetBusy(busy: true);
	...
	protected override IEnumerator HandleStartOfTurnWithTiming(int turn)
	{
		...
		{
		case 2:
			yield return PlayLineAlways(enemyActor, VO_Story_Hero_Deathwing_Male_Dragon_Story_Thrall_Mission6ExchangeA_01);
			...
			break;
		case 7:
			yield return PlayLineAlways(enemyActor, VO_Story_Hero_Deathwing_Male_Dragon_Story_Thrall_Mission6ExchangeB_01);
			break;
		case 9:
			yield return PlayLineAlways(enemyActor, VO_Story_Hero_Deathwing_Male_Dragon_Story_Thrall_Mission6ExchangeC_01);
			break;
		case 13:
