...
public class LOOT_Dungeon_BOSS_37h : LOOT_Dungeon
{
	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()))
		{
			...
			if (cardId == "BRM_002")
			{
				yield return PlayLineOnlyOnce(enemyActor, "VO_LOOTA_BOSS_37h_Female_BloodElf_Flamewakers_01.prefab:f14f69393caf7f0458dfa3e3d3539e10");
			}
		}
	}
	...
	protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
	{
		...
		{
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_LOOTA_BOSS_37h_Female_BloodElf_Intro_01.prefab:787f8e4723194de4bba60f2d80035ad0", Notification.SpeechBubbleDirection.TopRight, enemyActor));
		}
		else if (MissionEntity.STANDARD_EMOTE_RESPONSE_TRIGGERS.Contains(emoteType))
		{
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_LOOTA_BOSS_37h_Female_BloodElf_EmoteResponse_01.prefab:636239635d202b042a286ad844eda901", Notification.SpeechBubbleDirection.TopRight, enemyActor));
		}
	}
	...
	protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()))
		{
			...
			{
			case "LOOTA_843":
				yield return PlayLineOnlyOnce(enemyActor, "VO_LOOTA_BOSS_37h_Female_BloodElf_EventTheCandle_01.prefab:2674d9632f2b16245b8febb2a27e6551");
				break;
			case "EX1_279":
				yield return PlayEasterEggLine(enemyActor, "VO_LOOTA_BOSS_37h_Female_BloodElf_EventPyroblast_01.prefab:3104b792fda960c43a9ae857d8afeaaf");
				break;
			case "CS2_029":
				yield return PlayEasterEggLine(enemyActor, "VO_LOOTA_BOSS_37h_Female_BloodElf_EventFireball_01.prefab:51c0b0ac775aee44b9c3d9bcf321e35e");
				break;
			case "EX1_298":
				yield return PlayEasterEggLine(enemyActor, "VO_LOOTA_BOSS_37h_Female_BloodElf_EventRagnaros_01.prefab:52e35fb26e37aec4084d826f2a12e95c");
				break;
			}
		}
	}
