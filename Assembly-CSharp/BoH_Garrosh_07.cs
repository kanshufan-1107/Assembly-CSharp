...
public class BoH_Garrosh_07 : BoH_Garrosh_Dungeon
{
	...
	public override IEnumerator DoActionsBeforeDealingBaseMulliganCards()
	{
		...
		yield return PlayLineAlways(friendlyActor, VO_Story_Hero_Garrosh_Male_Orc_Story_Garrosh_Mission7Intro_01);
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		case 501:
			GameState.Get().SetBusy(busy: true);
			yield return PlayLineAlways(friendlyActor, VO_Story_Hero_Garrosh_Male_Orc_Story_Garrosh_Mission7Victory_01);
			GameState.Get().SetBusy(busy: false);
			break;
		case 112:
			yield return PlayAndRemoveRandomLineOnlyOnce(friendlyActor, m_missionEventTrigger502Lines);
			break;
		case 504:
			GameState.Get().SetBusy(busy: true);
			yield return PlayLineAlways(enemyActor, VO_Story_Hero_Anduin_Male_Human_Story_Garrosh_Mission7Loss_01);
			GameState.Get().SetBusy(busy: false);
			break;
		default:
