...
public class TurnStartIndicator : MonoBehaviour
{
	...
	public virtual void Show()
	{
		...
		scaleArgs.Add("scale", new Vector3(10f, 10f, 10f));
		scaleArgs.Add("time", 0.25f);
		scaleArgs.Add("oncomplete", "PunchTurnStartInstance");
		...
		moveArgs.Add("position", base.gameObject.transform.position + new Vector3(0.02f, 0.02f, 0.02f));
		moveArgs.Add("time", m_desiredDisplayDuration);
		moveArgs.Add("oncomplete", "HideTurnStartInstance");
