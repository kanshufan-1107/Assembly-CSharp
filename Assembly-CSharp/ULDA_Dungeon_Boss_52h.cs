...
public class ULDA_Dungeon_Boss_52h : ULDA_Dungeon
{
	...
	protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
	{
		...
		string playerHeroCardID = GameState.Get().GetFriendlySidePlayer().GetHero()
			.GetCardId();
		if (emoteType == EmoteType.START && playerHeroCardID != "ULDA_Reno")
		{
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		{
		case 102:
			yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_52h_Female_UndeadLich_BossTriggerFreezePlayer_01);
			break;
		case 101:
			yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_52h_Female_UndeadLich_PlayerFreezeBoss_01);
			break;
		default:
	...
	protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
		{
			...
			{
			case "ICC_854":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_52h_Female_UndeadLich_PlayerTrigger_Arfus_01);
				break;
			case "ULD_282":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_52h_Female_UndeadLich_PlayerTrigger_Jar_Dealer_01);
				break;
			case "FP1_013":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_52h_Female_UndeadLich_PlayerTrigger_Kelthuzad_01);
				break;
			case "ICC_314":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_52h_Female_UndeadLich_PlayerTrigger_LichKing_01);
				break;
			case "ULD_268":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_52h_Female_UndeadLich_PlayerTrigger_Psychopomp_01);
				break;
			}
		}
	}
	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
		{
			...
			{
			case "CS2_026":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_52h_Female_UndeadLich_BossTriggerFrostNova_01);
				break;
			case "DAL_577":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_52h_Female_UndeadLich_BossTriggerRayofFrost_01);
				break;
			case "CS2_033":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_52h_Female_UndeadLich_BossTriggerWaterElemental_01);
				break;
			}
		}
	}
