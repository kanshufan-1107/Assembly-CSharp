...
public class ScenarioGuestHeroesDbfRecord : DbfRecord
{
	...
	{
		ScenarioGuestHeroesDbfAsset dbfAsset = DbfShared.GetAssetBundle().LoadAsset(resourcePath, typeof(ScenarioGuestHeroesDbfAsset)) as ScenarioGuestHeroesDbfAsset;
		if (dbfAsset == null)
		{
			records = new List<T>();
