...
public class DeckRulesetRuleSubsetDbfRecord : DbfRecord
{
	...
	{
		DeckRulesetRuleSubsetDbfAsset dbfAsset = DbfShared.GetAssetBundle().LoadAsset(resourcePath, typeof(DeckRulesetRuleSubsetDbfAsset)) as DeckRulesetRuleSubsetDbfAsset;
		if (dbfAsset == null)
		{
			records = new List<T>();
