...
public class TRL_Dungeon_Boss_205h : TRL_Dungeon
{
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		{
		case 1001:
			yield return PlayLineOnlyOnce(enemyActor, VO_TRLA_205h_Female_Troll_ShrineComesBack_01);
			break;
		case 1002:
			yield return PlayLineOnlyOnce(enemyActor, VO_TRLA_205h_Female_Troll_ShrineComesBack_02);
			break;
		case 1003:
			yield return PlayLineOnlyOnce(enemyActor, VO_TRLA_205h_Female_Troll_ShrineEvent_PlusAttack_01);
			break;
		case 1004:
			yield return PlayAndRemoveRandomLineOnlyOnce(enemyActor, m_WildLines);
			break;
		case 1005:
			yield return PlayAndRemoveRandomLineOnlyOnce(enemyActor, m_BondLines);
			break;
		case 1006:
			yield return PlayAndRemoveRandomLineOnlyOnce(enemyActor, m_ArmorLines);
			break;
		default:
	...
	protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()))
		{
			...
			if (cardID == "UNG_926")
			{
				yield return PlayLineOnlyOnce(enemyActor, VO_TRLA_205h_Female_Troll_Play_CorneredSentry_01);
			}
		}
	}
	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()))
		{
			...
			{
			case "TRL_241":
				yield return PlayLineOnlyOnce(enemyActor, VO_TRLA_205h_Female_Troll_Play_Gonk_01);
				break;
			case "TRL_223":
				yield return PlayLineOnlyOnce(enemyActor, VO_TRLA_205h_Female_Troll_Play_SpiritOfTheRaptor_01);
				break;
			case "TRL_254":
				yield return PlayLineOnlyOnce(enemyActor, VO_TRLA_205h_Female_Troll_Play_MarkOfTheLoa_01);
				break;
			case "TRL_541":
				yield return PlayLineOnlyOnce(enemyActor, VO_TRLA_205h_Female_Troll_Play_Hakkar_01);
				break;
			}
		}
	}
