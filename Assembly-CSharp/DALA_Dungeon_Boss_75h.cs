...
public class DALA_Dungeon_Boss_75h : DALA_Dungeon
{
	...
	protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
	{
		...
		if (emoteType == EmoteType.START)
		{
			...
			{
			case "DALA_Chu":
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_DALA_BOSS_75h_Male_Human_IntroChu_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
				break;
			case "DALA_Eudora":
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_DALA_BOSS_75h_Male_Human_IntroEudora_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
				break;
			case "DALA_George":
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_DALA_BOSS_75h_Male_Human_IntroGeorge_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
				break;
			case "DALA_Kriziki":
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_DALA_BOSS_75h_Male_Human_IntroKriziki_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
				break;
			case "DALA_Barkeye":
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_DALA_BOSS_75h_Male_Human_IntroOlBarkeye_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
				break;
			case "DALA_Rakanishu":
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_DALA_BOSS_75h_Male_Human_IntroRakanishu_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
				break;
			case "DALA_Squemlish":
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_DALA_BOSS_75h_Male_Human_IntroSqueamlish_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
				break;
			case "DALA_Tekahn":
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_DALA_BOSS_75h_Male_Human_IntroTekahn_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
				break;
			case "DALA_Vessina":
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_DALA_BOSS_75h_Male_Human_IntroVessina_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
				break;
			default:
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		{
		case 101:
			yield return PlayLineOnlyOnce(enemyActor, VO_DALA_BOSS_75h_Male_Human_QuestA_01);
			break;
		case 102:
			yield return PlayLineOnlyOnce(enemyActor, VO_DALA_BOSS_75h_Male_Human_QuestA_02);
			break;
		case 103:
			GameState.Get().SetBusy(busy: true);
			yield return PlayLineOnlyOnce(enemyActor, VO_DALA_BOSS_75h_Male_Human_QuestA_03);
			GameState.Get().SetBusy(busy: false);
			break;
		case 104:
			yield return PlayLineOnlyOnce(enemyActor, VO_DALA_BOSS_75h_Male_Human_QuestB_01);
			break;
		case 105:
			yield return PlayLineOnlyOnce(enemyActor, VO_DALA_BOSS_75h_Male_Human_QuestB_02);
			break;
		case 106:
			GameState.Get().SetBusy(busy: true);
			yield return PlayLineOnlyOnce(enemyActor, VO_DALA_BOSS_75h_Male_Human_QuestB_03);
			GameState.Get().SetBusy(busy: false);
			break;
		case 107:
			yield return PlayLineOnlyOnce(enemyActor, VO_DALA_BOSS_75h_Male_Human_QuestC_01);
			break;
		case 108:
			yield return PlayLineOnlyOnce(enemyActor, VO_DALA_BOSS_75h_Male_Human_QuestC_02);
			break;
		case 109:
			GameState.Get().SetBusy(busy: true);
			yield return PlayLineOnlyOnce(enemyActor, VO_DALA_BOSS_75h_Male_Human_QuestC_03);
			GameState.Get().SetBusy(busy: false);
			break;
		case 110:
			GameState.Get().SetBusy(busy: true);
			yield return PlayLineOnlyOnce(enemyActor, VO_DALA_BOSS_75h_Male_Human_QuestCFail_01);
			GameState.Get().SetBusy(busy: false);
			break;
		case 111:
			yield return PlayLineOnlyOnce(enemyActor, VO_DALA_BOSS_75h_Male_Human_QuestD_01);
			break;
		case 112:
			yield return PlayLineOnlyOnce(enemyActor, VO_DALA_BOSS_75h_Male_Human_QuestD_02);
			break;
		case 113:
			yield return PlayLineOnlyOnce(enemyActor, VO_DALA_BOSS_75h_Male_Human_QuestD_03);
			break;
		case 114:
			GameState.Get().SetBusy(busy: true);
			yield return PlayLineOnlyOnce(enemyActor, VO_DALA_BOSS_75h_Male_Human_QuestD_04);
			GameState.Get().SetBusy(busy: false);
			break;
		case 115:
			yield return PlayLineOnlyOnce(enemyActor, VO_DALA_BOSS_75h_Male_Human_QuestE_01);
			break;
		case 116:
			yield return PlayLineOnlyOnce(enemyActor, VO_DALA_BOSS_75h_Male_Human_QuestE_02);
			break;
		case 117:
			GameState.Get().SetBusy(busy: true);
			yield return PlayLineOnlyOnce(enemyActor, VO_DALA_BOSS_75h_Male_Human_QuestE_03);
			GameState.Get().SetBusy(busy: false);
			break;
		case 118:
			GameState.Get().SetBusy(busy: true);
			yield return PlayAndRemoveRandomLineOnlyOnce(enemyActor, m_BossTurnOne);
			GameState.Get().SetBusy(busy: false);
			break;
		case 120:
			yield return PlayAndRemoveRandomLineOnlyOnce(enemyActor, m_BossOutro);
			break;
		default:
