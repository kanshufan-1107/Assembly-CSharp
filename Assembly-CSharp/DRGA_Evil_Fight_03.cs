...
public class DRGA_Evil_Fight_03 : DRGA_Dungeon
{
	...
	protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
	{
		...
		if (emoteType == EmoteType.START)
		{
			if (!m_Heroic)
			{
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_DRGA_BOSS_01h_Male_Human_Evil_Fight_03_BossStart_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
			}
			else if (m_Heroic)
			{
		...
		{
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_DRGA_BOSS_01h_Male_Human_Evil_Fight_03_EmoteResponse_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
		}
	}
	...
	protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
	{
		...
		{
		case "LOE_077":
			yield return PlayLineOnlyOnce(enemyActor, VO_DRGA_BOSS_01h_Male_Human_Evil_Fight_03_Player_BrannMinion_01);
			break;
		case "LOE_079":
			yield return PlayLineOnlyOnce(enemyActor, VO_DRGA_BOSS_01h_Male_Human_Evil_Fight_03_Player_EliseMinion_01);
			break;
		case "LOE_076":
			yield return PlayLineOnlyOnce(enemyActor, VO_DRGA_BOSS_01h_Male_Human_Evil_Fight_03_Player_FinleyMinion_01);
			break;
		case "ULD_139":
		case "ULD_500":
		case "ULD_156":
		case "ULD_238":
			if (m_Heroic)
			{
				yield return PlayLineOnlyOnce(enemyActor, VO_DRGA_BOSS_01h_Male_Human_Evil_Fight_03_Player_LoEMinion_01);
			}
			break;
		case "EX1_182":
			yield return PlayLineOnlyOnce(enemyActor, VO_DRGA_BOSS_01h_Male_Human_Evil_Fight_03_Player_Pilfer_01);
			break;
		case "DRGA_001":
		case "LOE_011":
			if (m_Heroic)
			{
				yield return PlayLineAlways(enemyActor, VO_DRGA_BOSS_01h_Male_Human_Evil_Fight_03_Player_RenoHero_01);
