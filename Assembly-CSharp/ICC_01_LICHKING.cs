...
public class ICC_01_LICHKING : ICC_MissionEntity
{
	...
	public override string GetNameBannerSubtextOverride(Player.Side playerSide)
	{
		if (playerSide == Player.Side.OPPOSING)
		{
			...
			if (opposingPlayer.GetHero() == opposingPlayer.GetStartingHero())
			{
	...
	public override void OnPlayThinkEmote()
	{
		...
		if (currentPlayer.IsFriendlySide() && !currentPlayer.GetHeroCard().HasActiveEmoteSound())
		{
			...
			{
			case 1:
				Gameplay.Get().StartCoroutine(PlayBossLine(enemyActor, "VO_ICC01_LichKing_Male_Human_Idle_01.prefab:4b9c6ba7bb584d04db2142a51282dd19"));
	...
	protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
	{
		...
		{
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_ICC01_LichKing_Male_Human_Intro_01.prefab:7febb86d30cc95342823c0d6e9881573", Notification.SpeechBubbleDirection.TopRight, enemyActor));
		}
		else
		{
			...
			if (!(enemyHeroCardID == "ICCA01_001"))
			{
				if (enemyHeroCardID == "ICCA01_013")
				{
					Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_ICC01_Tirion_Male_Human_EmoteResponse_02.prefab:472ecefae2bb58d40b80e893ab4960af", Notification.SpeechBubbleDirection.TopRight, enemyActor));
				}
			}
			else
			{
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_ICC01_LichKing_Male_Human_EmoteResponse_01.prefab:e99b3bedcc63f8248bd0e47d26947a41", Notification.SpeechBubbleDirection.TopRight, enemyActor));
			}
		}
	}
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		if (!m_playedLines.Contains(missionEventName))
		{
			...
			case 111:
				GameState.Get().SetBusy(busy: true);
				yield return PlayBossLine(playerActor, "VO_ICC01_Jaina_Female_Human_PostDeath_02.prefab:32db8cb82e111fd4c8bb56f5db507858");
				GameState.Get().SetBusy(busy: false);
				break;
			case 112:
				m_playedLines.Add(missionEventName);
	...
	protected override IEnumerator HandleStartOfTurnWithTiming(int turn)
	{
		...
		case 5:
			GameState.Get().SetBusy(busy: true);
			yield return PlayLineOnlyOnce(playerActor, "VO_ICC01_Jaina_Female_Human_DrawsRager_01.prefab:e8af0892cde840d41bf498a45573303f");
		...
		case 6:
			...
			break;
		case 7:
			yield return PlayLineOnlyOnce(playerActor, "VO_ICC01_Jaina_Female_Human_JainaDKIntro_05.prefab:e2b9b4bad3d006d45a1ed347b0cf6662");
			break;
		case 8:
			GameState.Get().SetBusy(busy: true);
	...
	{
		AudioSource audioSource = GetPreloadedSound("VO_ICC01_Tirion_Male_Human_PostDeath_01.prefab:baaf7891e78de8343ae7fca845615ed0");
		float length = 6.8f;
		...
		Notification popup = NotificationManager.Get().CreateBigCharacterQuoteWithText("Tirion_BigQuote.prefab:878fcebc1cddaf24f828c44edb07f7f8", NotificationManager.DEFAULT_CHARACTER_POS, "VO_ICC01_Tirion_Male_Human_PostDeath_01.prefab:baaf7891e78de8343ae7fca845615ed0", GameStrings.Get("VO_ICC01_Tirion_Male_Human_PostDeath_01"), length + 1f, null, useOverlayUI: false, Notification.SpeechBubbleDirection.BottomLeft);
		PlayMakerFSM fsm = popup.GetComponentInChildren<PlayMakerFSM>();
		if (fsm == null)
		{
	...
	public IEnumerator PlayJainaVictoryScreenLine(Actor jaina)
	{
		...
		yield return PlaySoundAndBlockSpeech("VO_ICC01_Jaina_Female_Human_PostDeath_02.prefab:32db8cb82e111fd4c8bb56f5db507858", Notification.SpeechBubbleDirection.BottomLeft, jaina, 2f, 1f, parentBubbleToActor: false, delayCardSoundSpells: false, scale);
		GameState.Get().SetBusy(busy: false);
	}
}
