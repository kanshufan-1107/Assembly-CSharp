...
public class BTA_Fight_08 : BTA_Dungeon
{
	...
	public override IEnumerator DoActionsBeforeDealingBaseMulliganCards()
	{
		...
		yield return PlayLineAlways(friendlyActor, VO_BTA_01_Female_NightElf_Mission_Fight_08_PlayerStart_01);
	...
	protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
	{
		...
		{
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_BTA_BOSS_08h_Female_Demon_Mission_Fight_08_Emote_Response_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
		}
	}
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		{
		case 100:
			yield return PlayLineAlways(enemyActor, VO_BTA_BOSS_08h_Female_Demon_Mission_Fight_08_Boss_WeaponEquip_01);
			break;
		case 101:
			yield return PlayLineAlways(enemyActor, VO_BTA_BOSS_08h_Female_Demon_Mission_Fight_08_Hero_WeaponEquip_01);
			break;
		case 102:
			yield return PlayLineAlways(enemyActor, VO_BTA_BOSS_08h_Female_Demon_Mission_Fight_08_Hero_ScavengersCunningTrigger_01);
			break;
		case 103:
			GameState.Get().SetBusy(busy: true);
		...
		case 501:
			...
			break;
		case 507:
			yield return PlayAndRemoveRandomLineOnlyOnce(enemyActor, m_VO_BTA_BOSS_08h_Female_Demon_Mission_Fight_08_HeroPower_Lines);
			break;
		default:
	...
	protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
		{
			...
			if (cardID == "TRL_156")
			{
				yield return PlayLineAlways(enemyActor, VO_BTA_BOSS_08h_Female_Demon_Mission_Fight_08_Hero_StolenSteel_01);
			}
		}
	}
	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
		{
			...
			if (cardID == "BT_117")
			{
				yield return PlayLineAlways(enemyActor, VO_BTA_BOSS_08h_Female_Demon_Mission_Fight_08_Boss_Bladestorm_01);
			}
		}
	}
