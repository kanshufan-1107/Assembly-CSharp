...
public class ULDA_Dungeon_Boss_37h : ULDA_Dungeon
{
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		{
		case 103:
			yield return PlayAndRemoveRandomLineOnlyOnce(enemyActor, m_DefeatPlayerLines);
			break;
		case 104:
		...
		case 106:
			...
			break;
		case 101:
			yield return PlayBossLine(enemyActor, VO_ULDA_BOSS_37h_Female_PlagueLord_PhaseChange1_01);
			break;
		case 102:
			yield return PlayBossLine(enemyActor, VO_ULDA_BOSS_37h_Female_PlagueLord_PhaseChange2_01);
			break;
		default:
	...
	protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
		{
			...
			{
			case "ULD_718":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_37h_Female_PlagueLord_PlayerPlagueofDeath_01);
				break;
			case "AT_033":
			case "EX1_182":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_37h_Female_PlagueLord_PlayerTriggerBurgle_01);
				break;
			case "ICC_314":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_37h_Female_PlagueLord_PlayerTriggerLichKing_01);
				break;
			case "EX1_622":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_37h_Female_PlagueLord_PlayerTriggerShadowWordDeath_01);
				break;
			case "EX1_016":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_37h_Female_PlagueLord_PlayerTriggerSylvanas_01);
				break;
			}
		}
	}
	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
		{
			...
			{
			case "OG_239":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_37h_Female_PlagueLord_BossTriggerDOOM_01);
				break;
			case "DAL_723":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_37h_Female_PlagueLord_BossTriggerForbiddenWords_01);
				break;
			case "ULD_718":
				yield return PlayAndRemoveRandomLineOnlyOnce(enemyActor, m_BossPlagueOfDeath);
				break;
			case "ULD_268":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_37h_Female_PlagueLord_BossTriggerPsychopomp_01);
				break;
			case "ULD_286":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_37h_Female_PlagueLord_BossTriggerShadowofDeath_01);
				break;
			case "EX1_622":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_37h_Female_PlagueLord_BossTriggerShadowWordDeath_01);
				break;
			case "CS2_234":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_37h_Female_PlagueLord_BossTriggerShadowWordPain_01);
				break;
			case "ULDA_BOSS_37t":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_37h_Female_PlagueLord_BossUniqueCard_01);
				break;
			}
		}
	}
