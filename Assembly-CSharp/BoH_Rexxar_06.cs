...
public class BoH_Rexxar_06 : BoH_Rexxar_Dungeon
{
	...
	public override IEnumerator DoActionsBeforeDealingBaseMulliganCards()
	{
		...
		yield return PlayLineAlways(friendlyActor, VO_Story_Hero_Rexxar_Male_OrcOgre_Story_Rexxar_Mission6Intro_01);
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		{
			GameState.Get().SetBusy(busy: true);
			yield return PlayLineAlways(friendlyActor, VO_Story_Hero_Rexxar_Male_OrcOgre_Story_Rexxar_Mission6Victory_01);
			Actor m_Baine = GetEnemyActorByCardId("Story_02_Baine");
			if (m_Baine != null)
			{
				yield return PlayLineAlways(m_Baine, VO_Story_Minion_Baine_Male_Tauren_Story_Rexxar_Mission6Victory_01);
			}
			GameState.Get().SetBusy(busy: false);
			break;
		}
		case 504:
			GameState.Get().SetBusy(busy: true);
			yield return PlayLineAlways(enemyActor, VO_Story_02_Centaur_Male_Centaur_Story_Rexxar_Mission6Loss_01);
			GameState.Get().SetBusy(busy: false);
			break;
		default:
	...
	protected override IEnumerator HandleStartOfTurnWithTiming(int turn)
	{
		...
		case 1:
		{
			...
			if (m_Baine != null)
			{
				yield return PlayLineAlways(m_Baine, VO_Story_Minion_Baine_Male_Tauren_Story_Rexxar_Mission6ExchangeA_01);
			}
			yield return PlayLineAlways(friendlyActor, VO_Story_Hero_Rexxar_Male_OrcOgre_Story_Rexxar_Mission6ExchangeA_01);
			break;
		}
		case 3:
			yield return PlayLineAlways(enemyActor, VO_Story_02_Centaur_Male_Centaur_Story_Rexxar_Mission6ExchangeB_01);
			yield return PlayLineAlways(friendlyActor, VO_Story_Hero_Rexxar_Male_OrcOgre_Story_Rexxar_Mission6ExchangeB_01);
			break;
		case 13:
			yield return PlayLineAlways(enemyActor, VO_Story_02_Centaur_Male_Centaur_Story_Rexxar_Mission6ExchangeC_01);
