...
public class ULDA_Dungeon_Boss_72h : ULDA_Dungeon
{
	...
	protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
	{
		...
		if (emoteType == EmoteType.START)
		{
			...
			{
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_ULDA_BOSS_72h_Male_TitanConstruct_IntroSpecialFinley_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
			}
			else
			{
	...
	protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
		{
			...
			{
			case "ULD_723":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_72h_Male_TitanConstruct_PlayerTrigger_Murmy_01);
				break;
			case "ULD_177":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_72h_Male_TitanConstruct_PlayerTrigger_Octosari_01);
				break;
			case "ULD_275":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_72h_Male_TitanConstruct_PlayerTrigger_Bone_Wraith_01);
				break;
			}
		}
	}
	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
		{
			...
			case "NEW1_030":
			case "OG_317":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_72h_Male_TitanConstruct_BossTriggerDeathwing_01);
				break;
			case "ULD_718":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_72h_Male_TitanConstruct_BossTriggerPlagueofDeath_01);
				break;
			case "EX1_622":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_72h_Male_TitanConstruct_BossTriggerShadowWordDeath_01);
				break;
			case "OG_239":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_72h_Male_TitanConstruct_PlayerTriggerDOOM_01);
				break;
			}
		}
	}
