...
public class BRM11_Vaelastrasz : BRM_MissionEntity
{
	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		Actor enemyActor = GameState.Get().GetOpposingSidePlayer().GetHero()
			.GetCard()
			.GetActor();
		if (entity.GetCardId() == "BRMA11_3" && !m_cardLinePlayed)
		{
			m_cardLinePlayed = true;
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_BRMA11_1_HERO_POWER_05.prefab:a15ff3617c584fc4dacf011685a21dd2", Notification.SpeechBubbleDirection.TopRight, enemyActor));
		}
	}
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		case 1:
			...
			yield return Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_BRMA11_1_KILL_PLAYER_06.prefab:52ea6310c1553f147a1de7d2bca500ad", Notification.SpeechBubbleDirection.TopRight, enemyActor));
			GameState.Get().SetBusy(busy: false);
			break;
		case 2:
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_BRMA11_1_ALEXSTRAZA_07.prefab:8d0705fc4be8e4144b7764931784dbca", Notification.SpeechBubbleDirection.TopRight, enemyActor));
			break;
		}
	}
