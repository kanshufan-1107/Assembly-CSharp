...
public class ULDA_Dungeon_Boss_09h : ULDA_Dungeon
{
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		{
		case 101:
			yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_09h_Male_Mech_HeroPowerLowArmor_01);
			break;
		case 102:
	...
	protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
	{
		...
		if (!(cardID == "EX1_102"))
		{
			if (cardID == "BOT_424")
			{
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_09h_Male_Mech_PlayerMechathun_01);
			}
		}
		else
		{
			yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_09h_Male_Mech_PlayerDemolisher_01);
		}
	}
	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
		{
			...
			{
			case "BOT_424":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_09h_Male_Mech_BossDemolisher_01);
				break;
			case "TRL_324":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_09h_Male_Mech_BossHeavyMetal_01);
				break;
			case "BOT_299":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_09h_Male_Mech_BossOmegaAssembly_01);
				break;
			}
		}
	}
