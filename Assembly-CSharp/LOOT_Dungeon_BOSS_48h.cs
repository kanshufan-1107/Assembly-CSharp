...
public class LOOT_Dungeon_BOSS_48h : LOOT_Dungeon
{
	...
	{
		base.PreloadAssets();
		foreach (string soundFile in new List<string> { TrappedRoom_LOOTA_BOSS_48h_Death, TrappedRoom_LOOTA_BOSS_48h_EmoteResponse, TrappedRoom_LOOTA_BOSS_48h_Intro })
		{
	...
	protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
	{
		...
		{
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(TrappedRoom_LOOTA_BOSS_48h_Intro, Notification.SpeechBubbleDirection.None, enemyActor));
		}
		else if (MissionEntity.STANDARD_EMOTE_RESPONSE_TRIGGERS.Contains(emoteType))
		{
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(TrappedRoom_LOOTA_BOSS_48h_EmoteResponse, Notification.SpeechBubbleDirection.TopRight, enemyActor));
		}
	}
