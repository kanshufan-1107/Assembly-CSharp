...
public class CardSpecificMultiVoSpell : CardSoundSpell
{
	...
	private bool SearchForCard()
	{
		...
		foreach (SpellZoneTag zoneTag in m_CardSpecificVoData.m_ZonesToSearch)
		{
			List<Zone> zones = SpellUtils.FindZonesFromTag(this, zoneTag, m_CardSpecificVoData.m_SideToSearch);
