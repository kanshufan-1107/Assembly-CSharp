...
public class GIL_Dungeon_Boss_40h : GIL_Dungeon
{
	...
	protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
	{
		...
		{
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_GILA_BOSS_40h_Female_Treant_Intro_01.prefab:5d14b06a592ef5640ae7acbdb74c031a", Notification.SpeechBubbleDirection.TopRight, enemyActor));
		}
		else if (MissionEntity.STANDARD_EMOTE_RESPONSE_TRIGGERS.Contains(emoteType))
		{
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_GILA_BOSS_40h_Female_Treant_EmoteResponse_01.prefab:1252f452e179aea4c97325973e1c3dc4", Notification.SpeechBubbleDirection.TopRight, enemyActor));
		}
	}
	...
	protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
	{
		...
		{
		case "GIL_653":
			yield return PlayEasterEggLine(enemyActor, "VO_GILA_BOSS_40h_Female_Treant_EventPlaysWoodsmansAxe_01.prefab:f765de0ef498d5f48998db8dac4ff08a");
			break;
		case "CS2_106":
		case "EX1_247":
		case "EX1_411":
		...
		case "EX1_398":
		{
			string randomLine = PopRandomLineWithChance(m_PlayerAxe);
			if (randomLine != null)
			{
