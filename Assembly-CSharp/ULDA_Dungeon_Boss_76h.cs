...
public class ULDA_Dungeon_Boss_76h : ULDA_Dungeon
{
	...
	protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
	{
		...
		if (emoteType == EmoteType.START)
		{
			...
			{
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_ULDA_BOSS_76h_Male_NefersetTolvir_IntroEliseFirst_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
			}
			else
			{
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		if (missionEvent == 101)
		{
			yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_76h_Male_NefersetTolvir_BossTriggerAttackPlayerFace_01);
		}
		else
		{
	...
	protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
		{
			...
			{
			case "ULD_179":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_76h_Male_NefersetTolvir_PlayerTrigger_Phalanx_Commander_01);
				break;
			case "ULD_152":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_76h_Male_NefersetTolvir_PlayerTrigger_Pressure_Plate_01);
				break;
			case "EX1_407":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_76h_Male_NefersetTolvir_PlayerTriggerBrawl_01);
				break;
			}
		}
	}
	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
		{
			...
			{
			case "DAL_731":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_76h_Male_NefersetTolvir_BossTriggerDuel_01);
				break;
			case "ULD_143":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_76h_Male_NefersetTolvir_BossTriggerPharoahsBlessing_01);
				break;
			case "ULD_728":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_76h_Male_NefersetTolvir_BossTriggerSubdue_01);
				break;
			case "CS2_097":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_76h_Male_NefersetTolvir_BossTriggerTruesilverChampion_01);
				break;
			}
		}
	}
