...
public class CardSelectionHandler : PegUIElement
{
	...
	protected override void OnOver(InteractionState oldState)
	{
		...
		TooltipPanelManager.TooltipBoneSource boneSource = ((m_cardChoice != 3) ? TooltipPanelManager.TooltipBoneSource.TOP_RIGHT : TooltipPanelManager.TooltipBoneSource.TOP_LEFT);
		TooltipPanelManager.Get().UpdateKeywordHelpForForge(m_actor.GetEntityDef(), m_actor, boneSource);
	}
