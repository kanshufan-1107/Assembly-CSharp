...
public class LOOT_Dungeon_BOSS_11h : LOOT_Dungeon
{
	...
	protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
	{
		...
		{
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_LOOTA_BOSS_11h_Male_Trogg_Intro_01.prefab:54f6017f84e6d824e93a04abd27f6f01", Notification.SpeechBubbleDirection.TopRight, enemyActor));
		}
		else if (MissionEntity.STANDARD_EMOTE_RESPONSE_TRIGGERS.Contains(emoteType))
		{
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_LOOTA_BOSS_11h_Male_Trogg_EmoteResponse_01.prefab:ed6cf5a2a048fea4e98c50eff13cd707", Notification.SpeechBubbleDirection.TopRight, enemyActor));
		}
	}
	...
	protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()))
		{
			...
			if (cardID == "EX1_619")
			{
				yield return PlayEasterEggLine(enemyActor, "VO_LOOTA_BOSS_11h_Male_Trogg_EventEquality_01.prefab:6b570bed497bd2e458e70d929695c99c");
			}
		}
	}
