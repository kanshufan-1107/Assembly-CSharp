...
public class ULDA_Dungeon_Boss_65h : ULDA_Dungeon
{
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		if (missionEvent == 101)
		{
			yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_65h_Male_Ogre_HeroPowerPlayStolenLegendary_01);
		}
		else
		{
	...
	protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
		{
			...
			{
			case "ULD_214":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_65h_Male_Ogre_PlayerTrigger_Freelanthropist_01);
				break;
			case "ULD_133":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_65h_Male_Ogre_PlayerTrigger_Crystal_Merchant_01);
				break;
			case "ULD_163":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_65h_Male_Ogre_PlayerTrigger_Expired_Merchant_01);
				break;
			}
		}
	}
	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
		{
			...
			{
			case "ULD_328":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_65h_Male_Ogre_BossTriggerCleverDisguise_01);
				break;
			case "ULD_229":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_65h_Male_Ogre_BossTriggerMischiefMaker_01);
				break;
			case "DAL_714":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_65h_Male_Ogre_BossTriggerUnderbellyFence_01);
				break;
			}
		}
	}
