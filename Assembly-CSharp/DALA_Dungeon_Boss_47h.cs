...
public class DALA_Dungeon_Boss_47h : DALA_Dungeon
{
	...
	{
		base.PreloadAssets();
		List<string> soundFiles = new List<string> { VO_DALA_BOSS_47h_Lavanthor_Death, VO_DALA_BOSS_47h_Lavanthor_DefeatPlayer, VO_DALA_BOSS_47h_Lavanthor_EmoteResponse, VO_DALA_BOSS_47h_Lavanthor_Intro };
