...
public class FriendListUIElement : PegUIElement
{
	...
	{
		bool shouldHighlight = ShouldBeHighlighted();
		if (!shouldHighlight)
		{
			shouldHighlight = ShouldChildBeHighlighted();
		}
		UpdateSelfHighlight(shouldHighlight);
	...
	{
		FriendListUIElement[] componentsInChildrenOnly = GameObjectUtils.GetComponentsInChildrenOnly<FriendListUIElement>(this, includeInactive: true);
