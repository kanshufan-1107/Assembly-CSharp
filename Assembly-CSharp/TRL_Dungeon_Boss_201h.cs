...
public class TRL_Dungeon_Boss_201h : TRL_Dungeon
{
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		{
		case 1001:
			yield return PlayLineOnlyOnce(enemyActor, VO_TRLA_201h_Male_Troll_Shrine_Returns_01);
			break;
		case 1002:
			yield return PlayLineOnlyOnce(enemyActor, VO_TRLA_201h_Male_Troll_Shrine_Returns_02);
			break;
		case 1003:
			yield return PlayLineOnlyOnce(enemyActor, VO_TRLA_201h_Male_Troll_Shrine_Returns_04);
			break;
		default:
