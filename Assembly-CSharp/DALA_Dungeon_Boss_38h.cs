...
public class DALA_Dungeon_Boss_38h : DALA_Dungeon
{
	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
		{
			...
			case "KAR_073":
			case "KAR_091":
				yield return PlayAndRemoveRandomLineOnlyOnce(enemyActor, m_BossPortal);
				break;
			case "KAR_076":
				yield return PlayLineOnlyOnce(enemyActor, VO_DALA_BOSS_38h_Female_Gnome_HeroPowerPlayFirelandsPortal_01);
				break;
			}
		}
	}
