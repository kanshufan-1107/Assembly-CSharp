...
public class ICC_09_Saurfang : ICC_MissionEntity
{
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		case 101:
			if (m_BloodBeastPlayedLines.Count != 0)
			{
				...
				string randomBeastLine = m_BloodBeastPlayedLines[Random.Range(0, m_BloodBeastPlayedLines.Count)];
				m_BloodBeastPlayedLines.Remove(randomBeastLine);
				yield return PlayLineOnlyOnce(enemyActor, randomBeastLine);
		...
		case 102:
			...
			GameState.Get().SetBusy(busy: true);
			yield return PlayBossLine(enemyActor, "VO_ICC09_Saurfang_Male_Orc_EquipWeapon_01.prefab:8bd83a3fd51352f448936c1e60c68ee7");
			GameState.Get().SetBusy(busy: false);
			break;
		case 103:
			m_playedLines.Add(missionEventName);
			yield return PlayLineOnlyOnce(enemyActor, "VO_ICC09_Saurfang_Male_Orc_AttackedByPlayer_01.prefab:8b07d4d9b9d768b468f6b4ff3c4d267e");
			break;
		case 104:
			if (m_BossAttackLines.Count != 0)
			{
				GameState.Get().SetBusy(busy: true);
				string randomAttackLine = m_BossAttackLines[Random.Range(0, m_BossAttackLines.Count)];
				m_BossAttackLines.Remove(randomAttackLine);
				yield return PlayLineOnlyOnce(enemyActor, randomAttackLine);
				GameState.Get().SetBusy(busy: false);
			}
			break;
		case 105:
			yield return PlayBossLine(enemyActor, "VO_ICC09_Saurfang_Male_Orc_Death_01.prefab:4543a7b852bd2f349b5dfb4092ebd1f6");
			break;
		case 106:
			yield return PlayEasterEggLine(enemyActor, "VO_ICC09_Saurfang_Male_Orc_WeaponDestroyed_01.prefab:a32f29795fe6bc54e88b4db71cb098eb");
			break;
		case 107:
			yield return PlayEasterEggLine(enemyActor, "VO_ICC09_Saurfang_Male_Orc_BloodBeastStolen_01.prefab:f17cc74435c0e9a4fba14a157c2e8ef2");
			break;
		case 108:
			yield return PlayEasterEggLine(enemyActor, "VO_ICC09_Saurfang_Male_Orc_CursedBlade_01.prefab:e6667792ec809c2418896ac658ccec4e");
			break;
		}
	}
	...
	protected override IEnumerator HandleGameOverWithTiming(TAG_PLAYSTATE gameResult)
	{
		...
		{
			yield return new WaitForSeconds(5f);
			string voLine = "VO_ICC09_LichKing_Male_Human_Lose_01.prefab:c5f2c5e213c4ad648be72f77a9afbb2f";
