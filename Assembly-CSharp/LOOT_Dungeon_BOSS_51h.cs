...
public class LOOT_Dungeon_BOSS_51h : LOOT_Dungeon
{
	...
	public override void OnPlayThinkEmote()
	{
		...
		if (currentPlayer.IsFriendlySide() && !currentPlayer.GetHeroCard().HasActiveEmoteSound())
		{
			...
			{
				string songLine = m_IdleSongLines[0];
				string underlay = m_IdleUnderlay[0];
	...
	protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
	{
		...
		if (emoteType == EmoteType.START)
		{
			...
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_LOOTA_BOSS_51h_Male_Dwarf_Intro_01.prefab:c513358ed8344364dbf85ee7bb4f8eca", Notification.SpeechBubbleDirection.TopRight, enemyActor));
		}
		else if (MissionEntity.STANDARD_EMOTE_RESPONSE_TRIGGERS.Contains(emoteType))
		{
			PlaySound("RussellTheBard_Short_Strum_Underlay.prefab:09e52281d7049da458f12cb79ee395da");
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_LOOTA_BOSS_51h_Male_Dwarf_EmoteResponse_01.prefab:777b3055ee92eae42b1b27826e242da7", Notification.SpeechBubbleDirection.TopRight, enemyActor));
		}
	}
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		case 103:
		{
			...
			if (m_heroPowerLines.Count != 0 && chanceVO >= randomNum)
			{
	...
	protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()))
		{
			...
			{
				PlaySound("RussellTheBard_Short_Strum_Underlay.prefab:09e52281d7049da458f12cb79ee395da");
				yield return PlayEasterEggLine(enemyActor, "VO_LOOTA_BOSS_51h_Male_Dwarf_EventBoombox_01.prefab:d031062f6c4754b42a8a0975a1b221a1");
			}
		}
	}
}
