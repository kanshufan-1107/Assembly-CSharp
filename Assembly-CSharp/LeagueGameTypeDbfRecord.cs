...
public class LeagueGameTypeDbfRecord : DbfRecord
{
	...
	[DbfField("IS_RANKED_PLAY")]
	public bool IsRankedPlay => m_isRankedPlay;
	...
	public void SetIsRankedPlay(bool v)
	{
		m_isRankedPlay = v;
	}
	...
	{
		LeagueGameTypeDbfAsset dbfAsset = DbfShared.GetAssetBundle().LoadAsset(resourcePath, typeof(LeagueGameTypeDbfAsset)) as LeagueGameTypeDbfAsset;
		if (dbfAsset == null)
		{
			records = new List<T>();
