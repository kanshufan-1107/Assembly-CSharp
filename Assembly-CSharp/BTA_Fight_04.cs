...
public class BTA_Fight_04 : BTA_Dungeon
{
	...
	public override IEnumerator DoActionsBeforeDealingBaseMulliganCards()
	{
		...
		yield return PlayLineAlways(friendlyActor, VO_BTA_01_Female_NightElf_Mission_Fight_04_PlayerStart_01);
	...
	protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
	{
		...
		{
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_BTA_BOSS_04h_Male_Dreadlord_Mission_Fight_04_Emote_Response_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
		}
	}
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		{
		case 101:
			yield return PlayLineAlways(enemyActor, VO_BTA_BOSS_04h_Male_Dreadlord_Mission_Fight_04_HeroPowerTrigger_02);
			break;
		case 102:
			yield return PlayLineAlways(friendlyActor, VO_BTA_01_Female_NightElf_Mission_Fight_04_VictoryA_01);
	...
	protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
		{
			...
			{
			case "BT_731":
				yield return PlayLineAlways(enemyActor, VO_BTA_BOSS_04h_Male_Dreadlord_Mission_Fight_04_Hero_InfectiousSporeling_01);
				break;
			case "BTA_05":
				yield return PlayLineAlways(enemyActor, VO_BTA_BOSS_04h_Male_Dreadlord_Mission_Fight_04_Hero_Sklibb_01);
				break;
			case "BTA_07":
	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
		{
			...
			{
			case "BT_199":
				yield return PlayLineAlways(enemyActor, VO_BTA_BOSS_04h_Male_Dreadlord_Mission_Fight_04_Boss_UnstableFelbolt_01);
				break;
			case "BT_304":
				yield return PlayLineAlways(enemyActor, VO_BTA_BOSS_04h_Male_Dreadlord_Mission_Fight_04_Boss_EnhancedDreadlord_01);
				break;
			case "BT_305":
				yield return PlayLineAlways(enemyActor, VO_BTA_BOSS_04h_Male_Dreadlord_Mission_Fight_04_Boss_ImprisonedImp_01);
				break;
			}
		}
	}
