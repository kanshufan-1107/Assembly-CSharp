...
public class GIL_Dungeon_Bonus_Boss_61h : GIL_Dungeon
{
	...
	protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
	{
		...
		{
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_GILA_BOSS_61h_Female_Orc_IntroShaw_01.prefab:535335d8e2b34334a83374b62d03f750", Notification.SpeechBubbleDirection.TopRight, enemyActor));
		}
		else if (MissionEntity.STANDARD_EMOTE_RESPONSE_TRIGGERS.Contains(emoteType))
		{
			...
			{
			case "GILA_500h4":
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_GILA_BOSS_61h_Female_Orc_EmoteResponseTess_01.prefab:4c726930acd2ee44eb6eb33fce12f292", Notification.SpeechBubbleDirection.TopRight, enemyActor));
				break;
			case "GILA_600h2":
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_GILA_BOSS_61h_Female_Orc_EmoteResponseCrowley_01.prefab:4e95c68f2b8446049b05b91b866d803c", Notification.SpeechBubbleDirection.TopRight, enemyActor));
				break;
			case "GILA_900h2":
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_GILA_BOSS_61h_Female_Orc_EmoteResponseToki_01.prefab:7a7b36e367568ea408ccec1ff319360d", Notification.SpeechBubbleDirection.TopRight, enemyActor));
				break;
			case "GILA_400h":
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_GILA_BOSS_61h_Female_Orc_EmoteResponseShaw_01.prefab:5b8a2ee25bd548849b1c6b20a7bd26e7", Notification.SpeechBubbleDirection.TopRight, enemyActor));
				break;
			default:
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_GILA_BOSS_61h_Female_Orc_EmoteResponse_01.prefab:bc6efd6494a855b419b46bf9643d4da6", Notification.SpeechBubbleDirection.TopRight, enemyActor));
				break;
			}
		}
	}
	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		if (!(cardID == "GIL_618"))
		{
			if (cardID == "GIL_825")
			{
				yield return PlayLineOnlyOnce(enemyActor, "VO_GILA_BOSS_61h_Female_Orc_EventSummonGodfrey_01.prefab:e7c1c99447f410146a6591b07cfe10ea");
			}
		}
		else
		{
			yield return PlayLineOnlyOnce(enemyActor, "VO_GILA_BOSS_61h_Female_Orc_EventSummonCrowskin_01.prefab:5b0211815822d664bab58ae89af6caf5");
		}
	}
	...
	protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
	{
		...
		{
		case "GILA_500h4":
			yield return PlayLineOnlyOnce(enemyActor, "VO_GILA_BOSS_61h_Female_Orc_IntroTess_01.prefab:ffbef8020373f24478241e3ea517a6f2");
			break;
		case "GILA_600h2":
			yield return PlayLineOnlyOnce(enemyActor, "VO_GILA_BOSS_61h_Female_Orc_IntroCrowley_01.prefab:5f8fb394ab0494a48aff74ac1234ed6c");
			break;
		case "GILA_900h2":
			yield return PlayLineOnlyOnce(enemyActor, "VO_GILA_BOSS_61h_Female_Orc_IntroToki_01.prefab:bcb8a646f92003e4c9797323ddc44033");
			break;
		}
	}
	...
	protected override IEnumerator HandleGameOverWithTiming(TAG_PLAYSTATE gameResult)
	{
		if (gameResult == TAG_PLAYSTATE.LOST)
		{
			...
			string voLine = "VO_GILA_BOSS_61h_Female_Orc_DefeatPlayer_01.prefab:a9bd704b56a75d2409a12a4a74a2e314";
			if (!NotificationManager.Get().HasSoundPlayedThisSession(voLine))
			{
				yield return Gameplay.Get().StartCoroutine(PlayCharacterQuoteAndWait("Hagatha_Banner_Quote.prefab:678033af721880948a86bc69b02ef1ac", voLine));
			}
		}
	}
