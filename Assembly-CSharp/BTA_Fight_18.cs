...
public class BTA_Fight_18 : BTA_Dungeon_Heroic
{
	...
	protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
	{
		...
		if (emoteType == EmoteType.START)
		{
			...
			case "HERO_04c":
			case "HERO_04d":
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_BTA_BOSS_18h_Male_Demon_Mission_Fight_18_BossStartPaladin_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
				break;
			case "HERO_10":
			case "HERO_10a":
			case "HERO_10b":
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_BTA_BOSS_18h_Male_Demon_Mission_Fight_18_BossStartDemonHunter_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
				break;
			default:
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_BTA_BOSS_18h_Male_Demon_Mission_Fight_18_BossStart_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
				break;
			}
		}
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		{
		case 110:
			yield return PlayLineAlways(enemyActor, VO_BTA_BOSS_18h_Male_Demon_Mission_Fight_18_Hero_SummonDemon_01);
			break;
		case 500:
	...
	protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
		{
			...
			if (cardID == "TRL_302")
			{
				yield return PlayLineAlways(enemyActor, VO_BTA_BOSS_18h_Male_Demon_Mission_Fight_18_Hero_TimeOut_01);
			}
		}
	}
	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
		{
			...
			case "CFM_094":
			case "OG_239":
				yield return PlayLineOnlyOnce(enemyActor, VO_BTA_BOSS_18h_Male_Demon_Mission_Fight_18_Boss_WarlockAOEDamageSpell_01);
				break;
			case "GVG_021":
				yield return PlayLineAlways(enemyActor, VO_BTA_BOSS_18h_Male_Demon_Mission_Fight_18_Boss_DarkPortal_01);
				break;
			}
		}
	}
