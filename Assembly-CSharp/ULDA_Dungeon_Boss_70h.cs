...
public class ULDA_Dungeon_Boss_70h : ULDA_Dungeon
{
	...
	protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
	{
		...
		if (emoteType == EmoteType.START)
		{
			...
			{
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_ULDA_BOSS_70h_Male_TitanConstruct_IntroSpecialBrann_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
			}
			else
			{
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		{
		case 105:
			yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_70h_Male_TitanConstruct_BossTriggerArcaneMissilesSpellPower_01);
			break;
		case 104:
			yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_70h_Male_TitanConstruct_BossVaporizeTrigger_01);
			break;
		case 101:
			yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_70h_Male_TitanConstruct_PlayerFreezeBoss_01);
			break;
		case 102:
			yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_70h_Male_TitanConstruct_PlayerFrostArmorTrigger_01);
			break;
		case 103:
			yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_70h_Male_TitanConstruct_PlayerPyroblastFace_01);
			break;
		default:
