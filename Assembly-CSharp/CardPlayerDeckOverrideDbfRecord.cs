...
public class CardPlayerDeckOverrideDbfRecord : DbfRecord
{
	...
	{
		CardPlayerDeckOverrideDbfAsset dbfAsset = DbfShared.GetAssetBundle().LoadAsset(resourcePath, typeof(CardPlayerDeckOverrideDbfAsset)) as CardPlayerDeckOverrideDbfAsset;
		if (dbfAsset == null)
		{
			records = new List<T>();
