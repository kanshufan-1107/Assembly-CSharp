...
public class ULDA_Dungeon_Boss_36h : ULDA_Dungeon
{
	...
	protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
	{
		...
		if (emoteType == EmoteType.START)
		{
			...
			{
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_ULDA_BOSS_36h_Female_Tauren_IntroFinley_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
			}
			else
			{
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		if (missionEvent == 101)
		{
			yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_36h_Female_Tauren_PlayerWeapon_01);
		}
		else
		{
	...
	protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
	{
		...
		if (!(cardID == "ULD_715"))
		{
			if (cardID == "TRL_500")
			{
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_36h_Female_Tauren_PlayerSurrendertoMadness_01);
			}
		}
		else
		{
			yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_36h_Female_Tauren_PlayerPlagueofMadness_01);
		}
	}
	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
		{
			...
			{
			case "CS2_112":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_36h_Female_Tauren_BossArcaniteReaper_01);
				break;
			case "ULD_715":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_36h_Female_Tauren_BossPlagueofMadness_01);
				break;
			case "EX1_400":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_36h_Female_Tauren_BossWhirlwind_01);
				break;
			}
		}
	}
