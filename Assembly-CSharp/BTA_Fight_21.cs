...
public class BTA_Fight_21 : BTA_Dungeon_Heroic
{
	...
	{
		base.PreloadAssets();
		List<string> soundFiles = new List<string> { BTA_BOSS_21h_Supremus_Play, BTA_BOSS_21h_Supremus_EmoteResponse, BTA_BOSS_21h_Supremus_Death };
	...
	{
		base.OnCreateGame();
		m_deathLine = BTA_BOSS_21h_Supremus_Death;
		m_standardEmoteResponseLine = BTA_BOSS_21h_Supremus_EmoteResponse;
	}
	...
	protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
	{
		...
		{
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(BTA_BOSS_21h_Supremus_Play, Notification.SpeechBubbleDirection.TopRight, enemyActor));
		}
