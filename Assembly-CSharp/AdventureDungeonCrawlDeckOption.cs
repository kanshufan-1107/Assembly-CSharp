...
public class AdventureDungeonCrawlDeckOption : AdventureOptionWidget
{
	...
	private void InitDataModel(AdventureDeckDbfRecord deckRecord)
	{
		...
		else
		{
			...
			AssetLoader.Get().LoadMaterial(deckRecord.DisplayTexture, onMaterialLoaded);
		}
	...
	public override void Select()
	{
		...
		else if (!(m_selectedCallback is DeckOptionSelectedCallback selectedCallback))
		{
		...
		{
			selectedCallback(m_deckRecord.DeckId, m_deckContents, m_dataModel.Locked);
		}
	}
}
