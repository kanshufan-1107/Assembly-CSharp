...
public class LightningAnimator : MonoBehaviour
{
	...
	private void RandomJointRotation()
	{
		...
		{
			Vector3 sourceRot = Vector3.Lerp(m_SourceMinRotation, m_SourceMaxRotation, Random.value);
			m_SourceJount.Rotate(sourceRot);
		}
		if (m_TargetJoint != null)
		{
			Vector3 targetRot = Vector3.Lerp(m_TargetMinRotation, m_TargetMaxRotation, Random.value);
			m_TargetJoint.Rotate(targetRot);
		}
	}
}
