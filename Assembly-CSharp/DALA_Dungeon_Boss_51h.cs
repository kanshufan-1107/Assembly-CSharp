...
public class DALA_Dungeon_Boss_51h : DALA_Dungeon
{
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		case 104:
			GameState.Get().SetBusy(busy: true);
			yield return PlayBossLine(enemyActor, VO_DALA_BOSS_51h_Female_Gnome_TurnOneA_01);
			GameState.Get().SetBusy(busy: false);
			break;
		case 105:
			GameState.Get().SetBusy(busy: true);
			yield return PlayBossLine(enemyActor, VO_DALA_BOSS_51h_Female_Gnome_TurnOneB_01);
			GameState.Get().SetBusy(busy: false);
			break;
		case 106:
			GameState.Get().SetBusy(busy: true);
			yield return PlayBossLine(enemyActor, VO_DALA_BOSS_51h_Female_Gnome_TurnTwo_01);
			GameState.Get().SetBusy(busy: false);
			break;
		case 107:
			GameState.Get().SetBusy(busy: true);
		...
		case 115:
			GameState.Get().SetBusy(busy: true);
			yield return PlayBossLine(enemyActor, VO_DALA_BOSS_51h_Female_Gnome_BossMillhouse_01);
			GameState.Get().SetBusy(busy: false);
			break;
		case 108:
			...
			break;
		case 109:
			yield return PlayLineOnlyOnce(enemyActor, VO_DALA_BOSS_51h_Female_Gnome_MillhouseFullBoard_01);
			break;
		case 110:
			yield return PlayLineOnlyOnce(enemyActor, VO_DALA_BOSS_51h_Female_Gnome_MillhouseSecond_01);
			break;
		case 111:
			yield return PlayLineOnlyOnce(enemyActor, VO_DALA_BOSS_51h_Female_Gnome_MillhouseShuffle_01);
			break;
		case 112:
			yield return PlayAndRemoveRandomLineOnlyOnce(enemyActor, m_PlayerMillhouseManaStorm);
			break;
		case 113:
			yield return PlayLineOnlyOnce(enemyActor, VO_DALA_BOSS_51h_Female_Gnome_PlayerMillhouseManastormDies_01);
			break;
		case 114:
			GameState.Get().SetBusy(busy: true);
