...
public class BoH_Rexxar_02 : BoH_Rexxar_Dungeon
{
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		case 501:
			GameState.Get().SetBusy(busy: true);
			yield return PlayLineAlways(enemyActor, VO_Story_Hero_Blackhand_Male_Orc_Story_Rexxar_Mission2Victory_01);
			yield return PlayLineAlways(friendlyActor, VO_Story_Hero_Rexxar_Male_OrcOgre_Story_Rexxar_Mission2Victory_01);
			GameState.Get().SetBusy(busy: false);
			break;
		case 504:
			GameState.Get().SetBusy(busy: true);
			yield return PlayLineAlways(enemyActor, VO_Story_Hero_Blackhand_Male_Orc_Story_Rexxar_Mission2Loss_01);
			GameState.Get().SetBusy(busy: false);
			break;
		default:
