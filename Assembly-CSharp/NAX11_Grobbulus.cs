	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		if (!(cardId == "NAX11_02"))
		{
			if (cardId == "NAX11_04" && !m_cardLinePlayed)
			{
				...
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_NAX11_01_CARD_03.prefab:5bb409481ec9ba74bb7336fb88b82ea2", Notification.SpeechBubbleDirection.TopRight, enemyActor));
			}
		}
		else if (!m_heroPowerLinePlayed)
		{
			m_heroPowerLinePlayed = true;
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_NAX11_01_HP_02.prefab:5683ba1493ba8aa47ba0fcbf61f2a39c", Notification.SpeechBubbleDirection.TopRight, enemyActor));
		}
	}
}
