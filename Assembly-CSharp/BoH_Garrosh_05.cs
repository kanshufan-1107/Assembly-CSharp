...
public class BoH_Garrosh_05 : BoH_Garrosh_Dungeon
{
	...
	public override IEnumerator DoActionsBeforeDealingBaseMulliganCards()
	{
		...
		yield return PlayLineAlways(friendlyActor, VO_Story_Hero_Garrosh_Male_Orc_Story_Garrosh_Mission5Intro_01);
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		{
			GameState.Get().SetBusy(busy: true);
			Actor m_MagathaActor = GetEnemyActorByCardId("Story_03_Magatha");
			if (m_MagathaActor != null)
			{
				yield return PlayLineAlways(m_MagathaActor, VO_Story_Minion_Magatha_Female_Tauren_Story_Minion_Magatha_Play_01);
			}
			GameState.Get().SetBusy(busy: false);
			break;
		}
		case 504:
			GameState.Get().SetBusy(busy: true);
			yield return PlayLineAlways(enemyActor, VO_Story_Hero_Cairne_Male_Tauren_Story_Garrosh_Mission5Loss_01);
			GameState.Get().SetBusy(busy: false);
			break;
		case 228:
		{
