...
public class LOE07_MineCart : LOE_MissionEntity
{
	...
	protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
	{
		if (MissionEntity.STANDARD_EMOTE_RESPONSE_TRIGGERS.Contains(emoteType))
		{
			Actor enemyActor = GameState.Get().GetOpposingSidePlayer().GetHero()
				.GetCard()
				.GetActor();
			SoundManager.Get().LoadAndPlay("Mine_response.prefab:5a1713d5acac1f34bacb52ef005eb417", enemyActor.gameObject);
		}
	}
	...
	{
		GameObject artGo = AssetLoader.Get().InstantiatePrefab("MineCartRushArt.prefab:77a3c4475a44dac4a91cef7cc9c621e5");
		m_mineCartArt = artGo.GetComponent<MineCartRushArt>();
	}
