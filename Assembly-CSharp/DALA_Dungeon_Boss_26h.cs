...
public class DALA_Dungeon_Boss_26h : DALA_Dungeon
{
	...
	{
		base.PreloadAssets();
		List<string> soundFiles = new List<string> { VO_DALA_BOSS_26h_DalaranFountainGolem_Death, VO_DALA_BOSS_26h_DalaranFountainGolem_DefeatPlayer, VO_DALA_BOSS_26h_DalaranFountainGolem_EmoteResponse, VO_DALA_BOSS_26h_DalaranFountainGolem_Intro };
