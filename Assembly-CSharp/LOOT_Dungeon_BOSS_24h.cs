...
public class LOOT_Dungeon_BOSS_24h : LOOT_Dungeon
{
	...
	{
		base.PreloadAssets();
		foreach (string soundFile in new List<string> { TheMothergloop_LOOTA_BOSS_24h_Death, TheMothergloop_LOOTA_BOSS_24h_EmoteResponse, TheMothergloop_LOOTA_BOSS_24h_Intro })
		{
	...
	protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
	{
		...
		{
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(TheMothergloop_LOOTA_BOSS_24h_Intro, Notification.SpeechBubbleDirection.None, enemyActor));
		}
		else if (MissionEntity.STANDARD_EMOTE_RESPONSE_TRIGGERS.Contains(emoteType))
		{
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(TheMothergloop_LOOTA_BOSS_24h_EmoteResponse, Notification.SpeechBubbleDirection.TopRight, enemyActor));
		}
	}
