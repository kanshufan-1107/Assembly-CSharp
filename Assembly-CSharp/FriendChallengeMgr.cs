...
public class FriendChallengeMgr
{
	...
	private void StartChallengeProcess()
	{
		...
		if (!IsChallengeTavernBrawl())
		{
			...
			{
				RankMgr.LogMessage("m_data.m_challengeFormatType = FT_UNKOWN", "StartChallengeProcess", "D:\\p4Workspace\\31.4.0\\Pegasus\\Client\\Assets\\Game\\Bnet\\Scripts\\FriendChallengeMgr.cs", 3628);
				return;
			}
