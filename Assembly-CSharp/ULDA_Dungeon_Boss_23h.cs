...
public class ULDA_Dungeon_Boss_23h : ULDA_Dungeon
{
	...
	{
		base.PreloadAssets();
		List<string> soundFiles = new List<string> { VO_ULDA_BOSS_23h_Skarik_Death_01, VO_ULDA_BOSS_23h_Skarik_Defeat_01, VO_ULDA_BOSS_23h_Skarik_EmoteResponse_01, VO_ULDA_BOSS_23h_Skarik_Intro_01 };
