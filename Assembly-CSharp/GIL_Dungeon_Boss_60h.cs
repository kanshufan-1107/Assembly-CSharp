...
public class GIL_Dungeon_Boss_60h : GIL_Dungeon
{
	...
	protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
	{
		...
		{
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_GILA_BOSS_60h_Male_HumanGhost_IntroTess_01.prefab:fff42d3944e8bd74bbd966676233a3ee", Notification.SpeechBubbleDirection.TopRight, enemyActor));
		}
		else if (MissionEntity.STANDARD_EMOTE_RESPONSE_TRIGGERS.Contains(emoteType))
		{
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_GILA_BOSS_60h_Male_HumanGhost_EmoteResponseTess_01.prefab:6315438179aa5bf48857edee7132976a", Notification.SpeechBubbleDirection.TopRight, enemyActor));
		}
	}
	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		{
			string randomLine = PopRandomLineWithChance(m_RandomBigWeaponLines);
			if (randomLine != null)
			{
		...
		if (cardID == "LOOT_542")
		{
			string randomLine2 = PopRandomLineWithChance(m_RandomKingsbaneLines);
			if (randomLine2 != null)
			{
	...
	protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()))
		{
			...
			{
			case "AT_070":
				yield return PlayBossLine(enemyActor, "VO_GILA_BOSS_60h_Male_HumanGhost_EventPlayKragg_02.prefab:5921fc1f19b5f2b479b6e1433b947dd0");
				break;
			case "LOOT_542":
				yield return PlayBossLine(enemyActor, "VO_GILA_BOSS_60h_Male_HumanGhost_EventPlayerKingsblade_01.prefab:fa4a18427dcec41409bb74eac8198200");
				break;
			case "GILA_611":
				yield return PlayBossLine(enemyActor, "VO_GILA_BOSS_60h_Male_HumanGhost_EventPlayTuskarrRaider_01.prefab:13ac2c5bc7b2dba4f89fe041aacd4811");
				break;
			}
		}
	}
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		if (missionEvent == 101)
		{
			yield return PlayBossLine(enemyActor, "VO_GILA_BOSS_60h_Male_HumanGhost_EventPlayPatches_02.prefab:0be9e962c132e8847af72531643812e3");
		}
	}
	...
	protected override IEnumerator HandleStartOfTurnWithTiming(int turn)
	{
		...
		if (turn == 2)
		{
			...
			yield return PlayLineOnlyOnce(playerActor, "VO_GILA_500h3_Female_Human_EVENT_NEMESIS_TURN2_01.prefab:66706a81a9665c843a3c30eefaf9fdbe");
