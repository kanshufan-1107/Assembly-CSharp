...
public class RAFLinkFrame : MonoBehaviour
{
	...
	public void Show()
	{
		if (!m_isShown)
		{
			...
			GameObject inputBlockerObject = CameraUtils.CreateInputBlocker(CameraUtils.FindFirstByLayer(base.gameObject.layer), "RAFLinkInputBlocker");
			...
			RAFManager.Get().GetRAFFrame().DarkenInputBlocker(inputBlockerObject, 0.5f);
		}
	}
