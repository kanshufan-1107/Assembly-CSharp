...
public class GameModeScene : PegasusScene
{
	...
	private void OnLoadScreenPrefabAttempted(AssetReference assetRef, GameObject go, object callbackData)
	{
	...
	private IEnumerator NotifySceneLoadedWhenReady()
	{
		...
		if (!AssetLoader.Get().InstantiatePrefab((string)m_screenPrefab, OnLoadScreenPrefabAttempted))
		{
			OnLoadScreenPrefabAttempted((string)m_screenPrefab, null, null);
		}
