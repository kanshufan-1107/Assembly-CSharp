...
public class BoH_Rexxar_05 : BoH_Rexxar_Dungeon
{
	...
	public override IEnumerator DoActionsBeforeDealingBaseMulliganCards()
	{
		...
		yield return PlayLineAlways(friendlyActor, VO_Story_Hero_Rexxar_Male_OrcOgre_Story_Rexxar_Mission5Intro_01);
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		{
			GameState.Get().SetBusy(busy: true);
			Actor m_WoundedFootman = GetEnemyActorByCardId("Story_02_WoundedFootman");
			if (m_WoundedFootman != null)
			{
				yield return PlayLineAlways(m_WoundedFootman, VO_Story_Minion_Footman_Male_Human_Story_Footman_Play_01);
			}
		...
		case 504:
			GameState.Get().SetBusy(busy: true);
			yield return PlayLineAlways(enemyActor, VO_Story_Hero_Darkscale_Female_Naga_Story_Rexxar_Mission5Loss_01);
			GameState.Get().SetBusy(busy: false);
			break;
		default:
	...
	protected override IEnumerator HandleStartOfTurnWithTiming(int turn)
	{
		...
		{
		case 17:
			yield return PlayLineAlways(enemyActor, VO_Story_Hero_Darkscale_Female_Naga_Story_Rexxar_Mission5ExchangeF_01);
			break;
		case 19:
			yield return PlayLineAlways(enemyActor, VO_Story_Hero_Darkscale_Female_Naga_Story_Rexxar_Mission5ExchangeG_01);
			break;
		}
	}
