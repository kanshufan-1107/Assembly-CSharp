...
public class BRM13_Nefarian : BRM_MissionEntity
{
	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		case "BRMA13_2":
		case "BRMA13_2H":
			yield return Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_BRMA13_1_TURN1_PT1_02.prefab:ac211cc8ab665034da99720e38b6b994", Notification.SpeechBubbleDirection.TopRight, enemyActor, 1f, 1f, parentBubbleToActor: false));
			enemyActor = GameState.Get().GetOpposingSidePlayer().GetHero()
				.GetCard()
				.GetActor();
			yield return Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_BRMA13_1_TURN1_PT2_03.prefab:dc72094fb84984f408d8d1ebf412d931", Notification.SpeechBubbleDirection.TopRight, enemyActor));
			break;
		case "BRMA13_4":
		case "BRMA13_4H":
			if (!m_heroPowerLinePlayed)
			{
				...
				case TAG_CLASS.PALADIN:
					yield return Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_BRMA13_1_HP_PALADIN_07.prefab:a75bd560cd1e9b44192dc1aa2f59c489", Notification.SpeechBubbleDirection.TopRight, enemyActor));
					break;
				case TAG_CLASS.PRIEST:
					yield return Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_BRMA13_1_HP_PRIEST_08.prefab:75d6f8035f037dd43af7c058f318c2fb", Notification.SpeechBubbleDirection.TopRight, enemyActor));
					break;
				case TAG_CLASS.WARLOCK:
					yield return Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_BRMA13_1_HP_WARLOCK_10.prefab:31e6b3b0244121a4d84fd08d3e0a7edb", Notification.SpeechBubbleDirection.TopRight, enemyActor));
					break;
				case TAG_CLASS.WARRIOR:
					yield return Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_BRMA13_1_HP_WARRIOR_09.prefab:8e663fca53457e042bfc9ed73649a48d", Notification.SpeechBubbleDirection.TopRight, enemyActor));
					break;
				case TAG_CLASS.MAGE:
					yield return Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_BRMA13_1_HP_MAGE_11.prefab:30c699c65929cbe4595e9607be6b83a6", Notification.SpeechBubbleDirection.TopRight, enemyActor));
					break;
				case TAG_CLASS.DRUID:
					yield return Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_BRMA13_1_HP_DRUID_14.prefab:64491ad68b7d3924c879f7614c843744", Notification.SpeechBubbleDirection.TopRight, enemyActor));
					break;
				case TAG_CLASS.SHAMAN:
					yield return Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_BRMA13_1_HP_SHAMAN_13.prefab:e248e28c2032e5c4c84490af8596f093", Notification.SpeechBubbleDirection.TopRight, enemyActor));
					break;
				case TAG_CLASS.HUNTER:
					yield return Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_BRMA13_1_HP_HUNTER_12.prefab:a36a163619384214b89421dc5f3f9b54", Notification.SpeechBubbleDirection.TopRight, enemyActor));
					break;
				case TAG_CLASS.ROGUE:
					yield return Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_BRMA13_1_HP_ROGUE_15.prefab:a12234845f3520b4da26d3e575c16b9e", Notification.SpeechBubbleDirection.TopRight, enemyActor));
					break;
				default:
					yield return Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_BRMA13_1_HP_GENERIC_18.prefab:b1f67fa18a6e9d94a974875d6abadcc8", Notification.SpeechBubbleDirection.TopRight, enemyActor));
					break;
				}
