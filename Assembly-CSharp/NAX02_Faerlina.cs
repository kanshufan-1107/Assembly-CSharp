...
public class NAX02_Faerlina : NAX_MissionEntity
{
	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		case "NAX2_03":
			if (!m_heroPowerLinePlayed)
			{
				...
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_NAX2_01_HP_04.prefab:c2607f2df2849a3478f64624ed464f45", Notification.SpeechBubbleDirection.TopRight, enemyActor));
			}
			break;
		case "NAX2_05":
		case "NAX2_05H":
			if (!m_cardLinePlayed)
			{
				...
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_NAX2_01_CARD_02.prefab:462f4054a3d870d44bffda29568fb42f", Notification.SpeechBubbleDirection.TopRight, enemyActor));
			}
			break;
		}
	}
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		if (missionEvent == 1)
		{
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_NAX2_01_CUSTOM_03.prefab:87a19007902dc794e88dd8c21dd1babe", Notification.SpeechBubbleDirection.TopRight, enemyActor));
		}
	}
}
