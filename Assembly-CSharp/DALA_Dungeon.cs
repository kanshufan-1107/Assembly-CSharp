...
public class DALA_Dungeon : DALA_MissionEntity
{
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		{
		case 501:
			yield return PlayLineOnlyOnce(playerActor, VO_DALA_Vessina_Female_Sethrak_TRIGGER_SNAKE_TRAP_01);
			break;
		case 502:
			yield return PlayLineOnlyOnce(playerActor, VO_DALA_George_Male_Human_TRIGGER_AVENGE_01);
			break;
		case 503:
			yield return PlayLineOnlyOnce(playerActor, VO_DALA_George_Male_Human_TRIGGER_NOBLE_SACRIFICE_01);
			break;
		case 504:
			yield return PlayLineOnlyOnce(playerActor, VO_DALA_George_Male_Human_TRIGGER_EYE_FOR_AN_EYE_01);
			break;
		case 505:
