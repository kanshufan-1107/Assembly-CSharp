...
public class BTA_Fight_01 : BTA_Dungeon
{
	...
	public override IEnumerator DoActionsBeforeDealingBaseMulliganCards()
	{
		...
		yield return PlayLineAlways(friendlyActor, VO_BTA_01_Female_NightElf_Mission_Fight_01_PlayerStart_01);
	...
	protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
	{
		...
		{
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_BTA_BOSS_01h_Male_Demon_Mission_Fight_01_Emote_Response_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
		}
	}
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		{
		case 101:
			yield return PlayLineAlways(enemyActor, VO_BTA_BOSS_01h_Male_Demon_Mission_Fight_01_Boss_UnstableFelboltFriendlyDies_01);
			break;
		case 102:
			yield return PlayLineAlways(enemyActor, VO_BTA_BOSS_01h_Male_Demon_Mission_Fight_01_Hero_BamboozleTrigger_01);
			break;
		case 500:
			yield return PlayLineOnlyOnce(enemyActor, VO_BTA_BOSS_01h_Male_Demon_Mission_Fight_01_Boss_Attack_01);
			break;
		case 501:
			GameState.Get().SetBusy(busy: true);
			yield return PlayLineAlways(enemyActor, VO_BTA_BOSS_01h_Male_Demon_Mission_Fight_01_VictoryA_01);
	...
	protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
	{
		...
		if (!(cardID == "CS2_077"))
		{
			if (cardID == "EX1_129")
			{
				yield return PlayLineAlways(enemyActor, VO_BTA_BOSS_01h_Male_Demon_Mission_Fight_01_Hero_FanofKnives_01);
			}
		}
		else
		{
			yield return PlayLineAlways(enemyActor, VO_BTA_BOSS_01h_Male_Demon_Mission_Fight_01_Hero_Sprint_01);
		}
	}
	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
		{
			...
			{
			case "BT_300":
				yield return PlayLineAlways(enemyActor, VO_BTA_BOSS_01h_Male_Demon_Mission_Fight_01_Boss_HandofGuldan_01);
				break;
			case "BTA_13":
				yield return PlayLineAlways(enemyActor, VO_BTA_BOSS_01h_Male_Demon_Mission_Fight_01_Boss_Deteriorate_01);
				break;
			case "BTA_17":
				yield return PlayLineAlways(enemyActor, VO_BTA_BOSS_01h_Male_Demon_Mission_Fight_01_Boss_RustedVoidwalker_01);
				break;
			}
		}
	}
	...
	protected override IEnumerator HandleStartOfTurnWithTiming(int turn)
	{
		...
		if (turn == 1)
		{
			yield return PlayLineAlways(friendlyActor, VO_BTA_01_Female_NightElf_Mission_Fight_01_TurnOne_01);
