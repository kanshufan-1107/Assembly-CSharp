...
public class NAX08_Gothik : NAX_MissionEntity
{
	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		case "NAX8_05":
			if (!m_unrelentingMinionLinePlayed)
			{
				...
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_NAX8_01_CARD_02.prefab:39a2051167989ad48a234c7bfcf6bb0b", Notification.SpeechBubbleDirection.TopRight, enemyActor));
			}
			break;
		case "NAX8_02":
			if (!m_cardLinePlayed)
			{
				...
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_NAX8_01_CUSTOM_03.prefab:4e1adb5a87d8efd45ba4fab32ba9dff1", Notification.SpeechBubbleDirection.TopRight, enemyActor));
			}
			break;
		}
	}
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		if (missionEvent == 1 && !m_deadReturnLinePlayed)
		{
			...
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_NAX8_01_CUSTOM2_04.prefab:10c0d0ad330cfb44eb7faa0413cd2e23", Notification.SpeechBubbleDirection.TopRight, enemyActor));
		}
	}
}
