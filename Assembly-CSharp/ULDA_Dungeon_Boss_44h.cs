...
public class ULDA_Dungeon_Boss_44h : ULDA_Dungeon
{
	...
	{
		base.PreloadAssets();
		List<string> soundFiles = new List<string> { VO_ULDA_BOSS_44h_TrapRoom_Death, VO_ULDA_BOSS_44h_TrapRoom_Defeat, VO_ULDA_BOSS_44h_TrapRoom_EmoteResponse, VO_ULDA_BOSS_44h_TrapRoom_Intro };
