...
public class KAR00_Prologue : KAR_MissionEntity
{
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		if (missionEvent == 2)
		{
			...
			yield return PlayCriticalLine(friendlyActor, "VO_Medivh_Male_Human_PrologueWin_01.prefab:fa080d80cc356ac4587e802bbb856afb");
	...
	protected override IEnumerator HandleStartOfTurnWithTiming(int turn)
	{
		...
		case 1:
			GameState.Get().SetBusy(busy: true);
			yield return PlayOpeningLine(enemyActor, "VO_Malchezaar_Male_Demon_PrologueTurn1_04.prefab:335b8e61366fc9745b8b7cd0a61cc5c7");
		...
		case 12:
			GameState.Get().SetBusy(busy: true);
			yield return PlayAdventureFlavorLine(enemyActor, "VO_Malchezaar_Male_Demon_PrologueTurn11_02.prefab:fbd92ceb10f5ee94c9e2564aa6124df0");
	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()))
		{
			...
			{
				GameState.Get().SetBusy(busy: true);
				yield return PlayBossLine(enemyActor, "VO_Malchezaar_Male_Demon_PrologueHeroPower_01.prefab:34d993460aa6bf249874ef52c64bb8c8");
