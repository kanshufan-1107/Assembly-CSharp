...
public class DALA_Dungeon_Boss_68h : DALA_Dungeon
{
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		{
		case 101:
			yield return PlayLineOnlyOnce(enemyActor, VO_DALA_BOSS_68h_Female_BloodElf_Player10CostMinion_01);
			break;
		case 102:
			yield return PlayLineOnlyOnce(enemyActor, VO_DALA_BOSS_68h_Female_BloodElf_Player1CostMinion_01);
			break;
		case 103:
	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
		{
			...
			case "KAR_077":
			case "KAR_091":
				yield return PlayLineOnlyOnce(enemyActor, VO_DALA_BOSS_68h_Female_BloodElf_BossPortal_01);
				break;
			}
		}
	}
