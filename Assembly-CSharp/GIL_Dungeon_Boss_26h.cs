...
public class GIL_Dungeon_Boss_26h : GIL_Dungeon
{
	...
	protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
	{
		...
		{
			if (playerHeroCardID == "GILA_900h")
			{
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_GILA_BOSS_26h_Male_Tauren_IntroToki_02.prefab:a2170e88fa5ee854bbfdb0ef56c85c47", Notification.SpeechBubbleDirection.TopRight, enemyActor));
			}
			else
			{
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_GILA_BOSS_26h_Male_Tauren_Intro_02.prefab:356bedd73c7f2d4429b9a27d2bba1c9c", Notification.SpeechBubbleDirection.TopRight, enemyActor));
			}
		}
		else if (MissionEntity.STANDARD_EMOTE_RESPONSE_TRIGGERS.Contains(emoteType))
		{
			if (playerHeroCardID == "GILA_900h")
			{
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_GILA_BOSS_26h_Male_Tauren_EmoteResponseToki_01.prefab:692123ffe8ef90d43940f4e859ca22da", Notification.SpeechBubbleDirection.TopRight, enemyActor));
			}
			else
			{
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_GILA_BOSS_26h_Male_Tauren_EmoteResponse_01.prefab:64aa7106bd06b1d4696335e0fe16cc60", Notification.SpeechBubbleDirection.TopRight, enemyActor));
			}
		}
	}
	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		case "GILA_BOSS_26t2":
		{
			string randomLine = PopRandomLineWithChance(m_SackOfGnomesRandomLines);
			if (randomLine != null)
			{
		...
		case "EX1_029":
			yield return PlayBossLine(enemyActor, "VO_GILA_BOSS_26h_Male_Tauren_EventPlaysLeper_01.prefab:87b119c33758df5488c79e39f5726583");
			break;
		case "GVG_082":
			yield return PlayBossLine(enemyActor, "VO_GILA_BOSS_26h_Male_Tauren_EventPlaysClockwork_02.prefab:750d4d813e1c28e478bf0bd1e07d53e8");
			break;
		case "NEW1_029":
			yield return PlayBossLine(enemyActor, "VO_GILA_BOSS_26h_Male_Tauren_EventPlaysMillhouse_02.prefab:2f68b6ac173275f4b888f6aed4682b08");
			break;
		case "GVG_116":
			yield return PlayBossLine(enemyActor, "VO_GILA_BOSS_26h_Male_Tauren_EventPlaysThermaplugg_02.prefab:3296c7c83da25224eadb03712274952e");
			break;
		case "AT_033":
			yield return PlayBossLine(enemyActor, "VO_GILA_BOSS_26h_Male_Tauren_EventBurgle_01.prefab:38c95405acb3f03448203a4e342bc93c");
			break;
		}
	}
	...
	protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
	{
		...
		if (!(cardID == "GILA_801"))
		{
			if (cardID == "GILA_907")
			{
				yield return PlayBossLine(enemyActor, "VO_GILA_BOSS_26h_Male_Tauren_EventPlayClockworkAssistant_01.prefab:edeb9459e433a6b41bcb627a135255fb");
			}
		}
		else
		{
			yield return PlayBossLine(enemyActor, "VO_GILA_BOSS_26h_Male_Tauren_EventPlayGattlingGunner_01.prefab:d15061c1491699245be500c1e639bbb5");
		}
	}
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		case 101:
		{
			string randomLine = PopRandomLineWithChance(m_PlayGnomesRandomLines);
			if (randomLine != null)
			{
				yield return PlayLineOnlyOnce(enemyActor, randomLine);
			}
		...
		case 102:
			yield return PlayBossLine(enemyActor, "VO_GILA_BOSS_26h_Male_Tauren_EventSilence_03.prefab:606503d7cd29980419bfc88a0b0d9c6c");
			break;
		}
	}
}
