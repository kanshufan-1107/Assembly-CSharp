...
public class ULDA_Dungeon_Boss_51h : ULDA_Dungeon
{
	...
	protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
	{
		...
		string playerHeroCardID = GameState.Get().GetFriendlySidePlayer().GetHero()
			.GetCardId();
		if (emoteType == EmoteType.START && playerHeroCardID != "ULDA_Elise")
		{
	...
	protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
		{
			...
			{
			case "ULD_186":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_51h_Female_Anubisath_PlayerTrigger_Pharaoh_Cat_01);
				break;
			case "ULD_138":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_51h_Female_Anubisath_PlayerTrigger_Anubisath_Defender_01);
				break;
			case "ULD_271":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_51h_Female_Anubisath_PlayerTrigger_Enslaved_Guardian_01);
				break;
			}
		}
	}
	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
		{
			...
			{
			case "ULD_138":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_51h_Female_Anubisath_BossTriggerAnubisathDefender_01);
				break;
			case "ULD_265":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_51h_Female_Anubisath_BossTriggerEmbalmingRitual_01);
				break;
			case "ULD_268":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_51h_Female_Anubisath_BossTriggerPsychopomp_01);
				break;
			}
		}
	}
