...
public class BTA_Prologue_Fight_02 : BTA_Prologue_Dungeon
{
	...
	protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
	{
		...
		{
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_Prologue_Xavius_Male_Satyr_Prologue_Mission2_Intro_03_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
		}
		else if (MissionEntity.STANDARD_EMOTE_RESPONSE_TRIGGERS.Contains(emoteType))
		{
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_Prologue_Xavius_Male_Satyr_Prologue_Xavius_EmoteResponse_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
		}
	}
	...
	protected void ShowMinionMoveTutorial()
	{
		...
		if (!(leftMostMinion == null))
		{
			...
			string textID = "DEMON_HUNTER_PROLOGUE_2_PORTAL_POPUP";
