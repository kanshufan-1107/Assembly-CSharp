...
public class ULDA_Dungeon_Boss_22h : ULDA_Dungeon
{
	...
	protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
	{
		...
		if (!(cardID == "ULD_721"))
		{
			if (cardID == "ULD_703")
			{
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_22h_Male_Colossus_PlayerTriggerDesertObelisk_01);
			}
		}
		else
		{
			yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_22h_Male_Colossus_PlayerTriggerColossusoftheMoon_01);
		}
	}
	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
		{
			...
			{
			case "ULD_721":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_22h_Male_Colossus_BossTriggerColossusoftheMoon_01);
				break;
			case "ULD_707":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_22h_Male_Colossus_BossTriggerPlagueofWrath_01);
				break;
			case "DAL_742":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_22h_Male_Colossus_BossTriggerWhirlwind_01);
				break;
			}
		}
	}
