...
public class KAR10_Aran : KAR_MissionEntity
{
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		if (!m_playedLines.Contains(missionEventName))
		{
			...
			case 1:
				...
				yield return PlayEasterEggLine(enemyActor, "VO_Aran_Male_Shade_AranCrackle_01.prefab:bc888dcf38fea67478451daed3a95b07");
				GameState.Get().SetBusy(busy: false);
				break;
			case 2:
				yield return PlayBossLine(enemyActor, "VO_Aran_Male_Shade_AranHeroPower_01.prefab:efd33279a659c4b45b71371592ed8477");
				break;
			}
		}
	}
	...
	protected override IEnumerator HandleStartOfTurnWithTiming(int turn)
	{
		...
		case 1:
			...
			{
				yield return PlayOpeningLine(enemyActor, "VO_Aran_Male_Shade_AranTurn1_01.prefab:145fc99930a9bf94e9220b73440f603b");
		...
		case 4:
			GameState.Get().SetBusy(busy: true);
			yield return PlayMissionFlavorLine(enemyActor, "VO_Aran_Male_Shade_AranTurn5_01.prefab:3f761320471ef964381b2eb26650cefd");
			GameState.Get().SetBusy(busy: false);
			break;
		case 8:
			GameState.Get().SetBusy(busy: true);
	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		if (!(cardID == "CS2_028"))
		{
			if (cardID == "CS2_033")
			{
				yield return PlayBossLine(enemyActor, "VO_Aran_Male_Shade_AranSpell_04.prefab:95571da88393435459da14036a4f20f8");
			}
		}
		else
		{
			yield return PlayBossLine(enemyActor, "VO_Aran_Male_Shade_AranSpell_03.prefab:00d1e54e1dcdfbe4497ed8011d01f4fb");
		}
	}
	...
	protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()))
		{
			...
			{
			case "CS2_034_H1":
				yield return PlayEasterEggLine(enemyActor, "VO_Aran_Male_Shade_AranMedivhSkin_01.prefab:2c2804e44bd75034a9e2c6a2fb86e1ba");
				break;
			case "GVG_085":
			case "OG_145":
				m_playedLines.Add("GVG_085");
				m_playedLines.Add("OG_145");
				yield return PlayEasterEggLine(enemyActor, "VO_Aran_Male_Shade_AranTrons_02.prefab:b37a84a69b76ea24993c7afbd4c0212c");
				break;
			}
		}
	}
