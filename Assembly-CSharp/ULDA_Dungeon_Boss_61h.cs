...
public class ULDA_Dungeon_Boss_61h : ULDA_Dungeon
{
	...
	protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
	{
		...
		if (emoteType == EmoteType.START)
		{
			...
			{
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_ULDA_BOSS_61h_Female_Dragon_IntroResponseBrann_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
			}
			else
			{
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		{
		case 104:
			yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_61h_Female_Dragon_BossTriggerCrackleDestroyMinion_01);
			break;
		case 102:
			yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_61h_Female_Dragon_HeroPowerRare_01);
			break;
		case 103:
			yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_61h_Female_Dragon_PlayerDragon_01);
			break;
		case 101:
			yield return PlayBossLine(enemyActor, VO_ULDA_BOSS_61h_Female_Dragon_TurnOne_01);
			break;
		default:
	...
	protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
		{
			...
			case "EX1_259":
			case "OG_206":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_61h_Female_Dragon_PlayerLightningSpell_01);
				break;
			}
		}
	}
	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		if (!(cardID == "TRL_569"))
		{
			if (cardID == "TRL_362")
			{
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_61h_Female_Dragon_BossTriggerDragonRoar_01);
			}
		}
		else
		{
			yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_61h_Female_Dragon_BossTriggerCrowdRoaster_01);
		}
	}
}
