...
public class DALA_Dungeon_Boss_36h : DALA_Dungeon
{
	...
	protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
	{
		...
		if (emoteType == EmoteType.START)
		{
			...
			{
			case "DALA_Eudora":
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_DALA_BOSS_36h_Male_Dwarf_IntroEudora_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
				break;
			case "DALA_Kriziki":
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_DALA_BOSS_36h_Male_Dwarf_IntroKriziki_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
				break;
			case "DALA_Squeamlish":
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_DALA_BOSS_36h_Male_Dwarf_IntroSqueamlish_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
				break;
			case "DALA_Barkeye":
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_DALA_BOSS_36h_Male_Dwarf_IntroOlBarkeye_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
				break;
			default:
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		{
		case 101:
			yield return PlayLineOnlyOnce(enemyActor, VO_DALA_BOSS_36h_Male_Dwarf_PlayerBeastDeathrattle_01);
			break;
		case 102:
			yield return PlayAndRemoveRandomLineOnlyOnce(enemyActor, m_PlayerSmallBeast);
			break;
		case 103:
			yield return PlayAndRemoveRandomLineOnlyOnce(enemyActor, m_PlayerBeast);
			break;
		case 104:
			yield return PlayAndRemoveRandomLineOnlyOnce(enemyActor, m_PlayerBigBeast);
			break;
		case 105:
			yield return PlayAndRemoveRandomLineOnlyOnce(enemyActor, m_PlayerZombeast);
			break;
		case 106:
			yield return PlayAndRemoveRandomLineOnlyOnce(enemyActor, m_BossBeast);
			break;
		case 107:
			yield return PlayLineOnlyOnce(enemyActor, VO_DALA_BOSS_36h_Male_Dwarf_TurnStart_01);
			break;
		case 108:
			yield return PlayLineOnlyOnce(enemyActor, VO_DALA_BOSS_36h_Male_Dwarf_Misc_01);
			break;
		default:
