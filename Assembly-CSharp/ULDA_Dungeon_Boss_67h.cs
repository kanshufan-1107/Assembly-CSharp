...
public class ULDA_Dungeon_Boss_67h : ULDA_Dungeon
{
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		case 113:
		{
			...
			if (m_introLine == VO_ULDA_BOSS_67h_Male_PlagueLord_IntroSpecialReno_01 || m_introLine == VO_ULDA_BOSS_67h_Male_PlagueLord_IntroSpecialBrann_01 || m_introLine == VO_ULDA_BOSS_67h_Male_PlagueLord_IntroSpecialElise_01 || m_introLine == VO_ULDA_BOSS_67h_Male_PlagueLord_IntroSpecialFinley_01)
			{
				...
				if (m_introLine == VO_ULDA_BOSS_67h_Male_PlagueLord_IntroSpecialReno_01)
				{
					yield return PlayBossLine(enemyActor, VO_ULDA_BOSS_67h_Male_PlagueLord_IntroSpecialReno2_01);
				}
				else if (m_introLine == VO_ULDA_BOSS_67h_Male_PlagueLord_IntroSpecialBrann_01)
				{
					yield return PlayBossLine(enemyActor, VO_ULDA_BOSS_67h_Male_PlagueLord_IntroSpecialBrann2_01);
				}
				else if (m_introLine == VO_ULDA_BOSS_67h_Male_PlagueLord_IntroSpecialElise_01)
				{
					yield return PlayBossLine(enemyActor, VO_ULDA_BOSS_67h_Male_PlagueLord_IntroSpecialElise2_01);
				}
				else if (m_introLine == VO_ULDA_BOSS_67h_Male_PlagueLord_IntroSpecialFinley_01)
				{
	...
	protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
		{
			...
			case "ULDA_017":
			case "ULDA_018":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_67h_Male_PlagueLord_PlayerTriggerJrExplorer_01);
				break;
			case "ULD_157":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_67h_Male_PlagueLord_PlayerTriggerSkilledPathfinder_01);
				break;
			case "ULD_003":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_67h_Male_PlagueLord_PlayerTriggerZephrystheGreat_01);
				break;
			case "ULD_304":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_67h_Male_PlagueLord_PlayerTriggerKingPhaoris_01);
				break;
			case "UNG_015":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_67h_Male_PlagueLord_PlayerTriggerSunkeeperTarim_01);
				break;
			}
		}
	}
	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
		{
			...
			{
			case "ULDA_BOSS_67t":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_67h_Male_PlagueLord_STORY_Finale_Elise_vs_Tekahn_b_01);
				break;
			case "EX1_308":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_67h_Male_PlagueLord_BossTriggerSoulfire_01);
				break;
			case "CS2_062":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_67h_Male_PlagueLord_BossTriggerHellfire_01);
				break;
			case "LOE_009":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_67h_Male_PlagueLord_BossTriggerObsidianDestroyer_01);
				break;
			case "CS2_032":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_67h_Male_PlagueLord_BossTriggerFlamestrike_01);
				break;
			case "CS2_029":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_67h_Male_PlagueLord_BossTriggerFireball_01);
				break;
			case "OG_086":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_67h_Male_PlagueLord_BossTriggerForbiddenFlame_01);
				break;
			case "ULD_717":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_67h_Male_PlagueLord_BossTriggerPlagueofFlames_01);
				break;
			}
		}
	}
