...
public class ULDA_Dungeon_Boss_40h : ULDA_Dungeon
{
	...
	protected IEnumerator PlayMultipleVOLinesForEmotes(EmoteType emoteType, CardSoundSpell emoteSpell)
	{
		...
		string playerHeroCardID = GameState.Get().GetFriendlySidePlayer().GetHero()
			.GetCardId();
		int enemyHealth = GameState.Get().GetOpposingSidePlayer().GetCurrentHealth();
		if (emoteType == EmoteType.START)
		{
			...
			if (enemyHealth <= 299 && enemyHealth >= 201)
			{
			...
			if (enemyHealth <= 200 && enemyHealth >= 101)
			{
			...
			if (m_introLine == VO_ULDA_BOSS_40h_Female_PlagueLord_IntroSpecialReno_01)
			{
			...
			else if (m_introLine == VO_ULDA_BOSS_40h_Female_PlagueLord_IntroSpecialBrann_01)
			{
			...
			else if (m_introLine == VO_ULDA_BOSS_40h_Female_PlagueLord_IntroSpecialElise_01)
			{
			...
			else if (m_introLine == VO_ULDA_BOSS_40h_Female_PlagueLord_IntroSpecialFinley_01)
			{
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		{
		case 107:
			yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_40h_Female_PlagueLord_BossMomentumSwing_01);
			break;
		case 103:
		...
		case 105:
			...
			break;
		case 106:
			yield return PlayBossLine(enemyActor, VO_ULDA_BOSS_40h_Female_PlagueLord_IdleSpecial_01);
			break;
		case 101:
			yield return PlayBossLine(enemyActor, VO_ULDA_BOSS_40h_Female_PlagueLord_PhaseChange1_01);
			break;
		case 102:
			yield return PlayBossLine(enemyActor, VO_ULDA_BOSS_40h_Female_PlagueLord_PhaseChange2_01);
			break;
		case 104:
	...
	protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
		{
			...
			{
			case "ULD_191":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_40h_Female_PlagueLord_PlayerTriggerBeamingSidekick_01);
				break;
			case "ULD_719":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_40h_Female_PlagueLord_PlayerTriggerDesertHare_01);
				break;
			case "ULD_271":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_40h_Female_PlagueLord_PlayerTriggerInjuredTolvir_01);
				break;
			case "EX1_607":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_40h_Female_PlagueLord_PlayerTriggerInnerRage_01);
				break;
			case "ULD_707":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_40h_Female_PlagueLord_PlayerTriggerPlagueofWrath_01);
				break;
			}
		}
	}
	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
		{
			...
			{
			case "ULD_258":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_40h_Female_PlagueLord_BossTriggerArmagedillo_01);
				break;
			case "EX1_392":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_40h_Female_PlagueLord_BossTriggerBattleRage_01);
				break;
			case "ULD_177":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_40h_Female_PlagueLord_BossTriggerOctosari_01);
				break;
			case "ULD_707":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_40h_Female_PlagueLord_BossTriggerPlagueofWrath_01);
				break;
			case "ULD_256":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_40h_Female_PlagueLord_BossTriggerReinforcements_01);
				break;
			case "ULD_206":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_40h_Female_PlagueLord_BossTriggerRestlessMummy_01);
				break;
			case "TRL_325":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_40h_Female_PlagueLord_BossTriggerSulthraze_01);
				break;
			case "ULD_185":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_40h_Female_PlagueLord_BossTriggerTempleBerserker_01);
				break;
			case "LOOT_380":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_40h_Female_PlagueLord_BossTriggerWoecleaver_01);
				break;
			}
		}
	}
