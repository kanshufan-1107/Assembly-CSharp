...
public class DALA_Dungeon_Boss_44h : DALA_Dungeon
{
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		if (missionEvent == 101)
		{
			yield return PlayAndRemoveRandomLineOnlyOnce(enemyActor, m_BossBurnsCardOnDraw);
		}
		else
		{
	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
		{
			...
			case "EX1_238":
			case "EX1_245":
				yield return PlayLineOnlyOnce(enemyActor, VO_DALA_BOSS_44h_Male_Arakkoa_BossShamanDamageSpell_01);
				break;
			case "OG_293":
			case "CFM_626":
				yield return PlayLineOnlyOnce(enemyActor, VO_DALA_BOSS_44h_Male_Arakkoa_BossArakoaPlayed_01);
				break;
			}
		}
	}
