...
public class GIL_Dungeon_Boss_51h : GIL_Dungeon
{
	...
	protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
	{
		...
		{
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_GILA_BOSS_51h_Male_Undead_Intro_01.prefab:f62d6a72af299064b8e79ffae9ece1dc", Notification.SpeechBubbleDirection.TopRight, enemyActor));
		}
		else if (MissionEntity.STANDARD_EMOTE_RESPONSE_TRIGGERS.Contains(emoteType))
		{
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_GILA_BOSS_51h_Male_Undead_EmoteResponse_01.prefab:5a733778d0078834e8c3610dcf4c9279", Notification.SpeechBubbleDirection.TopRight, enemyActor));
		}
	}
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		if (missionEvent == 101)
		{
			string randomLine = PopRandomLineWithChance(m_MinionWarning);
			if (randomLine != null)
			{
	...
	protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()))
		{
			...
			if (cardID == "GILA_816a")
			{
				yield return PlayEasterEggLine(enemyActor, "VO_GILA_BOSS_51h_Male_Undead_EventPlayCoinPouch_01.prefab:7cb96fee789ac8044994fbabb6061db7");
			}
		}
	}
}
