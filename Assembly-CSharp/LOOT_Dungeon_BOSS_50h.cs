...
public class LOOT_Dungeon_BOSS_50h : LOOT_Dungeon
{
	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		if (entity.GetControllerSide() == Player.Side.OPPOSING)
		{
			Actor enemyActor = GameState.Get().GetOpposingSidePlayer().GetHeroCard()
				.GetActor();
			if (entity.GetCardId() == "LOOTA_BOSS_50t" && m_PotionLines.Count != 0)
			{
	...
	protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
	{
		...
		{
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_LOOTA_BOSS_50h_Male_Kobold_Intro_01.prefab:f80b5a28ce912c04db88d22e5d244240", Notification.SpeechBubbleDirection.TopRight, enemyActor));
		}
		else if (MissionEntity.STANDARD_EMOTE_RESPONSE_TRIGGERS.Contains(emoteType))
		{
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_LOOTA_BOSS_50h_Male_Kobold_EmoteResponse_01.prefab:30cf49b490a303546b11d21a5dbb8a7d", Notification.SpeechBubbleDirection.TopRight, enemyActor));
		}
	}
	...
	protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()))
		{
			...
			if (cardID == "CFM_621")
			{
				yield return PlayEasterEggLine(enemyActor, "VO_LOOTA_BOSS_50h_Male_Kobold_EventKazakus_01.prefab:37b855a910c4d6941b3dc2cb272c7501");
			}
		}
	}
