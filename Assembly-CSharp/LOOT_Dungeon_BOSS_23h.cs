...
public class LOOT_Dungeon_BOSS_23h : LOOT_Dungeon
{
	...
	protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
	{
		...
		{
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_LOOTA_BOSS_23h_Male_Furbolg_Intro_01.prefab:7e40d7bc17378c6449ba9f7bb40ceab3", Notification.SpeechBubbleDirection.TopRight, enemyActor));
		}
		else if (MissionEntity.STANDARD_EMOTE_RESPONSE_TRIGGERS.Contains(emoteType))
		{
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_LOOTA_BOSS_23h_Male_Furbolg_EmoteResponse_01.prefab:e0068889c8f178846b15af6cb3a2fd1c", Notification.SpeechBubbleDirection.TopRight, enemyActor));
		}
	}
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		if (missionEvent == 101)
		{
			...
			if (m_BigMinionsLines.Count != 0 && chanceVO >= randomNum)
			{
