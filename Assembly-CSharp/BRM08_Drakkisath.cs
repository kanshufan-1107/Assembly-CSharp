...
public class BRM08_Drakkisath : BRM_MissionEntity
{
	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		Actor enemyActor = GameState.Get().GetOpposingSidePlayer().GetHero()
			.GetCard()
			.GetActor();
		if (entity.GetCardId() == "BRMA08_3" && !m_cardLinePlayed)
		{
			m_cardLinePlayed = true;
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_BRMA08_1_CARD_05.prefab:fd0151285c6aec540b909e0a29f5acb8", Notification.SpeechBubbleDirection.TopRight, enemyActor));
		}
	}
	...
	protected override IEnumerator HandleStartOfTurnWithTiming(int turn)
	{
		...
		{
		case 1:
			yield return Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_BRMA08_1_TURN1_ALT_02.prefab:d71f74a42d0105446a5e2e3c4b60e067", Notification.SpeechBubbleDirection.TopRight, enemyActor));
			break;
		case 4:
			if (!GameMgr.Get().IsClassChallengeMission())
			{
				yield return Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_BRMA08_1_TURN1_03.prefab:e4d206e77c3c8f548934be5fcce89ea5", Notification.SpeechBubbleDirection.TopRight, enemyActor));
