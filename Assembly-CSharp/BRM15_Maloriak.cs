...
public class BRM15_Maloriak : BRM_MissionEntity
{
	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		case "BRMA15_2H":
			if (!m_heroPowerLinePlayed)
			{
				...
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_BRMA15_1_HERO_POWER_06.prefab:27e3e01a28e94254a95c382f14bafe2c", Notification.SpeechBubbleDirection.TopRight, enemyActor));
			}
			break;
		case "BRMA15_3":
			if (!m_cardLinePlayed)
			{
				...
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_BRMA15_1_CARD_05.prefab:459bd07b2915f1d448418b2ddcd89917", Notification.SpeechBubbleDirection.TopRight, enemyActor));
			}
			break;
		}
	}
	...
	protected override IEnumerator HandleStartOfTurnWithTiming(int turn)
	{
		...
		{
		case 1:
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_BRMA15_1_TURN1_02.prefab:b2e6fc2aa07c2c743844fad9a8e782bb", Notification.SpeechBubbleDirection.TopRight, enemyActor));
			break;
		case 2:
