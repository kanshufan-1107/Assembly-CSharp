...
public class DALA_Dungeon_Boss_37h : DALA_Dungeon
{
	...
	protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
	{
		...
		{
			if (playerHeroCardID != "DALA_Rakanishu" && playerHeroCardID != "DALA_Tekahn" && playerHeroCardID != "DALA_Squeamlish" && playerHeroCardID != "DALA_Eudora" && playerHeroCardID != "DALA_George")
			{
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		{
		case 101:
			yield return PlayAndRemoveRandomLineOnlyOnce(enemyActor, m_HeroPowerDraw);
			break;
		case 102:
			yield return PlayLineOnlyOnce(enemyActor, VO_DALA_BOSS_37h_Male_Troll_PlayerDestroyMarinTreasure_01);
			break;
		case 103:
			yield return PlayLineOnlyOnce(enemyActor, VO_DALA_BOSS_37h_Male_Troll_PlayerPirate_01);
			break;
		case 104:
			yield return PlayLineOnlyOnce(enemyActor, VO_DALA_BOSS_37h_Male_Troll_TurnStart_01);
			break;
		default:
	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
		{
			...
			if (cardID == "LOE_079")
			{
				yield return PlayLineOnlyOnce(enemyActor, VO_DALA_BOSS_37h_Male_Troll_BossElise_01);
			}
		}
	}
}
