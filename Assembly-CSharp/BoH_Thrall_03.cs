...
public class BoH_Thrall_03 : BoH_Thrall_Dungeon
{
	...
	public override IEnumerator DoActionsBeforeDealingBaseMulliganCards()
	{
		...
		yield return MissionPlayVO(enemyActor, VO_Story_Hero_Orgrim2_Male_Orc_Story_Thrall_Mission3Intro_01);
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		case 507:
			GameState.Get().SetBusy(busy: true);
			yield return PlayLineAlways(enemyActor, VO_Story_Hero_Orgrim2_Male_Orc_Story_Thrall_Mission3Loss_01);
			GameState.Get().SetBusy(busy: false);
			break;
		case 102:
			GameState.Get().SetBusy(busy: true);
			yield return PlayLineAlways(enemyActor, VO_Story_Hero_Orgrim2_Male_Orc_Story_Thrall_Mission3Victory_01);
		...
		case 504:
			GameState.Get().SetBusy(busy: true);
			yield return PlayLineAlways(enemyActor, VO_Story_Hero_Orgrim2_Male_Orc_Story_Thrall_Mission3Victory_04);
			GameState.Get().SetBusy(busy: false);
			break;
		default:
