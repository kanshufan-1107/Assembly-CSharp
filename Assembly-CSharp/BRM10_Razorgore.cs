...
public class BRM10_Razorgore : BRM_MissionEntity
{
	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		if ((cardId == "BRMA10_3" || cardId == "BRMA10_3H") && !m_heroPowerLinePlayed)
		{
			...
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_BRMA10_1_HERO_POWER_04.prefab:5d2db978ae659d645a110f1bbfdefc03", Notification.SpeechBubbleDirection.TopRight, enemyActor));
		}
	}
	...
	protected override IEnumerator HandleStartOfTurnWithTiming(int turn)
	{
		...
		if (turn == 1)
		{
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_BRMA10_1_TURN1_02.prefab:470bcd541d18f5f4e99f1b2b1fd97622", Notification.SpeechBubbleDirection.TopRight, enemyActor));
		}
		yield break;
	}
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		if (missionEvent == 1)
		{
			...
			{
			case 1:
				yield return Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_BRMA10_1_EGG_DEATH_1_05.prefab:66bc1615e7b2e2143a07fd2cdcd3bd98", Notification.SpeechBubbleDirection.TopRight, enemyActor));
				break;
			case 2:
				yield return Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_BRMA10_1_EGG_DEATH_2_06.prefab:178e26b2103924c48b8511c2a5424bff", Notification.SpeechBubbleDirection.TopRight, enemyActor));
				break;
			case 3:
				yield return Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_BRMA10_1_EGG_DEATH_3_07.prefab:906089c0627eed044a123bd5cd9ae38d", Notification.SpeechBubbleDirection.TopRight, enemyActor));
				break;
			}
		}
	}
