...
public class ICC_07_Putricide : ICC_MissionEntity
{
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		case 103:
			...
			{
				GameState.Get().SetBusy(busy: true);
				string randomEquipWeaponLine = m_BossEquipWeaponLines[Random.Range(0, m_BossEquipWeaponLines.Count)];
				m_BossEquipWeaponLines.Remove(randomEquipWeaponLine);
				yield return PlayLineOnlyOnce(enemyActor, randomEquipWeaponLine);
				GameState.Get().SetBusy(busy: false);
			}
			break;
		case 104:
	...
	protected override IEnumerator HandleGameOverWithTiming(TAG_PLAYSTATE gameResult)
	{
		...
		{
			yield return new WaitForSeconds(5f);
			string voLine = "VO_ICC07_LichKing_Male_Human_Lose_01.prefab:80e34f0495b56a64c8e15802081f992c";
