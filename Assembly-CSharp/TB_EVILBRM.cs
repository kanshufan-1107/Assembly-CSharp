...
public class TB_EVILBRM : MissionEntity
{
	...
	{
		Notification.SpeechBubbleDirection bubbleDir = Notification.SpeechBubbleDirection.TopLeft;
		switch (boss)
		{
		case BOSS.BOOM:
			yield return PlayMissionFlavorLine("Blastermaster_Boom_popup_BrassRing_Quote.prefab:71029fa93b8e9564bb2fa3003158ba08", line, LEFT_OF_ENEMY_HERO, bubbleDir, 2.5f, persistCharacter);
			break;
		case BOSS.HAGATHA:
			yield return PlayMissionFlavorLine("Hagatha_Pop-up_BrassRing_Quote.prefab:82d8a1fd3b66a3c4da28e4dc34b42617", line, LEFT_OF_ENEMY_HERO, bubbleDir, 2.5f, persistCharacter);
			break;
		case BOSS.TOGWAGGLE:
			yield return PlayMissionFlavorLine("Togwaggle_pop-up_BrassRing_Quote.prefab:99e68bee5c488cb45a212327619b0922", line, LEFT_OF_ENEMY_HERO, bubbleDir, 2.5f, persistCharacter);
			break;
		case BOSS.LAZUL:
			yield return PlayMissionFlavorLine("Madam_Lazul_Popup_BrassRing_Quote.prefab:5fd991c28d0cc7842b99ae3ddb65aa0c", line, LEFT_OF_ENEMY_HERO, bubbleDir, 2.5f, persistCharacter);
			break;
		case BOSS.RAFAAM:
			yield return PlayMissionFlavorLine("Rafaam_popup_BrassRing_Quote:187724fae6d64cf49acf11aa53ca2087", line, LEFT_OF_ENEMY_HERO, bubbleDir, 2.5f, persistCharacter);
			break;
		}
	}
	...
	{
		Notification.SpeechBubbleDirection bubbleDir = Notification.SpeechBubbleDirection.TopRight;
		switch (boss)
		{
		case BOSS.BOOM:
			yield return PlayMissionFlavorLine("Blastermaster_Boom_popup_BrassRing_Quote.prefab:71029fa93b8e9564bb2fa3003158ba08", line, RIGHT_OF_ENEMY_HERO, bubbleDir, 2.5f, persistCharacter);
			break;
		case BOSS.HAGATHA:
			yield return PlayMissionFlavorLine("Hagatha_Pop-up_BrassRing_Quote.prefab:82d8a1fd3b66a3c4da28e4dc34b42617", line, RIGHT_OF_ENEMY_HERO, bubbleDir, 2.5f, persistCharacter);
			break;
		case BOSS.TOGWAGGLE:
			yield return PlayMissionFlavorLine("Togwaggle_pop-up_BrassRing_Quote.prefab:99e68bee5c488cb45a212327619b0922", line, RIGHT_OF_ENEMY_HERO, bubbleDir, 2.5f, persistCharacter);
			break;
		case BOSS.LAZUL:
			yield return PlayMissionFlavorLine("Madam_Lazul_Popup_BrassRing_Quote.prefab:5fd991c28d0cc7842b99ae3ddb65aa0c", line, RIGHT_OF_ENEMY_HERO, bubbleDir, 2.5f, persistCharacter);
			break;
		case BOSS.RAFAAM:
			yield return PlayMissionFlavorLine("Rafaam_popup_BrassRing_Quote:187724fae6d64cf49acf11aa53ca2087", line, RIGHT_OF_ENEMY_HERO, bubbleDir, 2.5f, persistCharacter);
			break;
		}
	}
