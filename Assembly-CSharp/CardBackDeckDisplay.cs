...
public class CardBackDeckDisplay : MonoBehaviour
{
	...
	public void UpdateDeckCardBacks()
	{
		if (m_CardBackManager != null)
		{
			CardBackManager.CardBackSlot cardBackSlot = (m_FriendlyDeck ? CardBackManager.CardBackSlot.FRIENDLY : CardBackManager.CardBackSlot.OPPONENT);
			m_CardBackManager.UpdateDeck(base.gameObject, cardBackSlot);
		}
	}
}
