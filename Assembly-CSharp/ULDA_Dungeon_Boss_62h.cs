...
public class ULDA_Dungeon_Boss_62h : ULDA_Dungeon
{
	...
	{
		base.PreloadAssets();
		List<string> soundFiles = new List<string> { VO_ULDA_BOSS_62h_Oasis_Death, VO_ULDA_BOSS_62h_Oasis_PlayerDefeat, VO_ULDA_BOSS_62h_Oasis_EmoteResponse, VO_ULDA_BOSS_62h_Oasis_Intro };
