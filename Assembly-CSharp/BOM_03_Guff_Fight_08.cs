...
public class BOM_03_Guff_Fight_08 : BOM_03_Guff_Dungeon
{
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		{
		case 514:
			yield return MissionPlayVO(friendlyActor, VO_Story_Hero_Guff_Male_Tauren_Story_Guff_Mission8Intro_01);
		...
		case 506:
			...
			break;
		case 504:
			yield return MissionPlayVO(friendlyActor, VO_Story_Hero_Guff_Male_Tauren_Story_Guff_Mission8ExchangeJ_01);
			break;
		case 505:
			GameState.Get().SetBusy(busy: true);
