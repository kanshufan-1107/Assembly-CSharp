...
public class BoH_Valeera_01 : BoH_Valeera_Dungeon
{
	...
	public override IEnumerator DoActionsBeforeDealingBaseMulliganCards()
	{
		...
		yield return MissionPlayVO(enemyActor, VO_Story_Hero_Rehgar_Male_Orc_Story_Valeera_Mission1Intro_01);
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		{
		case 101:
			yield return PlayLineAlways(enemyActor, VO_Story_Hero_Rehgar_Male_Orc_Story_Valeera_Mission1Loss_01);
			break;
		case 504:
			GameState.Get().SetBusy(busy: true);
			yield return PlayLineAlways(enemyActor, VO_Story_Hero_Rehgar_Male_Orc_Story_Valeera_Mission1Victory_01);
	...
	protected override IEnumerator HandleStartOfTurnWithTiming(int turn)
	{
		...
		case 7:
			...
			break;
		case 11:
			yield return PlayLineAlways(enemyActor, VO_Story_Hero_Rehgar_Male_Orc_Story_Valeera_Mission1ExchangeC_01);
