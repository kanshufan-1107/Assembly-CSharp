...
public class LOOT_Dungeon_BOSS_21h : LOOT_Dungeon
{
	...
	{
		base.PreloadAssets();
		foreach (string soundFile in new List<string> { LOOTA_BOSS_21h_GnoshTheGreatWorm_Death, LOOTA_BOSS_21h_GnoshTheGreatWorm_Intro, LOOTA_BOSS_21h_GnoshTheGreatWorm_EmoteResponse })
		{
	...
	protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
	{
		...
		{
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(LOOTA_BOSS_21h_GnoshTheGreatWorm_Intro, Notification.SpeechBubbleDirection.None, enemyActor));
		}
		else if (MissionEntity.STANDARD_EMOTE_RESPONSE_TRIGGERS.Contains(emoteType))
		{
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(LOOTA_BOSS_21h_GnoshTheGreatWorm_EmoteResponse, Notification.SpeechBubbleDirection.TopRight, enemyActor));
		}
	}
