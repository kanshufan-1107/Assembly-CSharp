...
public class BOM_03_Guff_Fight_03 : BOM_03_Guff_Dungeon
{
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		{
		case 514:
			yield return MissionPlayVO(enemyActor, VO_Story_Hero_Barak_Male_Centaur_Story_Guff_Mission3Intro_01);
			yield return MissionPlayVO(friendlyActor, VO_Story_Hero_Guff_Male_Tauren_Story_Guff_Mission3Intro_02);
			break;
		case 515:
			yield return MissionPlayVO(enemyActor, VO_Story_Hero_Barak_Male_Centaur_Story_Guff_Mission3EmoteResponse_01);
			break;
		case 516:
			yield return MissionPlaySound(enemyActor, VO_Story_Hero_Barak_Male_Centaur_Story_Guff_Mission3Death_01);
			break;
		case 506:
			GameState.Get().SetBusy(busy: true);
			yield return MissionPlayVO(enemyActor, VO_Story_Hero_Barak_Male_Centaur_Story_Guff_Mission3Loss_01);
			GameState.Get().SetBusy(busy: false);
			break;
		case 504:
			GameState.Get().SetBusy(busy: true);
			yield return MissionPlayVO(enemyActor, VO_Story_Hero_Barak_Male_Centaur_Story_Guff_Mission3Victory_01);
			GameState.Get().SetBusy(busy: false);
			break;
		case 505:
			GameState.Get().SetBusy(busy: true);
	...
	protected override IEnumerator HandleStartOfTurnWithTiming(int turn)
	{
		...
		{
		case 5:
			yield return MissionPlayVO(enemyActor, VO_Story_Hero_Barak_Male_Centaur_Story_Guff_Mission3ExchangeA_01);
			yield return MissionPlayVO(friendlyActor, VO_Story_Hero_Guff_Male_Tauren_Story_Guff_Mission3ExchangeA_02);
			break;
		case 7:
			yield return MissionPlayVO(enemyActor, VO_Story_Hero_Barak_Male_Centaur_Story_Guff_Mission3ExchangeC_01);
			yield return MissionPlayVO(friendlyActor, VO_Story_Hero_Guff_Male_Tauren_Story_Guff_Mission3ExchangeC_02);
			break;
		case 9:
			yield return MissionPlayVO(enemyActor, VO_Story_Hero_Barak_Male_Centaur_Story_Guff_Mission3ExchangeD_01);
			yield return MissionPlayVO(friendlyActor, VO_Story_Hero_Guff_Male_Tauren_Story_Guff_Mission3ExchangeD_02);
			break;
		case 11:
			yield return MissionPlayVO(enemyActor, VO_Story_Hero_Barak_Male_Centaur_Story_Guff_Mission3ExchangeE_01);
			if (HeroPowerBrukan)
			{
