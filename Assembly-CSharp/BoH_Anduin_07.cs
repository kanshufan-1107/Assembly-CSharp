...
public class BoH_Anduin_07 : BoH_Anduin_Dungeon
{
	...
	public override IEnumerator DoActionsBeforeDealingBaseMulliganCards()
	{
		...
		yield return MissionPlayVO(enemyActor, VO_Story_Hero_Garrosh_Male_Orc_Story_Garrosh_Mission7Intro_01);
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		case 507:
			GameState.Get().SetBusy(busy: true);
			yield return MissionPlayVO(enemyActor, VO_Story_Hero_Garrosh_Male_Orc_Story_Anduin_Mission7Loss_01);
			GameState.Get().SetBusy(busy: false);
			break;
		case 103:
			GameState.Get().SetBusy(busy: true);
		...
		case 101:
			GameState.Get().SetBusy(busy: true);
			yield return MissionPlayVO(enemyActor, VO_Story_Hero_Garrosh_Male_Orc_Story_Garrosh_Mission7Victory_01);
			GameState.Get().SetBusy(busy: false);
			break;
		case 112:
			yield return MissionPlayVOOnce(enemyActor, m_missionEventTrigger502Lines);
			break;
		case 515:
