...
public class ULDA_Dungeon_Boss_34h : ULDA_Dungeon
{
	...
	protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
	{
		...
		if (emoteType == EmoteType.START)
		{
			...
			{
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_ULDA_BOSS_34h_Male_Goblin_IntroBrann_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
			}
			else
			{
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		if (missionEvent == 101)
		{
			yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_34h_Male_Goblin_PlayerBomb_01);
		}
		else
		{
	...
	protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
		{
			...
			case "ULDA_017":
			case "ULDA_018":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_34h_Male_Goblin_PlayerJrExplorer_01);
				break;
			case "ULD_172":
			case "ULD_707":
			case "ULD_715":
			case "ULD_717":
			case "ULD_718":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_34h_Male_Goblin_PlayerPlagueSpell_01);
				break;
			}
		}
	}
	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
		{
			...
			{
			case "DAL_060":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_34h_Male_Goblin_BossClockworkGoblin_01);
				break;
			case "BOT_031":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_34h_Male_Goblin_BossGoblinBomb_01);
				break;
			case "DAL_615":
			case "DAL_614":
			case "DAL_739":
			case "ULD_616":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_34h_Male_Goblin_BossLackey_01);
				break;
			}
		}
	}
