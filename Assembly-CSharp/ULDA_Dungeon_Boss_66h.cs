...
public class ULDA_Dungeon_Boss_66h : ULDA_Dungeon
{
	...
	protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
	{
		...
		if (emoteType == EmoteType.START)
		{
			...
			{
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_ULDA_BOSS_66h_Male_Djinn_IntroRenoResponse_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
			}
			else
			{
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		{
		case 105:
			yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_66h_Male_Djinn_BossTriggerBenevolentDjinnLowHealth_01);
			break;
		case 101:
			yield return PlayBossLine(enemyActor, VO_ULDA_BOSS_66h_Male_Djinn_Idle1_01);
			break;
		case 102:
			yield return PlayBossLine(enemyActor, VO_ULDA_BOSS_66h_Male_Djinn_Idle2_02);
			break;
		case 103:
			yield return PlayBossLine(enemyActor, VO_ULDA_BOSS_66h_Male_Djinn_Idle3_03);
			break;
		case 104:
			yield return PlayBossLine(enemyActor, VO_ULDA_BOSS_66h_Male_Djinn_Idle4_04);
			break;
		default:
	...
	protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
		{
			...
			{
			case "ULD_178":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_66h_Male_Djinn_PlayerSiamat_01);
				break;
			case "LOOTA_814":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_66h_Male_Djinn_PlayerWishTreasure_01);
				break;
			case "ULD_003":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_66h_Male_Djinn_PlayerZephrys_01);
				break;
			}
		}
	}
	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
		{
			...
			case "EX1_259":
			case "OG_206":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_66h_Male_Djinn_BossTriggerLightningSpell_01);
				break;
			case "CS2_022":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_66h_Male_Djinn_BossTriggerPolymorph_01);
				break;
			}
		}
	}
