...
public class GIL_Dungeon_Boss_59h : GIL_Dungeon
{
	...
	protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
	{
		...
		{
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_GILA_BOSS_59h_Male_Undead_IntroCrowley_01.prefab:6c5d0cde28d5ee0488f66a0f53999059", Notification.SpeechBubbleDirection.TopRight, enemyActor));
		}
		else if (MissionEntity.STANDARD_EMOTE_RESPONSE_TRIGGERS.Contains(emoteType))
		{
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_GILA_BOSS_59h_Male_Undead_EmoteResponse_01.prefab:a7342a855d2c72749811c6d817d97280", Notification.SpeechBubbleDirection.TopRight, enemyActor));
		}
	}
	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		if (!(cardID == "BRM_013"))
		{
			if (cardID == "EX1_617")
			{
				string randomLine = PopRandomLineWithChance(m_RandomBossPlaysDeadlyShot);
				if (randomLine != null)
				{
		...
		{
			string randomLine = PopRandomLineWithChance(m_RandomBossPlaysQuickShot);
			if (randomLine != null)
			{
				yield return PlayLineOnlyOnce(enemyActor, randomLine);
			}
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		{
			string randomLine = PopRandomLineWithChance(m_RandomHeroPowerKillLines);
			if (randomLine != null)
			{
				yield return PlayLineOnlyOnce(enemyActor, randomLine);
			}
	...
	protected override IEnumerator HandleStartOfTurnWithTiming(int turn)
	{
		...
		if (turn == 2)
		{
			...
			yield return PlayLineOnlyOnce(enemyActor, "VO_GILA_BOSS_59h_Male_Undead_EventTurn02_01.prefab:a1b990749b36db246ace5dabd2369928");
