...
public enum Option
{
	...
	MUSIC_VOLUME,
	[Description("ambiencevolume")]
	AMBIENCE_VOLUME,
	[Description("dialogvolume")]
	DIALOG_VOLUME,
	[Description("soundeffectvolume")]
	SOUND_EFFECT_VOLUME,
	[Description("soundmonoenabled")]
	SOUND_MONO_ENABLED,
	...
	[Description("hasShownMinSpecNextVersionWarning")]
	...
	PROG_TILE_DEBUG,
	[Description("progHiddenAchievements")]
	...
	ANR_WAIT_SECONDS,
	[Description("AppRatingPromptLastMajorVersionSeen")]
	APP_RATING_PROMPT_LAST_MAJOR_VERSION_SEEN,
	[Description("AppRatingPromptHasRatedApp")]
	APP_RATING_AGREED,
	[Description("newestRewardedDeckId")]
	NEWEST_REWARDED_DECK_ID,
	[Description("showCreateSkipAcct")]
	SHOW_CREATE_SKIP_ACCT,
	[Description("debugShowProductIds")]
	DEBUG_SHOW_PRODUCT_IDS,
	[Description("ApkInstallStart")]
	APKINSTALL_START,
	[Description("ApkInstallFailureReported")]
	APKINSTALL_FAILURE_REPORTED,
	[Description("InternetUnreachable")]
	INTERNET_UNREACHABLE,
	[Description("showBgSkinIds")]
	DEBUG_SHOW_BATTLEGROUND_SKIN_IDS,
	[Description("PrivacyLocalSaveTimestamp")]
	AADC_LOCAL_SAVE_TIME_STAMP,
	[Description("PrivacyServerSaveTimestamp")]
	AADC_SERVER_SAVE_TIME_STAMP,
	[Description("PrivacyDisableChat")]
	AADC_DISABLE_CHAT,
	[Description("PrivacyDisablePersonalizedProducts")]
	AADC_DISABLE_PERSONALIZED_PRODUCTS,
	[Description("PrivacyDisablePushNotifications")]
	AADC_PUSH_NOTIFICATIONS,
	[Description("PrivacyDisableNearbyFriends")]
	AADC_DISABLE_NEARBY_FRIENDS,
	[Description("PrivacyDisableABTesting")]
	AADC_DISABLE_AB_TESTING,
	[Description("debugStartGadget")]
	DEBUG_START_GADGET_ON_STARTUP,
	[Description("debugGadgetStartPage")]
	DEBUG_GADGET_START_PAGE,
	[Description("debugGadgetStartLogs")]
	DEBUG_GADGET_START_LOGS,
	[Description("hasSeenHealUpDialogTutorialTraditional")]
	HAS_SEEN_HEAL_UP_POPUP_AFTER_TUTORIAL_TRADITIONAL,
	[Description("hasSeenHealUpDialogTutorialBattlegrounds")]
	HAS_SEEN_HEAL_UP_POPUP_AFTER_TUTORIAL_BATTLEGROUNDS,
	[Description("hasSeenHealUpDialogTutorialMercenaryVillage")]
	HAS_SEEN_HEAL_UP_POPUP_AFTER_TUTORIAL_MERCENARIES,
	[Description("InstalledLocales")]
	INSTALLED_LOCALES,
	[Description("CurrentLocaleTimestamp")]
	CURRENT_LOCALE_TIME_STAMP,
	[Description("afFirstBoxAfterTutorial")]
	AF_FIRST_BOX_AFTER_TUTORIAL,
	[Description("afFirstShopVisit")]
	AF_FIRST_SHOP_VISIT,
	[Description("afFirstPackOpened")]
	AF_FIRST_PACK_OPENED,
	[Description("afFirstNonTutorialGameStartTraditional")]
	AF_FIRST_NON_TUTORIAL_GAME_START_TRADITIONAL,
	[Description("afFirstNonTutorialGameStartBattlegrounds")]
	AF_FIRST_NON_TUTORIAL_GAME_START_BATTLEGROUNDS,
	[Description("afFirstNonTutorialGameStartMercenaries")]
	AF_FIRST_NON_TUTORIAL_GAME_START_MERCENARIES,
	[Description("afRewardTrackEvent")]
	AF_REWARD_TRACK_EVENT,
	[Description("MaxAgeInactiveLocales")]
	MAX_AGE_INACTIVE_LOCALES,
	[Description("MythicLevelChoice")]
	MYTHIC_LEVEL_CHOICE,
	[Description("InactivityAgentTimeout")]
	INACTIVITY_AGENT_TIMEOUT,
	[Description("NotificationSettingsTimeout")]
	NOTIFICATION_SETTINGS_TIME_STAMP,
	[Description("MaxAgeNotificationOptIn")]
	MAX_AGE_NOTIFICATION_OPTIN,
	[Description("BGRemainingBytes")]
	BG_REMAINING_BYTES,
	[Description("BGRemainingBytesStartTime")]
	BG_REMAINING_BYTES_STARTTIME,
	[Description("BGRemainingBytesStartTimeNew")]
	BG_REMAINING_BYTES_STARTTIME_NEW,
	[Description("CPUBenchmarkResult")]
	CPU_BENCHMARK_RESULT,
	[Description("GPUBenchmarkResult")]
	GPU_BENCHMARK_RESULT,
	[Description("ProfileAssets")]
	PROFILE_ASSETS,
	[Description("ExtractedBundles")]
	EXTRACT_ESSENTIAL_BUNDLES,
	[Description("FirstClientBuildNum")]
	FIRST_CLIENT_BUILD_NUMBER,
	[Description("TavernGuideLastVisitedQuestSetCategory")]
	TAVERN_GUIDE_LAST_VISITED_QUEST_SET_CATEGORY,
	[Description("SkippedInitialTutorial")]
	SKIPPED_INITIAL_TUTORIAL,
	[Description("hasSeenBGDownloadFinishedPopup")]
	HAS_SEEN_BG_DOWNLOAD_FINISHED_POPUP,
	[Description("firstDownloadPrompt")]
	FIRST_DOWNLOAD_USER_CHOICE,
	[Description("firstDownloadThreshold")]
	FIRST_DOWNLOAD_THRESHOLD,
	[Description("firstDownloadEnabled")]
	FIRST_DOWNLOAD_ENABLED,
	[Description("BattlegroundDataExists")]
	BATTLEGROUND_DATA_EXISTS,
	[Description("MercenaryDataExists")]
	MERCENARY_DATA_EXISTS,
	[Description("AdventureDataExists")]
	ADVENTURE_DATA_EXISTS,
	[Description("CallSDKInterval")]
	CALLSDK_INTERVAL,
	...
	DEPRECATED_HAS_CLICKED_TOURNAMENT,
	...
	[Description("hasSeenLoadEquipmentInSlotTutorial")]
	HAS_SEEN_LOAD_EQUIPMENT_IN_SLOT_TUTORIAL,
	[Description("hasUnlockedFirstEquipment")]
	HAS_UNLOCKED_FIRST_EQUIPMENT,
	...
	[Description("earlyConcedeDisabled")]
	...
	[Description("hasSeenTwistModeVO")]
	HAS_SEEN_TWIST_MODE_VO,
	[Description("battlegroundsPlayingDuosMode")]
	BATTLEGROUNDS_PLAYING_DUOS_MODE,
	[Description("hasSeenDuosTutorialViewTeammate")]
	BG_DUOS_TUTORIAL_PLAYED_VIEW_TEAMMATE,
	[Description("hasSeenDuosTutorialViewSelf")]
	BG_DUOS_TUTORIAL_PLAYED_VIEW_SELF,
	[Description("hasSeenDuosTutorialHealth")]
	BG_DUOS_TUTORIAL_PLAYED_HEALTH,
	[Description("hasSeenDuosTutorialCombat")]
	BG_DUOS_TUTORIAL_PLAYED_COMBAT,
	[Description("hasSeenDuosTutorialHeroSwap")]
	BG_DUOS_TUTORIAL_PLAYED_HERO_SWAP,
	[Description("hasSeenDuosTutorialPass")]
	BG_DUOS_TUTORIAL_PLAYED_PASS,
	[Description("hasSeenDuosTutorialReceive")]
	BG_DUOS_TUTORIAL_PLAYED_RECEIVE,
	[Description("hasSeenDuosTutorialCombatOrder")]
	BG_DUOS_TUTORIAL_PLAYED_COMBAT_ORDER,
	[Description("hasSeenDuosTutorialPing")]
	BG_DUOS_TUTORIAL_PLAYED_PING,
	[Description("hasSeenDuosTutorialPingWheel")]
	BG_DUOS_TUTORIAL_PLAYED_PING_WHEEL,
	[Description("hasSeenDuosTutorialTeammatePinged")]
	BG_DUOS_TUTORIAL_PLAYED_TEAMMATE_PINGED,
	[Description("hasSeenDuosTutorialBonusDamage")]
	BG_DUOS_TUTORIAL_PLAYED_BONUS_DAMAGE,
	[Description("hasSeenDuosLobbyTutorialToggle")]
	BG_DUOS_LOBBY_TUTORIAL_PLAYED_TOGGLE,
