...
public class BoH_Garrosh_03 : BoH_Garrosh_Dungeon
{
	...
	public override IEnumerator DoActionsBeforeDealingBaseMulliganCards()
	{
		...
		yield return PlayLineAlways(enemyActor, VO_Story_Hero_Zarzhet_Female_Nerubian_Story_Garrosh_Mission3Intro_01);
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		case 504:
			GameState.Get().SetBusy(busy: true);
			yield return PlayLineAlways(enemyActor, VO_Story_Hero_Zarzhet_Female_Nerubian_Story_Garrosh_Mission3Loss_01);
			GameState.Get().SetBusy(busy: false);
			break;
		default:
