...
public class BoH_Malfurion_07 : BoH_Malfurion_Dungeon
{
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		case 507:
			GameState.Get().SetBusy(busy: true);
			yield return PlayLineAlways(enemyActor, VO_Story_Hero_Ragnaros_Male_Elemental_Story_Malfurion_Mission7Loss_01);
			GameState.Get().SetBusy(busy: false);
			break;
		case 504:
			GameState.Get().SetBusy(busy: true);
			yield return PlayLineAlways(enemyActor, VO_Story_Hero_Ragnaros_Male_Elemental_Story_Malfurion_Mission7_Victory_01);
			GameState.Get().SetBusy(busy: false);
			break;
		case 101:
	...
	protected override IEnumerator HandleStartOfTurnWithTiming(int turn)
	{
		...
		case 3:
			...
			break;
		case 7:
			yield return PlayLineAlways(friendlyActor, VO_Story_Hero_Malfurion_Male_NightElf_Story_Malfurion_Mission7ExchangeB_01);
			break;
		case 11:
