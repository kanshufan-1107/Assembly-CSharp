...
public class ULDA_Dungeon_Boss_38h : ULDA_Dungeon
{
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		case 105:
			...
			break;
		case 106:
			yield return PlayBossLine(enemyActor, VO_ULDA_BOSS_38h_Male_PlagueLord_IdleSpecial_01);
			break;
		case 101:
			yield return PlayBossLine(enemyActor, VO_ULDA_BOSS_38h_Male_PlagueLord_PhaseChange1_01);
			break;
		case 102:
			yield return PlayBossLine(enemyActor, VO_ULDA_BOSS_38h_Male_PlagueLord_PhaseChange2_01);
			break;
		default:
	...
	protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
		{
			...
			{
			case "ULD_706":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_38h_Male_PlagueLord_PlayerTriggerBlatantDecoy_01);
				break;
			case "TRL_258":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_38h_Male_PlagueLord_PlayerTriggerMassHysteria_01);
				break;
			case "CS2_003":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_38h_Male_PlagueLord_PlayerTriggerMindVision_01);
				break;
			case "ULD_705":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_38h_Male_PlagueLord_PlayerTriggerMoguCultist_01);
				break;
			case "ULD_715":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_38h_Male_PlagueLord_PlayerTriggerPlagueofMadness_01);
				break;
			}
		}
	}
	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
		{
			...
			{
			case "ULD_328":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_38h_Male_PlagueLord_BossTriggerCleverDisguise_01);
				break;
			case "ICC_207":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_38h_Male_PlagueLord_BossTriggerDevourMind_01);
				break;
			case "CS1_113":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_38h_Male_PlagueLord_BossTriggerMindControl_01);
				break;
			case "ULD_715":
				yield return PlayAndRemoveRandomLineOnlyOnce(enemyActor, m_BossPlagueOfMadness);
				break;
			case "EX1_334":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_38h_Male_PlagueLord_BossTriggerShadowMadness_01);
				break;
			case "OG_116":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_38h_Male_PlagueLord_BossTriggerSpreadingMadness_01);
				break;
			case "TRL_500":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_38h_Male_PlagueLord_BossTriggerSurrendertoMadness_01);
				break;
			case "ULD_280":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_38h_Male_PlagueLord_BossTriggerWastewanderSapper_01);
				break;
			}
		}
	}
