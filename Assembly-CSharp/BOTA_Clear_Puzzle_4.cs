...
public class BOTA_Clear_Puzzle_4 : BOTA_MissionEntity
{
	...
	protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
	{
		...
		if (!(cardID == "ICC_041"))
		{
			if (cardID == "ICC_099")
			{
				yield return PlayEasterEggLine(enemyActor, VO_BOTA_BOSS_09h_Female_Banshee_PlayTicking_01);
			}
		}
		else
		{
			yield return PlayEasterEggLine(enemyActor, VO_BOTA_BOSS_09h_Female_Banshee_PlayDefile_01);
		}
	}
}
