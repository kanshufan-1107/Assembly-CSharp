...
public class DRGA_Evil_Fight_05 : DRGA_Dungeon
{
	...
	protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
	{
		...
		if (emoteType == EmoteType.START)
		{
			if (randomNumber < 3)
			{
				if (!m_Heroic)
				{
					Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_DRGA_BOSS_27ha_Male_Dwarf_Evil_Fight_05_BossStart_01_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
				}
				else if (m_Heroic)
				{
					Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_DRGA_BOSS_27ha_Male_Dwarf_Evil_Fight_05_BossStartHeroic_01_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
				}
			}
			else if (!m_Heroic)
			{
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_DRGA_BOSS_27hb_Female_NightElf_Evil_Fight_05_BossStart_02_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
			}
			else if (m_Heroic)
			{
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_DRGA_BOSS_27hb_Female_NightElf_Evil_Fight_05_BossStartHeroic_02_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
			}
		}
		else if (MissionEntity.STANDARD_EMOTE_RESPONSE_TRIGGERS.Contains(emoteType))
		{
			...
			{
			case 1:
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_DRGA_BOSS_27ha_Male_Dwarf_Evil_Fight_05_EmoteResponse_01_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
				break;
			case 2:
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_DRGA_BOSS_27hb_Female_NightElf_Evil_Fight_05_EmoteResponse_02_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
				break;
			case 3:
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_DRGA_BOSS_27hc_Female_Human_Evil_Fight_05_EmoteResponse_03_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
				break;
			case 4:
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_DRGA_BOSS_27hd_Male_Gnome_Evil_Fight_05_EmoteResponse_04_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
				break;
			}
		}
	}
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		{
		case 100:
			yield return PlayLineAlways(enemyActor, VO_DRGA_BOSS_27ha_Male_Dwarf_Evil_Fight_05_Misc_01_01);
			break;
		case 101:
			yield return PlayLineAlways(enemyActor, VO_DRGA_BOSS_27hb_Female_NightElf_Evil_Fight_05_Misc_02_01);
			break;
		case 102:
			yield return PlayLineAlways(enemyActor, VO_DRGA_BOSS_27hc_Female_Human_Evil_Fight_05_Misc_03_01);
			break;
		case 103:
			yield return PlayLineAlways(enemyActor, VO_DRGA_BOSS_27hc_Female_Human_Evil_Fight_05_Misc_05_01);
			break;
		case 104:
			yield return PlayLineAlways(enemyActor, VO_DRGA_BOSS_27hd_Male_Gnome_Evil_Fight_05_Misc_04_01);
			break;
		case 105:
			yield return PlayLineAlways(enemyActor, VO_DRGA_BOSS_27hd_Male_Gnome_Evil_Fight_05_Misc_06_01);
			break;
		case 107:
			if (!m_Heroic)
			{
		...
		case 108:
			if (!m_Heroic)
			{
				yield return PlayLineAlways(friendlyActor, VO_DRGA_BOSS_28h_Male_Tauren_Evil_Fight_05_Misc_01_01);
			}
			break;
		case 109:
			if (!m_Heroic)
			{
				yield return PlayLineAlways(friendlyActor, VO_DRGA_BOSS_28h_Male_Tauren_Evil_Fight_05_Misc_02_01);
			}
			break;
		case 110:
			if (!m_Heroic)
			{
				yield return PlayLineAlways(friendlyActor, VO_DRGA_BOSS_28h_Male_Tauren_Evil_Fight_05_Misc_03_01);
			}
			break;
		case 111:
			if (!m_Heroic)
			{
				yield return PlayLineAlways(friendlyActor, VO_DRGA_BOSS_28h_Male_Tauren_Evil_Fight_05_Misc_04_01);
			}
			break;
		case 112:
			if (!m_Heroic)
			{
				yield return PlayLineAlways(friendlyActor, VO_DRGA_BOSS_28h_Male_Tauren_Evil_Fight_05_Misc_05_01);
			}
			break;
		case 113:
			if (!m_Heroic)
			{
				yield return PlayLineAlways(friendlyActor, VO_DRGA_BOSS_28h_Male_Tauren_Evil_Fight_05_Misc_06_01);
			}
			break;
		case 114:
			yield return PlayAndRemoveRandomLineOnlyOnce(enemyActor, m_VO_DRGA_BOSS_Combined_Attack);
			break;
		default:
