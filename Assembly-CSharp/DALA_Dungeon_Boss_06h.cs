...
public class DALA_Dungeon_Boss_06h : DALA_Dungeon
{
	...
	protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
	{
		...
		string playerHeroCardID = GameState.Get().GetFriendlySidePlayer().GetHero()
			.GetCardId();
		if (enemyHeroCardID == DAZZIK_CARDID && emoteType == EmoteType.START && playerHeroCardID != "DALA_Chu" && playerHeroCardID != "DALA_George")
		{
		...
		if (enemyHeroCardID == DAZZIK_DK_CARDID)
		{
			...
			case EmoteType.THREATEN:
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_DALA_BOSS_06dk_Male_Goblin_EmoteResponseThreaten_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
				break;
			case EmoteType.GREETINGS:
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_DALA_BOSS_06dk_Male_Goblin_EmoteResponseGreetings_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
				break;
			case EmoteType.OOPS:
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_DALA_BOSS_06dk_Male_Goblin_EmoteResponseOops_02, Notification.SpeechBubbleDirection.TopRight, enemyActor));
				break;
			case EmoteType.THANKS:
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_DALA_BOSS_06dk_Male_Goblin_EmoteResponseThanks_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
				break;
			case EmoteType.WELL_PLAYED:
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_DALA_BOSS_06dk_Male_Goblin_EmoteResponseWellPlayed_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
				break;
			case EmoteType.WOW:
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_DALA_BOSS_06dk_Male_Goblin_EmoteResponseWow_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
				break;
			default:
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_DALA_BOSS_06dk_Male_Goblin_EmoteResponseGreetings_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
				break;
		...
		if (enemyHeroCardID == DAZZIK_CARDID)
		{
			...
			{
			case EmoteType.THREATEN:
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_DALA_BOSS_06h_Male_Goblin_EmoteResponseThreaten_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
				break;
			case EmoteType.GREETINGS:
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_DALA_BOSS_06h_Male_Goblin_EmoteResponseGreetings_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
				break;
			case EmoteType.OOPS:
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_DALA_BOSS_06h_Male_Goblin_EmoteResponseOops_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
				break;
			case EmoteType.THANKS:
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_DALA_BOSS_06h_Male_Goblin_EmoteResponseThanks_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
				break;
			case EmoteType.WELL_PLAYED:
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_DALA_BOSS_06h_Male_Goblin_EmoteResponseWellPlayed_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
				break;
			case EmoteType.WOW:
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_DALA_BOSS_06h_Male_Goblin_EmoteResponseWow_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
				break;
			default:
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_DALA_BOSS_06h_Male_Goblin_EmoteResponse_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
				break;
			}
		}
	}
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		{
		case 101:
			yield return PlayLineOnlyOnce(enemyActor, VO_DALA_BOSS_06h_Male_Goblin_BossWarriorSpell_01);
			break;
		case 102:
			yield return PlayLineOnlyOnce(enemyActor, VO_DALA_BOSS_06h_Male_Goblin_PlayerArmor_01);
			break;
		case 103:
			yield return PlayLineOnlyOnce(enemyActor, VO_DALA_BOSS_06dk_Male_Goblin_Attack_03);
			break;
		case 104:
			yield return PlayLineOnlyOnce(enemyActor, VO_DALA_BOSS_06h_Male_Goblin_Attack_01);
			break;
		default:
	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		if (!(cardID == "CS2_103"))
		{
			if (cardID == "EX1_411")
			{
				yield return PlayLineOnlyOnce(enemyActor, VO_DALA_BOSS_06dk_Male_Goblin_BossGorehowl_01);
			}
		}
		else
		{
			yield return PlayLineOnlyOnce(enemyActor, VO_DALA_BOSS_06dk_Male_Goblin_BossCharge_01);
		}
	}
	...
	public override void OnPlayThinkEmote()
	{
		...
		float randomThink = Random.Range(1f, 101f);
		if (thinkEmoteBossThinkChancePercentage > randomThink)
		{
			...
			if (enemyHeroCardID == DAZZIK_CARDID)
			{
				string voLine = PopRandomLine(m_IdleLinesCopy);
			...
			else if (enemyHeroCardID == DAZZIK_DK_CARDID)
			{
				string voDKLine = PopRandomLine(m_DKIdleLinesCopy);
				if (m_DKIdleLinesCopy.Count == 0)
				{
					m_DKIdleLinesCopy = new List<string>(m_DKIdleLines);
				}
				Gameplay.Get().StartCoroutine(PlayBossLine(enemyActor, voDKLine));
			}
		}
		else
		{
