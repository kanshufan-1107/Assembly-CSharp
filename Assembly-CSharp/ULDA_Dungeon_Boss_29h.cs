...
public class ULDA_Dungeon_Boss_29h : ULDA_Dungeon
{
	...
	protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
	{
		...
		if (emoteType == EmoteType.START)
		{
			...
			{
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_ULDA_BOSS_29h_Female_Elemental_IntroFinley_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
			}
			else
			{
	...
	protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
	{
		...
		if (!(cardID == "ULD_158"))
		{
			if (cardID == "ULD_137")
			{
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_29h_Female_Elemental_PlayerTrigger_Garden_Gnome_01);
			}
		}
		else
		{
			yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_29h_Female_Elemental_PlayerTrigger_Sandstorm_Elemental_01);
		}
	}
	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
		{
			...
			{
			case "EX1_250":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_29h_Female_Elemental_BossTriggerEarthElemental_01);
				break;
			case "ULD_197":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_29h_Female_Elemental_BossTriggerQuicksandElemental_01);
				break;
			case "ULD_158":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_29h_Female_Elemental_BossTriggerSandstormElemental_01);
				break;
			}
		}
	}
