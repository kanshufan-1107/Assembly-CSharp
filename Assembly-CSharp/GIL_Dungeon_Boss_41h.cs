...
public class GIL_Dungeon_Boss_41h : GIL_Dungeon
{
	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		{
			string randomLine = PopRandomLineWithChance(m_HackLines);
			if (randomLine != null)
			{
	...
	protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
	{
		...
		{
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_GILA_BOSS_41h_Male_NightElf_Intro_01.prefab:2ee1227d69533f24197e3d948f21f858", Notification.SpeechBubbleDirection.TopRight, enemyActor));
		}
		else if (MissionEntity.STANDARD_EMOTE_RESPONSE_TRIGGERS.Contains(emoteType))
		{
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_GILA_BOSS_41h_Male_NightElf_EmoteResponse_02.prefab:b6265a8078217254181079a5796fcc1f", Notification.SpeechBubbleDirection.TopRight, enemyActor));
		}
	}
}
