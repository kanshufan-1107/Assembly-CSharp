...
public class GIL_Dungeon_Boss_64h : GIL_Dungeon
{
	...
	protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
	{
		...
		{
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_GILA_BOSS_64h_Male_Goblin_Intro_01.prefab:65aab9bfdc181c34794b8d264d546266", Notification.SpeechBubbleDirection.TopRight, enemyActor));
		}
		else if (MissionEntity.STANDARD_EMOTE_RESPONSE_TRIGGERS.Contains(emoteType))
		{
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_GILA_BOSS_64h_Male_Goblin_EmoteResponse_01.prefab:a0a1b9e4c2e6f9f4bafe6ccf9a265e98", Notification.SpeechBubbleDirection.TopRight, enemyActor));
		}
	}
	...
	protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()))
		{
			...
			{
			case "EX1_085":
				yield return PlayBossLine(enemyActor, "VO_GILA_BOSS_64h_Male_Goblin_EventMCTech_01.prefab:7918a8f38c26d5e4d878d1df3646a1aa");
				break;
			case "CS1_113":
				yield return PlayBossLine(enemyActor, "VO_GILA_BOSS_64h_Male_Goblin_EventMindControl_01.prefab:a624eb8406e178d4da862a4de7765ab2");
				break;
			case "GILA_819":
				yield return PlayBossLine(enemyActor, "VO_GILA_BOSS_64h_Male_Goblin_EvenPlayCursedCurio_01.prefab:335bddebe01902d479380f324eee0071");
				break;
			}
		}
	}
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		{
		case 101:
			yield return PlayLineOnlyOnce(enemyActor, "VO_GILA_BOSS_64h_Male_Goblin_HeroPowerHandEmpty_01.prefab:6a88ebdeb564cf34c8a5ecc5f16f11de");
			break;
		case 102:
		{
			string randomLine = PopRandomLineWithChance(m_SmallRandomLines);
			if (randomLine != null)
			{
		...
		case 103:
		{
			string randomLine = PopRandomLineWithChance(m_MediumRandomLines);
			if (randomLine != null)
			{
				yield return PlayLineOnlyOnce(enemyActor, randomLine);
			}
		...
		case 104:
		{
			string randomLine = PopRandomLineWithChance(m_BigRandomLines);
			if (randomLine != null)
			{
				yield return PlayLineOnlyOnce(enemyActor, randomLine);
			}
