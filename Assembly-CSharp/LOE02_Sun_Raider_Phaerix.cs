...
public class LOE02_Sun_Raider_Phaerix : LOE_MissionEntity
{
	...
	protected override IEnumerator HandleStartOfTurnWithTiming(int turn)
	{
		...
		if (turn == 1)
		{
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_LOE_01_START.prefab:e4840e7e825b2aa438f783b50bb19584", Notification.SpeechBubbleDirection.TopRight, enemyActor));
