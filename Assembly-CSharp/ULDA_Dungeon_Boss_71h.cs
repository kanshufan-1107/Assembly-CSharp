...
public class ULDA_Dungeon_Boss_71h : ULDA_Dungeon
{
	...
	protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
	{
		...
		if (emoteType == EmoteType.START)
		{
			...
			{
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_ULDA_BOSS_71h_Male_TitanConstruct_IntroElise_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
			}
			else
			{
	...
	protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
		{
			...
			case "BOT_420":
			case "DAL_256":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_71h_Male_TitanConstruct_PlayerTreant_01);
				break;
			case "GVG_033":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_71h_Male_TitanConstruct_PlayerTreeofLife_01);
				break;
			case "EX1_622":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_71h_Male_TitanConstruct_PlayerTriggerShadowWordDeath_01);
				break;
			}
		}
	}
	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
		{
			...
			{
			case "ULD_135":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_71h_Male_TitanConstruct_BossHiddenOasis_01);
				break;
			case "EX1_161":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_71h_Male_TitanConstruct_BossNaturalize_01);
				break;
			case "EX1_164a":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_71h_Male_TitanConstruct_BossRampantGrowth_01);
				break;
			}
		}
	}
