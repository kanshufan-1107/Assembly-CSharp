...
public class PuzzleController : MonoBehaviour
{
	...
	private void Start()
	{
		...
		Transform puzzleUIBone = Board.Get().FindBone(m_PuzzleUIBoneName);
		m_puzzleProgressUI.transform.parent = puzzleUIBone;
	...
	{
		m_ProgressText.Text = GameStrings.Format("GAMEPLAY_PROGRESS_X_OF_Y", GetEntity().GetTag(GAME_TAG.PUZZLE_PROGRESS), GetEntity().GetTag(GAME_TAG.PUZZLE_PROGRESS_TOTAL));
		m_puzzleProgressUI.UpdateText(GetEntity());
	}
