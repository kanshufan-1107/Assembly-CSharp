...
public abstract class Tutorial_MissionEntity : GenericDungeonMissionEntity
{
	...
	public virtual IEnumerator PlayCustomEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
	{
		if (MissionEntity.STANDARD_EMOTE_RESPONSE_TRIGGERS.Contains(emoteType))
		{
			...
			{
			case EmoteType.WOW:
				yield return HandleMissionEventWithTiming(522);
				break;
			case EmoteType.THANKS:
				yield return HandleMissionEventWithTiming(525);
				break;
			case EmoteType.OOPS:
				yield return HandleMissionEventWithTiming(524);
				break;
			case EmoteType.THREATEN:
				yield return HandleMissionEventWithTiming(523);
				break;
			case EmoteType.WELL_PLAYED:
				yield return HandleMissionEventWithTiming(526);
				break;
			case EmoteType.GREETINGS:
				yield return HandleMissionEventWithTiming(527);
				break;
			}
		}
		yield return HandleMissionEventWithTiming(515);
	}
	...
	protected IEnumerator MissionPlayThinkEmote(Actor thinkingActor)
	{
		...
		{
			CardSoundSpell soundSpell2 = GameState.Get().GetOpposingSidePlayer().GetHeroCard()
				.PlayEmote(thinkEmote);
