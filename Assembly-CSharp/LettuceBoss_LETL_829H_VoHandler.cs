...
public class LettuceBoss_LETL_829H_VoHandler : VoPlaybackHandler
{
	...
	private List<string> m_IdleLines = new List<string> { VO_LETL_829H_Male_Demon_Idle_01 };

	public override void PreloadAssets()
	{
		base.PreloadAssets();
		List<string> soundFiles = new List<string> { VO_LETL_829H_Male_Demon_Attack_01, VO_LETL_829H_Male_Demon_Attack_02, VO_LETL_829H_Male_Demon_Death_01, VO_LETL_829H_Male_Demon_Idle_01, VO_LETL_829H_Male_Demon_Intro_01 };
	...
	{
		base.OnCreateGame();
		m_introLine = VO_LETL_829H_Male_Demon_Intro_01;
		m_deathLine = VO_LETL_829H_Male_Demon_Death_01;
	}
	...
	public override IEnumerator RespondToWillPlayCardWithTiming(string cardID, Entity playedEntity)
	{
		...
		Actor bossActor = FindEnemyActorInPlayByDesignCode("LETL_829H");
		if (playedEntity.GetLettuceAbilityOwner().GetCardId() == "LETL_829H")
		{
			...
			case "LETL_829P1_05":
				...
				yield return MissionPlayVOOnce(bossActor, VO_LETL_829H_Male_Demon_Attack_01);
				GameState.Get().SetBusy(busy: false);
				break;
			case "LETL_018P7_03":
				GameState.Get().SetBusy(busy: true);
				yield return MissionPlayVOOnce(bossActor, VO_LETL_829H_Male_Demon_Attack_02);
				GameState.Get().SetBusy(busy: false);
				break;
			}
		}
