...
public class NAX03_Maexxna : NAX_MissionEntity
{
	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		{
		case "NAX3_02":
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_NAX3_01_HP_01.prefab:428343bce2fa95c42837e3f7fd220634", Notification.SpeechBubbleDirection.TopRight, enemyActor));
			...
			break;
		case "NAX3_03":
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_NAX3_01_CARD_01.prefab:8f9084036cb9a31429b886ee01cc9bad", Notification.SpeechBubbleDirection.TopRight, enemyActor));
			break;
		case "EX1_586":
