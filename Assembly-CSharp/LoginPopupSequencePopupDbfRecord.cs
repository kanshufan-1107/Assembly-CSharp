...
public class LoginPopupSequencePopupDbfRecord : DbfRecord
{
	...
	{
		LoginPopupSequencePopupDbfAsset dbfAsset = DbfShared.GetAssetBundle().LoadAsset(resourcePath, typeof(LoginPopupSequencePopupDbfAsset)) as LoginPopupSequencePopupDbfAsset;
		if (dbfAsset == null)
		{
			records = new List<T>();
