...
public class ULDA_Dungeon_Boss_69h : ULDA_Dungeon
{
	...
	protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
	{
		...
		if (emoteType == EmoteType.START)
		{
			...
			{
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_ULDA_BOSS_69h_Female_TitanConstruct_IntroReno_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
			}
			else
			{
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		{
		case 102:
			yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_69h_Female_TitanConstruct_BossCounterSpellTrigger_01);
			break;
		case 103:
			yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_69h_Female_TitanConstruct_BossTwinSpellCast_01);
			break;
		case 101:
	...
	protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
		{
			...
			{
			case "EX1_563":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_69h_Female_TitanConstruct_PlayerMalygos_01);
				break;
			case "ULDA_403":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_69h_Female_TitanConstruct_PlayerTitanDiscTreasure_01);
				break;
			case "EX1_279":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_69h_Female_TitanConstruct_PlayerTriggerPyroblast_01);
				break;
			}
		}
	}
	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
		{
			...
			if (cardID == "CS2_027")
			{
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_69h_Female_TitanConstruct_BossMirrorImage_01);
			}
		}
	}
}
