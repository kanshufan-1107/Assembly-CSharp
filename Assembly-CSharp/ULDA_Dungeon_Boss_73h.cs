...
public class ULDA_Dungeon_Boss_73h : ULDA_Dungeon
{
	...
	protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
	{
		...
		if (emoteType == EmoteType.START)
		{
			...
			{
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_ULDA_BOSS_73h_Male_NefersetTolvir_IntroSpecialFinley_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
			}
			else
			{
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		if (missionEvent == 101)
		{
			yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_73h_Male_NefersetTolvir_BossTriggerExplosiveRunes_01);
		}
		else
		{
	...
	protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
		{
			...
			{
			case "ULD_189":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_73h_Male_NefersetTolvir_PlayerTrigger_Cursed_Lieutenant_01);
				break;
			case "ULD_304":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_73h_Male_NefersetTolvir_PlayerTrigger_King_Phaoris_01);
				break;
			case "ULD_178":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_73h_Male_NefersetTolvir_PlayerTrigger_Siamat_01);
				break;
			}
		}
	}
	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		if (!(cardID == "CS2_105"))
		{
			if (cardID == "LOOT_101")
			{
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_73h_Male_NefersetTolvir_BossTriggerPlayExplosiveRunes_01);
			}
		}
		else
		{
			yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_73h_Male_NefersetTolvir_BossTriggerHeroicStrike_01);
		}
	}
}
