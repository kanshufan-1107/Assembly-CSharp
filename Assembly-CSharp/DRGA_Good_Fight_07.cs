...
public class DRGA_Good_Fight_07 : DRGA_Dungeon
{
	...
	protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
	{
		...
		{
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_DRGA_BOSS_19h_Male_Dragon_Good_Fight_07_BossStart_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
		}
		else if (MissionEntity.STANDARD_EMOTE_RESPONSE_TRIGGERS.Contains(emoteType))
		{
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_DRGA_BOSS_19h_Male_Dragon_Good_Fight_07_EmoteResponse_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
		}
	}
	...
	protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
	{
		...
		if (!(cardID == "DRGA_BOSS_04t"))
		{
			if (cardID == "YOD_036")
			{
				yield return PlayLineOnlyOnce(enemyActor, VO_DRGA_BOSS_19h_Male_Dragon_Good_Fight_07_Player_Rotwing_01);
			}
		}
		else
		{
			yield return PlayAndRemoveRandomLineOnlyOnce(friendlyActor, m_VO_DRGA_BOSS_04h_Male_Dwarf_Good_Fight_07_Brann_DragonbreathLines);
		}
	}
