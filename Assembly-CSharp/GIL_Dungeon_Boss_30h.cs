...
public class GIL_Dungeon_Boss_30h : GIL_Dungeon
{
	...
	protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
	{
		...
		{
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_GILA_BOSS_30h_Female_Gnome_Intro_01.prefab:8299ef8185f5d9545af06156ce8b6910", Notification.SpeechBubbleDirection.TopRight, enemyActor));
		}
		else if (MissionEntity.STANDARD_EMOTE_RESPONSE_TRIGGERS.Contains(emoteType))
		{
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_GILA_BOSS_30h_Female_Gnome_EmoteResponse_01.prefab:ddb12b11b028f9a478e49fde4d26b989", Notification.SpeechBubbleDirection.TopRight, enemyActor));
		}
	}
	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		if (entity.IsSpell())
		{
			string randomLine = PopRandomLineWithChance(m_RandomHeroLines);
			if (randomLine != null)
			{
