...
public class DALA_Dungeon_Boss_08h : DALA_Dungeon
{
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		if (missionEvent == 101)
		{
			yield return PlayLineOnlyOnce(enemyActor, VO_DALA_BOSS_08h_Female_Treant_PlayerDruidSpell_01);
		}
		else
		{
	...
	protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
	{
		...
		if (emoteType == EmoteType.START)
		{
			...
			{
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_DALA_BOSS_08h_Female_Treant_IntroGeorge_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
			}
			else if (playerHeroCardID != "DALA_Squeamlish" && playerHeroCardID != "DALA_Barkeye" && playerHeroCardID != "DALA_Rakanishu" && playerHeroCardID != "DALA_Vessina")
			{
	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
		{
			...
			case "EX1_158t":
			case "DAL_256t2":
				yield return PlayLineOnlyOnce(enemyActor, VO_DALA_BOSS_08h_Female_Treant_BossTreant_01);
				break;
			case "TRL_341":
				yield return PlayLineOnlyOnce(enemyActor, VO_DALA_BOSS_08h_Female_Treant_BossTreeSpeaker_01);
				break;
			case "GIL_663":
				yield return PlayLineOnlyOnce(enemyActor, VO_DALA_BOSS_08h_Female_Treant_BossWitchwoodApple_01);
				break;
			}
		}
	}
