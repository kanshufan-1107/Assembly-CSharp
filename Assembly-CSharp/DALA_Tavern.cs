...
public class DALA_Tavern : DALA_Dungeon
{
	...
	public override void NotifyOfGameOver(TAG_PLAYSTATE playState)
	{
		...
		Network.Get().DisconnectFromGameServer(Network.DisconnectReason.DALA_Tavern);
	...
	public override void PreloadAssets()
	{
		...
		VOPool firstTavernVO = new VOPool(new List<string> { VO_DALA_900h_Male_Human_Intro_01 }, 1f, ShouldPlayValue.Once, VOSpeaker.OPPONENT_HERO, null, GameSaveKeySubkeyId.DAL_DUNGEON_HAS_SEEN_TAVERN_DRUID_VO);
		m_VOPools.Add(909, firstTavernVO);
		VOPool firstTavernVO2 = new VOPool(new List<string> { VO_DALA_900h_Male_Human_Intro_01 }, 1f, ShouldPlayValue.Once, VOSpeaker.OPPONENT_HERO, null, GameSaveKeySubkeyId.DAL_DUNGEON_HAS_SEEN_TAVERN_HUNTER_VO);
		m_VOPools.Add(910, firstTavernVO2);
		VOPool firstTavernVO3 = new VOPool(new List<string> { VO_DALA_900h_Male_Human_Intro_01 }, 1f, ShouldPlayValue.Once, VOSpeaker.OPPONENT_HERO, null, GameSaveKeySubkeyId.DAL_DUNGEON_HAS_SEEN_TAVERN_MAGE_VO);
		m_VOPools.Add(911, firstTavernVO3);
		VOPool firstTavernVO4 = new VOPool(new List<string> { VO_DALA_900h_Male_Human_Intro_01 }, 1f, ShouldPlayValue.Once, VOSpeaker.OPPONENT_HERO, null, GameSaveKeySubkeyId.DAL_DUNGEON_HAS_SEEN_TAVERN_PALADIN_VO);
		m_VOPools.Add(912, firstTavernVO4);
		VOPool firstTavernVO5 = new VOPool(new List<string> { VO_DALA_900h_Male_Human_Intro_01 }, 1f, ShouldPlayValue.Once, VOSpeaker.OPPONENT_HERO, null, GameSaveKeySubkeyId.DAL_DUNGEON_HAS_SEEN_TAVERN_PRIEST_VO);
		m_VOPools.Add(913, firstTavernVO5);
		VOPool firstTavernVO6 = new VOPool(new List<string> { VO_DALA_900h_Male_Human_Intro_01 }, 1f, ShouldPlayValue.Once, VOSpeaker.OPPONENT_HERO, null, GameSaveKeySubkeyId.DAL_DUNGEON_HAS_SEEN_TAVERN_ROGUE_VO);
		m_VOPools.Add(914, firstTavernVO6);
		VOPool firstTavernVO7 = new VOPool(new List<string> { VO_DALA_900h_Male_Human_Intro_01 }, 1f, ShouldPlayValue.Once, VOSpeaker.OPPONENT_HERO, null, GameSaveKeySubkeyId.DAL_DUNGEON_HAS_SEEN_TAVERN_SHAMAN_VO);
		m_VOPools.Add(915, firstTavernVO7);
		VOPool firstTavernVO8 = new VOPool(new List<string> { VO_DALA_900h_Male_Human_Intro_01 }, 1f, ShouldPlayValue.Once, VOSpeaker.OPPONENT_HERO, null, GameSaveKeySubkeyId.DAL_DUNGEON_HAS_SEEN_TAVERN_WARLOCK_VO);
		m_VOPools.Add(916, firstTavernVO8);
		VOPool firstTavernVO9 = new VOPool(new List<string> { VO_DALA_900h_Male_Human_Intro_01 }, 1f, ShouldPlayValue.Once, VOSpeaker.OPPONENT_HERO, null, GameSaveKeySubkeyId.DAL_DUNGEON_HAS_SEEN_TAVERN_WARRIOR_VO);
		m_VOPools.Add(917, firstTavernVO9);
	}
	...
	protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
	{
		...
		if (MissionEntity.STANDARD_EMOTE_RESPONSE_TRIGGERS.Contains(emoteType))
		{
			...
			{
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_DALA_901h_Male_Mech_TurnOne_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
			}
			else
			{
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		string playerHeroCardID = GameState.Get().GetFriendlySidePlayer().GetHero()
			.GetCardId();
		VOPool pool = null;
		int introMissionEvent = 0;
		string classIntroVO = null;
		string enemyHeroCardID = GameState.Get().GetOpposingSidePlayer().GetHero()
			.GetCardId();
		Actor enemyActor = GameState.Get().GetOpposingSidePlayer().GetHeroCard()
			.GetActor();
		if (enemyHeroCardID == BARTENDERBOB_CARDID)
		{
			...
			case 101:
			{
				...
				{
					introMissionEvent = 909;
					pool = m_VOPools[introMissionEvent];
					classIntroVO = VO_DALA_900h_Male_Human_IntroSqueamlish_01;
				}
				if (playerHeroCardID == "DALA_Barkeye")
				{
					introMissionEvent = 910;
					pool = m_VOPools[introMissionEvent];
					classIntroVO = VO_DALA_900h_Male_Human_IntroOlBarkeye_01;
				}
				if (playerHeroCardID == "DALA_Rakanishu")
				{
					introMissionEvent = 911;
					pool = m_VOPools[introMissionEvent];
					classIntroVO = VO_DALA_900h_Male_Human_IntroRakanishu_01;
				}
				if (playerHeroCardID == "DALA_George")
				{
					introMissionEvent = 912;
					pool = m_VOPools[introMissionEvent];
					classIntroVO = VO_DALA_900h_Male_Human_IntroGeorge_01;
				}
				if (playerHeroCardID == "DALA_Kriziki")
				{
					introMissionEvent = 913;
					pool = m_VOPools[introMissionEvent];
					classIntroVO = VO_DALA_900h_Male_Human_IntroKriziki_01;
				}
				if (playerHeroCardID == "DALA_Eudora")
				{
					introMissionEvent = 913;
					pool = m_VOPools[introMissionEvent];
					classIntroVO = VO_DALA_900h_Male_Human_IntroEudora_02;
				}
				if (playerHeroCardID == "DALA_Vessina")
				{
					introMissionEvent = 915;
					pool = m_VOPools[introMissionEvent];
					classIntroVO = VO_DALA_900h_Male_Human_IntroVessina_01;
				}
				if (playerHeroCardID == "DALA_Tekahn")
				{
					introMissionEvent = 916;
					pool = m_VOPools[introMissionEvent];
					classIntroVO = VO_DALA_900h_Male_Human_IntroTekahn_01;
				}
				if (playerHeroCardID == "DALA_Chu")
				{
					introMissionEvent = 917;
					pool = m_VOPools[introMissionEvent];
					classIntroVO = VO_DALA_900h_Male_Human_IntroChu_01;
				}
				GameSaveDataManager.Get().GetSubkeyValue(GameSaveKeyId.ADVENTURE_DATA_CLIENT_DALARAN, pool.m_oncePerAccountGameSaveSubkey, out long hasSeenVOSubkeyValue);
				if (hasSeenVOSubkeyValue > 0)
				{
					for (int i = 0; i < 3; i++)
					{
						m_IntroLines.Add(classIntroVO);
					}
					string voLine = PopRandomLine(m_IntroLines);
					yield return Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(voLine, Notification.SpeechBubbleDirection.TopRight, enemyActor));
				}
				else
				{
					yield return Gameplay.Get().StartCoroutine(base.HandleMissionEventWithTiming(introMissionEvent));
				}
				break;
			}
			case 102:
			{
				...
				string outroLine = PopRandomLine(m_OutroLinesCopy);
				yield return Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(outroLine, Notification.SpeechBubbleDirection.TopRight, enemyActor));
		...
		else
		{
			...
			case 101:
			{
				...
				{
					introMissionEvent = 909;
					_ = m_VOPools[introMissionEvent];
					classIntroVO = VO_DALA_901h_Male_Mech_IntroSqueamlish_01;
				}
				if (playerHeroCardID == "DALA_Barkeye")
				{
					introMissionEvent = 910;
					_ = m_VOPools[introMissionEvent];
					classIntroVO = VO_DALA_901h_Male_Mech_IntroOlBarkeye_01;
				}
				if (playerHeroCardID == "DALA_Rakanishu")
				{
					introMissionEvent = 911;
					_ = m_VOPools[introMissionEvent];
					classIntroVO = VO_DALA_901h_Male_Mech_IntroRakanishu_01;
				}
				if (playerHeroCardID == "DALA_George")
				{
					introMissionEvent = 912;
					_ = m_VOPools[introMissionEvent];
					classIntroVO = VO_DALA_901h_Male_Mech_IntroGeorge_01;
				}
				if (playerHeroCardID == "DALA_Kriziki")
				{
					introMissionEvent = 913;
					_ = m_VOPools[introMissionEvent];
					classIntroVO = VO_DALA_901h_Male_Mech_IntroKriziki_01;
				}
				if (playerHeroCardID == "DALA_Eudora")
				{
					introMissionEvent = 913;
					_ = m_VOPools[introMissionEvent];
					classIntroVO = VO_DALA_901h_Male_Mech_IntroEudora_01;
				}
				if (playerHeroCardID == "DALA_Vessina")
				{
					introMissionEvent = 915;
					_ = m_VOPools[introMissionEvent];
					classIntroVO = VO_DALA_901h_Male_Mech_IntroVessina_01;
				}
				if (playerHeroCardID == "DALA_Tekahn")
				{
					introMissionEvent = 916;
					_ = m_VOPools[introMissionEvent];
					classIntroVO = VO_DALA_901h_Male_Mech_IntroTekahn_01;
				}
				if (playerHeroCardID == "DALA_Chu")
				{
					introMissionEvent = 917;
					_ = m_VOPools[introMissionEvent];
					classIntroVO = VO_DALA_901h_Male_Mech_IntroChu_01;
				}
				for (int j = 0; j < 3; j++)
				{
					m_Bartendortron_IntroLines.Add(classIntroVO);
				}
				string voLine2 = PopRandomLine(m_Bartendortron_IntroLines);
				yield return Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(voLine2, Notification.SpeechBubbleDirection.TopRight, enemyActor));
				break;
			}
			case 102:
			{
				...
				string outroLine2 = PopRandomLine(m_Bartendortron_OutroLinesCopy);
				yield return Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(outroLine2, Notification.SpeechBubbleDirection.TopRight, enemyActor));
				GameState.Get().SetBusy(busy: false);
				break;
			}
			default:
	...
	protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
	{
		...
		if (enemyHeroCardID == BARTENDERBOB_CARDID)
		{
			...
			{
			case "DALA_902":
				yield return PlayLineOnlyOnce(enemyActor, VO_DALA_900h_Male_Human_PlayerDismiss_01);
				break;
			case "DALA_904":
				yield return PlayLineOnlyOnce(enemyActor, VO_DALA_900h_Male_Human_PlayerGoodFood_01);
				break;
			case "DALA_911":
				yield return PlayLineOnlyOnce(enemyActor, VO_DALA_900h_Male_Human_PlayerKindle_01);
				break;
			case "DALA_901":
				yield return PlayLineOnlyOnce(enemyActor, VO_DALA_900h_Male_Human_PlayerRecruit_01);
				break;
			case "DALA_907":
				yield return PlayLineOnlyOnce(enemyActor, VO_DALA_900h_Male_Human_PlayerRecruitAVeteran_01);
				break;
			case "DALA_905":
				yield return PlayLineOnlyOnce(enemyActor, VO_DALA_900h_Male_Human_PlayerRightHandMan_01);
				break;
			case "DALA_906":
				yield return PlayLineOnlyOnce(enemyActor, VO_DALA_900h_Male_Human_PlayerRoundOfDrinks_01);
				break;
			case "DALA_903":
				yield return PlayLineOnlyOnce(enemyActor, VO_DALA_900h_Male_Human_PlayerTakeAChance_01);
				break;
			case "DALA_913":
				yield return PlayLineOnlyOnce(enemyActor, VO_DALA_900h_Male_Human_PlayerTallTales_01);
				break;
			case "DALA_908":
				yield return PlayLineOnlyOnce(enemyActor, VO_DALA_900h_Male_Human_PlayerTellAStory_01);
				break;
			case "DALA_910":
				yield return PlayLineOnlyOnce(enemyActor, VO_DALA_900h_Male_Human_PlayerTheGangsAllHere_01);
				break;
			case "DALA_909":
				yield return PlayLineOnlyOnce(enemyActor, VO_DALA_900h_Male_Human_PlayerYoureAllFired_01);
				break;
			case "DALA_912":
				if (Random.Range(1, 11) == 1)
				{
					yield return PlayLineOnlyOnce(enemyActor, VO_DALA_900h_Male_Human_PlayerBrood_02);
				}
				else
				{
					yield return PlayLineOnlyOnce(enemyActor, VO_DALA_900h_Male_Human_PlayerBrood_01);
				}
				break;
			}
		}
		else
		{
			...
			{
			case "DALA_902":
				yield return PlayLineOnlyOnce(enemyActor, VO_DALA_901h_Male_Mech_PlayerDismiss_01);
				break;
			case "DALA_904":
				yield return PlayLineOnlyOnce(enemyActor, VO_DALA_901h_Male_Mech_PlayerGoodFood_01);
				break;
			case "DALA_911":
				yield return PlayLineOnlyOnce(enemyActor, VO_DALA_901h_Male_Mech_PlayerKindle_01);
				break;
			case "DALA_901":
				yield return PlayLineOnlyOnce(enemyActor, VO_DALA_901h_Male_Mech_PlayerRecruit_01);
				break;
			case "DALA_907":
				yield return PlayLineOnlyOnce(enemyActor, VO_DALA_901h_Male_Mech_PlayerRecruitAVeteran_01);
				break;
			case "DALA_905":
				if (Random.Range(1, 3) == 1)
				{
					yield return PlayLineOnlyOnce(enemyActor, VO_DALA_901h_Male_Mech_PlayerRightHandMan_01);
				}
				else
				{
					yield return PlayLineOnlyOnce(enemyActor, VO_DALA_901h_Male_Mech_PlayerRightHandMan_02);
				}
				break;
			case "DALA_906":
				yield return PlayLineOnlyOnce(enemyActor, VO_DALA_901h_Male_Mech_PlayerRoundOfDrinks_01);
				break;
			case "DALA_903":
				yield return PlayLineOnlyOnce(enemyActor, VO_DALA_901h_Male_Mech_PlayerTakeAChance_01);
				break;
			case "DALA_913":
				yield return PlayLineOnlyOnce(enemyActor, VO_DALA_901h_Male_Mech_PlayerTallTales_01);
				break;
			case "DALA_908":
				yield return PlayLineOnlyOnce(enemyActor, VO_DALA_901h_Male_Mech_PlayerTellAStory_01);
				break;
			case "DALA_910":
				yield return PlayLineOnlyOnce(enemyActor, VO_DALA_901h_Male_Mech_PlayerTheGangsAllHere_01);
				break;
			case "DALA_909":
				yield return PlayLineOnlyOnce(enemyActor, VO_DALA_901h_Male_Mech_PlayerYoureAllFired_01);
				break;
			case "DALA_912":
				if (Random.Range(1, 11) == 1)
				{
					yield return PlayLineOnlyOnce(enemyActor, VO_DALA_901h_Male_Mech_PlayerBrood_02);
				}
				else
				{
					yield return PlayLineOnlyOnce(enemyActor, VO_DALA_901h_Male_Mech_PlayerBrood_01);
				}
				break;
			}
		}
