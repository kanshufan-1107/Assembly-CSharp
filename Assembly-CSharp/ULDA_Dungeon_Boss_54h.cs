...
public class ULDA_Dungeon_Boss_54h : ULDA_Dungeon
{
	...
	protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
	{
		...
		if (emoteType == EmoteType.START)
		{
			...
			{
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_ULDA_BOSS_54h_Female_Hozen_Intro_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
			}
			else if (playerHeroCardID == "ULDA_Elise")
			{
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_ULDA_BOSS_54h_Female_Hozen_IntroSpecialFinley_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
			}
			else
			{
	...
	protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
		{
			...
			{
			case "ULD_706":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_54h_Female_Hozen_PlayerTrigger_Blatant_Decoy_01);
				break;
			case "ULD_195":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_54h_Female_Hozen_PlayerTrigger_Frightened_Flunky_01);
				break;
			case "ULD_134":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_54h_Female_Hozen_PlayerTrigger_BEEEES_01);
				break;
			}
		}
	}
	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
		{
			...
			case "DAL_739":
			case "ULD_616":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_54h_Female_Hozen_BossLackey_01);
				break;
			case "DAL_743":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_54h_Female_Hozen_BossTriggerHenchClanHogsteed_01);
				break;
			case "ULD_180":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_54h_Female_Hozen_BossTriggerSunstruckHenchman_01);
				break;
			}
		}
	}
