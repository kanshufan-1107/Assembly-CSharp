...
public class TemporaryAccountSignUpPopUp : UIBPopup
{
	...
	public readonly Vector3 SHOW_POS_PHONE = new Vector3(0f, 15f, -2f);

	public readonly Vector3 SHOW_SCALE_PHONE = new Vector3(85f, 85f, 85f);
	...
	public override void Show()
	{
		if (!base.IsShown())
		{
			...
			GameObject inputBlockerObject = CameraUtils.CreateInputBlocker(CameraUtils.FindFirstByLayer(base.gameObject.layer), "TemporaryAccountSignUpPopUpInputBlocker");
