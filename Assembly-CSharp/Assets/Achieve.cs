...
public static class Achieve
{
	...
	public enum Trigger
	{
		...
		[Description("mercenaries_bounty_started")]
		MERCENARIES_BOUNTY_STARTED = 41,
		[Description("starter_quests_completed")]
		STARTER_QUESTS_COMPLETED = 42
	}
	...
	{
		EnumUtils.TryGetEnum<ClientFlags>(value, out var e);
		return e;
	}

	public static Trigger ParseTriggerValue(string value)
	{
		EnumUtils.TryGetEnum<Trigger>(value, out var e);
		return e;
	}

	public static GameMode ParseGameModeValue(string value)
	{
		EnumUtils.TryGetEnum<GameMode>(value, out var e);
		return e;
	}

	public static PlayerType ParsePlayerTypeValue(string value)
	{
		EnumUtils.TryGetEnum<PlayerType>(value, out var e);
		return e;
	}
