...
public class CardSetSpellOverrideDbfRecord : DbfRecord
{
	...
	{
		CardSetSpellOverrideDbfAsset dbfAsset = DbfShared.GetAssetBundle().LoadAsset(resourcePath, typeof(CardSetSpellOverrideDbfAsset)) as CardSetSpellOverrideDbfAsset;
		if (dbfAsset == null)
		{
			records = new List<T>();
