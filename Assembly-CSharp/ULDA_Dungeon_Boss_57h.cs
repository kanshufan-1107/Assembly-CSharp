...
public class ULDA_Dungeon_Boss_57h : ULDA_Dungeon
{
	...
	{
		base.PreloadAssets();
		List<string> soundFiles = new List<string> { VO_ULDA_BOSS_57h_WingedGuardian_Death, VO_ULDA_BOSS_57h_WingedGuardian_Defeat, VO_ULDA_BOSS_57h_WingedGuardian_EmoteResponse, VO_ULDA_BOSS_57h_WingedGuardian_Intro };
