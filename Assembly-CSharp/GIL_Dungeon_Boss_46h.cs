...
public class GIL_Dungeon_Boss_46h : GIL_Dungeon
{
	...
	protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
	{
		...
		{
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_GILA_BOSS_46h_Male_Worgen_Intro_01.prefab:793a3ad2cd2405741ad472479cf70932", Notification.SpeechBubbleDirection.TopRight, enemyActor));
		}
		else if (MissionEntity.STANDARD_EMOTE_RESPONSE_TRIGGERS.Contains(emoteType))
		{
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_GILA_BOSS_46h_Male_Worgen_EmoteResponse_01.prefab:b86300a09c3a5ab43bb21a558a2aa331", Notification.SpeechBubbleDirection.TopRight, enemyActor));
		}
	}
	...
	protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
	{
		...
		{
		case "GILA_412":
			yield return PlayBossLine(enemyActor, "VO_GILA_BOSS_46h_Male_Worgen_EventPlayBloodMoon_01.prefab:95888d40608ed4344a19e1f276275a59");
			break;
		case "GILA_851a":
			yield return PlayBossLine(enemyActor, "VO_GILA_BOSS_46h_Male_Worgen_EventPlayTrapper_02.prefab:0f49f185267a7144689d07bf20405e02");
			break;
		case "KAR_005":
		case "KAR_005a":
		case "DS1_070":
