...
public class BOM_03_Guff_Fight_07 : BOM_03_Guff_Dungeon
{
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		{
		case 514:
			yield return MissionPlayVO(enemyActor, VO_Story_Hero_Mutanus_Male_Murloc_Story_Guff_Mission7Intro_01);
			yield return MissionPlayVO(friendlyActor, VO_Story_Hero_Guff_Male_Tauren_Story_Guff_Mission7Intro_02);
			break;
		case 515:
			yield return MissionPlayVO(enemyActor, VO_Story_Hero_Mutanus_Male_Murloc_Story_Guff_Mission7EmoteResponse_01);
			break;
		case 516:
			yield return MissionPlaySound(enemyActor, VO_Story_Hero_Mutanus_Male_Murloc_Story_Guff_Mission7Victory_01);
			break;
		case 506:
			GameState.Get().SetBusy(busy: true);
			yield return MissionPlayVO(enemyActor, VO_Story_Hero_Mutanus_Male_Murloc_Story_Guff_Mission7Loss_01);
	...
	protected override IEnumerator HandleStartOfTurnWithTiming(int turn)
	{
		...
		case 3:
			...
			break;
		case 5:
			yield return MissionPlayVO(enemyActor, VO_Story_Hero_Mutanus_Male_Murloc_Story_Guff_Mission7ExchangeB_01);
