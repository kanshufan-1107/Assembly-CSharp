...
public class BTA_Fight_12 : BTA_Dungeon
{
	...
	public override IEnumerator DoActionsBeforeDealingBaseMulliganCards()
	{
		...
		yield return PlayLineAlways(friendlyActor, VO_BTA_01_Female_NightElf_Mission_Fight_12_PlayerStart_01);
	...
	protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
	{
		...
		{
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_BTA_BOSS_12h_Male_Demon_Mission_Fight_12_Emote_Response_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
		}
	}
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		case 501:
			GameState.Get().SetBusy(busy: true);
			yield return PlayLineAlways(friendlyActor, VO_BTA_01_Female_NightElf_Mission_Fight_12_VictoryA_01);
			GameState.Get().SetBusy(busy: false);
			break;
		case 507:
			yield return PlayAndRemoveRandomLineOnlyOnce(enemyActor, m_VO_BTA_BOSS_12h_Male_Demon_Mission_Fight_12_HeroPowerTrigger_Lines);
			break;
		default:
	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
		{
			...
			{
			case "BTA_15":
				yield return PlayLineAlways(enemyActor, VO_BTA_BOSS_12h_Male_Demon_Mission_Fight_12_Boss_EndlessLegion_01);
				break;
			case "EX1_308":
				yield return PlayLineAlways(enemyActor, VO_BTA_BOSS_12h_Male_Demon_Mission_Fight_12_Boss_Soulfire_01);
				break;
			case "GVG_052":
				yield return PlayLineAlways(enemyActor, VO_BTA_BOSS_12h_Male_Demon_Mission_Fight_12_Boss_Crush_01);
				break;
			case "OG_276":
				yield return PlayLineAlways(enemyActor, VO_BTA_BOSS_12h_Male_Demon_Mission_Fight_12_Boss_BloodWarriors_01);
				break;
			}
		}
	}
