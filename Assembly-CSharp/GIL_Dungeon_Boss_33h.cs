...
public class GIL_Dungeon_Boss_33h : GIL_Dungeon
{
	...
	protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
	{
		...
		{
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_GILA_BOSS_33h_Male_Mech_Intro_01.prefab:0511c22148db56a448c2e55a8930a644", Notification.SpeechBubbleDirection.TopRight, enemyActor));
		}
		else if (MissionEntity.STANDARD_EMOTE_RESPONSE_TRIGGERS.Contains(emoteType))
		{
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_GILA_BOSS_33h_Male_Mech_EmoteResponse_01.prefab:e76887ef139b3454f952a8d666c627ef", Notification.SpeechBubbleDirection.TopRight, enemyActor));
		}
	}
	...
	protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()))
		{
			...
			if (cardID == "EX1_556")
			{
				yield return PlayEasterEggLine(enemyActor, "VO_GILA_BOSS_33h_Male_Mech_EventPlayHarvestGolem_01.prefab:2ffa7bb43bb5bc34ca7b76f0a8f05e8f");
			}
		}
	}
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		{
		case 101:
			yield return PlayLineOnlyOnce(enemyActor, "VO_GILA_BOSS_33h_Male_Mech_Attack_01.prefab:004b23d48756f1c4faf510e064804b5a");
			break;
		case 102:
		{
			string randomLine = PopRandomLineWithChance(m_WeaponKillLines);
			if (randomLine != null)
			{
