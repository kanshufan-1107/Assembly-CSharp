...
public class TB_RumbleDome : TB_RumbleDome_Dungeon
{
	...
	{
		base.PreloadAssets();
		List<string> soundFiles = new List<string> { VO_TB_FelFirefest_FelRagnaros_Male_Elemental_FelfireFest_Intro02_01, VO_TB_FelFirefest_FelRagnaros_Male_Elemental_FelfireFest_Intro03_01, VO_TB_FelFirefest_FelRagnaros_Male_Elemental_FelfireFest_Loss_01, VO_TB_FelFirefest_FelRagnaros_Male_Elemental_FelfireFest_Victory_01 };
