...
public class ULDA_Dungeon_Boss_28h : ULDA_Dungeon
{
	...
	protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
		{
			...
			{
			case "ULD_158":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_28h_Female_Revenant_PlayerTrigger_Sandstorm_Elemental_01);
				break;
			case "ULD_713":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_28h_Female_Revenant_PlayerTrigger_Swarm_of_Locusts_01);
				break;
			case "ULD_178":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_28h_Female_Revenant_PlayerTrigger_Siamat_01);
				break;
			}
		}
	}
	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		if (!(cardID == "NEW1_010"))
		{
			if (cardID == "LOOT_517")
			{
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_28h_Female_Revenant_BossTriggerMurmuringElemental_01);
			}
		}
		else
		{
			yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_28h_Female_Revenant_BossTriggerAlAkir_01);
		}
	}
}
