...
public class DALA_Dungeon_Boss_48h : DALA_Dungeon
{
	...
	protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
	{
		...
		if (emoteType == EmoteType.START)
		{
			...
			{
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_DALA_BOSS_48h_Male_Demon_IntroGeorge_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
			}
			else if (playerHeroCardID == "DALA_Tekahn")
			{
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_DALA_BOSS_48h_Male_Demon_IntroTekahn_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
			}
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		{
		case 101:
			yield return PlayLineOnlyOnce(enemyActor, VO_DALA_BOSS_48h_Male_Demon_BossBigDemon_01);
			break;
		case 102:
			yield return PlayAndRemoveRandomLineOnlyOnce(enemyActor, m_HeroPower);
			break;
		case 103:
			yield return PlayAndRemoveRandomLineOnlyOnce(enemyActor, m_HeroPowerBig);
			break;
		default:
	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
		{
			...
			{
			case "EX1_181":
				yield return PlayLineOnlyOnce(enemyActor, VO_DALA_BOSS_48h_Male_Demon_BossCalloftheVoid_01);
				break;
			case "FP1_022":
				yield return PlayLineOnlyOnce(enemyActor, VO_DALA_BOSS_48h_Male_Demon_BossVoidcaller_01);
				break;
			case "DALA_BOSS_48t":
				yield return PlayAndRemoveRandomLineOnlyOnce(enemyActor, m_BossVoidShift);
				break;
			}
		}
	}
