...
public abstract class BOM_05_Tamsin_MissionEntity : GenericDungeonMissionEntity
{
	...
	public BOM_05_Tamsin_MissionEntity()
	{
	...
	{
		yield return MissionPlayVO(actor, lines, base.InternalShouldPlayOnlyOnce, bUseBubble: true, bPlayOrder: false);
	}
