...
public class DRGA_Evil_Fight_06 : DRGA_Dungeon
{
	...
	protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
	{
		...
		{
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_DRGA_BOSS_20h_Male_Dragon_Evil_Fight_06_BossStart_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
		}
		else if (MissionEntity.STANDARD_EMOTE_RESPONSE_TRIGGERS.Contains(emoteType))
		{
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_DRGA_BOSS_20h_Male_Dragon_Evil_Fight_06_EmoteResponse_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
		}
	}
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		case 102:
			if (!m_Heroic)
			{
				yield return PlayLineAlways(friendlyActor, VO_DRGA_BOSS_06h_Female_Orc_Evil_Fight_06_Misc_02_Hero_01);
			}
			break;
		case 103:
			if (!m_Heroic)
			{
				yield return PlayLineAlways(friendlyActor, VO_DRGA_BOSS_06h_Female_Orc_Evil_Fight_06_Misc_03_Hero_01);
			}
			break;
		case 104:
			if (!m_Heroic)
			{
				yield return PlayLineAlways(friendlyActor, VO_DRGA_BOSS_06h_Female_Orc_Evil_Fight_06_Misc_04_Hero_01);
			}
			break;
		case 105:
			if (!m_Heroic)
	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		{
			yield return PlayLineAlways(enemyActor, VO_DRGA_BOSS_20h_Male_Dragon_Evil_Fight_06_Misc_02_01);
			if (!m_Heroic)
			{
