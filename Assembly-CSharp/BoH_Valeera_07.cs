...
public class BoH_Valeera_07 : BoH_Valeera_Dungeon
{
	...
	public override IEnumerator DoActionsBeforeDealingBaseMulliganCards()
	{
		...
		yield return MissionPlayVO(friendlyActor, VO_Story_Hero_Valeera_Female_BloodElf_Story_Valeera_Mission7Intro_01);
	...
	protected override IEnumerator HandleStartOfTurnWithTiming(int turn)
	{
		...
		case 1:
			...
			break;
		case 5:
			yield return PlayLineAlways(enemyActor, VO_Story_Hero_ChoGall_Male_Ogre_Story_Valeera_Mission7ExchangeB_01);
