...
public class DRGA_Good_Fight_08 : DRGA_Dungeon
{
	...
	protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
	{
		...
		if (emoteType == EmoteType.START)
		{
			...
			{
			case "HERO_01c":
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_DRGA_BOSS_22h_Male_Gronn_Good_Fight_08_Player_DragonHero_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
				break;
			case "NEW1_038":
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_DRGA_BOSS_22h_Male_Gronn_Good_Fight_08_Player_Gruul_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
				break;
			case "HERO_07a":
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_DRGA_BOSS_22h_Male_Gronn_Good_Fight_08_Player_NemsyHero_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
				break;
			case "YOD_009":
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_DRGA_BOSS_22h_Male_Gronn_Good_Fight_08_Player_RenoHero_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
				break;
			case "":
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_DRGA_BOSS_22h_Male_Gronn_Good_Fight_08_Player_Toki_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
				break;
			default:
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_DRGA_BOSS_22h_Male_Gronn_Good_Fight_08_BossStart_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
				break;
			}
		}
		else if (MissionEntity.STANDARD_EMOTE_RESPONSE_TRIGGERS.Contains(emoteType))
		{
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_DRGA_BOSS_22h_Male_Gronn_Good_Fight_08_EmoteResponse_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
		}
	}
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		case 100:
			if (!m_Heroic)
			{
				yield return PlayLineAlways(enemyActor, VO_DRGA_BOSS_22h_Male_Gronn_Good_Fight_08_Misc_01_01);
			}
			break;
		case 101:
			if (!m_Heroic)
			{
				yield return PlayLineAlways(enemyActor, VO_DRGA_BOSS_22h_Male_Gronn_Good_Fight_08_Misc_02_01);
			}
			break;
		case 102:
			yield return PlayLineAlways(enemyActor, VO_DRGA_BOSS_22h_Male_Gronn_Good_Fight_08_Misc_03_01);
			break;
		case 103:
			yield return PlayLineAlways(enemyActor, VO_DRGA_BOSS_22h_Male_Gronn_Good_Fight_08_Misc_04_01);
			break;
		case 104:
			if (!m_Heroic)
			{
				yield return PlayLineAlways(enemyActor, VO_DRGA_BOSS_22h_Male_Gronn_Good_Fight_08_Misc_05_01);
			}
			break;
		case 105:
			if (!m_Heroic)
			{
				yield return PlayLineAlways(enemyActor, VO_DRGA_BOSS_22h_Male_Gronn_Good_Fight_08_Misc_06_01);
			}
			break;
		case 106:
			if (!m_Heroic)
			{
				yield return PlayLineAlways(friendlyActor, VO_DRGA_BOSS_36h_Female_Gnome_Good_Fight_08_Misc_07_01);
		...
		case 107:
			if (!m_Heroic)
			{
				yield return PlayAndRemoveRandomLineOnlyOnce(friendlyActor, m_ChromieTransform);
			}
			break;
		case 108:
			if (!m_Heroic)
			{
				yield return PlayLineOnlyOnce(friendlyActor, VO_DRGA_BOSS_22h_Male_Gronn_Good_Fight_08_Boss_Heartseeker_01);
			}
			break;
		case 110:
			if (!m_Heroic)
			{
				yield return PlayLineAlways(friendlyActor, VO_DRGA_BOSS_36h_Female_Gnome_Good_Fight_08_Misc_11_01);
			}
			break;
		case 111:
			if (!m_Heroic)
			{
				yield return PlayLineAlways(friendlyActor, VO_DRGA_BOSS_36h_Female_Gnome_Good_Fight_08_Misc_12_01);
			}
			break;
		case 112:
			if (!m_Heroic)
			{
				yield return PlayLineAlways(friendlyActor, VO_DRGA_BOSS_36h_Female_Gnome_Good_Fight_08_Misc_13_01);
			}
			break;
		case 113:
			if (!m_Heroic)
			{
				yield return PlayLineAlways(friendlyActor, VO_DRGA_BOSS_36h_Female_Gnome_Good_Fight_08_Misc_14_01);
			}
			break;
		case 114:
			yield return PlayLineAlways(enemyActor, VO_DRGA_BOSS_22h_Male_Gronn_Good_Fight_08_Boss_Death_Round1_01);
			break;
		case 115:
			yield return PlayLineAlways(enemyActor, VO_DRGA_BOSS_22h_Male_Gronn_Good_Fight_08_Boss_Death_Round2_01);
			break;
		case 116:
			yield return PlayLineAlways(enemyActor, VO_DRGA_BOSS_22h_Male_Gronn_Good_Fight_08_Boss_DrawCard_01);
			break;
		case 117:
			yield return PlayLineOnlyOnce(enemyActor, VO_DRGA_BOSS_22h_Male_Gronn_Good_Fight_08_BossAttack_01);
			break;
		case 118:
			if (!m_Heroic)
			{
	...
	protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
		{
			...
			if (cardID == "NEW1_038")
			{
				yield return PlayLineOnlyOnce(enemyActor, VO_DRGA_BOSS_22h_Male_Gronn_Good_Fight_08_Player_Gruul_01);
			}
		}
	}
	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
		{
			...
			{
				yield return PlayAndRemoveRandomLineOnlyOnce(enemyActor, m_BossEquipDragonslayer);
			}
		}
	}
}
