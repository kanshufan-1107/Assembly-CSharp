...
public class ULDA_Dungeon_Boss_63h : ULDA_Dungeon
{
	...
	protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
	{
		...
		if (emoteType == EmoteType.START)
		{
			...
			{
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_ULDA_BOSS_63h_Female_Sethrak_IntroReno_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
			}
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		case 101:
			...
			break;
		case 103:
			yield return PlayBossLine(enemyActor, VO_ULDA_BOSS_63h_Female_Sethrak_Idle1_01);
			break;
		case 104:
			yield return PlayBossLine(enemyActor, VO_ULDA_BOSS_63h_Female_Sethrak_Idle2_01);
			break;
		case 105:
			yield return PlayBossLine(enemyActor, VO_ULDA_BOSS_63h_Female_Sethrak_Idle3_01);
			break;
		case 102:
			yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_63h_Female_Sethrak_OverloadPass_01);
			break;
		case 106:
			yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_63h_Female_Sethrak_PlayerOverloadTrigger_01);
			break;
		default:
	...
	protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
		{
			...
			if (cardID == "ULDA_036")
			{
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_63h_Female_Sethrak_PlayerTamedLocust_01);
			}
		}
	}
	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
		{
			...
			{
			case "ULD_181":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_63h_Female_Sethrak_BossEarthquake_01);
				break;
			case "ULD_276":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_63h_Female_Sethrak_BossEVILTotem_01);
				break;
			case "TRL_351":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_63h_Female_Sethrak_BossRainofToads_01);
				break;
			}
		}
	}
