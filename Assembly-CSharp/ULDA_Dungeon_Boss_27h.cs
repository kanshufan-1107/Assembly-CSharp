...
public class ULDA_Dungeon_Boss_27h : ULDA_Dungeon
{
	...
	protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
	{
		...
		if (emoteType == EmoteType.START)
		{
			...
			{
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_ULDA_BOSS_27h_Male_Troll_IntroElise_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
			}
			else
			{
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		{
		case 101:
			yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_27h_Male_Troll_PlayerHeroTreasure_01);
			break;
		case 102:
			yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_27h_Male_Troll_BossTriggerTreasure_01);
			break;
		default:
	...
	protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
	{
		...
		if (!(cardID == "ULD_280"))
		{
			if (cardID == "ULD_003")
			{
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_27h_Male_Troll_PlayerZephyrs_01);
			}
		}
		else
		{
			yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_27h_Male_Troll_BossWastewanderSapper_01);
		}
	}
	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
		{
			...
			if (cardID == "ULD_328")
			{
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_27h_Male_Troll_BossCleverDisguise_01);
			}
		}
	}
}
