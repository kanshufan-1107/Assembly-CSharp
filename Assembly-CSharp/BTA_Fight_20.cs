...
public class BTA_Fight_20 : BTA_Dungeon_Heroic
{
	...
	protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
	{
		...
		{
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_BTA_BOSS_20h_Male_Gronn_Mission_Fight_20_BossStart_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
		}
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		{
		case 110:
			yield return PlayLineOnlyOnce(enemyActor, VO_BTA_BOSS_20h_Male_Gronn_Mission_Fight_20_Hero_Dragon_01);
			break;
		case 115:
			yield return PlayLineOnlyOnce(enemyActor, VO_BTA_BOSS_20h_Male_Gronn_Mission_Fight_20_Boss_SlayeroftheMighty_01);
			break;
		case 116:
			yield return PlayLineOnlyOnce(enemyActor, VO_BTA_BOSS_20h_Male_Gronn_Mission_Fight_20_Boss_SlayeroftheMightyDragon_01);
			break;
		case 500:
			yield return PlayLineAlways(enemyActor, VO_BTA_BOSS_20h_Male_Gronn_Mission_Fight_20_Boss_Attack_01);
			break;
		case 507:
	...
	protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
		{
			...
			case "NEW1_030":
			case "DRG_026":
				yield return PlayLineAlways(enemyActor, VO_BTA_BOSS_20h_Male_Gronn_Mission_Fight_20_Hero_Deathwing_01);
				break;
			case "DAL_575":
				yield return PlayLineAlways(enemyActor, VO_BTA_BOSS_20h_Male_Gronn_Mission_Fight_20_Hero_Khadgar_01);
				break;
			case "NEW1_038":
				yield return PlayLineAlways(enemyActor, VO_BTA_BOSS_20h_Male_Gronn_Mission_FighT_20_Hero_Gruul_01);
				break;
			}
		}
	}
	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
		{
			...
			if (cardID == "CS2_108")
			{
				yield return PlayLineOnlyOnce(enemyActor, VO_BTA_BOSS_20h_Male_Gronn_Mission_Fight_20_Bladestorm_01);
			}
		}
	}
