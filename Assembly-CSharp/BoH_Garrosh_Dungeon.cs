...
public class BoH_Garrosh_Dungeon : BoH_Garrosh_MissionEntity
{
	...
	public static BoH_Garrosh_Dungeon InstantiateBoH_Garrosh_DungeonMissionEntityForBoss(List<Network.PowerHistory> powerList, Network.HistCreateGame createGame)
	{
		...
		Log.All.PrintError("BoH_Garrosh_Dungeon.InstantiateBoH_Garrosh_DungeonMissionEntityForBoss() - Found unsupported enemy Boss {0}.", opposingHeroCardID);
	...
	protected virtual void OnBossHeroPowerPlayed(Entity entity)
	{
		...
		if (m_enemySpeaking || m_MissionDisableAutomaticVO || chanceToPlay < chanceRoll)
		{
			return;
		}
	...
	protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
	{
		...
		else if (!m_MissionDisableAutomaticVO && MissionEntity.STANDARD_EMOTE_RESPONSE_TRIGGERS.Contains(emoteType))
		{
