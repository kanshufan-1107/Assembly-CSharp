...
public class SpellCardTypeAction : SpellAction
{
	...
	public FsmEvent m_LocationEvent;

	public FsmEvent m_BaconQuestRewardEvent;
	...
	public override void OnEnter()
	{
		...
		case TAG_CARDTYPE.LOCATION:
			base.Fsm.Event(m_LocationEvent);
			break;
		case TAG_CARDTYPE.BATTLEGROUND_QUEST_REWARD:
			base.Fsm.Event(m_BaconQuestRewardEvent);
			break;
		default:
