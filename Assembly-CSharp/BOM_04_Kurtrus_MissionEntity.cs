...
public abstract class BOM_04_Kurtrus_MissionEntity : GenericDungeonMissionEntity
{
	...
	public BOM_04_Kurtrus_MissionEntity()
	{
	...
	{
		string randomLine = PopRandomLine(lines, removeLine: false);
