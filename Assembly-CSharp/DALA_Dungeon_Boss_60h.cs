...
public class DALA_Dungeon_Boss_60h : DALA_Dungeon
{
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		{
		case 526:
			yield return PlayLineOnlyOnce(enemyActor, VO_DALA_BOSS_60h_Male_Human_Trigger_PlayerPlaysFloatingHead_01);
			break;
		case 102:
			yield return PlayLineOnlyOnce(enemyActor, VO_DALA_BOSS_60h_Male_Human_Trigger_PlayerSavedByHead_01);
			break;
		case 103:
			yield return PlayAndRemoveRandomLineOnlyOnce(enemyActor, m_CopySpell);
			break;
		default:
