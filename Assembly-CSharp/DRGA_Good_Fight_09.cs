...
public class DRGA_Good_Fight_09 : DRGA_Dungeon
{
	...
	protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
	{
		...
		{
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_DRGA_BOSS_31h_Female_Vupera_Good_Fight_09_BossStart_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
		}
		else if (MissionEntity.STANDARD_EMOTE_RESPONSE_TRIGGERS.Contains(emoteType))
		{
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_DRGA_BOSS_31h_Female_Vupera_Good_Fight_09_EmoteResponse_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
		}
	}
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		case 106:
			if (!m_Heroic)
			{
				yield return PlayLineOnlyOnce(friendlyActor, VO_DRGA_BOSS_30h_Male_Human_Good_Fight_09_Hero_LowHealth_01_01);
			}
			break;
		case 107:
			if (!m_Heroic)
			{
				yield return PlayLineOnlyOnce(friendlyActor, VO_DRGA_BOSS_30h_Male_Human_Good_Fight_09_Hero_LowHealth_02_01);
		...
		case 108:
			if (!m_Heroic)
			{
				yield return PlayAndRemoveRandomLineOnlyOnce(friendlyActor, m_VO_DRGA_BOSS_30h_Male_Human_Good_Fight_09_Hero_HeroPowerLines);
			}
			break;
		default:
	...
	protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
	{
		...
		case "DRGA_BOSS_30t7":
			if (!m_Heroic)
			{
				yield return PlayAndRemoveRandomLineOnlyOnce(friendlyActor, m_VO_DRGA_BOSS_30h_Male_Human_Good_Fight_09_Hero_FireCannonLines);
			}
			break;
		case "DRGA_BOSS_30t6":
			if (!m_Heroic)
			{
				yield return PlayLineOnlyOnce(friendlyActor, VO_DRGA_BOSS_30h_Male_Human_Good_Fight_09_Hero_GreaseMonkey_01);
			}
			break;
		case "AT_070":
		case "YOD_038":
			if (!m_Heroic)
			{
				yield return PlayLineOnlyOnce(friendlyActor, VO_DRGA_BOSS_30h_Male_Human_Good_Fight_09_Hero_Kragg_01);
			}
			break;
		case "DRGA_BOSS_30t3":
			if (!m_Heroic)
			{
				yield return PlayLineOnlyOnce(friendlyActor, VO_DRGA_BOSS_30h_Male_Human_Good_Fight_09_Hero_MissilePod_01);
			}
			break;
		case "DRGA_BOSS_30t5":
			if (!m_Heroic)
			{
				yield return PlayLineOnlyOnce(friendlyActor, VO_DRGA_BOSS_30h_Male_Human_Good_Fight_09_Hero_UpgradedCannon_01);
			}
			break;
		case "DRGA_BOSS_30t":
		case "DRGA_BOSS_30t2":
			if (!m_Heroic)
			{
				yield return PlayAndRemoveRandomLineOnlyOnce(friendlyActor, m_PlayerPlaysCannon);
			}
			break;
		case "DRGA_BOSS_15t2":
			break;
	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
		{
			...
			{
			case "DRGA_BOSS_30t4":
				yield return PlayLineOnlyOnce(enemyActor, VO_DRGA_BOSS_31h_Female_Vupera_Good_Fight_09_Boss_BombFlinger_01);
				break;
			case "DRGA_BOSS_31t":
				yield return PlayLineOnlyOnce(enemyActor, VO_DRGA_BOSS_31h_Female_Vupera_Good_Fight_09_Boss_DeathRay_01);
				break;
			case "DRGA_BOSS_30t7":
				yield return PlayAndRemoveRandomLineOnlyOnce(enemyActor, m_VO_DRGA_BOSS_31h_Female_Vupera_Good_Fight_09_Boss_FireCannonLines);
				break;
			case "DRGA_BOSS_30t2":
				yield return PlayLineOnlyOnce(enemyActor, VO_DRGA_BOSS_31h_Female_Vupera_Good_Fight_09_Boss_RocketLauncher_01);
				break;
			case "DRGA_BOSS_30t5":
				yield return PlayLineOnlyOnce(enemyActor, VO_DRGA_BOSS_31h_Female_Vupera_Good_Fight_09_Boss_UpgradedCannon_01);
				break;
			case "DRGA_BOSS_30t":
				yield return PlayAndRemoveRandomLineOnlyOnce(enemyActor, m_BossPlaysCannon);
				break;
			}
		}
	}
