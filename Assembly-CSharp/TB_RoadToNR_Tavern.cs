...
public class TB_RoadToNR_Tavern : ULDA_Dungeon
{
	...
	public override void NotifyOfGameOver(TAG_PLAYSTATE playState)
	{
		...
		Network.Get().DisconnectFromGameServer(Network.DisconnectReason.TB_RoadToNR_Tavern);
	...
	public override void PreloadAssets()
	{
		...
		{
			VO_ULDA_900h_Male_Human_Death_01, VO_ULDA_900h_Male_Human_Idle_02, VO_ULDA_900h_Male_Human_Idle_03, VO_ULDA_900h_Male_Human_Idle1_01, VO_ULDA_900h_Male_Human_Idle2_01, VO_ULDA_900h_Male_Human_Intro_01, VO_ULDA_900h_Male_Human_Intro_02, VO_ULDA_900h_Male_Human_IntroBrann_01, VO_ULDA_900h_Male_Human_IntroDesert_01, VO_ULDA_900h_Male_Human_IntroElise_01,
			VO_ULDA_900h_Male_Human_IntroFinley_01, VO_ULDA_900h_Male_Human_IntroHallsofOrigination_01, VO_ULDA_900h_Male_Human_IntroLostCity_01, VO_ULDA_900h_Male_Human_IntroReno_01, VO_ULDA_900h_Male_Human_IntroTomb_01, VO_ULDA_900h_Male_Human_Outro_01, VO_ULDA_900h_Male_Human_Outro_02, VO_ULDA_900h_Male_Human_Outro_03, VO_ULDA_900h_Male_Human_Outro_04, VO_ULDA_900h_Male_Human_OutroTomb_01,
			VO_ULDA_900h_Male_Human_PlayerBrood_01, VO_ULDA_900h_Male_Human_PlayerBrood_02, VO_ULDA_900h_Male_Human_PlayerBrood_03, VO_ULDA_900h_Male_Human_PlayerDismiss_01, VO_ULDA_900h_Male_Human_PlayerDismiss_02, VO_ULDA_900h_Male_Human_PlayerDismiss_03, VO_ULDA_900h_Male_Human_PlayerGoodFood_01, VO_ULDA_900h_Male_Human_PlayerGoodFood_02, VO_ULDA_900h_Male_Human_PlayerGoodFood_03, VO_ULDA_900h_Male_Human_PlayerKindle_01,
			VO_ULDA_900h_Male_Human_PlayerKindle_02, VO_ULDA_900h_Male_Human_PlayerKindle_03, VO_ULDA_900h_Male_Human_PlayerRecruit_01, VO_ULDA_900h_Male_Human_PlayerRecruit_02, VO_ULDA_900h_Male_Human_PlayerRecruit_03, VO_ULDA_900h_Male_Human_PlayerRecruitAVeteran_01, VO_ULDA_900h_Male_Human_PlayerRecruitAVeteran_02, VO_ULDA_900h_Male_Human_PlayerRecruitAVeteran_03, VO_ULDA_900h_Male_Human_PlayerRightHandMan_01, VO_ULDA_900h_Male_Human_PlayerRightHandMan_02,
			VO_ULDA_900h_Male_Human_PlayerRightHandMan_03, VO_ULDA_900h_Male_Human_PlayerRoundofDrinks_01, VO_ULDA_900h_Male_Human_PlayerRoundofDrinks_02, VO_ULDA_900h_Male_Human_PlayerRoundofDrinks_03, VO_ULDA_900h_Male_Human_PlayerTakeAChance_01, VO_ULDA_900h_Male_Human_PlayerTakeAChance_02, VO_ULDA_900h_Male_Human_PlayerTakeAChance_03, VO_ULDA_900h_Male_Human_PlayerTallTales_01, VO_ULDA_900h_Male_Human_PlayerTallTales_02, VO_ULDA_900h_Male_Human_PlayerTallTales_03,
			VO_ULDA_900h_Male_Human_PlayerTellAStory_01, VO_ULDA_900h_Male_Human_PlayerTellAStory_02, VO_ULDA_900h_Male_Human_PlayerTellAStory_03, VO_ULDA_900h_Male_Human_PlayerTheChallenge_01, VO_ULDA_900h_Male_Human_PlayerTheChallenge_02, VO_ULDA_900h_Male_Human_PlayerTheChallenge_03, VO_ULDA_900h_Male_Human_PlayerTheGangsAllHere_01, VO_ULDA_900h_Male_Human_PlayerTheGangsAllHere_02, VO_ULDA_900h_Male_Human_PlayerTheGangsAllHere_03, VO_ULDA_900h_Male_Human_PlayerYoureAllFired_01,
			VO_ULDA_900h_Male_Human_PlayerYoureAllFired_02, VO_ULDA_900h_Male_Human_PlayerYoureAllFired_03, VO_ULDA_900h_Male_Human_RareTreasure_01, VO_ULDA_Brann_Male_Dwarf_Entering_The_Inn_01, VO_ULDA_Brann_Male_Dwarf_Entering_The_Inn_02, VO_ULDA_Brann_Male_Dwarf_Entering_The_Inn_03, VO_ULDA_Elise_Female_NightElf_Entering_The_Inn_01, VO_ULDA_Elise_Female_NightElf_Entering_The_Inn_02, VO_ULDA_Elise_Female_NightElf_Entering_The_Inn_03, VO_ULDA_Finley_Male_Murloc_Entering_The_Inn_01,
			VO_ULDA_Finley_Male_Murloc_Entering_The_Inn_02, VO_ULDA_Finley_Male_Murloc_Entering_The_Inn_03, VO_ULDA_Reno_Male_Human_Entering_The_Inn_01, VO_ULDA_Reno_Male_Human_Entering_The_Inn_02, VO_ULDA_Reno_Male_Human_Entering_The_Inn_03
		};
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		case 101:
			...
			{
			case "ULDA_Reno":
				yield return PlayRandomLineAlways(playerActor, m_IntroRenoLines);
				m_IntroLines.Add(VO_ULDA_900h_Male_Human_IntroReno_01);
				break;
			case "ULDA_Brann":
				yield return PlayRandomLineAlways(playerActor, m_IntroBrannLines);
				m_IntroLines.Add(VO_ULDA_900h_Male_Human_IntroBrann_01);
				break;
			case "ULDA_Finley":
				yield return PlayRandomLineAlways(playerActor, m_IntroFinleyLines);
				m_IntroLines.Add(VO_ULDA_900h_Male_Human_IntroFinley_01);
				break;
			case "ULDA_Elise":
				yield return PlayRandomLineAlways(playerActor, m_IntroEliseLines);
	...
	protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
		{
			...
			{
			case "DALA_912":
				yield return PlayAndRemoveRandomLineOnlyOnce(enemyActor, m_PlayerBroodLines);
				break;
			case "DALA_902":
				yield return PlayAndRemoveRandomLineOnlyOnce(enemyActor, m_PlayerDismissLines);
				break;
			case "DALA_909":
				yield return PlayAndRemoveRandomLineOnlyOnce(enemyActor, m_PlayerYoureAllFiredLines);
				break;
			case "DALA_904":
				yield return PlayAndRemoveRandomLineOnlyOnce(enemyActor, m_PlayerGoodFoodLines);
				break;
			case "DALA_911":
				yield return PlayAndRemoveRandomLineOnlyOnce(enemyActor, m_PlayerKindleLines);
				break;
			case "DALA_901":
				yield return PlayAndRemoveRandomLineOnlyOnce(enemyActor, m_PlayerRecruitLines);
				break;
			case "DALA_907":
				yield return PlayAndRemoveRandomLineOnlyOnce(enemyActor, m_PlayerRecruitAVeteranLines);
				break;
			case "DALA_905":
				yield return PlayAndRemoveRandomLineOnlyOnce(enemyActor, m_PlayerRightHandManLines);
				break;
			case "DALA_906":
				yield return PlayAndRemoveRandomLineOnlyOnce(enemyActor, m_PlayerRoundofDrinksLines);
				break;
			case "DALA_903":
				yield return PlayAndRemoveRandomLineOnlyOnce(enemyActor, m_PlayerTakeAChanceLines);
				break;
			case "DALA_913":
				yield return PlayAndRemoveRandomLineOnlyOnce(enemyActor, m_PlayerTallTalesLines);
				break;
			case "ULDA_602":
				yield return PlayAndRemoveRandomLineOnlyOnce(enemyActor, m_PlayerTellAStoryLines);
				break;
			case "ULDA_608":
				yield return PlayAndRemoveRandomLineOnlyOnce(enemyActor, m_PlayerTheChallengeLines);
				break;
			case "DALA_910":
				yield return PlayAndRemoveRandomLineOnlyOnce(enemyActor, m_PlayerTheGangsAllHereLines);
				break;
			case "ULDA_607":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_900h_Male_Human_RareTreasure_01);
				break;
			}
		}
	}
