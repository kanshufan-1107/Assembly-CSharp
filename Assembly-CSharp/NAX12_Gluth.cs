	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		if (!(cardId == "NAX12_02"))
		{
			if (cardId == "NAX12_04" && !m_cardLinePlayed)
			{
				...
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_NAX12_01_CARD_01.prefab:ecf464bc8e10cb44bb2a5b7967f534aa", Notification.SpeechBubbleDirection.TopRight, enemyActor));
		...
		else if (m_heroPowerLinePlayed <= 2)
		{
			...
			{
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_NAX12_01_HP_01.prefab:f2dea305f5fc82340ac4a42cc9ba7d8e", Notification.SpeechBubbleDirection.TopRight, enemyActor));
				yield break;
			}
