...
public class BTA_Fight_24 : BTA_Dungeon_Heroic
{
	...
	protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
	{
		...
		if (emoteType == EmoteType.START)
		{
			...
			{
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_BTA_BOSS_24h_Female_Naga_Mission_Fight_24_BossStartIllidan_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
			}
			else
			{
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_BTA_BOSS_24h_Female_Naga_Mission_Fight_24_BossStart_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
			}
		}
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		{
		case 500:
			yield return PlayLineOnlyOnce(enemyActor, VO_BTA_BOSS_24h_Female_Naga_Mission_Fight_24_Boss_Attack_01);
			break;
		case 507:
	...
	protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
		{
			...
			if (cardID == "BT_109")
			{
				yield return PlayLineOnlyOnce(enemyActor, VO_BTA_BOSS_24h_Female_Naga_Mission_Fight_24_Hero_LadyVashj_01);
			}
		}
	}
	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
		{
			...
			{
			case "BTA_BOSS_24t":
				yield return PlayAndRemoveRandomLineOnlyOnce(enemyActor, m_VO_BTA_BOSS_24h_Female_Naga_Mission_Fight_24_Boss_CoilfangEliteLines);
				break;
			case "BT_110":
				yield return PlayLineOnlyOnce(enemyActor, VO_BTA_BOSS_24h_Female_Naga_Mission_Fight_24_Boss_BowEquip_01);
				break;
			case "BT_230":
				yield return PlayLineOnlyOnce(enemyActor, VO_BTA_BOSS_24h_Female_Naga_Mission_Fight_24_Boss_CoilfangWarlord_01);
				break;
			case "EX1_238":
				yield return PlayLineOnlyOnce(enemyActor, VO_BTA_BOSS_24h_Female_Naga_Mission_Fight_24_Boss_DeadlyShot_01);
				break;
			}
		}
	}
