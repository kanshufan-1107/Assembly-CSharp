...
public class DALA_Dungeon_Boss_39h : DALA_Dungeon
{
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		{
		case 101:
			yield return PlayLineOnlyOnce(enemyActor, VO_DALA_BOSS_39h_Male_Draenei_PlayerGeorge_01);
			break;
		case 102:
			yield return PlayLineOnlyOnce(enemyActor, VO_DALA_BOSS_39h_Male_Draenei_PlayerGeorgeSTART_01);
			break;
		case 103:
