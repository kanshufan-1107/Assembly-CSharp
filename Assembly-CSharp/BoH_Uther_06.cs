...
public class BoH_Uther_06 : BoH_Uther_Dungeon
{
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		{
		case 504:
			yield return PlayLineAlways(enemyActor, VO_Story_Hero_Venim_Male_Lich_Story_Uther_Mission6Loss_01);
			break;
		case 501:
			GameState.Get().SetBusy(busy: true);
	...
	protected override IEnumerator HandleStartOfTurnWithTiming(int turn)
	{
		...
		{
		case 1:
			yield return PlayLineAlways(enemyActor, VO_Story_Hero_Venim_Male_Lich_Story_Uther_Mission6Intro_01);
			break;
		case 7:
