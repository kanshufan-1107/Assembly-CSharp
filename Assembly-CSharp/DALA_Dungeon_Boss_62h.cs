...
public class DALA_Dungeon_Boss_62h : DALA_Dungeon
{
	...
	protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
	{
		...
		if (emoteType == EmoteType.START)
		{
			...
			{
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_DALA_BOSS_62h_Male_Tauren_IntroGeorge_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
			}
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		if (missionEvent == 101)
		{
			yield return PlayLineOnlyOnce(enemyActor, VO_DALA_BOSS_62h_Male_Tauren_BossNoAttack_01);
		}
		else
		{
	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
		{
			...
			case "OG_337":
			case "TRL_408":
				yield return PlayLineOnlyOnce(enemyActor, VO_DALA_BOSS_62h_Male_Tauren_BossHorror_01);
				break;
			case "CFM_603":
			case "CS1_113":
				yield return PlayAndRemoveRandomLineOnlyOnce(enemyActor, m_BossStealMinion);
				break;
			}
		}
	}
