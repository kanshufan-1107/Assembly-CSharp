...
public class BoH_Garrosh_01 : BoH_Garrosh_Dungeon
{
	...
	public override IEnumerator DoActionsBeforeDealingBaseMulliganCards()
	{
		...
		yield return PlayLineAlways(enemyActor, VO_Story_04_Geyah_Female_Orc_Story_Garrosh_Mission1Intro_01);
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		case 501:
			GameState.Get().SetBusy(busy: true);
			yield return PlayLineAlways(enemyActor, VO_Story_04_Geyah_Female_Orc_Story_Garrosh_Mission1Victory_01);
		...
		case 504:
			GameState.Get().SetBusy(busy: true);
			yield return PlayLineAlways(enemyActor, VO_Story_04_Geyah_Female_Orc_Story_Garrosh_Mission1Loss_01);
			GameState.Get().SetBusy(busy: false);
			break;
		default:
