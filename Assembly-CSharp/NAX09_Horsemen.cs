...
public class NAX09_Horsemen : NAX_MissionEntity
{
	...
	protected override IEnumerator HandleStartOfTurnWithTiming(int turn)
	{
		...
		yield return Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_NAX9_02_CUSTOM_01.prefab:520d0daa9374bfa47ab3f380f0e1ef65", Notification.SpeechBubbleDirection.TopRight, zeliekActor));
	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		if (!(cardId == "NAX9_06"))
		{
			if (cardId == "NAX9_07" && !m_cardLinePlayed)
			{
				...
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_FP1_031_Attack_07.prefab:b4c323c69c7f5cf418ec6b228b188c5d", Notification.SpeechBubbleDirection.TopRight, enemyActor));
			}
		}
		else if (!m_heroPowerLinePlayed)
		{
			m_heroPowerLinePlayed = true;
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_FP1_031_EnterPlay_06.prefab:51754c9428cdf374882cb4020bbd5627", Notification.SpeechBubbleDirection.TopRight, enemyActor));
		}
	}
}
