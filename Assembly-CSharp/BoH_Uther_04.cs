...
public class BoH_Uther_04 : BoH_Uther_Dungeon
{
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		{
		case 504:
			yield return PlayLineAlways(enemyActor, Story_04_Darkportal_EmoteResponse);
			break;
		case 502:
			GameState.Get().SetBusy(busy: true);
			yield return PlayLineAlways(friendlyActor, VO_Story_Hero_Uther_Male_Human_Story_Uther_Mission4ExchangeD_01);
			GameState.Get().SetBusy(busy: true);
			break;
		case 501:
			GameState.Get().SetBusy(busy: true);
			yield return PlayLineAlways(friendlyActor, VO_Story_Hero_Uther_Male_Human_Story_Uther_Mission4Victory_01);
