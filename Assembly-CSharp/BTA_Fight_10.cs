...
public class BTA_Fight_10 : BTA_Dungeon
{
	...
	public override IEnumerator DoActionsBeforeDealingBaseMulliganCards()
	{
		...
		yield return PlayLineAlways(friendlyActor, VO_BTA_BOSS_10h2_Male_Sporelok_Start_01);
	...
	protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
	{
		...
		{
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_BTA_BOSS_10h_Male_Orc_Mission_Fight_10_Emote_Response_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
		}
	}
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		case 501:
			GameState.Get().SetBusy(busy: true);
			yield return PlayLineAlways(enemyActor, VO_BTA_BOSS_10h_Male_Orc_Mission_Fight_10_VictoryA_01);
		...
		case 507:
			...
			break;
		case 508:
			yield return PlayLineOnlyOnce(enemyActor, VO_BTA_BOSS_10h_Male_Orc_Mission_Fight_10_HeroPowerFace_04);
			break;
		default:
	...
	protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
		{
			...
			{
			case "BT_036":
				yield return PlayLineAlways(enemyActor, VO_BTA_BOSS_10h_Male_Orc_Mission_Fight_10_Hero_ChaosStrike_01);
				break;
			case "BTA_BOSS_10t":
				yield return PlayLineAlways(enemyActor, VO_BTA_BOSS_10h_Male_Orc_Mission_Fight_10_Hero_FungalFortunes_01);
				break;
			case "BT_491":
				yield return PlayLineAlways(enemyActor, VO_BTA_BOSS_10h_Male_Orc_Mission_Fight_10_Hero_FuriousFelfin_01);
				break;
			}
		}
	}
	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
		{
			...
			{
			case "BT_252":
				yield return PlayLineAlways(enemyActor, VO_BTA_BOSS_10h_Male_Orc_Mission_Fight_10_Boss_Renew_01);
				break;
			case "BT_493":
				yield return PlayLineAlways(enemyActor, VO_BTA_BOSS_10h_Male_Orc_Mission_Fight_10_Boss_PriestessofFury_01);
				break;
			case "BT_921":
				yield return PlayLineAlways(enemyActor, VO_BTA_BOSS_10h_Male_Orc_Mission_Fight_10_Boss_AldrachiWarblades_01);
				break;
			}
		}
	}
	...
	protected override IEnumerator HandleStartOfTurnWithTiming(int turn)
	{
		...
		{
		case 5:
			yield return PlayLineAlways(friendlyActor, VO_BTA_BOSS_10h2_Male_Sporelok_Mission_Fight_10_Bonding_02A_01);
