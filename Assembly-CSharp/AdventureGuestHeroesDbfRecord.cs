...
public class AdventureGuestHeroesDbfRecord : DbfRecord
{
	...
	public int BaseGuestHeroId => m_baseGuestHeroId;

	public GuestHeroDbfRecord BaseGuestHeroRecord => GameDbf.GuestHero.GetRecord(m_baseGuestHeroId);
	...
	public void SetBaseGuestHeroId(int v)
	{
		m_baseGuestHeroId = v;
	}
	...
	public override object GetVar(string name)
	{
		return name switch
		{
			...
			"BASE_GUEST_HERO_ID" => m_baseGuestHeroId, 
	...
	{
		AdventureGuestHeroesDbfAsset dbfAsset = DbfShared.GetAssetBundle().LoadAsset(resourcePath, typeof(AdventureGuestHeroesDbfAsset)) as AdventureGuestHeroesDbfAsset;
		if (dbfAsset == null)
		{
			records = new List<T>();
