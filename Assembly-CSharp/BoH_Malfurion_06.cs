...
public class BoH_Malfurion_06 : BoH_Malfurion_Dungeon
{
	...
	public override IEnumerator DoActionsBeforeDealingBaseMulliganCards()
	{
		...
		yield return MissionPlayVO(enemyActor, VO_Story_Hero_Xavius_Male_Satyr_Story_Malfurion_Mission6Intro_01);
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		case 507:
			GameState.Get().SetBusy(busy: true);
			yield return PlayLineAlways(enemyActor, VO_Story_Hero_Xavius_Male_Satyr_Story_Malfurion_Mission6Loss_01);
			GameState.Get().SetBusy(busy: false);
			break;
		case 504:
			GameState.Get().SetBusy(busy: true);
		...
		case 102:
			GameState.Get().SetBusy(busy: true);
			yield return PlayLineAlways(enemyActor, VO_Story_Hero_Xavius_Male_Satyr_Story_Malfurion_Mission6_Victory_01);
			GameState.Get().SetBusy(busy: false);
			break;
		case 101:
