...
public class ULDA_Dungeon_Boss_35h : ULDA_Dungeon
{
	...
	protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
	{
		...
		{
			if (playerHeroCardID != "ULDA_Reno" && playerHeroCardID != "ULDA_Elise")
			{
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		if (missionEvent == 101)
		{
			yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_35h_Male_BoneWraith_Misc_01);
		}
		else
		{
	...
	protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
		{
			...
			{
			case "NEW1_010":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_35h_Male_BoneWraith_PlayerAlAkir_01);
				break;
			case "LOE_020":
			case "ULD_182":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_35h_Male_BoneWraith_PlayerCamel_01);
				break;
			case "ICC_201":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_35h_Male_BoneWraith_PlayerRolltheBones_01);
				break;
			}
		}
	}
	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
		{
			...
			{
			case "ULD_275":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_35h_Male_BoneWraith_BossBoneWraith_01);
				break;
			case "ULD_181":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_35h_Male_BoneWraith_BossEarthquake_01);
				break;
			case "BRM_011":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_35h_Male_BoneWraith_BossLavaShock_01);
				break;
			}
		}
	}
