...
public class LOOT_Dungeon_BOSS_12h : LOOT_Dungeon
{
	...
	protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
	{
		...
		{
			string randomLine = m_IntroLines[Random.Range(0, m_IntroLines.Count)];
		...
		{
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_LOOTA_BOSS_12h_Male_Kobold_EmoteResponse_01.prefab:8114296dd0a4eb742837f7147c34e37a", Notification.SpeechBubbleDirection.TopRight, enemyActor));
		}
	}
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		if (!m_playedLines.Contains(missionEventName))
		{
			...
			case 101:
			{
				string randomLine = m_DeathLines[Random.Range(0, m_DeathLines.Count)];
	...
	protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()))
		{
			...
			if (cardID == "UNG_807")
			{
				yield return PlayEasterEggLine(enemyActor, "VO_LOOTA_BOSS_12h_Male_Kobold_EventPlayerPlaysCrab_01.prefab:1e4208a2ac0cc584292fe3375d0145c7");
			}
		}
	}
}
