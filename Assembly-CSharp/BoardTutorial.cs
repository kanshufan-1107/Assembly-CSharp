...
public class BoardTutorial : MonoBehaviour
{
	...
	{
		s_instance = this;
		RenderUtils.EnableRenderers(m_Highlight, enable: false);
		RenderUtils.EnableRenderers(m_EnemyHighlight, enable: false);
	...
	private void UpdateHighlight()
	{
		...
		{
			RenderUtils.EnableRenderers(m_Highlight, m_highlightEnabled);
	...
	private void UpdateEnemyHighlight()
	{
		...
		{
			RenderUtils.EnableRenderers(m_EnemyHighlight, m_enemyHighlightEnabled);
