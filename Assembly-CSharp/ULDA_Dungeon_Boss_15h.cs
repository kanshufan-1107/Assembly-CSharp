...
public class ULDA_Dungeon_Boss_15h : ULDA_Dungeon
{
	...
	{
		base.PreloadAssets();
		List<string> soundFiles = new List<string> { VO_ULDA_BOSS_15h_LtHerring_Death, VO_ULDA_BOSS_15h_LtHerring_Defeat, VO_ULDA_BOSS_15h_LtHerring_EmoteResponse, VO_ULDA_BOSS_15h_LtHerring_Intro };
