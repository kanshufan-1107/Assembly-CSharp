...
public class ULDA_Dungeon_Boss_50h : ULDA_Dungeon
{
	...
	protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
	{
		...
		if (emoteType == EmoteType.START)
		{
			...
			{
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_ULDA_BOSS_50h_Male_Gnoll_IntroBrann_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
			}
			else if (playerHeroCardID == "ULDA_Finley")
			{
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_ULDA_BOSS_50h_Male_Gnoll_IntroFinley_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
			}
			else
			{
	...
	protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
		{
			...
			{
			case "ULDA_401":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_50h_Male_Gnoll_PlayerBlunderbussTreasure_01);
				break;
			case "ULD_713":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_50h_Male_Gnoll_PlayerSwarmofLocusts_01);
				break;
			case "TRL_405":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_50h_Male_Gnoll_PlayerUntamedBeastmaster_01);
				break;
			}
		}
	}
	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
		{
			...
			{
			case "ULD_154":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_50h_Male_Gnoll_BossHyenaAlpha_01);
				break;
			case "ULD_184":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_50h_Male_Gnoll_BossKoboldSandtrooper_01);
				break;
			case "DAL_371":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_50h_Male_Gnoll_BossMarkedShot_01);
				break;
			}
		}
	}
