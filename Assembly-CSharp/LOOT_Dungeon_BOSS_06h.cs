...
public class LOOT_Dungeon_BOSS_06h : LOOT_Dungeon
{
	...
	protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
	{
		...
		{
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_LOOTA_BOSS_06h_Male_Furbolg_Intro_01.prefab:80aabdb2e58804e4b820fe25fd706f58", Notification.SpeechBubbleDirection.TopRight, enemyActor));
		}
		else if (MissionEntity.STANDARD_EMOTE_RESPONSE_TRIGGERS.Contains(emoteType))
		{
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_LOOTA_BOSS_06h_Male_Furbolg_EmoteResponse_01.prefab:8c00812afbfab854b9cc0fa40ad7a250", Notification.SpeechBubbleDirection.TopRight, enemyActor));
		}
	}
	...
	protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
	{
		...
		if (!(cardID == "OG_027"))
		{
			if (cardID == "ICC_481")
			{
				yield return PlayEasterEggLine(enemyActor, "VO_LOOTA_BOSS_06h_Male_Furbolg_EventPlayerEvolves_01.prefab:990e6ac0bad905549bead65facc02ab8");
			}
		}
		else
		{
