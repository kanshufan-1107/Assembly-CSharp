...
public class GIL_Dungeon_Boss_49h : GIL_Dungeon
{
	...
	protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
	{
		...
		{
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_GILA_BOSS_49h_Female_Undead_Intro_02.prefab:2f0acde3738fe4446865336c303d12a8", Notification.SpeechBubbleDirection.TopRight, enemyActor));
		}
		else if (MissionEntity.STANDARD_EMOTE_RESPONSE_TRIGGERS.Contains(emoteType))
		{
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_GILA_BOSS_49h_Female_Undead_EmoteResponse_01.prefab:bc5c2c4ceee01194fa3a2008208b7bd4", Notification.SpeechBubbleDirection.TopRight, enemyActor));
		}
	}
	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		if (!(cardID == "GILA_BOSS_49t"))
		{
			...
			{
				string randomLine = PopRandomLineWithChance(m_RandomPlayPactLines);
				if (randomLine != null)
				{
		...
		{
			string randomLine = PopRandomLineWithChance(m_RandomPlayFaithfulLines);
			if (randomLine != null)
			{
				yield return PlayLineOnlyOnce(enemyActor, randomLine);
			}
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		{
			string randomLine = PopRandomLineWithChance(m_RandomPlayFaithfulDeathLines);
			if (randomLine != null)
			{
				yield return PlayLineOnlyOnce(enemyActor, randomLine);
			}
	...
	protected override IEnumerator HandleStartOfTurnWithTiming(int turn)
	{
		...
		if (turn == 2)
		{
			...
			yield return PlayLineOnlyOnce(playerActor, "VO_GILA_400h_Male_Human_EVENT_NEMESIS_TURN2_01.prefab:aa59fb8f1a646c042b1b22355393a9a3");
