...
public class BoH_Uther_02 : BoH_Uther_Dungeon
{
	...
	public override IEnumerator DoActionsBeforeDealingBaseMulliganCards()
	{
		...
		yield return PlayLineAlways(friendlyActor, VO_Story_Hero_Uther_Male_Human_Story_Uther_Mission2Intro_01);
	...
	protected override IEnumerator HandleStartOfTurnWithTiming(int turn)
	{
		...
		case 3:
			...
			break;
		case 9:
			yield return PlayLineAlways(enemyActor, VO_Story_Hero_Orgrim_Male_Orc_Story_Uther_Mission2ExchangeC_01);
