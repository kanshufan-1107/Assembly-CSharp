	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		if (!(cardId == "NAX5_02"))
		{
			if (cardId == "NAX5_03" && !m_cardLinePlayed)
			{
				...
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_NAX5_01_CARD_03.prefab:877904b2ca125a24983e76dfb44929fb", Notification.SpeechBubbleDirection.TopRight, enemyActor));
			}
		}
		else if (!m_heroPowerLinePlayed)
		{
			m_heroPowerLinePlayed = true;
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_NAX5_01_HP_02.prefab:3f0aa9156dbf8c04198a38aea754c0bf", Notification.SpeechBubbleDirection.TopRight, enemyActor));
		}
	}
}
