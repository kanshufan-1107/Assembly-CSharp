...
public class SetFilterItem : PegUIElement
{
	...
	public bool EditModeOnly
	{
		get
		{
			return m_editModeOnly;
		}
		set
		{
			m_editModeOnly = value;
		}
	}
	...
	protected override void OnOver(InteractionState oldState)
	{
		...
		{
			m_tooltipZone.ShowCollectionManagerTooltip(m_tooltipHeadline, m_tooltipDescription);
		}
	}
	...
	protected override void OnRelease()
	{
		...
		else if (!m_isSelected && UniversalInputManager.Get().IsTouchMode())
		{
			SoundManager.Get().LoadAndPlay("tiny_button_press_1.prefab:44fc68b7418870b4797b85f0ca88a8db");
		}
	}
