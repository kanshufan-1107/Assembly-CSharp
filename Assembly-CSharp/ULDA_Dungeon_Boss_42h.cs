...
public class ULDA_Dungeon_Boss_42h : ULDA_Dungeon
{
	...
	protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
		{
			...
			{
			case "TRL_304":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_42h_Male_SandTroll_PlayerFarakkiBattleAxe_01);
				break;
			case "GIL_581":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_42h_Male_SandTroll_PlayerSandbinder_01);
				break;
			case "TRL_131":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_42h_Male_SandTroll_PlayerSandDrudge_01);
				break;
			}
		}
	}
	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
		{
			...
			{
			case "LOOT_060":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_42h_Male_SandTroll_BossCrushingHand_01);
				break;
			case "EX1_243":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_42h_Male_SandTroll_BossDustDevil_01);
				break;
			case "ULD_158":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_42h_Male_SandTroll_BossSandstormElemental_01);
				break;
			}
		}
	}
