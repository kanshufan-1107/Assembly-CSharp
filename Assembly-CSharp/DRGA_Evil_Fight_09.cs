...
public class DRGA_Evil_Fight_09 : DRGA_Dungeon
{
	...
	protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
	{
		...
		{
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_DRGA_BOSS_32h_Male_Dragon_Evil_Fight_09_BossStart_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
		}
		else if (MissionEntity.STANDARD_EMOTE_RESPONSE_TRIGGERS.Contains(emoteType))
		{
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_DRGA_BOSS_32h_Male_Dragon_Evil_Fight_09_EmoteResponse_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
		}
	}
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		case 116:
			...
			break;
		case 120:
			yield return PlayAndRemoveRandomLineOnlyOnce(enemyActor, m_missionEventTrigger120Lines);
			break;
		case 121:
			if (!m_Heroic)
			{
	...
	{
		GameObject turnCounterGo = AssetLoader.Get().InstantiatePrefab("DRG_Airship_Turn_Timer.prefab:d29fadcd008628c408fe1d26485ea2b9");
	...
	private void UpdateTurnCounterText(int cost)
	{
		...
		string counterName = GameStrings.FormatPlurals("MISSION_AIRSHIPCOUNTERNAME", pluralNumbers);
