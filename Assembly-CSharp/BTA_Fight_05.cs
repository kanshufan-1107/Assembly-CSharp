...
public class BTA_Fight_05 : BTA_Dungeon
{
	...
	public override IEnumerator DoActionsBeforeDealingBaseMulliganCards()
	{
		...
		yield return PlayLineAlways(friendlyActor, VO_BTA_01_Female_NightElf_Mission_Fight_05_PlayerStart_01);
	...
	protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
	{
		...
		{
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_BTA_BOSS_05h_Male_Human_Mission_Fight_05_Emote_Response_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
		}
	}
	...
	protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
	{
		...
		{
			yield return PlayRandomLineAlways(enemyActor, m_VO_BTA_BOSS_05h_Male_Human_Mission_Fight_05_BrokenAppear_Lines);
		}
	}
	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
		{
			...
			{
			case "BTA_11":
				yield return PlayLineAlways(enemyActor, VO_BTA_BOSS_05h_Male_Human_Mission_Fight_05_Boss_RustswornChampion_01);
				break;
			case "CS2_062":
				yield return PlayLineAlways(enemyActor, VO_BTA_BOSS_05h_Male_Human_Mission_Fight_05_Boss_Hellfire_01);
				break;
			case "EX1_302":
				yield return PlayLineAlways(enemyActor, VO_BTA_BOSS_05h_Male_Human_Mission_Fight_05_Boss_MortalCoilKill_01);
				break;
			}
		}
	}
	...
	protected override IEnumerator HandleStartOfTurnWithTiming(int turn)
	{
		...
		if (turn == 1)
		{
			yield return PlayLineAlways(enemyActor, VO_BTA_BOSS_05h_Male_Human_Mission_Fight_05_TurnOne_01);
		}
	}
}
