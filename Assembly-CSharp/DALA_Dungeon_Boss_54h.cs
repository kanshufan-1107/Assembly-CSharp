...
public class DALA_Dungeon_Boss_54h : DALA_Dungeon
{
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		{
		case 101:
			yield return PlayLineOnlyOnce(enemyActor, VO_DALA_BOSS_54h_Male_Goblin_Exposition_01);
			break;
		case 102:
			yield return PlayLineOnlyOnce(enemyActor, VO_DALA_BOSS_54h_Male_Goblin_PlayerBigSpell_01);
			break;
		case 103:
			yield return PlayAndRemoveRandomLineOnlyOnce(enemyActor, m_PlayerUnlockMana);
			break;
		case 104:
			yield return PlayAndRemoveRandomLineOnlyOnce(enemyActor, m_PlayerHeroPowerTriggers);
			break;
		case 105:
			yield return PlayAndRemoveRandomLineOnlyOnce(enemyActor, m_BossHeroPowerTriggers);
			break;
		case 106:
			yield return PlayAndRemoveRandomLineOnlyOnce(enemyActor, m_BossOverloadPass);
			break;
		case 107:
			yield return PlayLineOnlyOnce(enemyActor, VO_DALA_BOSS_54h_Male_Goblin_BossBigSpell_01);
			break;
		default:
	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
		{
			...
			if (cardID == "BRM_011")
			{
				yield return PlayAndRemoveRandomLineOnlyOnce(enemyActor, m_BossLavaShock);
			}
		}
	}
}
