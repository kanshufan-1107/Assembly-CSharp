...
public class QuestDialogOnProgress2DbfRecord : DbfRecord
{
	...
	{
		QuestDialogOnProgress2DbfAsset dbfAsset = DbfShared.GetAssetBundle().LoadAsset(resourcePath, typeof(QuestDialogOnProgress2DbfAsset)) as QuestDialogOnProgress2DbfAsset;
		if (dbfAsset == null)
		{
			records = new List<T>();
