...
public class BRM03_Thaurissan : BRM_MissionEntity
{
	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		if (!(cardId == "BRMA03_2"))
		{
			if (cardId == "BRMA_01" && !m_cardLinePlayed)
			{
				...
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_BRMA03_1_CARD_04.prefab:2ebdf13895d3b4e4e8979764b99e89e0", Notification.SpeechBubbleDirection.TopRight, enemyActor));
			}
		}
		else if (!m_heroPowerLinePlayed)
		{
			m_heroPowerLinePlayed = true;
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_BRMA03_1_HERO_POWER_06.prefab:2ad44580bf0939c4292a8a454a6fb859", Notification.SpeechBubbleDirection.TopRight, enemyActor));
		}
	}
	...
	protected override IEnumerator HandleStartOfTurnWithTiming(int turn)
	{
		...
		if (turn == 1)
		{
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_BRMA03_1_TURN1_02.prefab:f452794f36ba643449268981c5d6a6fc", Notification.SpeechBubbleDirection.TopRight, enemyActor));
		}
		yield break;
	}
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		case 1:
			...
			yield return Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_BRMA03_1_MOIRA_DEATH_05.prefab:917ad0f8ed4c2674aad35244c2284fc8", Notification.SpeechBubbleDirection.TopRight, enemyActor));
			GameState.Get().SetBusy(busy: false);
			break;
		case 2:
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_BRMA03_1_VS_RAG_07.prefab:bb0cc8e74eb40f44e99eacd240257b37", Notification.SpeechBubbleDirection.TopRight, enemyActor));
			break;
		}
	}
