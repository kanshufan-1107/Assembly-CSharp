...
public class GIL_Dungeon_Boss_39h : GIL_Dungeon
{
	...
	protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
	{
		...
		{
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_GILA_BOSS_41h_Female_HumanGhost_Intro_01.prefab:2d9a2c1744722b04487c9983f830b25f", Notification.SpeechBubbleDirection.TopRight, enemyActor));
		}
		else if (MissionEntity.STANDARD_EMOTE_RESPONSE_TRIGGERS.Contains(emoteType))
		{
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_GILA_BOSS_41h_Female_HumanGhost_EmoteResponse_01.prefab:2f02f1ad1940efc4498a56fdf9425bc1", Notification.SpeechBubbleDirection.TopRight, enemyActor));
		}
	}
	...
	protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
	{
		...
		{
		case "LOOT_415":
			yield return PlayBossLine(enemyActor, "VO_GILA_BOSS_41h_Female_HumanGhost_EventPlayRin_01.prefab:ad7bd3274cab68846ae61271015ebc01");
			break;
		case "CFM_602b":
		case "GIL_828":
		case "UNG_851":
		...
		case "BRM_007":
		{
			string randomLine = PopRandomLineWithChance(m_RandomShuffleLines);
			if (randomLine != null)
			{
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		case 101:
		{
			string randomLine = PopRandomLineWithChance(m_RandomDrawLines);
			if (randomLine != null)
			{
				yield return PlayBossLine(enemyActor, randomLine);
			}
		...
		case 102:
		{
			string randomLine = PopRandomLineWithChance(m_RandomFatigueLines);
			if (randomLine != null)
			{
				yield return PlayBossLine(enemyActor, randomLine);
			}
		...
		case 103:
			yield return PlayBossLine(enemyActor, "VO_GILA_BOSS_41h_Female_HumanGhost_EventFatigueDeath_01.prefab:0551a75f20704894ba0340fafe3eefc2");
			break;
		}
	}
}
