...
public class TRL_Dungeon_Boss_202h : TRL_Dungeon
{
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		{
		case 1001:
			yield return PlayLineOnlyOnce(enemyActor, VO_TRLA_202h_Female_Troll_Shrine_Return_02);
			break;
		case 1002:
			yield return PlayLineOnlyOnce(enemyActor, VO_TRLA_202h_Female_Troll_Shrine_Return_03);
			break;
		case 1003:
			yield return PlayLineOnlyOnce(enemyActor, VO_TRLA_202h_Female_Troll_Shrine_Return_04);
			break;
		case 1004:
			yield return PlayAndRemoveRandomLineOnlyOnce(enemyActor, m_StealthShrineDeathLines);
			break;
		case 1005:
			if (Random.Range(0f, 1f) < chanceToPlayVO)
			{
				yield return PlayAndRemoveRandomLineOnlyOnce(enemyActor, m_StealLines);
			}
			break;
		case 1006:
			if (Random.Range(0f, 1f) < chanceToPlayVO)
	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		{
		case "TRL_092":
			yield return PlayLineOnlyOnce(enemyActor, VO_TRLA_202h_Female_Troll_Play_Spirit_01);
			yield break;
		case "TRL_409":
			yield return PlayLineOnlyOnce(enemyActor, VO_TRLA_202h_Female_Troll_Play_Gral_02);
			yield break;
		case "TRL_157":
			yield return PlayLineOnlyOnce(enemyActor, VO_TRLA_202h_Female_Troll_Play_WalkThePlank_01);
			yield break;
		case "TRL_124":
			yield return PlayLineOnlyOnce(enemyActor, VO_TRLA_202h_Female_Troll_Play_RaidingParty_01);
			yield break;
		case "GVG_025":
			yield return PlayLineOnlyOnce(enemyActor, VO_TRLA_202h_Female_Troll_Play_OneEyedCheat_01);
			yield break;
		case "AT_032":
			yield return PlayLineOnlyOnce(enemyActor, VO_TRLA_202h_Female_Troll_Play_ShadyDealer_01);
			yield break;
		case "CFM_637":
			yield return PlayLineOnlyOnce(enemyActor, VO_TRLA_202h_Female_Troll_Play_Patches_01);
			yield break;
		}
		if (entity.HasRace(TAG_RACE.PIRATE) && Random.Range(0f, 1f) < 0.5f)
		{
			yield return PlayAndRemoveRandomLineOnlyOnce(enemyActor, m_PirateLines);
		}
	}
}
