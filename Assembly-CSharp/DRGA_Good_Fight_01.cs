...
public class DRGA_Good_Fight_01 : DRGA_Dungeon
{
	...
	protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
	{
		...
		if (emoteType == EmoteType.START)
		{
			if (!m_Heroic)
			{
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_DRGA_BOSS_05h_Male_Goblin_Good_Fight_01_BossStart_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
			}
			else if (m_Heroic)
			{
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_DRGA_BOSS_05h_Male_Goblin_Good_Fight_01_BossStartHeroic_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
			}
		}
		else if (MissionEntity.STANDARD_EMOTE_RESPONSE_TRIGGERS.Contains(emoteType))
		{
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_DRGA_BOSS_05h_Male_Goblin_Good_Fight_01_EmoteResponse_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
		}
	}
	...
	protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
	{
		...
		case "GVG_110":
			if (m_Heroic)
			{
				yield return PlayLineOnlyOnce(enemyActor, VO_DRGA_BOSS_05h_Male_Goblin_Good_Fight_01_Player_DrBoom_01);
			}
			break;
		case "BOT_238":
			if (m_Heroic)
			{
				yield return PlayLineOnlyOnce(enemyActor, VO_DRGA_BOSS_05h_Male_Goblin_Good_Fight_01_Player_DrBoomHero_01);
			}
			break;
		case "DAL_008":
			if (m_Heroic)
			{
				yield return PlayLineOnlyOnce(enemyActor, VO_DRGA_BOSS_05h_Male_Goblin_Good_Fight_01_Player_DrBoomsScheme_01);
			}
			break;
		case "DRGA_BOSS_05t":
		case "DRGA_BOSS_05t3":
		case "DRGA_BOSS_05t4":
		case "DRGA_BOSS_05t5":
			yield return PlayAndRemoveRandomLineOnlyOnce(enemyActor, m_VO_DRGA_BOSS_05h_Male_Goblin_Good_Fight_01_Player_InventionLines);
			break;
		}
	}
	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
		{
			...
			{
			case "DRGA_BOSS_05t2":
				yield return PlayAndRemoveRandomLineOnlyOnce(enemyActor, m_VO_DRGA_BOSS_05h_Male_Goblin_Good_Fight_01_DrBoom_BoomBarrageLines);
				break;
			case "DRGA_BOSS_05t4":
				yield return PlayLineOnlyOnce(enemyActor, VO_DRGA_BOSS_05h_Male_Goblin_Good_Fight_01_DrBoom_FUSE_01);
				break;
			case "DRGA_BOSS_05t3":
				yield return PlayLineOnlyOnce(enemyActor, VO_DRGA_BOSS_05h_Male_Goblin_Good_Fight_01_DrBoom_Lighterbot_01);
				break;
			case "DRGA_BOSS_05t":
				yield return PlayLineOnlyOnce(enemyActor, VO_DRGA_BOSS_05h_Male_Goblin_Good_Fight_01_DrBoom_PilotedWhirlOTron_01);
				break;
			case "DRGA_BOSS_05t5":
				yield return PlayLineOnlyOnce(enemyActor, VO_DRGA_BOSS_05h_Male_Goblin_Good_Fight_01_DrBoom_Recyclebot_01);
				break;
			}
		}
	}
