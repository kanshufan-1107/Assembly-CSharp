...
public class TRL_Dungeon_Boss_207h : TRL_Dungeon
{
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		{
		case 1001:
			yield return PlayLineOnlyOnce(enemyActor, VO_TRLA_207h_Male_Troll_Shrine_EVENT_01);
			break;
		case 1002:
			yield return PlayLineOnlyOnce(enemyActor, VO_TRLA_207h_Male_Troll_Shrine_EVENT_02);
			break;
		case 1003:
			yield return PlayLineOnlyOnce(enemyActor, VO_TRLA_207h_Male_Troll_Shrine_EVENT_03);
			break;
		case 1004:
	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()))
		{
			...
			{
			case "TRL_315":
				yield return PlayLineOnlyOnce(enemyActor, VO_TRLA_207h_Male_Troll_Play_Pyromaniac_01);
				break;
			case "UNG_084":
				yield return PlayLineOnlyOnce(enemyActor, VO_TRLA_207h_Male_Troll_Play_FirePlume_01);
				break;
			case "EX1_559":
				yield return PlayLineOnlyOnce(enemyActor, VO_TRLA_207h_Male_Troll_Play_Antonidas_01);
				break;
			case "CS2_118":
				yield return PlayLineOnlyOnce(enemyActor, VO_TRLA_207h_Male_Troll_Play_Magma_Rager_01);
				break;
			case "TRLA_135":
				yield return PlayLineOnlyOnce(enemyActor, VO_TRLA_207h_Male_Troll_Play_Fan_of_Flames_01);
				break;
			case "TRL_316":
				yield return PlayLineOnlyOnce(enemyActor, VO_TRLA_207h_Male_Troll_Play_Janalai_01);
				break;
			case "EX1_279":
				yield return PlayLineOnlyOnce(enemyActor, VO_TRLA_207h_Male_Troll_Play_Pyroblast_01);
				break;
			case "CS2_029":
				yield return PlayLineOnlyOnce(enemyActor, VO_TRLA_207h_Male_Troll_Play_Fireball_01);
				break;
			case "TRL_317":
				yield return PlayLineOnlyOnce(enemyActor, VO_TRLA_207h_Male_Troll_Play_Blast_Wave_01);
				break;
			case "CS2_032":
				yield return PlayLineOnlyOnce(enemyActor, VO_TRLA_207h_Male_Troll_Play_Flamestrike_01);
				break;
			case "TRLA_133":
				yield return PlayLineOnlyOnce(enemyActor, VO_TRLA_207h_Male_Troll_Kill_Opponent_01);
				break;
			case "TRLA_129s":
				yield return PlayLineOnlyOnce(enemyActor, VO_TRLA_207h_Male_Troll_Trigger_Frostfire_01);
				break;
			case "UNG_955":
				yield return PlayLineOnlyOnce(enemyActor, VO_TRLA_207h_Male_Troll_Trigger_Meteor_01);
				break;
			case "GIL_147":
				yield return PlayLineOnlyOnce(enemyActor, VO_TRLA_207h_Male_Troll_Trigger_Cinderstorm_01);
				break;
			}
		}
	}
