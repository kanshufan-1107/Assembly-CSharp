...
public class ULDA_Dungeon_Boss_05h : ULDA_Dungeon
{
	...
	{
		base.PreloadAssets();
		List<string> soundFiles = new List<string> { VO_ULDA_BOSS_05h_GlacktheScorpid_Death_01, VO_ULDA_BOSS_05h_GlacktheScorpid_Defeat_01, VO_ULDA_BOSS_05h_GlacktheScorpid_EmoteResponse_01, VO_ULDA_BOSS_05h_GlacktheScorpid_Intro_01 };
