...
public class DALA_Dungeon_Boss_20h : DALA_Dungeon
{
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		case 101:
			...
			break;
		case 102:
			yield return PlayAndRemoveRandomLineOnlyOnce(enemyActor, m_BossClearOverload);
			break;
		case 103:
			yield return PlayAndRemoveRandomLineOnlyOnce(enemyActor, m_OverloadPass);
			break;
		case 104:
			yield return PlayLineOnlyOnce(enemyActor, VO_DALA_BOSS_20h_Male_Troll_PlayerShamanSpell_01);
			break;
		default:
	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
		{
			...
			{
			case "EX1_241":
				yield return PlayLineOnlyOnce(enemyActor, VO_DALA_BOSS_20h_Male_Troll_BossLavaBurst_01);
				break;
			case "BOT_246":
			case "EX1_238":
			case "EX1_251":
			case "EX1_259":
			case "GIL_600":
				yield return PlayLineOnlyOnce(enemyActor, VO_DALA_BOSS_20h_Male_Troll_BossLightningSpell_01);
				break;
			}
		}
	}
