...
public class ULDA_Dungeon_Boss_75h : ULDA_Dungeon
{
	...
	protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
	{
		...
		if (emoteType == EmoteType.START)
		{
			...
			{
			case "ULDA_Reno":
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_ULDA_BOSS_75h_Male_NefersetTolvir_IntroSpecial_Reno_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
				break;
			case "ULDA_Elise":
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_ULDA_BOSS_75h_Male_NefersetTolvir_IntroSpecial_Elise_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
				break;
			case "ULDA_Brann":
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_ULDA_BOSS_75h_Male_NefersetTolvir_IntroSpecial_Brann_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
				break;
			case "ULDA_Finley":
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_ULDA_BOSS_75h_Male_NefersetTolvir_IntroSpecial_Finley_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
				break;
			}
		}
	...
	protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
	{
		...
		if (!(cardID == "ULD_719"))
		{
			if (cardID == "ULD_292")
			{
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_75h_Male_NefersetTolvir_PlayerTrigger_Oasis_Surger_01);
			}
		}
		else
		{
			yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_75h_Male_NefersetTolvir_PlayerTrigger_Desert_Hare_01);
		}
	}
	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
		{
			...
			{
			case "ULD_430":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_75h_Male_NefersetTolvir_BossTriggerDesertSpear_01);
				break;
			case "EX1_539":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_75h_Male_NefersetTolvir_BossTriggerKillCommand_01);
				break;
			case "ULD_194":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_75h_Male_NefersetTolvir_BossTriggerWastelandScorpid_01);
				break;
			case "ULD_429":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_75h_Male_NefersetTolvir_BossTriggerHuntersPack_01);
				break;
			}
		}
	}
