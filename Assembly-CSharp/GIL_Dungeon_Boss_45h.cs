...
public class GIL_Dungeon_Boss_45h : GIL_Dungeon
{
	...
	protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
	{
		...
		{
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_GILA_BOSS_45h_Female_Human_Intro_01.prefab:5cbaf2dc51852e24dbd17bbbdf87cf8f", Notification.SpeechBubbleDirection.TopRight, enemyActor));
		}
		else if (MissionEntity.STANDARD_EMOTE_RESPONSE_TRIGGERS.Contains(emoteType))
		{
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_GILA_BOSS_45h_Female_Human_EmoteResponse_01.prefab:ec9bd3abc0eb6d243b3fc7a34fa43406", Notification.SpeechBubbleDirection.TopRight, enemyActor));
		}
	}
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		case 101:
			...
			{
				string randomLine = m_PlayerDraw[Random.Range(0, m_PlayerDraw.Count)];
				m_PlayerDraw.Remove(randomLine);
				yield return PlayLineOnlyOnce(enemyActor, randomLine);
			}
			break;
		case 102:
			yield return PlayBossLine(enemyActor, "VO_GILA_BOSS_45h_Female_Human_EventFirstDamage_01.prefab:2aae7467c86b7624085aa0e2bf6beaef");
			break;
		}
	}
	...
	protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()))
		{
			...
			{
			case "EX1_007":
				yield return PlayEasterEggLine(enemyActor, "VO_GILA_BOSS_45h_Female_Human_EventPlaysAcolyte_01.prefab:6cd648f8d77f0c944b9d82978c4ed975");
				break;
			case "EX1_015":
				yield return PlayEasterEggLine(enemyActor, "VO_GILA_BOSS_45h_Female_Human_EventPlaysNovice_01.prefab:c54565566da737d4f8a8aa92cf1648da");
				break;
			case "EX1_096":
				yield return PlayEasterEggLine(enemyActor, "VO_GILA_BOSS_45h_Female_Human_EventPlaysHoarder_01.prefab:2a99af8e9559db74a88b2f53f41ceb2d");
				break;
			case "GILA_850b":
				yield return PlayEasterEggLine(enemyActor, "VO_GILA_BOSS_45h_Female_Human_EventPlayHallowedWater_01.prefab:a0de02488030e9e4fb0caa5deced73d6");
				break;
			}
		}
	}
