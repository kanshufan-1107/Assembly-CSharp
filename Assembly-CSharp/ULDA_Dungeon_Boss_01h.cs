...
public class ULDA_Dungeon_Boss_01h : ULDA_Dungeon
{
	...
	protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
	{
		...
		if (emoteType == EmoteType.START)
		{
			...
			{
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_ULDA_BOSS_01h_Male_Human_IntroFinley_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
			}
			else
			{
	...
	protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
		{
			...
			{
			case "ULDA_401":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_01h_Male_Human_PlayerBlunderbuss_01);
				break;
			case "ULDA_207":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_01h_Male_Human_PlayerGatlingWand_01);
				break;
			case "BOT_031":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_01h_Male_Human_PlayerGoblinBomb_01);
				break;
			}
		}
	}
	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
		{
			...
			case "DAL_739":
			case "DAL_741":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_01h_Male_Human_BossLackey_01);
				break;
			case "DAL_371":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_01h_Male_Human_BossMarkedShot_01);
				break;
			case "ULD_152":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_01h_Male_Human_BossPressurePlate_01);
				break;
			case "DAL_373":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_01h_Male_Human_BossTriggerRapidFire_01);
				break;
			}
		}
	}
