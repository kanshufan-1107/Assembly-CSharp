...
public class DALA_Dungeon_Boss_16h : DALA_Dungeon
{
	...
	protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
	{
		...
		if (emoteType == EmoteType.START)
		{
			...
			{
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_DALA_BOSS_16h_Female_Human_IntroGeorge_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
			}
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		case 101:
			...
			break;
		case 102:
			yield return PlayLineOnlyOnce(enemyActor, VO_DALA_BOSS_16h_Female_Human_HeroPowerSwapBack_01);
			break;
		default:
	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
		{
			...
			{
			case "GIL_118":
				yield return PlayLineOnlyOnce(enemyActor, VO_DALA_BOSS_16h_Female_Human_BossDerrangedDoctor_01);
				break;
			case "TRL_564":
				yield return PlayLineOnlyOnce(enemyActor, VO_DALA_BOSS_16h_Female_Human_BossMojomasterZihi_01);
				break;
			case "DAL_544":
				yield return PlayLineOnlyOnce(enemyActor, VO_DALA_BOSS_16h_Female_Human_BossPotionVendor_01);
				break;
			}
		}
	}
