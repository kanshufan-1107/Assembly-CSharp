...
public class BTA_Fight_13 : BTA_Dungeon
{
	...
	public override IEnumerator DoActionsBeforeDealingBaseMulliganCards()
	{
		...
		yield return PlayLineAlways(friendlyActor, VO_BTA_01_Female_NightElf_Mission_Fight_13_PlayerStart_01);
	...
	protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
	{
		...
		{
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_BTA_BOSS_13h_Male_Ogre_Mission_Fight_13_Emote_Response_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
		}
	}
	...
	protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
	{
		...
		{
		case "BT_495":
			yield return PlayLineAlways(enemyActor, VO_BTA_BOSS_13h_Male_Ogre_Mission_Fight_13_Hero_GlaiveboundAdeptTrigger_01);
			break;
		case "BT_509":
			yield return PlayLineAlways(enemyActor, VO_BTA_BOSS_13h_Male_Ogre_Mission_Fight_13_Hero_FelSummoner_01);
			break;
		case "BT_510":
			yield return PlayLineAlways(enemyActor, VO_BTA_BOSS_13h_Male_Ogre_Mission_Fight_13_Hero_WrathspikeBrute_01);
			break;
		case "BT_514":
			yield return PlayLineAlways(enemyActor, VO_BTA_BOSS_13h_Male_OgreMech_Mission_Fight_13_Hero_ImmolationAura_01, m_OgreMechSpeechBubbleDirection);
			break;
		case "BTA_10":
	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
		{
			...
			{
			case "BTA_14":
				yield return PlayLineAlways(enemyActor, VO_BTA_BOSS_13h_Male_Ogre_Mission_Fight_13_Boss_RustedBasilisk_01);
				break;
			case "BTA_15":
				yield return PlayLineAlways(enemyActor, VO_BTA_BOSS_13h_Male_OgreMech_Mission_Fight_13_Boss_EndlessLegion_01, m_OgreMechSpeechBubbleDirection);
				break;
			case "BTA_16":
				yield return PlayLineAlways(enemyActor, VO_BTA_BOSS_13h_Male_Ogre_Mission_Fight_13_Boss_RustedFungalGiant_01);
				break;
			}
		}
	}
