...
public class DALA_Dungeon_Boss_61h : DALA_Dungeon
{
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		case 101:
			...
			break;
		case 102:
			yield return PlayAndRemoveRandomLineOnlyOnce(enemyActor, m_BossHeroPowerNother);
			break;
		case 103:
			yield return PlayLineOnlyOnce(enemyActor, VO_DALA_BOSS_61h_Female_Aranasi_HeroPowerPhaseSpider_01);
			break;
		case 104:
			yield return PlayLineOnlyOnce(enemyActor, VO_DALA_BOSS_61h_Female_Aranasi_BossPhaseSpiderKill_01);
			break;
		default:
	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		if (!(cardID == "DALA_BOSS_61t"))
		{
			if (cardID == "ICC_054")
			{
				yield return PlayLineOnlyOnce(enemyActor, VO_DALA_BOSS_61h_Female_Aranasi_BossSpreadingPlague_01);
			}
		}
		else
		{
			yield return PlayAndRemoveRandomLineOnlyOnce(enemyActor, m_BossPhaseSpider);
		}
	}
}
