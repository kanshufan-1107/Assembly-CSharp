...
public class RP_Fight_03 : RP_Dungeon
{
	...
	protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
	{
		...
		{
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_TB_ReturningPlayer_Houndmastr2_Male_Demon_TB_ReturningPlayer_Houndmastr2_EmoteResponse_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
		}
	}
