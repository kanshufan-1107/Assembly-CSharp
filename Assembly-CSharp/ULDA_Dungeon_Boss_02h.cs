...
public class ULDA_Dungeon_Boss_02h : ULDA_Dungeon
{
	...
	protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
	{
		...
		if (!(cardID == "ULD_198"))
		{
			if (cardID == "ULD_265")
			{
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_02h_Male_NefersetTolvir_PlayerTrigger_Embalming_Ritual_01);
			}
		}
		else
		{
			yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_02h_Male_NefersetTolvir_PlayerTrigger_Conjured_Mirage_01);
		}
	}
	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
		{
			...
			{
			case "ULD_208":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_02h_Male_NefersetTolvir_BossKhartutDefender_01);
				break;
			case "ULD_723":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_02h_Male_NefersetTolvir_BossTriggerMurmy_01);
				break;
			case "ULD_185":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_02h_Male_NefersetTolvir_BossTriggerTempleBerserker_01);
				break;
			}
		}
	}
