...
public class TB_SPT_DALA : MissionEntity
{
	...
	private IEnumerator PlayBossLineLeft(BOSS boss, string line, bool persistCharacter = false)
	{
		...
		case BOSS.LAZUL:
			...
			break;
		case BOSS.RAFAAM:
			yield return PlayMissionFlavorLine("Rafaam_popup_BrassRing_Quote.prefab:187724fae6d64cf49acf11aa53ca2087", line, LEFT_OF_ENEMY_HERO, bubbleDir, 2.5f, persistCharacter);
			break;
		}
	}
