...
public class BOTA_Clear_Puzzle_3 : BOTA_MissionEntity
{
	...
	protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()))
		{
			...
			{
			case "OG_100":
				yield return PlayEasterEggLine(enemyActor, VO_BOTA_BOSS_08h_Female_Eredar_PlayHorror_01);
				break;
			case "GIL_665":
				yield return PlayEasterEggLine(enemyActor, VO_BOTA_BOSS_08h_Female_Eredar_PlayWeakness_01);
				break;
			case "GVG_077":
				yield return PlayEasterEggLine(enemyActor, VO_BOTA_BOSS_08h_Female_Eredar_PlayAnima_01);
				break;
			}
		}
	}
