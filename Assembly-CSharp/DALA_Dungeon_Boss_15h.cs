...
public class DALA_Dungeon_Boss_15h : DALA_Dungeon
{
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		{
		case 101:
			yield return PlayLineOnlyOnce(enemyActor, VO_DALA_BOSS_15h_Female_NightElf_PlayerHeal_01);
			break;
		case 102:
			yield return PlayLineOnlyOnce(enemyActor, VO_DALA_BOSS_15h_Female_NightElf_PlayerDemon_01);
			break;
		case 103:
	...
	protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
	{
		...
		{
			if (playerHeroCardID != "DALA_George" && playerHeroCardID != "DALA_Kriziki")
			{
