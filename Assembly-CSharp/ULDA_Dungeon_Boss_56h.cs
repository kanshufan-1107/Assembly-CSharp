...
public class ULDA_Dungeon_Boss_56h : ULDA_Dungeon
{
	...
	{
		base.PreloadAssets();
		List<string> soundFiles = new List<string> { VO_ULDA_BOSS_56h_SandPufferFrog_Death, VO_ULDA_BOSS_56h_SandPufferFrog_Defeat, VO_ULDA_BOSS_56h_SandPufferFrog_EmoteResponse, VO_ULDA_BOSS_56h_SandPufferFrog_Intro };
