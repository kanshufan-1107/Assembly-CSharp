...
public class BTA_Fight_11 : BTA_Dungeon
{
	...
	public override IEnumerator DoActionsBeforeDealingBaseMulliganCards()
	{
		...
		yield return PlayLineAlways(friendlyActor, VO_BTA_01_Female_NightElf_Mission_Fight_11_PlayerStart_01);
	...
	protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
	{
		...
		{
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_BTA_BOSS_11h_Female_Arakkoa_Mission_Fight_11_Emote_Response_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
		}
	}
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		{
		case 100:
			yield return PlayLineAlways(enemyActor, VO_BTA_BOSS_11h_Female_Arakkoa_Mission_Fight_11_Boss_AmbushTrigger_01);
			break;
		case 507:
			yield return PlayRandomLineAlways(enemyActor, m_missionEventTrigger105_Lines);
			break;
		case 500:
		...
		case 501:
			GameState.Get().SetBusy(busy: true);
			yield return PlayLineAlways(friendlyActor, VO_BTA_01_Female_NightElf_Mission_Fight_11_VictoryA_01);
	...
	protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
		{
			...
			{
			case "BT_173":
				yield return PlayLineAlways(enemyActor, VO_BTA_BOSS_11h_Female_Arakkoa_Mission_Fight_11_Hero_CommandtheIllidari_01);
				break;
			case "BT_407":
				yield return PlayLineAlways(enemyActor, VO_BTA_BOSS_11h_Female_Arakkoa_Mission_Fight_11_Hero_UrzulHorror_01);
				break;
			case "BTA_06":
				yield return PlayLineAlways(enemyActor, VO_BTA_BOSS_11h_Female_Arakkoa_Mission_Fight_11_Misc_01);
				break;
			}
		}
	}
	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
		{
			...
			{
			case "BT_160":
				yield return PlayLineAlways(enemyActor, VO_BTA_BOSS_11h_Female_Arakkoa_Mission_Fight_11_Boss_RustswornCultist_01);
				break;
			case "BTA_12":
				yield return PlayLineAlways(enemyActor, VO_BTA_BOSS_11h_Female_Arakkoa_Mission_Fight_11_RustedLegionGanarg_01);
				break;
			case "CFM_781":
				yield return PlayLineAlways(enemyActor, VO_BTA_BOSS_11h_Female_Arakkoa_Mission_Fight_11_Boss_Penance_01);
				break;
			}
		}
	}
