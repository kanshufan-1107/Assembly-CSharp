...
public class Portrait : ScriptableObject
{
	...
	[CustomEditField(Sections = "Portrait")]
	public Material m_BattlegroundsHeroBuddyPortraitMaterial;
	...
	public Material m_LoadedBattlegroundsHeroBuddyPortrait { get; set; }
	...
	public void OnDestroy()
	{
		...
		if ((bool)m_LoadedBattlegroundsHeroBuddyPortrait)
		{
			Object.Destroy(m_LoadedBattlegroundsHeroBuddyPortrait);
		}
	...
	public void OnPortraitLoaded(AssetHandle<Texture> portrait, int quality)
	{
		...
		SetTextureIfNotNull(m_BattlegroundsHeroBuddyPortraitMaterial, m_LoadedBattlegroundsHeroBuddyPortrait, m_loadedPortraitTexture);
	}
	...
	{
		return m_portraitQuality.PremiumType == TAG_PREMIUM.GOLDEN;
	}
