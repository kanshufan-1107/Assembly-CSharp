...
public class ULDA_Dungeon_Boss_60h : ULDA_Dungeon
{
	...
	protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
	{
		...
		if (emoteType == EmoteType.START)
		{
			...
			{
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_ULDA_BOSS_60h_Male_Ethereal_IntroResponseReno_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
			}
			else
			{
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		{
		case 101:
			yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_60h_Male_Ethereal_PlayerTriggerCThunDefeatBoss_01);
			break;
		case 102:
			yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_60h_Male_Ethereal_PlayerTriggerFatigue_01);
			break;
		default:
	...
	protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
		{
			...
			{
			case "ULD_143":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_60h_Male_Ethereal_PlayerTrigger_Pharaohs_Blessing_01);
				break;
			case "ULD_290":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_60h_Male_Ethereal_PlayerTrigger_History_Buff_01);
				break;
			case "OG_280":
				yield return PlayAndRemoveRandomLineOnlyOnce(enemyActor, m_PlayerTriggerCThun);
				break;
			case "NEW1_021":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_60h_Male_Ethereal_PlayerTrigger_Doomsayer_01);
				break;
			case "CS2_234":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_60h_Male_Ethereal_PlayerTrigger_ShadowWordPain_01);
				break;
			case "ULD_216":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_60h_Male_Ethereal_PlayerTrigger_Puzzle_Box_of_Yogg_Saron_01);
				break;
			}
		}
	}
	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
		{
			...
			{
			case "OG_280":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_60h_Male_Ethereal_BossTriggerCthun_01);
				break;
			case "OG_141":
			case "DAL_613":
			case "EX1_564":
			...
			case "OG_174":
			case "DAL_744":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_60h_Male_Ethereal_BossTriggerFaceless_01);
				break;
			case "ULD_189":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_60h_Male_Ethereal_BossTriggerLineLieutenant_01);
				break;
			}
		}
	}
