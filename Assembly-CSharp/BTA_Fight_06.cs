...
public class BTA_Fight_06 : BTA_Dungeon
{
	...
	public override IEnumerator DoActionsBeforeDealingBaseMulliganCards()
	{
		...
		yield return PlayLineAlways(friendlyActor, VO_BTA_01_Female_NightElf_Mission_Fight_06_PlayerStart_01);
	...
	protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
	{
		...
		{
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_BTA_BOSS_06h_Male_Orc_Mission_Fight_06_Emote_Response_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
		}
	}
	...
	protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
		{
			...
			{
			case "BT_717":
				yield return PlayLineAlways(enemyActor, VO_BTA_BOSS_06h_Male_Orc_Mission_Fight_06_Hero_BurrowingScorpid_01);
				break;
			case "BT_202":
				yield return PlayLineAlways(enemyActor, VO_BTA_BOSS_06h_Male_Orc_Mission_Fight_06_Hero_Helboar_01);
				break;
			case "BTA_03":
				...
				break;
			case "BTA_05":
				yield return PlayLineAlways(enemyActor, VO_BTA_BOSS_06h_Male_Orc_Mission_Fight_06_Sklibb_Played_01);
				break;
			case "BTA_07":
	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
		{
			...
			{
			case "GVG_083":
				yield return PlayLineAlways(enemyActor, VO_BTA_BOSS_06h_Male_Orc_Mission_Fight_06_Boss_ImprisonedGanarg_01);
				break;
			case "BOT_700":
				yield return PlayLineAlways(enemyActor, VO_BTA_BOSS_06h_Male_Orc_Mission_FighT_06_Boss_ScrapyardColossus_01);
				break;
			case "GVG_118":
				yield return PlayLineAlways(enemyActor, VO_BTA_BOSS_06h_Male_Orc_Mission_Fight_06_Boss_BonechewerBrawler_01);
				break;
			case "CFM_688":
				yield return PlayLineAlways(enemyActor, VO_BTA_BOSS_06h_Male_Orc_Mission_Fight_06_Boss_SpikedHogrider_01);
				break;
			case "DAL_376":
				yield return PlayLineAlways(enemyActor, VO_BTA_BOSS_06h_Male_Orc_Mission_Fight_06_Boss_HeavyMetal_01);
				break;
			}
		}
	}
	...
	protected override IEnumerator HandleStartOfTurnWithTiming(int turn)
	{
		...
		if (turn == 1)
		{
			yield return PlayLineAlways(friendlyActor, VO_BTA_01_Female_NightElf_Mission_Fight_06_TurnOne_01);
		}
	}
	...
	{
		GameObject turnCounterGo = AssetLoader.Get().InstantiatePrefab("BTA_Destroyer_Turn_Timer.prefab:5641f96ff71c06c4e8416952d878e3c7");
	...
	private void UpdateTurnCounterText(int cost)
	{
		...
		string counterName = GameStrings.FormatPlurals("MISSION_SPAREPARTSCOUNTERNAME", pluralNumbers);
