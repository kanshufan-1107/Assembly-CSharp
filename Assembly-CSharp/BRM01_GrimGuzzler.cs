...
public class BRM01_GrimGuzzler : BRM_MissionEntity
{
	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		case "BRMA01_2H":
			if (!m_heroPowerLinePlayed)
			{
				...
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_BRMA01_1_HERO_POWER_04.prefab:ddd556f3fc3107642ba85ffa60e56efd", Notification.SpeechBubbleDirection.TopRight, enemyActor));
			}
			break;
		case "BRMA01_4":
			if (!m_cardLinePlayed)
			{
				...
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_BRMA01_1_CARD_05.prefab:4d60a73b9cc4c3645a387eb198be2d8a", Notification.SpeechBubbleDirection.TopRight, enemyActor));
			}
			break;
		}
	}
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		case 1:
			if (!m_eTCLinePlayed && !m_disableSpecialCardVO)
			{
				...
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_BRMA01_1_ETC_06.prefab:966f2e43e86303b4da0adc2529bd22a3", Notification.SpeechBubbleDirection.TopRight, enemyActor));
		...
		case 2:
			if (!m_succubusLinePlayed && !m_disableSpecialCardVO)
			{
				...
				GameState.Get().SetBusy(busy: true);
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_BRMA01_1_SUCCUBUS_08.prefab:6e04c1f0a2ce98d4187e5ee6499211a9", Notification.SpeechBubbleDirection.TopRight, enemyActor));
				GameState.Get().SetBusy(busy: false);
			}
			break;
		case 3:
			if (!m_warGolemLinePlayed && !m_disableSpecialCardVO)
			{
				...
				GameState.Get().SetBusy(busy: true);
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_BRMA01_1_WARGOLEM_07.prefab:d45ef18ce5906d74e94ecb0e56323d37", Notification.SpeechBubbleDirection.TopRight, enemyActor));
				GameState.Get().SetBusy(busy: false);
			}
			break;
		}
	...
	protected override IEnumerator HandleStartOfTurnWithTiming(int turn)
	{
		...
		{
		case 1:
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_BRMA01_1_TURN1_02.prefab:914cf2bf87da18c458f38f8fcbc98481", Notification.SpeechBubbleDirection.TopRight, enemyActor));
			break;
		case 3:
