...
public class ULDA_Dungeon_Boss_58h : ULDA_Dungeon
{
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		{
		case 101:
			yield return PlayAndRemoveRandomLineOnlyOnce(enemyActor, m_HeroPowerTriggerCorrectLines);
			break;
		case 102:
			yield return PlayAndRemoveRandomLineOnlyOnce(enemyActor, m_HeroPowerTriggerIncorrectLines);
			break;
		case 104:
			yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_58h_Male_Tolvir_PlayerTriggerDiscover_01);
			break;
		case 103:
			yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_58h_Male_Tolvir_PlayerTriggerSecret_01);
			break;
		default:
	...
	protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
		{
			...
			if (cardID == "ULD_155")
			{
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_58h_Male_Tolvir_PlayerTriggerReadingHieroglyphics_01);
			}
		}
	}
	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
		{
			...
			{
			case "ULD_193":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_58h_Male_Tolvir_BossTriggerLivingMonument_01);
				break;
			case "ULD_268":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_58h_Male_Tolvir_BossTriggerPsychopomp_01);
				break;
			case "ULD_216":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_58h_Male_Tolvir_BossTriggerPuzzleboxofYoggSaron_01);
				break;
			}
		}
	}
