...
public class GIL_Dungeon_Boss_58h : GIL_Dungeon
{
	...
	protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
	{
		...
		{
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_GILA_BOSS_58h_Male_Giant_Intro_01.prefab:71e5135d4f6d84245abc1ce40bba77fb", Notification.SpeechBubbleDirection.TopRight, enemyActor));
		}
		else if (MissionEntity.STANDARD_EMOTE_RESPONSE_TRIGGERS.Contains(emoteType))
		{
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_GILA_BOSS_58h_Male_Giant_EmoteResponse_01.prefab:7f1980710cf3f024caacacd2331e0679", Notification.SpeechBubbleDirection.TopRight, enemyActor));
		}
	}
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		case 101:
		{
			string randomLine = PopRandomLineWithChance(m_MinionReturn);
			if (randomLine != null)
			{
		...
		case 102:
			yield return PlayEasterEggLine(enemyActor, "VO_GILA_BOSS_58h_Male_Giant_EventBigWeapon_01.prefab:d57a95e52bab4ae46874b9d08736ba7d");
			break;
		}
	}
}
