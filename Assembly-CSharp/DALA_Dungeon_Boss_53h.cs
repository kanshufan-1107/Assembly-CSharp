...
public class DALA_Dungeon_Boss_53h : DALA_Dungeon
{
	...
	protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
	{
		...
		{
			if (playerHeroCardID != "DALA_George" && playerHeroCardID != "DALA_Barkeye" && playerHeroCardID != "DALA_Rakanishu" && playerHeroCardID != "DALA_Vessina")
			{
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		{
		case 101:
			yield return PlayAndRemoveRandomLineOnlyOnce(enemyActor, m_PlayerMurloc);
			break;
		case 102:
