...
public class BTA_Fight_23 : BTA_Dungeon_Heroic
{
	...
	protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
	{
		...
		if (emoteType == EmoteType.START)
		{
			...
			case "HERO_10a":
			case "HERO_10b":
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_BTA_BOSS_08hx_Female_Demon_Mission_Fight_23_BossStartDemonHunter_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
				break;
			default:
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_BTA_BOSS_08hx_Female_Demon_Mission_Fight_23_BossStart_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
				break;
			}
		}
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		{
		case 110:
			yield return PlayLineInOrderOnce(enemyActor, m_VO_BTA_BOSS_08hx_Female_Demon_Mission_Fight_23_WeaponDestroy);
			break;
		case 500:
	...
	protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
		{
			...
			if (cardID == "BT_117")
			{
				yield return PlayLineOnlyOnce(enemyActor, VO_BTA_BOSS_08hx_Female_Demon_Mission_Fight_23_Hero_Bladestorm_01);
			}
		}
	}
