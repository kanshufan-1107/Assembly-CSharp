...
public class TRL_Dungeon_Boss_203h : TRL_Dungeon
{
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		{
		case 1001:
			yield return PlayLineOnlyOnce(enemyActor, VO_TRLA_203h_Male_Troll_Shrine_Return_01);
			break;
		case 1002:
			yield return PlayLineOnlyOnce(enemyActor, VO_TRLA_203h_Male_Troll_Shrine_Return_02);
			break;
		case 1003:
			yield return PlayLineOnlyOnce(enemyActor, VO_TRLA_203h_Male_Troll_Shrine_Return_03);
			break;
		case 1004:
			yield return PlayAndRemoveRandomLineOnlyOnce(enemyActor, m_ShieldLines);
			break;
		case 1005:
			yield return PlayAndRemoveRandomLineOnlyOnce(enemyActor, m_BuffLines);
			break;
		case 1006:
			yield return PlayAndRemoveRandomLineOnlyOnce(enemyActor, m_DamageLines);
			break;
		default:
	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		{
		case "TRL_309":
			yield return PlayLineOnlyOnce(enemyActor, VO_TRLA_203h_Male_Troll_Play_Spirit_01);
			yield break;
		case "TRL_300":
			yield return PlayLineOnlyOnce(enemyActor, VO_TRLA_203h_Male_Troll_Play_Shirvallah_01);
			yield break;
		case "TRL_307":
			yield return PlayLineOnlyOnce(enemyActor, VO_TRLA_203h_Male_Troll_Play_FlashOfLight_01);
			yield break;
		case "TRL_302":
			yield return PlayAndRemoveRandomLineOnlyOnce(enemyActor, m_TimeOutLines);
			yield break;
		case "TRL_305":
			yield return PlayAndRemoveRandomLineOnlyOnce(enemyActor, m_ChallengerLines);
			yield break;
		}
		if (entity.HasTag(GAME_TAG.RUSH))
		{
			yield return PlayAndRemoveRandomLineOnlyOnce(enemyActor, m_RushLines);
		}
	}
}
