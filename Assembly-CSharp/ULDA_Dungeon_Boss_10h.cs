...
public class ULDA_Dungeon_Boss_10h : ULDA_Dungeon
{
	...
	protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
	{
		...
		if (emoteType == EmoteType.START)
		{
			...
			{
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_ULDA_BOSS_10h_Male_Sethrak_IntroElise_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
			}
			else if (playerHeroCardID == "ULDA_Finley")
			{
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_ULDA_BOSS_10h_Male_Sethrak_IntroFinley_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
			}
			else if (playerHeroCardID != "ULDA_Reno")
			{
	...
	protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
		{
			...
			{
			case "ULD_162":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_10h_Male_Sethrak_PlayerEVILRecruiter_01);
				break;
			case "ULD_154":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_10h_Male_Sethrak_PlayerHyenaAlpha_01);
				break;
			case "ULDA_040":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_10h_Male_Sethrak_PlayerSackofLamps_01);
				break;
			}
		}
	}
	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
		{
			...
			{
			case "BOT_087":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_10h_Male_Sethrak_BossAcademicEspionage_01);
				break;
			case "ULD_328":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_10h_Male_Sethrak_BossCleverDisguise_01);
				break;
			case "EX1_182":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_10h_Male_Sethrak_BossPilfer_01);
				break;
			}
		}
	}
