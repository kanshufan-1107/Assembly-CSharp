...
public class DALA_Dungeon_Boss_57h : DALA_Dungeon
{
	...
	protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
	{
		...
		if (emoteType == EmoteType.START)
		{
			...
			{
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_DALA_BOSS_57h_Male_Goblin_IntroChu_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
			}
			else if (playerHeroCardID == "DALA_Vessina")
			{
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_DALA_BOSS_57h_Male_Goblin_IntroVessina_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
			}
			else if (playerHeroCardID != "DALA_Eudora")
			{
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		{
		case 101:
			yield return PlayLineOnlyOnce(enemyActor, VO_DALA_BOSS_57h_Male_Goblin_Exposition_Story_01);
			break;
		case 102:
			yield return PlayLineOnlyOnce(enemyActor, VO_DALA_BOSS_57h_Male_Goblin_Exposition_Story_02);
			break;
		case 103:
			yield return PlayLineOnlyOnce(enemyActor, VO_DALA_BOSS_57h_Male_Goblin_Exposition_Story_03);
			break;
		case 104:
			yield return PlayAndRemoveRandomLineOnlyOnce(enemyActor, m_TurnStart);
			break;
		case 105:
			yield return PlayLineOnlyOnce(enemyActor, VO_DALA_BOSS_57h_Male_Goblin_PlayerBad_01);
			break;
		case 106:
			yield return PlayLineOnlyOnce(enemyActor, VO_DALA_BOSS_57h_Male_Goblin_PlayerBagOfCoins_01);
			break;
		case 107:
			yield return PlayLineOnlyOnce(enemyActor, VO_DALA_BOSS_57h_Male_Goblin_PlayerCoinFirst_01);
			break;
		case 108:
			yield return PlayAndRemoveRandomLineOnlyOnce(enemyActor, m_BossTreasure);
			break;
		case 109:
			yield return PlayAndRemoveRandomLineOnlyOnce(enemyActor, m_HeroPower);
			break;
		case 110:
			yield return PlayAndRemoveRandomLineOnlyOnce(enemyActor, m_HeroPowerFull);
			break;
		case 111:
			yield return PlayLineOnlyOnce(enemyActor, VO_DALA_BOSS_57h_Male_Goblin_PlayerCoinIntoNothing_01);
			break;
		case 112:
			yield return PlayAndRemoveRandomLineOnlyOnce(enemyActor, m_BossHeroPowerPlayerTreasure);
			break;
		default:
