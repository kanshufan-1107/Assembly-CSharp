...
public class DALA_Dungeon_Boss_45h : DALA_Dungeon
{
	...
	protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
	{
		...
		if (emoteType == EmoteType.START)
		{
			...
			{
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_DALA_BOSS_45h_Male_Observer_IntroSqueamlish_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
			}
			else if (playerHeroCardID != "DALA_Tekahn")
			{
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		{
		case 101:
			yield return PlayAndRemoveRandomLineOnlyOnce(enemyActor, m_HeroPowerHuge);
			break;
		case 102:
			yield return PlayAndRemoveRandomLineOnlyOnce(enemyActor, m_HeroPowerLarge);
			break;
		case 103:
			yield return PlayAndRemoveRandomLineOnlyOnce(enemyActor, m_HeroPowerMedium);
			break;
		case 104:
			yield return PlayAndRemoveRandomLineOnlyOnce(enemyActor, m_HeroPowerSmall);
			break;
		case 105:
			yield return PlayLineOnlyOnce(enemyActor, VO_DALA_BOSS_45h_Male_Observer_BossBigMinion_01);
			break;
		case 106:
			yield return PlayLineOnlyOnce(enemyActor, VO_DALA_BOSS_45h_Male_Observer_PlayerEyeforanEyeTrigger_01);
			break;
		case 107:
			yield return PlayLineOnlyOnce(enemyActor, VO_DALA_BOSS_45h_Male_Observer_PlayerPatches_02);
			break;
		default:
	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
		{
			...
			{
			case "TRL_555":
				yield return PlayLineOnlyOnce(enemyActor, VO_DALA_BOSS_45h_Male_Observer_BossDemonBolt_01);
				break;
			case "CS2_062":
			case "EX1_312":
			case "OG_239":
				yield return PlayLineOnlyOnce(enemyActor, VO_DALA_BOSS_45h_Male_Observer_BossDamageSpell_01);
				break;
			}
		}
	}
