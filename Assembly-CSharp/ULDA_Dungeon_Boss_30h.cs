...
public class ULDA_Dungeon_Boss_30h : ULDA_Dungeon
{
	...
	protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
	{
		...
		if (!(cardID == "ULD_186"))
		{
			if (cardID == "CS2_029")
			{
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_30h_Female_NefersetTolvir_PlayerTrigger_Fireball_01);
			}
		}
		else
		{
			yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_30h_Female_NefersetTolvir_PlayerTrigger_Pharaoh_Cat_01);
		}
	}
	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
		{
			...
			{
			case "UNG_809":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_30h_Female_NefersetTolvir_BossTriggerFirefly_01);
				break;
			case "CS2_032":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_30h_Female_NefersetTolvir_BossTriggerFlamestrike_01);
				break;
			case "BRM_002":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_30h_Female_NefersetTolvir_BossTriggerFlamewaker_01);
				break;
			}
		}
	}
