...
public class BoH_Uther_03 : BoH_Uther_Dungeon
{
	...
	public override IEnumerator DoActionsBeforeDealingBaseMulliganCards()
	{
		...
		yield return PlayLineAlways(enemyActor, VO_Story_Minion_Varok_Male_Orc_Story_Uther_Mission3Intro_01);
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		{
		case 504:
			yield return PlayLineAlways(enemyActor, VO_Story_Minion_Varok_Male_Orc_Story_Uther_Mission3Loss_01);
			break;
		case 501:
			yield return PlayLineAlways(enemyActor, VO_Story_Minion_Varok_Male_Orc_Story_Uther_Mission3Victory_01);
