...
public class DALA_Dungeon_Boss_21h : DALA_Dungeon
{
	...
	protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
	{
		...
		{
			if (playerHeroCardID != "DALA_George" && playerHeroCardID != "DALA_Eudora")
			{
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		case 101:
			...
			yield return PlayBossLine(enemyActor, VO_DALA_BOSS_21h_Male_Human_StartOfTurnPrediction_01);
			break;
		case 102:
			m_PredictionSpoken = true;
			yield return PlayBossLine(enemyActor, VO_DALA_BOSS_21h_Male_Human_StartOfTurnPrediction_02);
			break;
		case 103:
			m_PredictionSpoken = true;
			yield return PlayBossLine(enemyActor, VO_DALA_BOSS_21h_Male_Human_StartOfTurnPrediction_03);
			break;
		case 111:
			if (m_PredictionSpoken)
			{
				m_PredictionSpoken = false;
				yield return PlayBossLine(enemyActor, VO_DALA_BOSS_21h_Male_Human_WrongPrediction_01);
			}
			break;
		case 112:
			if (m_PredictionSpoken)
			{
				m_PredictionSpoken = false;
				yield return PlayBossLine(enemyActor, VO_DALA_BOSS_21h_Male_Human_WrongPrediction_03);
			}
			break;
		case 113:
			if (m_PredictionSpoken)
			{
				m_PredictionSpoken = false;
				yield return PlayBossLine(enemyActor, VO_DALA_BOSS_21h_Male_Human_WrongPrediction_04);
			}
			break;
		case 131:
			if (m_PredictionSpoken)
			{
				m_PredictionSpoken = false;
				yield return PlayBossLine(enemyActor, VO_DALA_BOSS_21h_Male_Human_CorrectPrediction_01);
			}
			break;
		case 132:
			if (m_PredictionSpoken)
			{
				m_PredictionSpoken = false;
				yield return PlayBossLine(enemyActor, VO_DALA_BOSS_21h_Male_Human_CorrectPrediction_03);
			}
			break;
		case 133:
			if (m_PredictionSpoken)
			{
				m_PredictionSpoken = false;
				yield return PlayBossLine(enemyActor, VO_DALA_BOSS_21h_Male_Human_CorrectPrediction_04);
			}
			break;
		case 104:
			yield return PlayAndRemoveRandomLineOnlyOnce(enemyActor, m_PlayerSecret);
			break;
		case 105:
			yield return PlayAndRemoveRandomLineOnlyOnce(enemyActor, m_BossHeroPower);
			break;
		default:
