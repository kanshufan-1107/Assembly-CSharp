...
public class BTA_Fight_07 : BTA_Dungeon
{
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		case 103:
			...
			{
				yield return PlayLineAlways(friendlyActor, VO_BTA_BOSS_07h2_Female_NightElf_Mission_Fight_07_Hero_Refueling_03);
			...
			{
				yield return PlayRandomLineAlways(friendlyActor, m_missionEventTrigger103_Lines);
			}
			break;
		case 106:
			yield return PlayLineAlways(friendlyActor, VO_BTA_BOSS_07h2_Female_NightElf_Mission_Fight_07_Misc_03);
			break;
		case 107:
		...
		case 501:
			...
			yield return PlayLineAlways(friendlyActor, VO_BTA_BOSS_07h2_Female_NightElf_Mission_Fight_07_VictoryA_01);
			...
			break;
		case 507:
			yield return PlayAndRemoveRandomLineOnlyOnce(friendlyActor, m_VO_BTA_BOSS_07h2_Female_NightElf_Mission_Fight_07_HeroPower_Lines);
			break;
		default:
	...
	protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
	{
		...
		{
		case "BTA_BOSS_07s2":
			yield return PlayRandomLineAlways(friendlyActor, m_VO_BTA_BOSS_07h2_Female_NightElf_Mission_Fight_07_Hero_ExhaustBackfire_Lines);
			break;
		case "BTA_BOSS_07s3":
			yield return PlayRandomLineAlways(friendlyActor, m_VO_BTA_BOSS_07h2_Female_NightElf_Mission_Fight_07_Hero_FelCannons_Lines);
		...
		case "BTA_BOSS_07s4":
			if (Random.Range(1, 4) == 1)
			{
				yield return PlayLineAlways(friendlyActor, VO_BTA_BOSS_07h2_Female_NightElf_Mission_Fight_07_Hero_SelfRepairs_03);
			...
			{
				yield return PlayRandomLineAlways(friendlyActor, m_VO_BTA_BOSS_07h2_Female_NightElf_Mission_Fight_07_Hero_SelfRepairs_Lines);
			}
			break;
		}
	}
