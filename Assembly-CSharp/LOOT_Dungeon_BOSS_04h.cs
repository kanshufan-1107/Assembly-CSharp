...
public class LOOT_Dungeon_BOSS_04h : LOOT_Dungeon
{
	...
	protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
	{
		...
		if (emoteType == EmoteType.START)
		{
			...
			{
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_LOOTA_BOSS_04h_Female_Kobold_Intro2_01.prefab:d7f7f1554e369f84889996b2859d90cc", Notification.SpeechBubbleDirection.TopRight, enemyActor));
			}
			if (cardId == "LOOTA_BOSS_27h")
			{
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_LOOTA_BOSS_04h_Female_Kobold_Intro1_01.prefab:1d9348a07de8c03449e6341941f594d3", Notification.SpeechBubbleDirection.TopRight, enemyActor));
			}
		}
		else if (MissionEntity.STANDARD_EMOTE_RESPONSE_TRIGGERS.Contains(emoteType))
		{
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_LOOTA_BOSS_04h_Female_Kobold_EmoteResponse_01.prefab:f0813696aafb10c42a8d9977c77fde0e", Notification.SpeechBubbleDirection.TopRight, enemyActor));
		}
	}
	...
	protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()))
		{
			...
			if (cardID == "LOOTA_840")
			{
				yield return PlayEasterEggLine(enemyActor, "VO_LOOTA_BOSS_04h_Female_Kobold_EventWaxRagerPlay_01.prefab:a7c97e6d06c29c1499c3d3efc8d649aa");
			}
		}
	}
}
