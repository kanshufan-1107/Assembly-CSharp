...
public class ULDA_Dungeon_Boss_45h : ULDA_Dungeon
{
	...
	protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
	{
		...
		if (emoteType == EmoteType.START)
		{
			...
			{
			case "ULDA_Brann":
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_ULDA_BOSS_45h_Male_BloodElf_IntroBrann_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
				break;
			case "ULDA_Elise":
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_ULDA_BOSS_45h_Male_BloodElf_IntroElise_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
				break;
			case "ULDA_Finley":
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_ULDA_BOSS_45h_Male_BloodElf_IntroFinley_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
				break;
			case "ULDA_Reno":
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_ULDA_BOSS_45h_Male_BloodElf_IntroReno_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
				break;
			default:
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		case 101:
			...
			break;
		case 102:
			yield return PlayAndRemoveRandomLineOnlyOnce(enemyActor, m_HeroPowerTreasureLines);
			break;
		default:
	...
	protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
		{
			...
			{
			case "AT_033":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_45h_Male_BloodElf_PlayerBurgle_01);
				break;
			case "ULD_172":
			case "ULD_707":
			case "ULD_715":
			case "ULD_717":
			case "ULD_718":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_45h_Male_BloodElf_PlayerPlagueSpell_01);
				break;
			}
		}
	}
	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
		{
			...
			{
			case "EX1_590":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_45h_Male_BloodElf_BossBloodKnight_01);
				break;
			case "ULD_145":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_45h_Male_BloodElf_BossBrazenZealout_01);
				break;
			case "LOE_116":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_45h_Male_BloodElf_BossReliquarySeeker_01);
				break;
			}
		}
	}
