...
public class TB_Firefest2 : MissionEntity
{
	...
	{
		int ragnarosId = GameState.Get().GetGameEntity().GetTag(GAME_TAG.TAG_SCRIPT_DATA_ENT_2);
		Entity ragnarosEnt = GameState.Get().GetEntity(ragnarosId);
		if (ragnarosEnt != null)
		{
			ragnarosCard = ragnarosEnt.GetCard();
		}
	...
	private IEnumerator PlayBossLineGameOver(BOSS boss, string line, bool persistCharacter = false)
	{
		...
		{
		case BOSS.AHUNE:
			yield return PlayMissionFlavorLine("Ahune_BigQuote.prefab:00dd8f83adda33345ac291cc76241482", line, RIGHT_OF_ENEMY_HERO, bubbleDir, 2.5f, persistCharacter);
			break;
		case BOSS.RAGNAROS:
			yield return PlayMissionFlavorLine("Ragnaros_BigQuote.prefab:843c4fab946192943a909b026f755505", line, RIGHT_OF_ENEMY_HERO, bubbleDir, 2.5f, persistCharacter);
			break;
		}
	}
	...
	private IEnumerator PlayBossLine(BOSS boss, string line, bool persistCharacter = false)
	{
		...
		{
		case BOSS.AHUNE:
			yield return PlayMissionFlavorLine("Ahune_BigQuote.prefab:00dd8f83adda33345ac291cc76241482", line, LEFT_OF_ENEMY_HERO, bubbleDir, 2.5f, persistCharacter);
			break;
		case BOSS.RAGNAROS:
			yield return PlayMissionFlavorLine("Ragnaros_BigQuote.prefab:843c4fab946192943a909b026f755505", line, LEFT_OF_ENEMY_HERO, bubbleDir, 2.5f, persistCharacter);
			break;
		}
	}
