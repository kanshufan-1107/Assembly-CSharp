...
public class ULDA_Dungeon_Boss_31h : ULDA_Dungeon
{
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		case 101:
			...
			break;
		case 102:
			yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_31h_Female_Trogg_HeroPowerTrogg_01);
			break;
		case 103:
			yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_31h_Female_Trogg_BossWeapon_01);
			break;
		case 104:
			yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_31h_Female_Trogg_PlayerSpell_01);
			break;
		default:
	...
	protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
		{
			...
			{
			case "AT_111":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_31h_Female_Trogg_PlayerRefreshmentVendor_01);
				break;
			case "LOOTA_109":
			case "GVG_067":
			case "LOOT_315":
			...
			case "GVG_068":
			case "CFM_338":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_31h_Female_Trogg_PlayerTrogg_01);
				break;
			case "OG_330":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_31h_Female_Trogg_PlayerUndercityHuckster_01);
				break;
			}
		}
	}
	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
		{
			...
			case "GVG_068":
			case "CFM_338":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_31h_Female_Trogg_BossTrogg_01);
				break;
			case "GVG_118":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_31h_Female_Trogg_BossTroggzor_01);
				break;
			}
		}
	}
