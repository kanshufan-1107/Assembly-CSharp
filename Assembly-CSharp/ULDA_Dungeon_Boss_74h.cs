...
public class ULDA_Dungeon_Boss_74h : ULDA_Dungeon
{
	...
	protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
		{
			...
			{
			case "ULD_262":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_74h_Male_NefersetTolvir_PlayerTrigger_High_Priest_Amet_01);
				break;
			case "ULD_705":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_74h_Male_NefersetTolvir_PlayerTrigger_Mogu_Cultist_01);
				break;
			case "ULD_193":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_74h_Male_NefersetTolvir_PlayerTrigger_Living_Monument_01);
				break;
			}
		}
	}
	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
		{
			...
			{
			case "ULD_145":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_74h_Male_NefersetTolvir_BossTriggerBrazenZealot_01);
				break;
			case "DAL_141":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_74h_Male_NefersetTolvir_BossTriggerDesperateMeasures_01);
				break;
			case "ULD_714":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_74h_Male_NefersetTolvir_BossTriggerPenance_01);
				break;
			}
		}
	}
