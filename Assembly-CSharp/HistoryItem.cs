...
public class HistoryItem : MonoBehaviour
{
	...
	protected TAG_CARD_ALTERNATE_COST m_splatType;
	...
	public Collider GetTileCollider()
	{
		...
		Transform t = m_tileActor.GetMeshRenderer().transform.Find("Collider");
		if (t == null)
		{
			return null;
		}
	...
	public void DisplaySpells()
	{
		...
		else if (m_entity.IsCharacter() || m_entity.IsWeapon())
		{
			...
			{
				DisplaySplatOnActor(m_mainCardActor, m_splatAmount, m_isPoisonous, m_isCriticalHit, m_splatType);
			}
		}
	}

	private void DisplaySplatOnActor(Actor actor, int damage, bool isPoisonous, bool isCriticalHit, TAG_CARD_ALTERNATE_COST alternateCostSplat)
	{
		...
		if (!(spell == null))
		{
			...
			obj.SetDamageIsCrit(isCriticalHit);
			obj.SetAlternateCostSplat(alternateCostSplat);
