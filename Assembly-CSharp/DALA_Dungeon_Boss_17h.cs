...
public class DALA_Dungeon_Boss_17h : DALA_Dungeon
{
	...
	protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
	{
		...
		if (emoteType == EmoteType.START)
		{
			...
			{
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_DALA_BOSS_17h_Female_Tauren_IntroGeorge_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
			}
			else if (playerHeroCardID == "DALA_Squeamlish")
			{
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_DALA_BOSS_17h_Female_Tauren_IntroSqueamlish_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
			}
			else
			{
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		{
		case 101:
			yield return PlayAndRemoveRandomLineOnlyOnce(enemyActor, m_BossHeroPowerTrigger);
			break;
		case 102:
			yield return PlayLineOnlyOnce(enemyActor, VO_DALA_BOSS_17h_Female_Tauren_PlayerChooseOne_01);
			break;
		default:
	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
		{
			...
			case "GVG_080":
			case "ICC_051":
				yield return PlayLineOnlyOnce(enemyActor, VO_DALA_BOSS_17h_Female_Tauren_BossDruidOfThe_01);
				break;
			case "EX1_164":
				yield return PlayLineOnlyOnce(enemyActor, VO_DALA_BOSS_17h_Female_Tauren_BossNourish_01);
				break;
			case "TRL_343":
				yield return PlayLineOnlyOnce(enemyActor, VO_DALA_BOSS_17h_Female_Tauren_BossWardruidLoti_01);
				break;
			}
		}
	}
