...
public class LOE10_Giantfin : LOE_MissionEntity
{
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		case 2:
			if (!m_cardLinePlayed2)
			{
				...
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeechOnce("VO_LOEA10_1_MIDDLEFIN.prefab:db87360596b82634f9350b9fb516a52c", Notification.SpeechBubbleDirection.TopRight, enemyActor));
			}
			break;
		case 3:
	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		Actor enemyActor = GameState.Get().GetOpposingSidePlayer().GetHero()
			.GetCard()
			.GetActor();
		if (entity.GetCardId() == "LOEA10_5" && !m_nyahLinePlayed)
		{
			m_nyahLinePlayed = true;
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeechOnce("VO_LOE_10_NYAH.prefab:e9c4965c3cf4d274886180e4facf749f", Notification.SpeechBubbleDirection.TopRight, enemyActor));
	...
	protected override IEnumerator HandleStartOfTurnWithTiming(int turn)
	{
		...
		{
			yield return Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeechOnce("VO_LOE_10_TURN1.prefab:5f1e5b8506cd049419e78ee08f8143e4", Notification.SpeechBubbleDirection.TopRight, enemyActor));
