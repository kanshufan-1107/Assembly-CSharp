...
public class BoH_Rexxar_08 : BoH_Rexxar_Dungeon
{
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		{
			GameState.Get().SetBusy(busy: true);
			yield return PlayLineAlways(enemyActor, VO_Story_Hero_Gorgrom_Male_Gronn_Story_Rexxar_Mission8Loss_01);
			GameState.Get().SetBusy(busy: false);
		}
		else
		{
	...
	protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
	{
		...
		if (!(cardID == "EX1_610"))
		{
			...
			{
				yield return PlayLineAlways(enemyActor, VO_Story_Hero_Gorgrom_Male_Gronn_Story_Rexxar_Mission8ExchangeE_01);
			}
		}
		else
		{
			yield return PlayLineAlways(enemyActor, VO_Story_Hero_Gorgrom_Male_Gronn_Story_Rexxar_Mission8ExchangeD_01);
		}
	}
	...
	protected override IEnumerator HandleStartOfTurnWithTiming(int turn)
	{
		...
		case 7:
			...
			break;
		case 13:
			yield return PlayLineAlways(enemyActor, VO_Story_Hero_Gorgrom_Male_Gronn_Story_Rexxar_Mission8ExchangeC_01);
