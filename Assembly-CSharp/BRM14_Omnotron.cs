...
public class BRM14_Omnotron : BRM_MissionEntity
{
	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		case "BRMA14_6H":
			if (!m_heroPower1LinePlayed)
			{
				...
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_BRMA14_1_HP1_03.prefab:49a86de40b9af024ea935f62b98017b3", Notification.SpeechBubbleDirection.TopRight, enemyActor));
			}
			break;
		case "BRMA14_4":
		case "BRMA14_4H":
			if (!m_heroPower2LinePlayed)
			{
				...
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_BRMA14_1_HP2_04.prefab:a3d3b1b54ba372a49b3320f600da1b0f", Notification.SpeechBubbleDirection.TopRight, enemyActor));
			}
			break;
		case "BRMA14_2":
		case "BRMA14_2H":
			if (!m_heroPower3LinePlayed)
			{
				...
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_BRMA14_1_HP3_05.prefab:0f20a4c1fdb6d9143b9d10b617c8c901", Notification.SpeechBubbleDirection.TopRight, enemyActor));
			}
			break;
		case "BRMA14_8":
		case "BRMA14_8H":
			if (!m_heroPower4LinePlayed)
			{
				...
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_BRMA14_1_HP4_06.prefab:481cbb26507bdf24eba7d240ae131496", Notification.SpeechBubbleDirection.TopRight, enemyActor));
			}
			break;
		case "BRMA14_10":
		case "BRMA14_10H":
			if (!m_heroPower5LinePlayed)
			{
				...
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_BRMA14_1_HP5_07.prefab:99da345a6ef8bbb46b9ebf4e729b34c8", Notification.SpeechBubbleDirection.TopRight, enemyActor));
			}
			break;
		case "BRMA14_11":
			if (!m_cardLinePlayed)
			{
				...
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_BRMA14_1_CARD_09.prefab:40a09cf3c2c8a334da8195687dfa6dc1", Notification.SpeechBubbleDirection.TopRight, enemyActor));
			}
			break;
		}
	}
	...
	protected override IEnumerator HandleStartOfTurnWithTiming(int turn)
	{
		...
		if (turn == 1)
		{
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_BRMA14_1_TURN1_02.prefab:32791f2d54bc6c4478f8d9f28720da20", Notification.SpeechBubbleDirection.TopRight, enemyActor));
		}
		yield break;
	}
