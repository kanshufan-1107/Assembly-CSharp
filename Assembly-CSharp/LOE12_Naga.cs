...
public class LOE12_Naga : LOE_MissionEntity
{
	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		if (entity.GetCardId() == "LOEA12_3" && !m_pearlLinePlayed)
		{
	...
	protected override IEnumerator HandleStartOfTurnWithTiming(int turn)
	{
		...
		{
		case 1:
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeechOnce("VO_LOE_12_NAZJAR_TURN_1.prefab:9dcfc1a022a6c0540bbc71fa387b47e7", Notification.SpeechBubbleDirection.TopRight, enemyActor));
		...
		case 5:
			...
			break;
		case 9:
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeechOnce("VO_LOE_12_NAZJAR_TURN_5.prefab:e229c1ff3bc5b8c4dadb845e94ed0ffb", Notification.SpeechBubbleDirection.TopRight, enemyActor));
