...
public class BTA_Fight_02 : BTA_Dungeon
{
	...
	public override IEnumerator DoActionsBeforeDealingBaseMulliganCards()
	{
		...
		yield return PlayLineAlways(friendlyActor, VO_BTA_01_Female_NightElf_Mission_Fight_02_PlayerStart_01);
	...
	protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
	{
		...
		{
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_BTA_BOSS_02h_Female_Demon_Mission_Fight_02_Emote_Response_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
		}
	}
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		{
		case 100:
			yield return PlayLineAlways(enemyActor, VO_BTA_BOSS_02h_Female_Demon_Mission_Fight_02_Boss_ReplicatotronTransform_01);
			break;
		case 101:
			yield return PlayLineAlways(enemyActor, VO_BTA_BOSS_02h_Female_Demon_Mission_Fight_02_Hero_StealthMinion_01);
			break;
		case 103:
			...
			break;
		case 104:
			yield return PlayAndRemoveRandomLineOnlyOnce(enemyActor, m_VO_BTA_BOSS_02h_Female_Demon_Mission_Fight_02_HeroPowerTrigger_Lines);
			break;
		case 500:
	...
	protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
	{
		...
		if (!(cardID == "BT_205"))
		{
			if (cardID == "BT_213")
			{
				yield return PlayLineAlways(enemyActor, VO_BTA_BOSS_02h_Female_Demon_Mission_Fight_02_Hero_ImprisonedFelmaw_01);
			}
		}
		else
		{
			yield return PlayLineAlways(enemyActor, VO_BTA_BOSS_02h_Female_Demon_Mission_Fight_02_Hero_Scrapshot_01);
		}
	}
	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
		{
			...
			{
			case "BT_008":
				yield return PlayLineAlways(enemyActor, VO_BTA_BOSS_02h_Female_Demon_Mission_Fight_02_Boss_RustswornInitiate_01);
				break;
			case "BTA_13":
				yield return PlayLineAlways(enemyActor, VO_BTA_BOSS_02h_Female_Demon_Mission_Fight_02_Boss_Deteriorate_01);
				break;
			case "BT_156":
				yield return PlayLineAlways(enemyActor, VO_BTA_BOSS_02h_Female_Demon_Mission_Fight_02_Boss_ImprsonedVilefiend_01);
				break;
			}
		}
	}
	...
	protected override IEnumerator HandleStartOfTurnWithTiming(int turn)
	{
		...
		if (turn == 1)
		{
			yield return PlayLineAlways(enemyActor, VO_BTA_BOSS_02h_Female_Demon_Mission_Fight_02_TurnOneResponse_01);
