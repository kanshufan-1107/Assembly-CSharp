...
public class GIL_Dungeon_Boss_66h : GIL_Dungeon
{
	...
	protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
	{
		...
		{
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_GILA_BOSS_66h_Female_Undead_Intro_01.prefab:a5215794eefe1114d9ffd4cc13cc7d1e", Notification.SpeechBubbleDirection.TopRight, enemyActor));
		}
		else if (MissionEntity.STANDARD_EMOTE_RESPONSE_TRIGGERS.Contains(emoteType))
		{
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_GILA_BOSS_66h_Female_Undead_EmoteResponse_02.prefab:d3150f2caf430a44ba2ff7eee0dc7a8a", Notification.SpeechBubbleDirection.TopRight, enemyActor));
		}
	}
	...
	protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()))
		{
			...
			if (cardID == "GILA_852a")
			{
				yield return PlayEasterEggLine(enemyActor, "VO_GILA_BOSS_66h_Female_Undead_EventPlayHorn_02.prefab:8c24650aeffa2f142963239d8a560e7d");
			}
		}
	}
}
