...
public class ULDA_Dungeon_Boss_77h : ULDA_Dungeon
{
	...
	{
		base.PreloadAssets();
		List<string> soundFiles = new List<string> { VO_ULDA_BOSS_77h_Gorebite_Death, VO_ULDA_BOSS_77h_Gorebite_Defeat, VO_ULDA_BOSS_77h_Gorebite_EmoteResponse, VO_ULDA_BOSS_77h_Gorebite_Intro };
