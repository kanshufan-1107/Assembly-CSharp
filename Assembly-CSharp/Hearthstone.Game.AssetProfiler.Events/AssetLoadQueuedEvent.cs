...
public class AssetLoadQueuedEvent : IProfilingEvent, IProfilingSnapshot
{
	public string Name => "AssetLoadQueuedEvent";
	...
	public AssetLoadQueuedEvent(string assetAddress, string assetPath)
	{
