...
public class DRGA_Good_Fight_02 : DRGA_Dungeon
{
	...
	protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
	{
		...
		{
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_DRGA_BOSS_10h_Male_Elemental_Good_Fight_02_BossStart_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
		}
		else if (MissionEntity.STANDARD_EMOTE_RESPONSE_TRIGGERS.Contains(emoteType))
		{
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_DRGA_BOSS_10h_Male_Elemental_Good_Fight_02_EmoteResponse_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
		}
	}
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		case 104:
			...
			break;
		case 107:
			yield return PlayAndRemoveRandomLineOnlyOnce(enemyActor, m_missionEventTrigger107Lines);
			break;
		case 108:
			yield return PlayLineOnlyOnce(enemyActor, VO_DRGA_BOSS_10h_Male_Elemental_Good_Fight_02_BossAttack_01);
			break;
		case 109:
			if (!m_Heroic)
			{
				yield return PlayLineAlways(enemyActor, VO_DRGA_BOSS_10h_Male_Elemental_Good_Fight_02_Boss_Flavor_01_01);
	...
	protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
	{
		...
		{
		case "ICC_078":
			yield return PlayLineOnlyOnce(enemyActor, VO_DRGA_BOSS_10h_Male_Elemental_Good_Fight_02_Player_Avalanche_01);
			break;
		case "DRG_068":
			yield return PlayLineOnlyOnce(enemyActor, VO_DRGA_BOSS_10h_Male_Elemental_Good_Fight_02_Player_LivingDragonbreath_01);
			break;
		case "KARA_00_08":
			if (!m_Heroic)
			{
				yield return PlayLineOnlyOnce(friendlyActor, VO_DRGA_BOSS_35h_Male_Human_Good_Fight_02_Khadgar_ArchmageApprentice_01);
			}
			break;
		case "DAL_558":
			if (!m_Heroic)
			{
				yield return PlayLineOnlyOnce(friendlyActor, VO_DRGA_BOSS_35h_Male_Human_Good_Fight_02_Khadgar_ArchmageVargoth_01);
			}
			break;
		case "KARA_00_07":
			if (!m_Heroic)
			{
				yield return PlayLineOnlyOnce(friendlyActor, VO_DRGA_BOSS_35h_Male_Human_Good_Fight_02_Khadgar_AstralPortal_01);
			}
			break;
		case "DAL_609":
			if (!m_Heroic)
			{
				yield return PlayLineOnlyOnce(friendlyActor, VO_DRGA_BOSS_35h_Male_Human_Good_Fight_02_Khadgar_Kalecgos_01);
			}
			break;
		case "KARA_00_05":
			if (!m_Heroic)
			{
				yield return PlayLineAlways(friendlyActor, VO_DRGA_BOSS_35h_Male_Human_Good_Fight_02_Khadgar_Misc_04_01);
			}
			break;
		}
	}
