...
public class BTA_Fight_25 : BTA_Dungeon_Heroic
{
	...
	protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
	{
		...
		if (emoteType == EmoteType.START)
		{
			...
			{
			case "HERO_04a":
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_BTA_BOSS_25h_Male_BloodElf_Mission_Fight_25_BossStartLiadrin_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
				break;
			case "HERO_04b":
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_BTA_BOSS_25h_Male_BloodElf_Mission_Fight_25_BossStartArthas_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
				break;
			case "HERO_10":
			case "HERO_10a":
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_BTA_BOSS_25h_Male_BloodElf_Mission_Fight_25_BossStartIllidan_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
				break;
			case "HERO_08":
			case "HERO_08c":
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_BTA_BOSS_25h_Male_BloodElf_Mission_Fight_25_BossStartJaina_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
				break;
			default:
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_BTA_BOSS_25h_Male_BloodElf_Mission_Fight_25_BossStart_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
				break;
			}
		}
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		{
		case 110:
			yield return PlayLineOnlyOnce(enemyActor, VO_BTA_BOSS_25h_Male_BloodElf_Mission_Fight_25_Boss_VaporizeTrigger_01);
			break;
		case 115:
			yield return PlayLineAlways(enemyActor, VO_BTA_BOSS_25h_Male_BloodElf_Mission_Fight_25_Hero_CounterSpell_01);
			break;
		case 120:
			yield return PlayLineOnlyOnce(enemyActor, VO_BTA_BOSS_25h_Male_BloodElf_Mission_Fight_25_Hero_Treant_01);
			break;
		case 500:
	...
	protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
		{
			...
			case "DRG_248":
			case "EX1_275":
				yield return PlayLineOnlyOnce(enemyActor, VO_BTA_BOSS_25h_Male_BloodElf_Mission_Fight_25_Hero_FrostSpell_01);
				break;
			case "ICC_314":
				yield return PlayLineOnlyOnce(enemyActor, VO_BTA_BOSS_25h_Male_BloodElf_Mission_Fight_25_Hero_LichKing_01);
				break;
			}
		}
	}
	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
		{
			...
			{
			case "BTA_BOSS_25s":
				yield return PlayAndRemoveRandomLineOnlyOnce(enemyActor, m_VO_BTA_BOSS_25h_Male_BloodElf_Mission_Fight_25_Boss_GravityLapseLines);
				break;
			case "BT_735":
				yield return PlayLineOnlyOnce(enemyActor, VO_BTA_BOSS_25h_Male_BloodElf_Mission_Fight_25_Boss_Alar_01);
				break;
			case "CS2_032":
				yield return PlayLineOnlyOnce(enemyActor, VO_BTA_BOSS_25h_Male_BloodElf_Mission_Fight_25_Boss_Flamestrike_01);
				break;
			case "EX1_279":
				yield return PlayAndRemoveRandomLineOnlyOnce(enemyActor, m_VO_BTA_BOSS_25h_Male_BloodElf_Mission_Fight_25_HeroPowerLines);
				break;
			}
		}
	}
