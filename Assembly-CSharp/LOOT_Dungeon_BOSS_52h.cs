...
public class LOOT_Dungeon_BOSS_52h : LOOT_Dungeon
{
	...
	{
		base.PreloadAssets();
		foreach (string soundFile in new List<string> { LOOTA_BOSS_52h_TreasureVault_Death, LOOTA_BOSS_52h_TreasureVault_Emote, LOOTA_BOSS_52h_TreasureVault_Intro })
		{
	...
	protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
	{
		...
		{
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(LOOTA_BOSS_52h_TreasureVault_Intro, Notification.SpeechBubbleDirection.None, enemyActor));
		}
		else if (MissionEntity.STANDARD_EMOTE_RESPONSE_TRIGGERS.Contains(emoteType))
		{
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(LOOTA_BOSS_52h_TreasureVault_Emote, Notification.SpeechBubbleDirection.TopRight, enemyActor));
		}
	}
