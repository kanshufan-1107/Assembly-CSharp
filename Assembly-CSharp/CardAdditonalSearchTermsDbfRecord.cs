...
public class CardAdditonalSearchTermsDbfRecord : DbfRecord
{
	...
	{
		CardAdditonalSearchTermsDbfAsset dbfAsset = DbfShared.GetAssetBundle().LoadAsset(resourcePath, typeof(CardAdditonalSearchTermsDbfAsset)) as CardAdditonalSearchTermsDbfAsset;
		if (dbfAsset == null)
		{
			records = new List<T>();
