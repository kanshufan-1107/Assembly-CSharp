...
public class ULDA_Dungeon_Boss_24h : ULDA_Dungeon
{
	...
	{
		base.PreloadAssets();
		List<string> soundFiles = new List<string> { VO_ULDA_BOSS_24h_SuspiciousPalmTree_Death, VO_ULDA_BOSS_24h_SuspiciousPalmTree_Defeat, VO_ULDA_BOSS_24h_SuspiciousPalmTree_EmoteResponse, VO_ULDA_BOSS_24h_SuspiciousPalmTree_Intro };
