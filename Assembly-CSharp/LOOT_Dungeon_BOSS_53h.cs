...
public class LOOT_Dungeon_BOSS_53h : LOOT_Dungeon
{
	...
	public override void OnPlayThinkEmote()
	{
		...
		if (currentPlayer.IsFriendlySide() && !currentPlayer.GetHeroCard().HasActiveEmoteSound())
		{
			...
			{
				string songLine = m_IdleLines[0];
				m_IdleLines.RemoveAt(0);
				Gameplay.Get().StartCoroutine(PlayBossLine(enemyActor, songLine));
			}
		}
	}
	...
	protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
	{
		...
		{
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_LOOTA_BOSS_53h2_Female_Undead_Intro_01.prefab:1b2a36b185a12124d93aa365ea6e09da", Notification.SpeechBubbleDirection.TopRight, enemyActor));
		}
		else if (MissionEntity.STANDARD_EMOTE_RESPONSE_TRIGGERS.Contains(emoteType))
		{
			...
			{
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_LOOTA_BOSS_53h2_Female_Undead_EmoteResponse_01.prefab:bbf07041f5574b248a637c1f32854c1a", Notification.SpeechBubbleDirection.TopRight, enemyActor));
			}
			if (cardId == "LOOTA_BOSS_53h2")
			{
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_LOOTA_BOSS_53h2_Female_Undead_TimeRewindPlayCard1_01.prefab:0fc1a8ac09c4dff4e9c77d0e585b1e09", Notification.SpeechBubbleDirection.TopRight, enemyActor));
			}
		}
	}
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		case 101:
		{
			...
			if (m_ExtraTurnLines.Count != 0 && chanceVO >= randomNum)
			{
	...
	protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()))
		{
			...
			case "UNG_028t":
			case "LOOTA_830":
				yield return PlayEasterEggLine(enemyActor, "VO_LOOTA_BOSS_53h2_Female_Undead_EventPlayerTimeWalk_01.prefab:670d03d507a53de41b3ad656aeb5a568");
				break;
			case "LOOTA_811":
				yield return PlayEasterEggLine(enemyActor, "VO_LOOTA_BOSS_53h2_Female_Undead_EventManaDestroyed_01.prefab:9380576598589cb4b8d813599e80a5a1");
				break;
			}
		}
	}
