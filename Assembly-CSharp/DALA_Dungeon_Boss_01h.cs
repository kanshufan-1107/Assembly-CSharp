...
public class DALA_Dungeon_Boss_01h : DALA_Dungeon
{
	...
	{
		base.PreloadAssets();
		List<string> soundFiles = new List<string> { VO_DALA_BOSS_01h_Chomper_Death, VO_DALA_BOSS_01h_Chomper_DefeatPlayer, VO_DALA_BOSS_01h_Chomper_EmoteResponse, VO_DALA_BOSS_01h_Chomper_Intro };
