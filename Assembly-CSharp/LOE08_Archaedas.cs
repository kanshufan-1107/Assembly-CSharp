	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		if (!(cardID == "LOEA06_04"))
		{
			if (cardID == "LOEA06_03")
			{
				...
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeechOnce("VO_LOE_08_ANIMATE_STONE.prefab:75c31e408053e0748aae95242e662f27", Notification.SpeechBubbleDirection.TopRight, enemyActor));
			}
		}
		else
		{
			m_playedLines.Add(cardID);
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeechOnce("VO_LOE_08_LANDSLIDE.prefab:c56764ff130183f4688c0dfb30eaf8b2", Notification.SpeechBubbleDirection.TopRight, enemyActor));
		}
	}
