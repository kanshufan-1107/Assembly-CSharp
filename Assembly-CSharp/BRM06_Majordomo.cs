...
public class BRM06_Majordomo : BRM_MissionEntity
{
	...
	protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
	{
		...
		{
			Entity heroEntity = GameState.Get().GetOpposingSidePlayer().GetHero();
			if (heroEntity.GetCardId() == "BRMA06_1" || heroEntity.GetCardId() == "BRMA06_1H")
			{
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_BRMA06_1_RESPONSE_03.prefab:a908e5d8056a26b4dbdc0ea833f19a6e", Notification.SpeechBubbleDirection.TopRight, enemyActor));
			}
			else if (heroEntity.GetCardId() == "BRMA06_3" || heroEntity.GetCardId() == "BRMA06_3H")
			{
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_BRMA06_3_RESPONSE_03.prefab:3abe0ccef6f202a45b4727361bc704df", Notification.SpeechBubbleDirection.TopRight, enemyActor));
			}
		}
	}
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		if (missionEvent == 1)
		{
			...
			Actor enemyActor = GameState.Get().GetOpposingSidePlayer().GetHeroCard()
				.GetActor();
			yield return Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_BRMA06_3_TURN1_02.prefab:7d7272a7a2a62bf4f91488020ed8ab94", Notification.SpeechBubbleDirection.TopRight, enemyActor));
		}
	}
	...
	protected override IEnumerator HandleStartOfTurnWithTiming(int turn)
	{
		...
		if (turn == 1)
		{
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_BRMA06_1_TURN1_02_ALT.prefab:e0ae95e6abc774f4b9bc68f07f7bbc29", Notification.SpeechBubbleDirection.TopRight, enemyActor));
		}
		yield break;
	}
