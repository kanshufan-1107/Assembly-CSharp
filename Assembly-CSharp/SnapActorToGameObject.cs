...
public class SnapActorToGameObject : MonoBehaviour
{
	...
	private void Start()
	{
		Actor actor = GameObjectUtils.FindComponentInThisOrParents<Actor>(base.gameObject);
		if (actor == null)
		{
			Spell spell = GameObjectUtils.FindComponentInParents<Spell>(base.gameObject);
			if (spell != null)
			{
