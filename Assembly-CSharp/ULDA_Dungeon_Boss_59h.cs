...
public class ULDA_Dungeon_Boss_59h : ULDA_Dungeon
{
	...
	{
		base.PreloadAssets();
		List<string> soundFiles = new List<string> { VO_ULDA_BOSS_59h_Direbat_Death, VO_ULDA_BOSS_59h_Direbat_Defeat, VO_ULDA_BOSS_59h_Direbat_EmoteResponse, VO_ULDA_BOSS_59h_Direbat_Intro };
