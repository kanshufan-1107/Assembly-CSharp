...
public class CollectionManagerDisplay : CollectibleDisplay
{
	...
	private void CreateDeckFromClipboard(ShareableDeck shareableDeck)
	{
		...
		if (inCollectionManager)
		{
			...
			{
				RankMgr.LogMessage("Options.GetFormatType() = FT_UNKOWN", "CreateDeckFromClipboard", "D:\\p4Workspace\\32.0.0\\Pegasus\\Client\\Assets\\Game\\CollectionManager\\CollectionManagerDisplay.cs", 3396);
				return;
			}
