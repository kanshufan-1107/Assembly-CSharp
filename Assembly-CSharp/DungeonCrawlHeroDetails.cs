...
public class DungeonCrawlHeroDetails : MonoBehaviour
{
	...
	private void RefreshHeroInfo()
	{
		...
		{
			string heroName = m_heroEntityDef.GetName();
	...
	private void ApplyPendingUIEventsIfLoaded()
	{
		...
		foreach (HeroPowerUIEvent heroPowerEvent in m_heroPowerPendingUIEvents)
		{
			m_heroPower.AddEventListener(heroPowerEvent.m_type, heroPowerEvent.m_handler);
		}
