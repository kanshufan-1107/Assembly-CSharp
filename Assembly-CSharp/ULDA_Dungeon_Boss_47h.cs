...
public class ULDA_Dungeon_Boss_47h : ULDA_Dungeon
{
	...
	{
		base.PreloadAssets();
		List<string> soundFiles = new List<string> { VO_ULDA_BOSS_47h_TotallyNormalJar_Death, VO_ULDA_BOSS_47h_TotallyNormalJar_Defeat, VO_ULDA_BOSS_47h_TotallyNormalJar_EmoteResponse, VO_ULDA_BOSS_47h_TotallyNormalJar_Intro };
