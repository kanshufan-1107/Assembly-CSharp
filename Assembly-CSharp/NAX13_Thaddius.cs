...
public class NAX13_Thaddius : NAX_MissionEntity
{
	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		Actor enemyActor = GameState.Get().GetOpposingSidePlayer().GetHero()
			.GetCard()
			.GetActor();
		if (entity.GetCardId() == "NAX13_02" && !m_heroPowerLinePlayed)
		{
			m_heroPowerLinePlayed = true;
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_NAX13_01_HP_02.prefab:cc9afdc24fabea54abc939924c34c7f8", Notification.SpeechBubbleDirection.TopRight, enemyActor));
		}
	}
}
