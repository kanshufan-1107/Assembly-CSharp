...
public class ULDA_Dungeon_Boss_33h : ULDA_Dungeon
{
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		{
		case 107:
			yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_33h_Male_Gnome_BossFirstMech_01);
			break;
		case 104:
			yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_33h_Male_Gnome_HeroPowerBossMinionOnly_01);
			break;
		case 106:
			yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_33h_Male_Gnome_HeroPowerMinionDestroy_01);
			break;
		case 103:
			yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_33h_Male_Gnome_HeroPowerNoMinions_01);
			break;
		case 102:
			yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_33h_Male_Gnome_Take20Damage_01);
			break;
		case 101:
			yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_33h_Male_Gnome_TurnOne_01);
			break;
		default:
	...
	protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
		{
			...
			{
			case "DAL_759":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_33h_Male_Gnome_BossViciousScraphound_01);
				break;
			case "BOT_540":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_33h_Male_Gnome_PlayerEMPOperative_01);
				break;
			case "TRL_530":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_33h_Male_Gnome_PlayerMaskedContender_01);
				break;
			case "DAL_063":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_33h_Male_Gnome_PlayerWrenchcalibur_01);
				break;
			}
		}
	}
