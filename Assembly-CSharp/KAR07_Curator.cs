...
public class KAR07_Curator : KAR_MissionEntity
{
	...
	protected override IEnumerator HandleStartOfTurnWithTiming(int turn)
	{
		...
		{
		case 1:
			yield return PlayOpeningLine(enemyActor, "VO_Curator_Male_ArcaneGolem_CuratorTurn1_01.prefab:5ad59d406d00ab44d82384257b8fb4a4");
			break;
		case 8:
			GameState.Get().SetBusy(busy: true);
			yield return PlayMissionFlavorLine(enemyActor, "VO_Curator_Male_ArcaneGolem_CuratorTurn5_01.prefab:e59c87cd9998ae44f802ac7dd5e74b34");
			GameState.Get().SetBusy(busy: false);
			break;
		case 12:
			GameState.Get().SetBusy(busy: true);
			yield return PlayMissionFlavorLine(enemyActor, "VO_Curator_Male_ArcaneGolem_CuratorTurn9_01.prefab:df9344fd46b080545a70895065033838");
			GameState.Get().SetBusy(busy: false);
			break;
		}
	}
	...
	protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()))
		{
			...
			{
			case "EX1_089":
				yield return PlayEasterEggLine(enemyActor, "VO_Curator_Male_ArcaneGolem_CuratorArcaneGolem_01.prefab:44f96236a79304a4592eadbb92a60991");
				break;
			case "CS2_034_H1":
				yield return PlayEasterEggLine(enemyActor, "VO_Curator_Male_ArcaneGolem_CuratorMedivhSkin_01.prefab:72f9a039470438e4c908f514f7b0112d");
				break;
			case "EX1_558":
				yield return PlayEasterEggLine(enemyActor, "VO_Curator_Male_ArcaneGolem_CuratorHarrison_02.prefab:d8882bd7ba7f51043975da6e9430a033");
				break;
			case "LOE_011":
				yield return PlayEasterEggLine(enemyActor, "VO_Curator_Male_ArcaneGolem_CuratorReno_02.prefab:805272a3ed96b0343b6c330b821777f5");
				break;
			}
		}
	}
	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()))
		{
			...
			case "KARA_07_03heroic":
				GameState.Get().SetBusy(busy: true);
				yield return PlayBossLine(enemyActor, "VO_Curator_Male_ArcaneGolem_CuratorMurlocs_01.prefab:25fe890f35a409e40b9ae5475c534eeb");
				openedPortal = true;
				GameState.Get().SetBusy(busy: false);
				break;
			case "KARA_07_04":
			case "KARA_07_04heroic":
				GameState.Get().SetBusy(busy: true);
				yield return PlayBossLine(enemyActor, "VO_Curator_Male_ArcaneGolem_CuratorPirates_01.prefab:ac13b5145f3830a46b852218464e30bf");
				openedPortal = true;
				GameState.Get().SetBusy(busy: false);
				break;
			case "KARA_07_05":
			case "KARA_07_05heroic":
				GameState.Get().SetBusy(busy: false);
				yield return PlayBossLine(enemyActor, "VO_Curator_Male_ArcaneGolem_CuratorBeasts_01.prefab:c169916328b5c75419231d5010294d85");
				openedPortal = true;
				GameState.Get().SetBusy(busy: false);
				break;
			case "KARA_07_06":
			case "KARA_07_06heroic":
				GameState.Get().SetBusy(busy: true);
				yield return PlayBossLine(enemyActor, "VO_Curator_Male_ArcaneGolem_CuratorDemons_01.prefab:51ea55c4a2dc2b648b80da79fdf44e19");
				openedPortal = true;
				GameState.Get().SetBusy(busy: false);
				break;
			case "KARA_07_07":
			case "KARA_07_07heroic":
				GameState.Get().SetBusy(busy: true);
				yield return PlayBossLine(enemyActor, "VO_Curator_Male_ArcaneGolem_CuratorMechs_01.prefab:f3c8f9a25842b6845b39f6de8a832c97");
				openedPortal = true;
				GameState.Get().SetBusy(busy: false);
				break;
			case "KARA_07_08":
			case "KARA_07_08heroic":
				GameState.Get().SetBusy(busy: true);
				yield return PlayBossLine(enemyActor, "VO_Curator_Male_ArcaneGolem_CuratorDragons_01.prefab:11288acd111088a43965361a5a3fde44");
				openedPortal = true;
				GameState.Get().SetBusy(busy: false);
				break;
			}
			if (openedPortal && !m_playedLines.Contains("VO_Moroes_Male_Human_CuratorTurn3_01"))
			{
