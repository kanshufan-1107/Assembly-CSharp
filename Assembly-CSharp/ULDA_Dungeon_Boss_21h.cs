...
public class ULDA_Dungeon_Boss_21h : ULDA_Dungeon
{
	...
	protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
	{
		...
		{
			if (playerHeroCardID != "ULDA_Elise" && playerHeroCardID != "ULDA_Reno")
			{
	...
	protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
	{
		...
		if (!(cardID == "ULD_276"))
		{
			if (cardID == "ULD_155")
			{
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_21h_Female_BloodElf_PlayerUnsealtheVault_01);
			}
		}
		else
		{
			yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_21h_Female_BloodElf_PlayerTranslatingHieroglyphics_01);
		}
	}
	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
		{
			...
			{
			case "DAL_727":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_21h_Female_BloodElf_BossCalltoAdventure_01);
				break;
			case "EX1_080":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_21h_Female_BloodElf_BossSecretkeeper_01);
				break;
			case "ULD_728":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_21h_Female_BloodElf_BossSubdue_01);
				break;
			}
		}
	}
