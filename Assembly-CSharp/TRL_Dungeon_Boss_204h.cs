...
public class TRL_Dungeon_Boss_204h : TRL_Dungeon
{
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		{
		case 1001:
			yield return PlayLineOnlyOnce(enemyActor, VO_TRLA_204h_Male_Troll_Event_RandomSpell_01);
			break;
		case 1002:
			yield return PlayLineOnlyOnce(enemyActor, VO_TRLA_204h_Male_Troll_Event_Reducecost_01);
			break;
		case 1003:
			yield return PlayLineOnlyOnce(enemyActor, VO_TRLA_204h_Male_Troll_Shrine_DrawCards_02);
			break;
		case 1004:
			yield return PlayLineOnlyOnce(enemyActor, VO_TRLA_204h_Male_Troll_Shrine_BigDamage_02);
			break;
		case 1005:
			yield return PlayLineOnlyOnce(enemyActor, VO_TRLA_204h_Male_Troll_Shrine_BigDamage_03);
			break;
		default:
	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()))
		{
			...
			{
			case "TRL_901":
				yield return PlayLineOnlyOnce(enemyActor, VO_TRLA_204h_Male_Troll_Event_Panther_01);
				break;
			case "TRL_900":
				yield return PlayLineOnlyOnce(enemyActor, VO_TRLA_204h_Male_Troll_Shrine_BigDamage_04);
				break;
			case "TRLA_165":
				yield return PlayLineOnlyOnce(enemyActor, VO_TRLA_204h_Male_Troll_Shrine_DrawCards_03);
				break;
			case "TRL_348":
				yield return PlayLineOnlyOnce(enemyActor, VO_TRLA_204h_Male_Troll_Event_Lynx_01);
				break;
			case "TRLA_166":
				yield return PlayLineOnlyOnce(enemyActor, VO_TRLA_204h_Male_Troll_Event_Harbinger_01);
				break;
			case "TRL_111":
				yield return PlayLineOnlyOnce(enemyActor, VO_TRLA_204h_Male_Troll_Event_Hatchet_02);
				break;
			}
		}
	}
