...
public class DRGA_Good_Fight_11 : DRGA_Dungeon
{
	...
	protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
	{
		...
		if (emoteType == EmoteType.START)
		{
			if (!m_Heroic)
			{
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_DRGA_BOSS_08h_Male_Kobold_Good_Fight_11_BossStart_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
				return;
			}
			if (m_Heroic)
			{
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_DRGA_BOSS_08h_Male_Kobold_Good_Fight_11_BossStartHeroic_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
				return;
			}
		}
		if (MissionEntity.STANDARD_EMOTE_RESPONSE_TRIGGERS.Contains(emoteType))
		{
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_DRGA_BOSS_08h_Male_Kobold_Good_Fight_11_EmoteResponse_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
		}
	}
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		case 100:
			if (!m_Heroic)
			{
				yield return PlayLineAlways(enemyActor, VO_DRGA_BOSS_08h_Male_Kobold_Good_Fight_11_Misc_01_01);
			}
			break;
		case 101:
			if (!m_Heroic)
			{
				yield return PlayLineAlways(enemyActor, VO_DRGA_BOSS_08h_Male_Kobold_Good_Fight_11_Misc_02_01);
			}
			break;
		case 104:
			if (!m_Heroic)
			...
			break;
		case 106:
			yield return PlayLineOnlyOnce(enemyActor, VO_DRGA_BOSS_08h_Male_Kobold_Good_Fight_11_BossAttack_01);
			break;
		case 107:
			if (!m_Heroic)
			{
				yield return PlayLineAlways(enemyActor, VO_DRGA_BOSS_08h_Male_Kobold_Good_Fight_11_Reno_Released_04_01);
			}
			break;
		case 108:
			if (!m_Heroic)
	...
	protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
		{
			...
			case "UNG_842":
			case "UNG_851":
				yield return PlayLineOnlyOnce(enemyActor, VO_DRGA_BOSS_08h_Male_Kobold_Good_Fight_11_Player_Elise_01);
				break;
			case "DRGA_BOSS_08t2":
				yield return PlayAndRemoveRandomLineOnlyOnce(enemyActor, m_VO_DRGA_BOSS_08h_Male_Kobold_Good_Fight_11_Player_LivingCandleLines);
				break;
			case "LOOT_541":
				yield return PlayLineOnlyOnce(enemyActor, VO_DRGA_BOSS_08h_Male_Kobold_Good_Fight_11_Player_Togwaggle_01);
				break;
			case "DRG_036":
				yield return PlayLineOnlyOnce(enemyActor, VO_DRGA_BOSS_08h_Male_Kobold_Good_Fight_11_Player_Waxadred_01);
				break;
			case "LOOT_117":
				yield return PlayLineOnlyOnce(enemyActor, VO_DRGA_BOSS_08h_Male_Kobold_Good_Fight_11_Player_WaxElemental_01);
				break;
			case "DAL_064":
			case "GVG_110":
			case "DAL_431":
			case "DAL_729":
			case "DAL_417":
				yield return PlayLineOnlyOnce(enemyActor, VO_DRGA_BOSS_08h_Male_Kobold_Good_Fight_11_Player_EVIL_01);
				break;
			}
		}
	}
	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
		{
			...
			{
				yield return PlayAndRemoveRandomLineOnlyOnce(enemyActor, m_VO_DRGA_BOSS_08h_Male_Kobold_Good_Fight_11_Boss_WaxLanceLines);
			}
		}
	}
