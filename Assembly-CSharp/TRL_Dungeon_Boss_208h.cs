...
public class TRL_Dungeon_Boss_208h : TRL_Dungeon
{
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		{
		case 1001:
			yield return PlayLineOnlyOnce(enemyActor, VO_TRLA_208h_Female_Troll_Shrine_BigRez_02);
			break;
		case 1002:
			yield return PlayLineOnlyOnce(enemyActor, VO_TRLA_208h_Female_Troll_Shrine_BigSummon_02);
			break;
		case 1003:
			yield return PlayLineOnlyOnce(enemyActor, VO_TRLA_208h_Female_Troll_Shrine_BigSummon_03);
			break;
		case 1004:
			yield return PlayAndRemoveRandomLineOnlyOnce(enemyActor, m_DeathrattleLines);
			break;
		case 1005:
			yield return PlayAndRemoveRandomLineOnlyOnce(enemyActor, m_HealingLines);
			break;
		case 1006:
			yield return PlayAndRemoveRandomLineOnlyOnce(enemyActor, m_SpellLines);
			break;
		default:
	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()))
		{
			...
			{
			case "TRL_260":
				yield return PlayLineOnlyOnce(enemyActor, VO_TRLA_208h_Female_Troll_Shrine_BigRez_01);
				break;
			case "TRL_502":
				yield return PlayLineOnlyOnce(enemyActor, VO_TRLA_208h_Female_Troll_Shrine_BigRez_03);
				break;
			case "TRL_501":
				yield return PlayLineOnlyOnce(enemyActor, VO_TRLA_208h_Female_Troll_Play_AuchenaiPhantasm_01);
				break;
			case "TRL_097":
				yield return PlayLineOnlyOnce(enemyActor, VO_TRLA_208h_Female_Troll_Play_Seance_01);
				break;
			case "TRL_500":
				yield return PlayLineOnlyOnce(enemyActor, VO_TRLA_208h_Female_Troll_Play_Surrender_01);
				break;
			case "TRLA_150":
				yield return PlayLineOnlyOnce(enemyActor, VO_TRLA_208h_Female_Troll_EventMedic_01);
				break;
			case "TRLA_151":
				yield return PlayLineOnlyOnce(enemyActor, VO_TRLA_208h_Female_Troll_EventMender_01);
				break;
			case "TRLA_152":
				yield return PlayLineOnlyOnce(enemyActor, VO_TRLA_208h_Female_Troll_EventSoulbreaker_01);
				break;
			}
		}
	}
