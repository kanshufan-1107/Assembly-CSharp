...
public class ULDA_Dungeon_Boss_78h : ULDA_Dungeon
{
	...
	{
		base.PreloadAssets();
		List<string> soundFiles = new List<string> { VO_ULDA_BOSS_78h_Octosari_Death, VO_ULDA_BOSS_78h_Octosari_DefeatPlayer, VO_ULDA_BOSS_78h_Octosari_EmoteResponse, VO_ULDA_BOSS_78h_Octosari_Intro };
