...
public class DALA_Dungeon_Boss_63h : DALA_Dungeon
{
	...
	protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
	{
		...
		{
			if (playerHeroCardID != "DALA_Eudora" && playerHeroCardID != "DALA_Chu" && playerHeroCardID != "DALA_Squeamlish")
			{
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		{
		case 101:
			yield return PlayLineOnlyOnce(enemyActor, VO_DALA_BOSS_63h_Male_Orc_BossBigWeapon_01);
			break;
		case 102:
			yield return PlayLineOnlyOnce(enemyActor, VO_DALA_BOSS_63h_Male_Orc_PlayerDragon_01);
			break;
		case 103:
			yield return PlayAndRemoveRandomLineOnlyOnce(enemyActor, m_HeroPower);
			break;
		case 104:
			yield return PlayAndRemoveRandomLineOnlyOnce(enemyActor, m_HeroPowerRare);
			break;
		default:
	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
		{
			...
			if (cardID == "EX1_407")
			{
				yield return PlayLineOnlyOnce(enemyActor, VO_DALA_BOSS_63h_Male_Orc_BossBrawl_01);
			}
		}
	}
}
