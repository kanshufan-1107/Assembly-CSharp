...
public class MercenaryMessageItemDisplayContentDataModel : DataModelEventDispatcher, IDataModel, IDataModelProperties
{
	public const int ModelId = 486;
	...
	public int DataModelId => 486;

	public string DataModelDisplayName => "mercenary_message_item_display_content";
