...
public class AchievementDataModel : DataModelEventDispatcher, IDataModel, IDataModelProperties
{
	...
	private AchievementManager.AchievementDisplayMode m_DisplayMode;
	...
	private DataModelProperty[] m_properties = new DataModelProperty[25]
	{
		...
		new DataModelProperty
		{
			...
			Type = typeof(AchievementManager.AchievementDisplayMode)
		},
		new DataModelProperty
		{
			PropertyId = 22,
		...
		{
			PropertyId = 24,
			PropertyDisplayName = "locked_message",
			Type = typeof(string)
		}
	};
	...
	public AchievementManager.AchievementDisplayMode DisplayMode
	{
		get
		{
	...
	public string LockedMessage
	{
		...
		set
		{
			if (!(m_LockedMessage == value))
			{
				m_LockedMessage = value;
				DispatchChangedListeners();
				DataContext.DataVersion++;
			}
		}
	...
	public bool SetPropertyValue(int id, object value)
	{
		...
		case 20:
			...
			return true;
		case 21:
			DisplayMode = ((value != null) ? ((AchievementManager.AchievementDisplayMode)value) : AchievementManager.AchievementDisplayMode.Default);
			return true;
		case 22:
		...
		case 23:
			...
			return true;
		case 24:
			LockedMessage = ((value != null) ? ((string)value) : null);
			return true;
		default:
			return false;
		}
