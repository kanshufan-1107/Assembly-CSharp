...
public class PVPDRLobbyDataModel : DataModelEventDispatcher, IDataModel, IDataModelProperties
{
	...
	private bool m_IsSessionRolledOver;
	...
	private DataModelProperty[] m_properties = new DataModelProperty[23]
	{
		...
		{
			PropertyId = 575,
			PropertyDisplayName = "is_session_rolled_over",
			Type = typeof(bool)
		}
	};
	...
	public bool IsSessionRolledOver
	{
		get
		{
			return m_IsSessionRolledOver;
		}
		set
		{
			if (m_IsSessionRolledOver != value)
			{
				m_IsSessionRolledOver = value;
				DispatchChangedListeners();
				DataContext.DataVersion++;
			}
		}
	...
	public int GetPropertiesHashCode()
	{
		...
		_ = m_IsRatingNotice;
		int num18 = ((num17 + m_IsRatingNotice.GetHashCode()) * 31 + ((m_NoticeRatingString != null) ? m_NoticeRatingString.GetHashCode() : 0)) * 31;
		_ = m_IsSessionRolledOver;
		return num18 + m_IsSessionRolledOver.GetHashCode();
	}
	...
	public bool SetPropertyValue(int id, object value)
	{
		...
		case 262:
			...
			return true;
		case 575:
			IsSessionRolledOver = value != null && (bool)value;
			return true;
		default:
			return false;
		}
