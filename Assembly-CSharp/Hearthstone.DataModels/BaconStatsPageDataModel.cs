...
public class BaconStatsPageDataModel : DataModelEventDispatcher, IDataModel, IDataModelProperties
{
	...
	private DataModelProperty[] m_properties = new DataModelProperty[23]
	{
		...
		{
			PropertyId = 21,
			PropertyDisplayName = "cards_passed",
			Type = typeof(int)
		},
		new DataModelProperty
		{
			PropertyId = 22,
			PropertyDisplayName = "pings_sent",
			Type = typeof(int)
		}
	};
	...
	public bool SetPropertyValue(int id, object value)
	{
		...
		case 20:
			...
			return true;
		case 21:
			CardsPassed = ((value != null) ? ((int)value) : 0);
			return true;
		case 22:
			PingsSent = ((value != null) ? ((int)value) : 0);
			return true;
		default:
			return false;
		}
