...
public class TextMessageItemDisplayContentDataModel : DataModelEventDispatcher, IDataModel, IDataModelProperties
{
	public const int ModelId = 487;
	...
	public int DataModelId => 487;

	public string DataModelDisplayName => "text_message_item_display_content";
