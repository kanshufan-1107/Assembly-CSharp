...
public class GIL_Dungeon_Boss_52h : GIL_Dungeon
{
	...
	protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
	{
		...
		{
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_GILA_BOSS_52h_Male_Human_IntroALT_02.prefab:188027863e77f9a45b98d167b20b4c84", Notification.SpeechBubbleDirection.TopRight, enemyActor));
		}
		else if (MissionEntity.STANDARD_EMOTE_RESPONSE_TRIGGERS.Contains(emoteType))
		{
			if (enemyHeroCardID == "GILA_BOSS_52h")
			{
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_GILA_BOSS_52h_Male_Human_EmoteResponse_02.prefab:7814835bce0a20b4c8f08b44b8f49df1", Notification.SpeechBubbleDirection.TopRight, enemyActor));
			}
			if (enemyHeroCardID == "GILA_BOSS_52h2")
			{
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_GILA_BOSS_52h2_Male_Worgen_EmoteResponse_02.prefab:7b90e896be2eb4f42ad4d49d1e3b02f9", Notification.SpeechBubbleDirection.TopRight, enemyActor));
			}
		}
	}
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		case 101:
		{
			string randomLine = PopRandomLineWithChance(m_RandomNormalLines);
			if (randomLine != null)
			{
		...
		case 102:
		{
			string randomLine = PopRandomLineWithChance(m_RandomBeastLines);
			if (randomLine != null)
			{
				yield return PlayLineOnlyOnce(enemyActor, randomLine);
			}
		...
		case 103:
			yield return PlayLineOnlyOnce(enemyActor, "VO_GILA_BOSS_52h_Male_Human_EventTransform_01.prefab:cde26ca6a55ffa141b921e42b957e435");
			break;
		}
	}
	...
	protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
	{
		...
		{
			string randomLine = PopRandomLineWithChance(m_RandomStealthLines);
			if (randomLine != null)
			{
				yield return PlayLineOnlyOnce(enemyActor, randomLine);
			}
