...
public class DALA_Dungeon_Boss_58h : DALA_Dungeon
{
	...
	protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
	{
		...
		if (emoteType == EmoteType.START)
		{
			...
			{
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_DALA_BOSS_58h_Male_Goblin_IntroEudora_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
			}
			else if (playerHeroCardID == "DALA_RAkanishu")
			{
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_DALA_BOSS_58h_Male_Goblin_IntroRakanishu_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
			}
			else
			{
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		{
		case 101:
			yield return PlayAndRemoveRandomLineOnlyOnce(enemyActor, m_TurnOne);
			break;
		case 102:
			yield return PlayLineOnlyOnce(enemyActor, VO_DALA_BOSS_58h_Male_Goblin_TurnTwo_01);
			break;
		case 103:
			yield return PlayLineOnlyOnce(enemyActor, VO_DALA_BOSS_58h_Male_Goblin_TurnFour_01);
			break;
		case 104:
			yield return PlayLineOnlyOnce(enemyActor, VO_DALA_BOSS_58h_Male_Goblin_TurnSix_01);
			break;
		case 105:
			yield return PlayLineOnlyOnce(enemyActor, VO_DALA_BOSS_58h_Male_Goblin_HeroPowerSilence_01);
			break;
		case 106:
			yield return PlayLineOnlyOnce(enemyActor, VO_DALA_BOSS_58h_Male_Goblin_BossDrawBomb_01);
			break;
		case 107:
			yield return PlayAndRemoveRandomLineOnlyOnce(enemyActor, m_WiresTrigger);
			break;
		default:
	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
		{
			...
			{
			case "BOT_031":
				yield return PlayLineOnlyOnce(enemyActor, VO_DALA_BOSS_58h_Male_Goblin_BossGoblinBombs_01);
				break;
			case "BOT_511":
			case "DAL_060":
			case "GVG_056t":
				yield return PlayLineOnlyOnce(enemyActor, VO_DALA_BOSS_58h_Male_Goblin_BossShuffleBomb_01);
				break;
			}
		}
	}
