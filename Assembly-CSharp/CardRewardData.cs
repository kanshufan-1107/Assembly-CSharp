public class CardRewardData : RewardData
{
	...
	public CardRewardData(string cardID, TAG_PREMIUM premium, int count, bool showQuestToast = false)
		: this(cardID, premium, count, "", "", showQuestToast)
	{
	}

	public CardRewardData(string cardID, TAG_PREMIUM premium, int count, string nameOverride, string descriptionOverride, bool showQuestToast = false)
		: base(Reward.Type.CARD, showQuestToast)
	{
		CardID = cardID;
		Count = count;
		Premium = premium;
	...
	public override string ToString()
	{
		...
		string cardName = ((entityDef == null) ? "[UNKNOWN]" : entityDef.GetName());
		return $"[CardRewardData: cardName={cardName} CardID={CardID}, Premium={Premium} Count={Count} Origin={base.Origin} OriginData={base.OriginData}]";
	}
