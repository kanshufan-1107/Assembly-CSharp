...
public class ULDA_Dungeon_Boss_55h : ULDA_Dungeon
{
	...
	{
		base.PreloadAssets();
		List<string> soundFiles = new List<string> { VO_ULDA_BOSS_55h_WaterTotingMurlocs_Birth, VO_ULDA_BOSS_55h_WaterTotingMurlocs_Death, VO_ULDA_BOSS_55h_WaterTotingMurlocs_Defeat, VO_ULDA_BOSS_55h_WaterTotingMurlocs_EmoteResponse };
