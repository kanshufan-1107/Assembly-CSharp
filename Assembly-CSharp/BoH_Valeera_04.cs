...
public class BoH_Valeera_04 : BoH_Valeera_Dungeon
{
	...
	public override IEnumerator DoActionsBeforeDealingBaseMulliganCards()
	{
		...
		yield return MissionPlayVO(enemyActor, VO_Story_Hero_Vendellin_Male_BloodElf_Story_Valeera_Mission4Intro_01);
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		{
		case 507:
			yield return PlayLineAlways(enemyActor, VO_Story_Hero_Vendellin_Male_BloodElf_Story_Valeera_Mission4Loss_01);
			break;
		case 102:
			GameState.Get().SetBusy(busy: true);
			yield return PlayLineAlways(enemyActor, VO_Story_Hero_Vendellin_Male_BloodElf_Story_Valeera_Mission4Victory_01);
			GameState.Get().SetBusy(busy: false);
			break;
		case 103:
			GameState.Get().SetBusy(busy: true);
	...
	protected override IEnumerator HandleStartOfTurnWithTiming(int turn)
	{
		...
		{
		case 1:
			yield return PlayLineAlways(enemyActor, VO_Story_Hero_Vendellin_Male_BloodElf_Story_Valeera_Mission4ExchangeA_01);
