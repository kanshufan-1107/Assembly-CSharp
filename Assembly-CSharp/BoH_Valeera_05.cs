...
public class BoH_Valeera_05 : BoH_Valeera_Dungeon
{
	...
	public override IEnumerator DoActionsBeforeDealingBaseMulliganCards()
	{
		...
		yield return MissionPlayVO(enemyActor, VO_Story_Hero_Stasia_Female_Undead_Story_Valeera_Mission5Intro_01);
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		{
		case 507:
			yield return PlayLineAlways(enemyActor, VO_Story_Hero_Stasia_Female_Undead_Story_Valeera_Mission5Loss_01);
			break;
		case 504:
			GameState.Get().SetBusy(busy: true);
		...
		case 108:
		{
			Actor m_Garona = GetEnemyActorByCardId("Story_06_Garona");
			if (m_Garona != null)
			{
				yield return PlayLineAlways(m_Garona, VO_Story_Hero_Garona_Female_Orc_Story_Valeera_Mission5ExchangeD_01);
			}
		...
		case 109:
		{
			Actor m_GaronaDormant = GetEnemyActorByCardId("Story_06_GaronaDormant");
			if (m_GaronaDormant != null)
			{
				yield return PlayLineAlways(m_GaronaDormant, VO_Story_Hero_Garona_Female_Orc_Story_Valeera_Mission5ExchangeD_01);
			}
			yield return PlayLineAlways(friendlyActor, VO_Story_Hero_Valeera_Female_BloodElf_Story_Valeera_Mission5ExchangeD_02);
			break;
		}
