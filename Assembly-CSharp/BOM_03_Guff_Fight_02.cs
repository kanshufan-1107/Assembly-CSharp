...
public class BOM_03_Guff_Fight_02 : BOM_03_Guff_Dungeon
{
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		{
		case 514:
			yield return MissionPlayVO(friendlyActor, VO_Story_Hero_Guff_Male_Tauren_Story_Guff_Mission2Intro_01);
		...
		case 504:
			GameState.Get().SetBusy(busy: true);
			yield return MissionPlayVO(friendlyActor, VO_Story_Hero_Guff_Male_Tauren_Story_Guff_Mission2Victory_01);
	...
	protected override IEnumerator HandleStartOfTurnWithTiming(int turn)
	{
		...
		case 5:
			...
			break;
		case 9:
			yield return MissionPlayVO(enemyActor, VO_Story_Hero_Vapos_Male_Elemental_Story_Guff_Mission2ExchangeC_01);
	...
	private void UpdateTurnCounterText(int cost)
	{
		...
		string counterName = GameStrings.FormatPlurals("BOM_GUFF_02", pluralNumbers);
