...
public class ULDA_Dungeon_Boss_41h : ULDA_Dungeon
{
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		{
		case 102:
			yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_41h_Female_Worgen_HeroPowerBeast_01);
			break;
		case 103:
			yield return PlayAndRemoveRandomLineOnlyOnce(enemyActor, m_HeroPowerLines);
			break;
		case 101:
			yield return PlayBossLine(enemyActor, VO_ULDA_BOSS_41h_Female_Worgen_TurnOne_01);
			break;
		default:
	...
	protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
	{
		...
		if (!(cardID == "EX1_382"))
		{
			if (cardID == "ULD_327")
			{
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_41h_Female_Worgen_PlayerBazaarMugger_01);
			}
		}
		else
		{
			yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_41h_Female_Worgen_PlayerAldorPeacekeeper_01);
		}
	}
	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
		{
			...
			{
			case "GIL_828":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_41h_Female_Worgen_BossDireFrenzy_01);
				break;
			case "BOT_402":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_41h_Female_Worgen_BossSecretPlan_01);
				break;
			case "LOOT_079":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_41h_Female_Worgen_BossWanderingMonsterTrigger_01);
				break;
			}
		}
	}
