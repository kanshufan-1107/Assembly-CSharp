...
public class DALA_Dungeon_Boss_67h : DALA_Dungeon
{
	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
		{
			...
			{
			case "LOOT_108":
				yield return PlayLineOnlyOnce(enemyActor, VO_DALA_BOSS_67h_Male_Human_BossAluneth_01);
				break;
			case "BRM_002":
			case "DAL_182":
			case "NEW1_020":
				yield return PlayLineOnlyOnce(enemyActor, VO_DALA_BOSS_67h_Male_Human_BossSpellDamageMinion_01);
				break;
			case "AT_004":
			case "CFM_623":
			case "CS2_023":
			...
			case "DS1_185":
			case "EX1_277":
				yield return PlayAndRemoveRandomLineOnlyOnce(enemyActor, m_BossArcaneSpells);
				break;
			}
		}
	}
