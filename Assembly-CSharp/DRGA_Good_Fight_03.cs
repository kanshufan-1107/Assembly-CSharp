...
public class DRGA_Good_Fight_03 : DRGA_Dungeon
{
	...
	protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
	{
		...
		if (emoteType == EmoteType.START)
		{
			if (!m_Heroic)
			{
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_DRGA_BOSS_13h_Female_Arakkoa_Good_Fight_03_BossStart_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
			}
			else if (m_Heroic)
			{
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_DRGA_BOSS_13h_Female_Arakkoa_Good_Fight_03_BossStartHeroic_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
			}
		}
		else if (MissionEntity.STANDARD_EMOTE_RESPONSE_TRIGGERS.Contains(emoteType))
		{
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_DRGA_BOSS_13h_Female_Arakkoa_Good_Fight_03_EmoteResponse_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
		}
	}
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		case 101:
			if (!m_Heroic)
			{
				yield return PlayLineAlways(enemyActor, VO_DRGA_BOSS_13h_Female_Arakkoa_Good_Fight_03_Backstory_01a_01);
		...
		case 103:
			...
			break;
		case 104:
			yield return PlayLineOnlyOnce(enemyActor, VO_DRGA_BOSS_13h_Female_Arakkoa_Good_Fight_03_BossAttack_01);
			break;
		default:
	...
	protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
	{
		...
		if (!(cardID == "DAL_256"))
		{
			...
			{
				yield return PlayAndRemoveRandomLineOnlyOnce(friendlyActor, m_VO_DRGA_BOSS_02h_Female_NightElf_Good_Fight_03_Elise_ThePerfectIdeaLines);
			}
		}
		else if (!m_Heroic)
		{
			yield return PlayAndRemoveRandomLineOnlyOnce(friendlyActor, m_VO_DRGA_BOSS_02h_Female_NightElf_Good_Fight_03_Elise_StandAgainstEvilLines);
		}
	}
	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
		{
			...
			{
			case "DRG_071":
				yield return PlayLineOnlyOnce(enemyActor, VO_DRGA_BOSS_13h_Female_Arakkoa_Good_Fight_03_Kriziki_BadLuckAlbatros_01);
				break;
			case "DRGA_BOSS_13t":
				yield return PlayAndRemoveRandomLineOnlyOnce(enemyActor, m_VO_DRGA_BOSS_13h_Female_Arakkoa_Good_Fight_03_Kriziki_DiamondWindsLines);
				break;
			case "DRG_088":
				yield return PlayLineOnlyOnce(enemyActor, VO_DRGA_BOSS_13h_Female_Arakkoa_Good_Fight_03_Kriziki_DreadRaven_01);
				break;
			case "DAL_729":
				yield return PlayLineOnlyOnce(enemyActor, VO_DRGA_BOSS_13h_Female_Arakkoa_Good_Fight_03_Kriziki_PlayerMadameLazul_01);
				break;
			case "ULD_173":
				yield return PlayLineOnlyOnce(enemyActor, VO_DRGA_BOSS_13h_Female_Arakkoa_Good_Fight_03_Kriziki_PlayerVessina_01);
				break;
			case "YOD_003":
				yield return PlayLineOnlyOnce(enemyActor, VO_DRGA_BOSS_13h_Female_Arakkoa_Good_Fight_03_Kriziki_WingedGuardian_01);
				break;
			}
		}
	}
