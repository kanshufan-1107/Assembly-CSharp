...
public class KAR06_Crone : KAR_MissionEntity
{
	...
	private Actor GetDorothee()
	{
		...
		foreach (Card card in player.GetBattlefieldZone().GetCards())
		{
			...
			if (cardEntity.GetControllerId() == player.GetPlayerId() && cardEntity.GetCardId() == "KARA_04_01")
			{
	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()))
		{
			...
			case "KARA_04_05":
			case "KARA_04_05h":
				yield return PlayBossLine(enemyActor, "VO_Crone_Female_Troll_CroneFlyingMonkeys_01.prefab:8f6b0cbfef4a3384286ec890a06d1d10");
				break;
			case "KARA_04_02hp":
				yield return PlayCriticalLine(enemyActor, "VO_Crone_Female_Troll_CroneEmoteResponse_02.prefab:84a22c615324303489aa69ffb9423a7f");
				break;
			}
		}
	}
