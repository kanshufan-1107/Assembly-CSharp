...
public class DungeonCrawlDataTavernBrawl : IDungeonCrawlData
{
	public struct DataSet
	{
		...
		public List<GuestHero> m_guestHeroes;
	...
	{
		return AdventureUtils.GetHeroPowersForAdventureAndGuestHero(GetSelectedAdventure(), guestHeroId);
	}
	...
	{
		return AdventureUtils.GetLoadoutTreasuresForAdventureAndGuestHero(GetSelectedAdventure(), guestHeroId);
	}
