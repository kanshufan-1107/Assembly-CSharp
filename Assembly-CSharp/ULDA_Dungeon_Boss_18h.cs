...
public class ULDA_Dungeon_Boss_18h : ULDA_Dungeon
{
	...
	protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
	{
		...
		if (emoteType == EmoteType.START)
		{
			...
			{
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_ULDA_BOSS_18h_Male_Gnome_IntroFinleyResponse_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
			}
			else if (playerHeroCardID != "ULDA_Reno" && playerHeroCardID != "ULDA_Brann")
			{
	...
	protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
		{
			...
			{
			case "GVG_096":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_18h_Male_Gnome_PlayerPilotedShredder_01);
				break;
			case "ULD_172":
			case "ULD_707":
			case "ULD_715":
			case "ULD_717":
			case "ULD_718":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_18h_Male_Gnome_PlayerPlague_01);
				break;
			case "GVG_116":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_18h_Male_Gnome_PlayerThermaplugg_01);
				break;
			}
		}
	}
	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
		{
			...
			{
			case "LOE_007":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_18h_Male_Gnome_BossCurseofRafaam_01);
				break;
			case "GIL_665":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_18h_Male_Gnome_BossCurseofWeakness_01);
				break;
			case "EX1_029":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_18h_Male_Gnome_BossLeperGnome_01);
				break;
			}
		}
	}
