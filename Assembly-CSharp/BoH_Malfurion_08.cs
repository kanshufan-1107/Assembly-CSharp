...
public class BoH_Malfurion_08 : BoH_Malfurion_Dungeon
{
	...
	public override IEnumerator DoActionsBeforeDealingBaseMulliganCards()
	{
		...
		yield return MissionPlayVO(enemyActor, VO_Story_Hero_Sylvanas_Female_Undead_Story_Malfurion_Mission8Intro_01);
	...
	public override IEnumerator OnPlayThinkEmoteWithTiming()
	{
		...
		if (thinkEmoteBossIdleChancePercentage > randomThink || (!m_Mission_FriendlyPlayIdleLines && m_Mission_EnemyPlayIdleLines))
		{
			Actor enemyActor = GameState.Get().GetOpposingSidePlayer().GetHeroCard()
				.GetActor();
			if (opposingHeroCard == "Story_08_Saurfang_008h2")
			{
				string voLine = PopRandomLine(m_BossSaurfangIdleLinesCopy);
			...
			else if (opposingHeroCard == "Story_08_Sylvanas_008hb")
			{
				string voLine2 = PopRandomLine(m_BossIdleLinesCopy);
	...
	protected override IEnumerator HandleStartOfTurnWithTiming(int turn)
	{
		...
		{
		case 1:
			yield return PlayLineAlways(enemyActor, VO_Story_Hero_Sylvanas_Female_Undead_Story_Malfurion_Mission8ExchangeA_01);
			break;
		case 3:
			yield return PlayLineAlways(enemyActor, VO_Story_Hero_Sylvanas_Female_Undead_Story_Malfurion_Mission8ExchangeB_01);
