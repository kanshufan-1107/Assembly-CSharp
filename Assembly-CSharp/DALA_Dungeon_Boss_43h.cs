...
public class DALA_Dungeon_Boss_43h : DALA_Dungeon
{
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		case 101:
			...
			break;
		case 102:
			yield return PlayAndRemoveRandomLineOnlyOnce(enemyActor, m_RopeExplodes);
			break;
		case 103:
			yield return PlayLineOnlyOnce(enemyActor, VO_DALA_BOSS_43h_Female_BloodElf_TurnOne_01);
			break;
		default:
	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
		{
			...
			if (cardID == "UNG_028t")
			{
				yield return PlayLineOnlyOnce(enemyActor, VO_DALA_BOSS_43h_Female_BloodElf_BossTimeWarp_01);
			}
		}
	}
}
