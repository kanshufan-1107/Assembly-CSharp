...
public class ULDA_Dungeon_Boss_68h : ULDA_Dungeon
{
	...
	{
		base.PreloadAssets();
		List<string> soundFiles = new List<string> { VO_ULDA_BOSS_68h_WeaponizedWasp_Death, VO_ULDA_BOSS_68h_WeaponizedWasp_PlayerDefeat, VO_ULDA_BOSS_68h_WeaponizedWasp_EmoteResponse, VO_ULDA_BOSS_68h_WeaponizedWasp_Intro };
