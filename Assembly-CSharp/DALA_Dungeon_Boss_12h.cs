...
public class DALA_Dungeon_Boss_12h : DALA_Dungeon
{
	...
	protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
	{
		...
		{
			if (playerHeroCardID != "DALA_George" && playerHeroCardID != "DALA_Rakanishu" && playerHeroCardID != "DALA_Chu")
			{
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		case 101:
			...
			break;
		case 102:
			yield return PlayAndRemoveRandomLineOnlyOnce(enemyActor, m_HeroPowerOne);
			break;
		default:
	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
		{
			...
			{
			case "LOOT_014":
				yield return PlayLineOnlyOnce(enemyActor, VO_DALA_BOSS_12h_Male_Undead_BossKoboldLibrarian_01);
				break;
			case "CS2_062":
			case "EX1_308":
				yield return PlayLineOnlyOnce(enemyActor, VO_DALA_BOSS_12h_Male_Undead_BossWarlockFire_01);
				break;
			}
		}
	}
