...
public class ULDA_Dungeon_Boss_12h : ULDA_Dungeon
{
	...
	{
		base.PreloadAssets();
		List<string> soundFiles = new List<string> { VO_ULDA_BOSS_12h_Pyramad_Death_01, VO_ULDA_BOSS_12h_Pyramad_Defeat_01, VO_ULDA_BOSS_12h_Pyramad_EmoteResponse_01, VO_ULDA_BOSS_12h_Pyramad_Intro_01 };
