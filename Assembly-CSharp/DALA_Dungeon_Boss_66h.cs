...
public class DALA_Dungeon_Boss_66h : DALA_Dungeon
{
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		case 101:
			...
			break;
		case 102:
			yield return PlayLineOnlyOnce(enemyActor, VO_DALA_BOSS_66h_Female_Undead_HeroPowerEmpty_01);
			break;
		case 103:
			yield return PlayLineOnlyOnce(enemyActor, VO_DALA_BOSS_66h_Female_Undead_BossBigMinion_01);
			break;
		case 104:
			yield return PlayLineOnlyOnce(enemyActor, VO_DALA_BOSS_66h_Female_Undead_BossBurnCard_01);
			break;
		case 105:
			yield return PlayLineOnlyOnce(enemyActor, VO_DALA_BOSS_66h_Female_Undead_PlayerBurnCard_01);
			break;
		case 106:
			yield return PlayLineOnlyOnce(enemyActor, VO_DALA_BOSS_66h_Female_Undead_PlayerRushMinion_01);
			break;
		case 107:
			yield return PlayLineOnlyOnce(enemyActor, VO_DALA_BOSS_66h_Female_Undead_TriggerBomb_01);
			break;
		default:
	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
		{
			...
			if (cardID == "GIL_665")
			{
				yield return PlayLineOnlyOnce(enemyActor, VO_DALA_BOSS_66h_Female_Undead_BossCurseofWeakness_01);
			}
		}
	}
}
