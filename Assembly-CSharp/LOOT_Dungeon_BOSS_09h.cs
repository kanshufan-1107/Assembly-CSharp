...
public class LOOT_Dungeon_BOSS_09h : LOOT_Dungeon
{
	...
	protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
	{
		...
		{
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_LOOTA_BOSS_09h_Female_Furbolg_Intro_01.prefab:29cd999b72b06e0468d7bf599c86bd0b", Notification.SpeechBubbleDirection.TopRight, enemyActor));
		}
		else if (MissionEntity.STANDARD_EMOTE_RESPONSE_TRIGGERS.Contains(emoteType))
		{
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_LOOTA_BOSS_09h_Female_Furbolg_EmoteResponse_01.prefab:21a1c7420686dbd4789868f49a5949e7", Notification.SpeechBubbleDirection.TopRight, enemyActor));
		}
	}
	...
	protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
	{
		...
		case "ICC_056":
			if (m_FrostLines.Count != 0)
			{
				...
				yield return PlayEasterEggLine(enemyActor, randomLine);
