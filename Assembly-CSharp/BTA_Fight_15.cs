...
public class BTA_Fight_15 : BTA_Dungeon
{
	...
	public override IEnumerator DoActionsBeforeDealingBaseMulliganCards()
	{
		...
		yield return PlayLineAlways(friendlyActor, VO_BTA_01_Female_NightElf_Mission_Fight_15_PlayerStart_01);
	...
	protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
	{
		...
		{
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_BTA_BOSS_15h_Female_Broken_Mission_Fight_15_Emote_Response_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
		}
	}
	...
	protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
		{
			...
			{
			case "BT_354":
				yield return PlayLineAlways(enemyActor, VO_BTA_BOSS_15h_Female_Broken_Mission_Fight_15_Hero_BladeDance_01);
				break;
			case "BT_429":
				yield return PlayLineAlways(enemyActor, VO_BTA_BOSS_15h_Female_Broken_Mission_Fight_15_Hero_Metamorphosis_01);
				break;
			case "BT_493":
				yield return PlayLineAlways(enemyActor, VO_BTA_BOSS_15h_Female_Broken_Mission_Fight_15_Hero_PriestessofFury_01);
				break;
			}
		}
	}
	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
		{
			...
			{
			case "BT_702":
				yield return PlayLineAlways(enemyActor, VO_BTA_BOSS_15h_Female_Broken_Mission_Fight_15_Boss_AshtongueSlayer_01);
				break;
			case "CS2_077":
				yield return PlayLineAlways(enemyActor, VO_BTA_BOSS_15h_Female_Broken_Mission_Fight_15_Boss_Sprint_01);
				break;
			case "EX1_126":
				yield return PlayLineAlways(enemyActor, VO_BTA_BOSS_15h_Female_Broken_Mission_Fight_15_Boss_Betrayal_01);
				break;
			}
		}
	}
