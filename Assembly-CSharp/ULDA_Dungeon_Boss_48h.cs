...
public class ULDA_Dungeon_Boss_48h : ULDA_Dungeon
{
	...
	protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
	{
		...
		if (emoteType == EmoteType.START)
		{
			...
			{
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_ULDA_BOSS_48h_Female_Maghar_IntroSpecial_Finley_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
			}
			else
			{
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		if (missionEvent == 101)
		{
			yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_48h_Female_Maghar_BossTriggerWarriorDamageDestroySpell_01);
		}
		else
		{
	...
	protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
		{
			...
			{
			case "ULD_229":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_48h_Female_Maghar_PlayerTrigger_Mischief_Maker_01);
				break;
			case "EX1_407":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_48h_Female_Maghar_PlayerTriggerBrawl_01);
				break;
			case "ULD_280":
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_48h_Female_Maghar_PlayerTrigger_Wasteland_Scorpid_01);
				break;
			}
		}
	}
	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		if (!(cardID == "EX1_407"))
		{
			if (cardID == "CS2_124")
			{
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_48h_Female_Maghar_BossTriggerWolfrider_01);
			}
		}
		else
		{
			yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_48h_Female_Maghar_BossTriggerBrawl_01);
		}
	}
}
