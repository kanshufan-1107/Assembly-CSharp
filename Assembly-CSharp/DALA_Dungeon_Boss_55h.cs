...
public class DALA_Dungeon_Boss_55h : DALA_Dungeon
{
	...
	protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
	{
		...
		if (emoteType == EmoteType.START)
		{
			...
			{
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_DALA_BOSS_55h_Male_Human_IntroGeorge_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
			}
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		{
		case 101:
			yield return PlayLineOnlyOnce(enemyActor, VO_DALA_BOSS_55h_Male_Human_TurnOne_02);
			break;
		case 102:
			yield return PlayLineOnlyOnce(enemyActor, VO_DALA_BOSS_55h_Male_Human_Exposition_02);
			break;
		case 103:
			yield return PlayLineOnlyOnce(enemyActor, VO_DALA_BOSS_55h_Male_Human_Exposition_01);
			break;
		case 104:
			yield return PlayLineOnlyOnce(enemyActor, VO_DALA_BOSS_55h_Male_Human_BossWeaponEquip_01);
			break;
		case 105:
			yield return PlayAndRemoveRandomLineOnlyOnce(enemyActor, m_BossHeroPower);
			break;
		case 106:
			yield return PlayAndRemoveRandomLineOnlyOnce(enemyActor, m_HeroPowerMany);
			break;
		case 107:
			yield return PlayLineOnlyOnce(enemyActor, VO_DALA_BOSS_55h_Male_Human_HeroPowerFull_01);
			break;
		default:
	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
		{
			...
			if (cardID == "KAR_091")
			{
				yield return PlayLineOnlyOnce(enemyActor, VO_DALA_BOSS_55h_Male_Human_BossIronforgePortal_01);
			}
		}
	}
}
