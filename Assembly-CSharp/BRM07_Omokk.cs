...
public class BRM07_Omokk : BRM_MissionEntity
{
	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		case "BRMA07_2H":
			if (!m_heroPowerLinePlayed)
			{
				...
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_BRMA07_1_HERO_POWER_05.prefab:10f8a1b1fc7c9374b8c2b741f27694be", Notification.SpeechBubbleDirection.TopRight, enemyActor));
			}
			break;
		case "BRMA07_3":
			if (!m_cardLinePlayed)
			{
				...
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_BRMA07_1_CARD_04.prefab:f498bd13724f67d48a0f0bc55034c44b", Notification.SpeechBubbleDirection.TopRight, enemyActor));
			}
			break;
		}
	}
	...
	protected override IEnumerator HandleStartOfTurnWithTiming(int turn)
	{
		...
		{
		case 1:
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_BRMA07_1_TURN1_02.prefab:ac11bf2418c6e0f418f2216348b224c3", Notification.SpeechBubbleDirection.TopRight, enemyActor));
			break;
		case 4:
			NotificationManager.Get().CreateCharacterQuote("NormalNefarian_Quote.prefab:708840e536eb141479a23b632ebcc913", quotePos, GameStrings.Get("VO_NEFARIAN_OMOKK1_44"), "VO_NEFARIAN_OMOKK1_44.prefab:82ad9b06a62bf044b9e5660054e5fae6");
			break;
		case 8:
			NotificationManager.Get().CreateCharacterQuote("NormalNefarian_Quote.prefab:708840e536eb141479a23b632ebcc913", quotePos, GameStrings.Get("VO_NEFARIAN_OMOKK2_45"), "VO_NEFARIAN_OMOKK2_45.prefab:bb20664f6b0c27149a6048f473ca0398");
			break;
		}
		yield break;
	}
