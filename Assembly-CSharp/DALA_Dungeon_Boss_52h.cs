...
public class DALA_Dungeon_Boss_52h : DALA_Dungeon
{
	...
	protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
	{
		...
		if (emoteType == EmoteType.START)
		{
			...
			{
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_DALA_BOSS_52h_Female_Human_IntroChu_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
			}
	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		if (!(cardID == "DAL_095"))
		{
			if (cardID == "DAL_096")
			{
				yield return PlayLineOnlyOnce(enemyActor, VO_DALA_BOSS_52h_Female_Human_BossVioletWarden_02);
			}
		}
		else
		{
			yield return PlayLineOnlyOnce(enemyActor, VO_DALA_BOSS_52h_Female_Human_BossVioletSpellsword_01);
		}
	}
}
