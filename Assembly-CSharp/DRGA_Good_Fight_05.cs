...
public class DRGA_Good_Fight_05 : DRGA_Dungeon
{
	...
	protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
	{
		...
		{
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_DRGA_BOSS_18h_Female_BloodElf_Good_Fight_05_BossStart_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
		}
		else if (MissionEntity.STANDARD_EMOTE_RESPONSE_TRIGGERS.Contains(emoteType))
		{
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_DRGA_BOSS_18h_Female_BloodElf_Good_Fight_05_EmoteResponse_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
		}
	}
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		{
		case 100:
			yield return PlayAndRemoveRandomLineOnlyOnce(enemyActor, m_missionEventTrigger100Lines);
			break;
		case 101:
			yield return PlayAndRemoveRandomLineOnlyOnce(enemyActor, m_missionEventTrigger101Lines);
			break;
		case 102:
			yield return PlayLineOnlyOnce(enemyActor, VO_DRGA_BOSS_18h_Female_BloodElf_Good_Fight_05_BossAttack_01);
			break;
		case 103:
			if (!m_Heroic)
			{
				yield return PlayLineAlways(enemyActor, VO_DRGA_BOSS_18h_Female_BloodElf_Good_Fight_05_Misc_01_01);
				yield return PlayLineAlways(friendlyActor, VO_DRGA_BOSS_23h_Female_Forsaken_Good_Fight_05_Misc_02_01);
			}
			break;
		case 105:
			yield return PlayLineAlways(enemyActor, VO_DRGA_BOSS_18h_Female_BloodElf_Good_Fight_05_Misc_03_01);
			break;
		case 106:
			yield return PlayAndRemoveRandomLineOnlyOnce(enemyActor, m_Player_Dragon_01_01);
			break;
		case 110:
			m_Galakrond = true;
			yield return PlayLineOnlyOnce(enemyActor, VO_DRGA_BOSS_18h_Female_BloodElf_Good_Fight_05_Player_Galakrond_01);
			break;
		default:
	...
	protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
		{
			...
			{
			case "YOD_013":
				yield return PlayLineOnlyOnce(enemyActor, VO_DRGA_BOSS_18h_Female_BloodElf_Good_Fight_05_Player_ClericOfScales_01);
				break;
			case "DRG_235":
				yield return PlayLineOnlyOnce(enemyActor, VO_DRGA_BOSS_18h_Female_BloodElf_Good_Fight_05_Player_DragonriderTalritha_01);
				break;
			case "TRL_302":
				yield return PlayLineOnlyOnce(friendlyActor, VO_DRGA_BOSS_23h_Female_Forsaken_Good_Fight_05_Misc_04_01);
				break;
			}
		}
	}
	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
		{
			...
			if (cardID == "ICC_027")
			{
				yield return PlayLineOnlyOnce(enemyActor, VO_DRGA_BOSS_18h_Female_BloodElf_Good_Fight_05_Boss_BoneDrake_01);
			}
		}
	}
	...
	public override void OnPlayThinkEmote()
	{
		...
		if (thinkEmoteBossThinkChancePercentage > randomThink)
		{
			...
			if (!m_Galakrond)
			{
				string voLine = PopRandomLine(m_VO_DRGA_BOSS_18h_Female_BloodElf_Good_Fight_05_IdleLinesNoGalakrondCopy);
			...
			{
				string voLine2 = PopRandomLine(m_VO_DRGA_BOSS_18h_Female_BloodElf_Good_Fight_05_IdleLinesPostGalakrondCopy);
