...
public class LOOT_Dungeon_BOSS_25h : LOOT_Dungeon
{
	...
	protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
	{
		...
		{
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_LOOTA_BOSS_25h_Male_Dragon_Intro_01.prefab:add998ba4e2e01b44aaac7fba9c2b4cc", Notification.SpeechBubbleDirection.TopRight, enemyActor));
		}
		else if (MissionEntity.STANDARD_EMOTE_RESPONSE_TRIGGERS.Contains(emoteType))
		{
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_LOOTA_BOSS_25h_Male_Dragon_EmoteResponse_01.prefab:e90ae3d9090ead040a3b44f8a4e01c4b", Notification.SpeechBubbleDirection.TopRight, enemyActor));
		}
	}
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		if (missionEvent == 101)
		{
			...
			if (m_TreasureDestroyedLines.Count != 0 && chanceVO >= randomNum)
			{
	...
	protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()))
		{
			...
			if (cardID == "LOOT_357")
			{
				yield return PlayEasterEggLine(enemyActor, "VO_LOOTA_BOSS_25h_Male_Dragon_EventMarinTheFox_01.prefab:7660408d472cffa498431e1c6bf0b6bb");
				yield return null;
			}
		}
	}
