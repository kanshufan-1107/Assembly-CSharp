...
public class BoH_Garrosh_06 : BoH_Garrosh_Dungeon
{
	...
	public override IEnumerator DoActionsBeforeDealingBaseMulliganCards()
	{
		...
		yield return PlayLineAlways(enemyActor, VO_Story_Hero_Jaina_Human_Female_Story_Jaina_Mission6Intro_01);
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		case 105:
			...
			break;
		case 501:
			yield return PlayLineAlways(friendlyActor, VO_Story_Hero_Garrosh_Male_Orc_Story_Jaina_Mission6Victory_01);
		...
		case 502:
			...
			{
				yield return PlayLineAlways(friendlyActor, VO_Story_Hero_Garrosh_Male_Orc_Story_Garrosh_Mission6ExchangeB_01);
			}
			else
			{
				yield return null;
	...
	protected override IEnumerator HandleStartOfTurnWithTiming(int turn)
	{
		...
		{
		case 1:
			yield return PlayLineAlways(enemyActor, VO_Story_Hero_Jaina_Human_Female_Story_Jaina_Mission6ExchangeA_01);
		...
		case 3:
			...
			break;
		case 5:
			yield return PlayLineAlways(enemyActor, VO_Story_Hero_Jaina_Female_Human_Story_Garrosh_Mission6ExchangeC_01);
			yield return PlayLineAlways(friendlyActor, VO_Story_Hero_Garrosh_Male_Orc_Story_Garrosh_Mission6ExchangeC_01);
			break;
		case 7:
			yield return PlayLineAlways(enemyActor, VO_Story_Hero_Jaina_Female_Human_Story_Garrosh_Mission6ExchangeD_01);
