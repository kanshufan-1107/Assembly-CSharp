	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		if (!(cardId == "NAX6_02"))
		{
			if (cardId == "NAX6_03" && !m_cardLinePlayed)
			{
				...
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_NAX6_01_CARD_03.prefab:a0f9ea501662eb344b224d4b1e79aa4c", Notification.SpeechBubbleDirection.TopRight, enemyActor));
			}
		}
		else if (!m_heroPowerLinePlayed)
		{
			m_heroPowerLinePlayed = true;
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_NAX6_01_HP_02.prefab:3e1a96b32f62ce041a2fc526a59aa3d1", Notification.SpeechBubbleDirection.TopRight, enemyActor));
		}
	}
}
