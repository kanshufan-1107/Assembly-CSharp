public class PlayerTagThresholdCardTextBuilder : CardTextBuilder
{
	public override string BuildCardTextInHand(Entity entity)
	{
		...
		GAME_TAG playerTag = (GAME_TAG)entity.GetTag(GAME_TAG.PLAYER_TAG_THRESHOLD_TAG_ID);
		int tagValue = player?.GetTag(playerTag) ?? 0;
		int tagThreshold = entity.GetTag(GAME_TAG.PLAYER_TAG_THRESHOLD_VALUE);
