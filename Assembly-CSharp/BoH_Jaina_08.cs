...
public class BoH_Jaina_08 : BoH_Jaina_Dungeon
{
	...
	public override IEnumerator DoActionsBeforeDealingBaseMulliganCards()
	{
		...
		yield return PlayLineAlways(friendlyActor, VO_Story_Hero_Jaina_Human_Female_Story_Jaina_Mission8Intro_01);
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		{
			GameState.Get().SetBusy(busy: true);
			yield return PlayLineAlways(enemyActor, VO_Story_01_Aethas_Male_BloodElf_Story_Jaina_Mission8Loss_01);
			GameState.Get().SetBusy(busy: false);
		}
		else
		{
