...
public class BTA_Fight_22 : BTA_Dungeon_Heroic
{
	...
	protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
	{
		...
		if (emoteType == EmoteType.START)
		{
			...
			{
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_BTA_BOSS_22h_Male_Human_Mission_Fight_22_BossStartIllidan_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
			}
			else
			{
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_BTA_BOSS_22h_Male_Human_Mission_Fight_22_BossStart_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
			}
		}
	...
	protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
		{
			...
			{
			case "ICC_314":
				yield return PlayLineOnlyOnce(enemyActor, VO_BTA_BOSS_22h_Male_Human_Mission_Fight_22_Hero_LichKing_01);
				break;
			case "ICC_481":
			case "ICC_827":
			case "ICC_828":
			...
			case "ICC_833":
			case "ICC_834":
				yield return PlayLineOnlyOnce(enemyActor, VO_BTA_BOSS_22h_Male_Human_Mission_Fight_22_Hero_DeathKnightHero_01);
				break;
			}
		}
	}
	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
		{
			...
			{
			case "ICC_314t4":
				yield return PlayLineOnlyOnce(enemyActor, VO_BTA_BOSS_22h_Male_Human_Mission_Fight_22_Boss_DeathGrip_01);
				break;
			case "ICC_314t5":
				yield return PlayLineOnlyOnce(enemyActor, VO_BTA_BOSS_22h_Male_Human_Mission_Fight_22_Boss_SiphonSoul_01);
				break;
			case "ICC_314t8":
				yield return PlayLineOnlyOnce(enemyActor, VO_BTA_BOSS_22h_Male_Human_Mission_Fight_22_Boss_DeathandDecay_01);
				break;
			}
		}
	}
