...
public class ULDA_Dungeon_Boss_26h : ULDA_Dungeon
{
	...
	protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
	{
		...
		if (emoteType == EmoteType.START)
		{
			...
			{
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_ULDA_BOSS_26h_Female_Mechagnome_IntroReno_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
			}
			else
			{
	...
	protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
	{
		...
		if (!(cardID == "GVG_119"))
		{
			if (cardID == "ULDA_115")
			{
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_26h_Female_Mechagnome_PlayerGnomebliterator_01);
			}
		}
		else
		{
			yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_26h_Female_Mechagnome_PlayerBlingtron_01);
		}
	}
	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		if (!(cardID == "GVG_082"))
		{
			if (cardID == "ULDA_207")
			{
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_26h_Female_Mechagnome_BossGatlingWandTreasure_01);
			}
		}
		else
		{
			yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_26h_Female_Mechagnome_BossClockworkGnome_01);
		}
	}
}
