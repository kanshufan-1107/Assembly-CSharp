...
public class DALA_Dungeon_Boss_10h : DALA_Dungeon
{
	...
	protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
	{
		...
		{
			if (playerHeroCardID != "DALA_Squeamlish" && playerHeroCardID != "DALA_Eudora" && playerHeroCardID != "DALA_Rakanishu" && playerHeroCardID != "DALA_Chu")
			{
	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		if (!(cardID == "AT_031"))
		{
			if (cardID == "CFM_669")
			{
				yield return PlayLineOnlyOnce(enemyActor, VO_DALA_BOSS_10h_Male_Kobold_BossBurglyBully_01);
			}
		}
		else
		{
			yield return PlayLineOnlyOnce(enemyActor, VO_DALA_BOSS_10h_Male_Kobold_BossCutpurse_01);
		}
	}
}
