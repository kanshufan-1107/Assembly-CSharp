...
public class AdventureChooserDescription : MonoBehaviour
{
	...
	private void RefreshText()
	{
		...
		{
			string hex = m_WarningTextColor.r.ToString("X2") + m_WarningTextColor.g.ToString("X2") + m_WarningTextColor.b.ToString("X2");
			showText = "<color=#" + hex + ">" + m_RequiredText + "</color>\n" + m_DescText;
		}
		else
		{
			showText = m_DescText;
		...
		m_DescriptionObject.Text = showText;
	}
}
