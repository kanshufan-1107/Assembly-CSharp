...
public class TB13_LethalPuzzles : MissionEntity
{
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		case 10:
		{
			...
			if (banner != null)
			{
				banner.SetName(GameStrings.Get("TB_LETHAL_NAME"));
			}
			yield break;
		}
		}
		if (s_minionMsgs.ContainsKey(missionEvent))
		{
			...
			NameBanner banner2 = Gameplay.Get().GetNameBannerForSide(Player.Side.OPPOSING);
			if (banner2 != null)
			{
				banner2.SetName(GameStrings.Get("TB_LETHAL_NAME"));
			}
		}
	}
}
