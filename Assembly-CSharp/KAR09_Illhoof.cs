...
public class KAR09_Illhoof : KAR_MissionEntity
{
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		if (!m_playedLines.Contains(missionEventName))
		{
			...
			if (missionEvent == 1)
			{
				...
				yield return PlayMissionFlavorLine(enemyActor, "VO_Illhoof_Male_Demon_IllhoofWounded_01.prefab:b46f0340df9465e4f840d1303fc3b940");
	...
	protected override IEnumerator HandleStartOfTurnWithTiming(int turn)
	{
		...
		{
			yield return PlayOpeningLine(enemyActor, "VO_Illhoof_Male_Demon_IllhoofTurn1_01.prefab:bb152da0f208c2342baa7ea5bf44e68d");
	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		case "KARA_09_05heroic":
			...
			{
				GameState.Get().SetBusy(busy: true);
				yield return PlayBossLine(enemyActor, "VO_Illhoof_Male_Demon_IlhoofKilrek_01.prefab:57aeb9e4838443e4b9e25968c7db9045");
		...
		case "KARA_09_03heroic":
			yield return PlayBossLine(enemyActor, "VO_Illhoof_Male_Demon_IllhoofSummonImps_01.prefab:cc3a062bf710c454ca87743d4bccc7d6");
			break;
		}
	}
	...
	protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
	{
		...
		{
			yield return PlayEasterEggLine(enemyActor, "VO_Illhoof_Male_Demon_IllhoofSummoningPortal_01.prefab:36097ec5b99abda439a1606c2270fced");
		}
	}
