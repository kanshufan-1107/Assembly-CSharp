...
public class GIL_Dungeon_Boss_55h : GIL_Dungeon
{
	...
	protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
	{
		...
		{
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_GILA_BOSS_55h_Female_NightElf_Intro_01.prefab:e3728559d0b0985429d242b1fe2b9b8b", Notification.SpeechBubbleDirection.TopRight, enemyActor));
		}
		else if (MissionEntity.STANDARD_EMOTE_RESPONSE_TRIGGERS.Contains(emoteType))
		{
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_GILA_BOSS_55h_Female_NightElf_EmoteResponse_01.prefab:116d3641525316e48946409c8fc0c513", Notification.SpeechBubbleDirection.TopRight, enemyActor));
		}
	}
	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		{
			string randomLine = PopRandomLineWithChance(m_RandomAssimilationLines);
			if (randomLine != null)
			{
	...
	protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
	{
		...
		if (!(cardID == "GILA_853b"))
		{
			if (cardID == "GILA_802")
			{
				yield return PlayBossLine(enemyActor, "VO_GILA_BOSS_55h_Female_NightElf_EventPlayCartographer_01.prefab:68105bfdb75d15444a189b7713d2eb6a");
			}
		}
		else
		{
			yield return PlayBossLine(enemyActor, "VO_GILA_BOSS_55h_Female_NightElf_EventPlayCompass_01.prefab:4976a34329a9cbc48926976b879ca402");
		}
	}
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		if (!m_playedLines.Contains(missionEventName) && missionEvent == 101)
		{
			string randomLine = PopRandomLineWithChance(m_RandomWispLines);
			if (randomLine != null)
			{
				yield return PlayLineOnlyOnce(enemyActor, randomLine);
			}
