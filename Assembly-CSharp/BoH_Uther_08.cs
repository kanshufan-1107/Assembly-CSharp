...
public class BoH_Uther_08 : BoH_Uther_Dungeon
{
	...
	public override IEnumerator DoActionsBeforeDealingBaseMulliganCards()
	{
		...
		yield return PlayLineAlways(friendlyActor, VO_Story_Hero_Uther_Male_Human_Story_Uther_Mission8Intro_01);
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		if (missionEvent == 504)
		{
			yield return PlayLineAlways(enemyActor, VO_Story_Hero_Arthas_Male_Human_Story_Uther_Mission8Loss_01);
		}
		else
		{
	...
	protected override IEnumerator HandleStartOfTurnWithTiming(int turn)
	{
		...
		{
		case 5:
			yield return PlayLineAlways(friendlyActor, VO_Story_Hero_Uther_Male_Human_Story_Uther_Mission8ExchangeB_01);
			yield return PlayLineAlways(enemyActor, VO_Story_Hero_Arthas_Male_Human_Story_Uther_Mission8ExchangeB_01);
			break;
		case 13:
			yield return PlayLineAlways(friendlyActor, VO_Story_Hero_Uther_Male_Human_Story_Uther_Mission8ExchangeC_01);
