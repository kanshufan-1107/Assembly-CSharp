...
public class ULDA_Dungeon_Boss_79h : ULDA_Dungeon
{
	...
	{
		base.PreloadAssets();
		List<string> soundFiles = new List<string> { VO_ULDA_BOSS_79h_ArmadilloMech_Death, VO_ULDA_BOSS_79h_ArmadilloMech_Defeat, VO_ULDA_BOSS_79h_ArmadilloMech_EmoteResponse, VO_ULDA_BOSS_79h_ArmadilloMech_Intro };
