...
public class BRM09_RendBlackhand : BRM_MissionEntity
{
	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		case "BRMA09_2H":
			if (!m_heroPower1LinePlayed)
			{
				...
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_BRMA09_1_HERO_POWER1_06.prefab:fb6da306ffffaee43b86149480e916d1", Notification.SpeechBubbleDirection.TopRight, enemyActor));
			}
			break;
		case "BRMA09_3":
		case "BRMA09_3H":
			if (!m_heroPower2LinePlayed)
			{
				...
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_BRMA09_1_HERO_POWER2_07.prefab:f59ec9255ae38a64c83c90b88b9b04ca", Notification.SpeechBubbleDirection.TopRight, enemyActor));
			}
			break;
		case "BRMA09_4":
		case "BRMA09_4H":
			if (!m_heroPower3LinePlayed)
			{
				...
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_BRMA09_1_HERO_POWER3_08.prefab:213cfaf6d91a2ba42b087e59ed8099a4", Notification.SpeechBubbleDirection.TopRight, enemyActor));
			}
			break;
		case "BRMA09_5":
		case "BRMA09_5H":
			if (!m_heroPower4LinePlayed)
			{
				...
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_BRMA09_1_HERO_POWER4_09.prefab:1068556d8d1e5694eb2d7925ec96957f", Notification.SpeechBubbleDirection.TopRight, enemyActor));
			}
			break;
		case "BRMA09_6":
			if (!m_cardLinePlayed)
			{
				...
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_BRMA09_1_CARD_05.prefab:2976c75ead5ee7c409ff9ee6ce5bb77d", Notification.SpeechBubbleDirection.TopRight, enemyActor));
			}
			break;
		}
	}
	...
	protected override IEnumerator HandleStartOfTurnWithTiming(int turn)
	{
		...
		if (turn == 1)
		{
			yield return Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_BRMA09_1_TURN1_03.prefab:72e081aa0659e0d49ad1b5dfa890f1c5", Notification.SpeechBubbleDirection.TopRight, enemyActor));
