...
public class NAX04_Noth : NAX_MissionEntity
{
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		if (missionEvent == 1 && !m_heroPowerLinePlayed)
		{
			...
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_NAX4_01_HP_02.prefab:ef429c4ce7a413d4fa8ce390025bd388", Notification.SpeechBubbleDirection.TopRight, enemyActor));
		}
	}
	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		Actor enemyActor = GameState.Get().GetOpposingSidePlayer().GetHero()
			.GetCard()
			.GetActor();
		if (entity.GetCardId() == "NAX4_05" && !m_cardLinePlayed)
		{
			m_cardLinePlayed = true;
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_NAX4_01_CARD_03.prefab:676865be5229fbb4ea8b71bb7570b6f2", Notification.SpeechBubbleDirection.TopRight, enemyActor));
		}
	}
}
