...
public class DALA_Dungeon_Boss_46h : DALA_Dungeon
{
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		{
		case 101:
			yield return PlayAndRemoveRandomLineOnlyOnce(enemyActor, m_BubblePop);
			break;
		case 102:
			yield return PlayAndRemoveRandomLineOnlyOnce(enemyActor, m_HeroDamageGT5);
			break;
		case 103:
			yield return PlayLineOnlyOnce(enemyActor, VO_DALA_BOSS_46h_Female_Revenant_PlayerMech_01);
			break;
		default:
	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
		{
			...
			{
			case "LOOT_373":
				yield return PlayLineOnlyOnce(enemyActor, VO_DALA_BOSS_46h_Female_Revenant_BossHealingRain_01);
				break;
			case "UNG_817":
				yield return PlayLineOnlyOnce(enemyActor, VO_DALA_BOSS_46h_Female_Revenant_BossTidalSurge_01);
				break;
			case "CS2_033":
				yield return PlayLineOnlyOnce(enemyActor, VO_DALA_BOSS_46h_Female_Revenant_BossWaterElemental_01);
				break;
			}
		}
	}
