...
public class GIL_Dungeon_Boss_56h : GIL_Dungeon
{
	...
	protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
	{
		...
		{
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_GILA_BOSS_56h_Male_Elemental_IntroALT_02.prefab:685ce5a72c2c9b143ae449798cd25504", Notification.SpeechBubbleDirection.TopRight, enemyActor));
		}
		else if (MissionEntity.STANDARD_EMOTE_RESPONSE_TRIGGERS.Contains(emoteType))
		{
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_GILA_BOSS_56h_Male_Elemental_EmoteResponse_01.prefab:b6e33ab8bedec2f45880bc0814a6244e", Notification.SpeechBubbleDirection.TopRight, enemyActor));
		}
	}
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		case 102:
			yield return PlayBossLine(enemyActor, "VO_GILA_BOSS_56h_Male_Elemental_EventTransformFace_02.prefab:cc00cd508d1eca745a9fd7360b2a9bea");
			break;
		}
	}
}
