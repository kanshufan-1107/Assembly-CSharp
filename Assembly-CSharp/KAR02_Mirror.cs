...
public class KAR02_Mirror : KAR_MissionEntity
{
	...
	{
		List<EmoteType> most_triggers = new List<EmoteType>(MissionEntity.STANDARD_EMOTE_RESPONSE_TRIGGERS);
		most_triggers.Remove(EmoteType.WELL_PLAYED);
		m_emoteResponseGroups = new List<EmoteResponseGroup>
		{
			new EmoteResponseGroup
			{
				m_triggers = most_triggers,
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		if (!m_playedLines.Contains(missionEventName))
		{
			...
			if (missionEvent == 1)
			{
				yield return PlayMissionFlavorLine(enemyActor, "VO_Mirror_Male_Mirror_MirrorFirstCard_01.prefab:abb11971ce998394aab0bb5e4e9eee4a");
			}
		}
	}
	...
	protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
	{
		...
		if (!(cardID == "CS2_027"))
		{
			...
			{
				yield return PlayEasterEggLine(enemyActor, "VO_Mirror_Male_Mirror_MirrorMedivhSkin_01.prefab:c9a9fce27cb32be46a0c6486d57bcdaf");
			}
		}
		else
		{
			yield return PlayEasterEggLine(enemyActor, "VO_Mirror_Male_Mirror_MirrorMirrorImage_01.prefab:3ff331329b643284ca06eb7a3fa0001d");
		}
	}
