...
public class ULDA_Dungeon_Boss_08h : ULDA_Dungeon
{
	...
	{
		base.PreloadAssets();
		List<string> soundFiles = new List<string> { VO_ULDA_BOSS_08h_Sinkhole_Death_01, VO_ULDA_BOSS_08h_Sinkhole_Defeat_01, VO_ULDA_BOSS_08h_Sinkhole_EmoteResponse_01, VO_ULDA_BOSS_08h_Sinkhole_Intro_01 };
