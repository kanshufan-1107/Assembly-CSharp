public class PreviousInstanceStatus
{
	...
	private static int CrashInARow
	{
		get
		{
	...
	private static int SameExceptionCount
	{
		get
		{
	...
	private static string LastExceptionHash
	{
		get
		{
	...
	private static string UpdatedClientVersion
	{
		get
		{
	...
	public static void ReportAppStatus()
	{
		...
		LowMemoryCount = 0;
		ExceptionHash = "None";
		ClearStatusForNewVersion();
	}

	private static void ClearStatusForNewVersion()
	{
		if (!UpdatedClientVersion.Equals("31.4"))
		{
			UpdatedClientVersion = "31.4";
			CrashCount = 0;
			ExceptionCount = 0;
			LowMemoryCount = 0;
			CrashInARow = 0;
