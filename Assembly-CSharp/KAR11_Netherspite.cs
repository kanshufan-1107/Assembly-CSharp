...
public class KAR11_Netherspite : KAR_MissionEntity
{
	...
	protected override IEnumerator HandleStartOfTurnWithTiming(int turn)
	{
		...
		case 6:
			...
			{
				yield return PlayMissionFlavorLine(enemyActor, "VO_Netherspite_Male_Dragon_NetherspiteTurn5_01.prefab:5c5e1d24755bfe34f825ce62f9deb6fa");
		...
		case 10:
			GameState.Get().SetBusy(busy: true);
			yield return PlayAdventureFlavorLine(enemyActor, "VO_Netherspite_Male_Dragon_NetherspiteTurn7_01.prefab:714c8bbda55d73b4a96f6c08ad3f2372");
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		if (!m_playedLines.Contains(missionEventName))
		{
			...
			{
				GameState.Get().SetBusy(busy: true);
				yield return PlayMissionFlavorLine(enemyActor, "VO_Netherspite_Male_Dragon_NetherspiteTurn3_02.prefab:909c9170498e2ff458bb5e607ae35fe1");
				GameState.Get().SetBusy(busy: false);
			}
		}
	}
	...
	protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
	{
		...
		if (!(cardID == "GVG_003"))
		{
			if (cardID == "EX1_009")
			{
				yield return PlayBossLine(enemyActor, "VO_Netherspite_Male_Dragon_NetherspiteAngryChicken_01.prefab:4364929242fd7864eb2f681df1ab4f9e");
			}
		}
		else
		{
			yield return PlayBossLine(enemyActor, "VO_Netherspite_Male_Dragon_NetherspiteUnstablePortal_02.prefab:59a7527262c5e2d45b25672b8a2150f8");
		}
	}
