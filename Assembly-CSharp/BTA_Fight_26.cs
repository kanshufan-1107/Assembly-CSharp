...
public class BTA_Fight_26 : BTA_Dungeon_Heroic
{
	...
	protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
	{
		...
		{
			if (playerHeroCardID == "HERO_04b")
			{
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_BTA_BOSS_17hx_Male_NightElf_Mission_Fight_26_BossStartArthas_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
			}
			else if (playerHeroCardID == "HERO_03a")
			{
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_BTA_BOSS_17hx_Male_NightElf_Mission_Fight_26_BossStartMaiev_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
			}
			else
			{
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_BTA_BOSS_17hx_Male_NightElf_Mission_Fight_26_BossStart_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
			}
		}
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		case 500:
			...
			break;
		case 507:
			yield return PlayAndRemoveRandomLineOnlyOnce(enemyActor, m_missionEventTrigger507Lines);
			break;
		case 161:
			yield return PlayAndRemoveRandomLineOnlyOnce(enemyActor, m_VO_BTA_BOSS_17hx_Male_NightElf_Mission_Fight_26_Boss_InnerDemon);
			break;
		default:
	...
	protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
		{
			...
			if (cardID == "BT_713")
			{
				yield return PlayLineAlways(enemyActor, VO_BTA_BOSS_17hx_Male_NightElf_Mission_Fight_26_Hero_Akama_01);
			}
		}
	}
	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
		{
			...
			{
			case "BTA_BOSS_26s":
				yield return PlayLineOnlyOnce(enemyActor, VO_BTA_BOSS_17hx_Male_NightElf_Mission_Fight_26_Boss_YouAreNotPrepared_01);
				break;
			case "BT_429":
				yield return PlayLineAlways(enemyActor, VO_BTA_BOSS_17hx_Male_NightElf_Mission_Fight_26_Boss_Metamorphosis_01);
				break;
			case "BT_491":
				yield return PlayLineAlways(enemyActor, VO_BTA_BOSS_17hx_Male_NightElf_Mission_Fight_26_Boss_SpectralSight_01);
				break;
			case "BT_601":
				yield return PlayLineAlways(enemyActor, VO_BTA_BOSS_17hx_Male_NightElf_Mission_Fight_26_Boss_SkullofGuldan_01);
				break;
			}
		}
	}
