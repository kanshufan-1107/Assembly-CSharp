...
public class LOOT_Dungeon_BOSS_99h : LOOT_Dungeon
{
	...
	protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
	{
		...
		{
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_LOOTA_BOSS_12h_Male_Kobold_Intro_01.prefab:6d07bbeb5760a0b41a5033bf335a6295", Notification.SpeechBubbleDirection.TopRight, enemyActor));
		}
		else if (MissionEntity.STANDARD_EMOTE_RESPONSE_TRIGGERS.Contains(emoteType))
		{
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_LOOT_541_Male_Kobold_EmoteResponse_01.prefab:38b613ef138dcc241944d5153f9952ae", Notification.SpeechBubbleDirection.TopRight, enemyActor));
		}
	}
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		case 101:
		{
			...
			if (m_HeroLines.Count != 0 && chanceVO >= randomNum)
			{
				string randomLine2 = m_HeroLines[Random.Range(0, m_HeroLines.Count)];
				yield return PlayLineOnlyOnce(enemyActor, randomLine2);
				m_HeroLines.Remove(randomLine2);
				yield return null;
			}
			break;
		}
		...
		case 104:
			...
			if (m_TogwaggleCandleAttackLines.Count > 0)
			{
				...
				string randomLine = m_TogwaggleCandleAttackLines[randomLineIndex];
	...
	protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()))
		{
			...
			{
			case "LOOTA_843":
				yield return PlayEasterEggLine(enemyActor, "VO_LOOTA_BOSS_12h_Male_Kobold_EventPlayCandle_01.prefab:4a9d8402c1a8fa749b223f2ecfccb6ec");
				break;
			case "LOOT_541":
				yield return PlayEasterEggLine(enemyActor, "VO_LOOTA_BOSS_12h_Male_Kobold_EventPlayKoboldKing_01.prefab:82ee9011090b3d0478ec63e306d20526");
				break;
			case "EX1_298":
