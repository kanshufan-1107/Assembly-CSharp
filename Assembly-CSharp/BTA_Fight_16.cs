...
public class BTA_Fight_16 : BTA_Dungeon
{
	...
	public override IEnumerator DoActionsBeforeDealingBaseMulliganCards()
	{
		...
		yield return PlayLineAlways(friendlyActor, VO_BTA_01_Female_NightElf_Mission_Fight_16_PlayerStart_01);
	...
	protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
	{
		...
		{
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech(VO_BTA_BOSS_16h_Male_Demon_Mission_Fight_16_Emote_Response_01, Notification.SpeechBubbleDirection.TopRight, enemyActor));
		}
	}
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		case 100:
			...
			break;
		case 101:
			yield return PlayRandomLineAlways(enemyActor, m_missionEventTrigger101_Lines);
			break;
		case 102:
			yield return PlayLineAlways(enemyActor, VO_BTA_BOSS_16h_Male_Demon_Mission_Fight_16_MidpointA_01);
			yield return PlayLineAlways(friendlyActor, VO_BTA_01_Female_NightElf_Mission_Fight_16_MidpointB_01);
			break;
		case 103:
			yield return PlayLineAlways(enemyActor, VO_BTA_BOSS_16h_Male_Demon_Mission_Fight_16_Hero_Demon_01);
			break;
		case 104:
			yield return PlayLineAlways(enemyActor, VO_BTA_BOSS_16h_Male_Demon_Mission_Fight_16_Hero_HiddenAmulet_01);
			break;
		case 105:
	...
	protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
		{
			...
			{
			case "BT_491":
				yield return PlayLineAlways(enemyActor, VO_BTA_BOSS_16h_Male_Demon_Mission_Fight_16_Hero_SpectralSight_01);
				break;
			case "BT_512":
				yield return PlayLineAlways(enemyActor, VO_BTA_BOSS_16h_Male_Demon_Mission_Fight_16_Hero_InnerDemon_01);
				break;
			case "BT_752":
				yield return PlayLineAlways(enemyActor, VO_BTA_BOSS_16h_Male_Demon_Mission_Fight_16_Hero_Blur_01);
				break;
			case "BTA_05":
			case "BTA_06":
				yield return PlayLineAlways(enemyActor, VO_BTA_BOSS_16h_Male_Demon_Mission_Fight_16_Hero_Sklibb_01);
				break;
			case "BTA_BOSS_15s":
				yield return PlayLineAlways(enemyActor, VO_BTA_BOSS_16h_Male_Demon_Mission_Fight_16_Hero_HiddenAmulet_01);
				break;
	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
		{
			...
			{
			case "BT_302":
				yield return PlayLineAlways(enemyActor, VO_BTA_BOSS_16h_Male_Demon_Mission_Fight_16_Boss_DarkPortal_01);
				break;
			case "BTA_13":
				yield return PlayLineAlways(enemyActor, VO_BTA_BOSS_16h_Male_Demon_Mission_Fight_16_Boss_Deteriorate_01);
				break;
			case "BTA_15":
				yield return PlayLineAlways(enemyActor, VO_BTA_BOSS_16h_Male_Demon_Mission_Fight_16_Boss_EndlessLegion_01);
				break;
			case "BTA_16":
				yield return PlayLineAlways(enemyActor, VO_BTA_BOSS_16h_Male_Demon_Mission_Fight_16_Boss_RustedFungalGiant_01);
				break;
			}
		}
	}
	...
	protected override IEnumerator HandleStartOfTurnWithTiming(int turn)
	{
		...
		{
		case 1:
			yield return PlayLineAlways(friendlyActor, VO_BTA_01_Female_NightElf_Mission_Fight_16_Turn1_Story_01);
