...
public class ULDA_Dungeon_Boss_25h : ULDA_Dungeon
{
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		if (missionEvent == 101)
		{
			yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_25h_Female_SandTroll_BossTriggerPlatedBeetleDeathrattle_01);
		}
		else
		{
	...
	protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
	{
		...
		if (!(cardID == "ULD_712"))
		{
			if (cardID == "ULDA_501")
			{
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_25h_Female_SandTroll_PlayerFinleysMount_01);
			}
		}
		else
		{
			yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_25h_Female_SandTroll_PlayerBugCollector_01);
		}
	}
	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		if (!(cardID == "ULD_133"))
		{
			if (cardID == "ULD_231")
			{
				yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_25h_Female_SandTroll_BossWhirlkickMaster_01);
			}
		}
		else
		{
			yield return PlayLineOnlyOnce(enemyActor, VO_ULDA_BOSS_25h_Female_SandTroll_BossCrystalMerchant_01);
		}
	}
}
