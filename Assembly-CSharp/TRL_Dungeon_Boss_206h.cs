...
public class TRL_Dungeon_Boss_206h : TRL_Dungeon
{
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		{
		case 1001:
			yield return PlayLineOnlyOnce(enemyActor, VO_TRLA_206h_Female_Troll_Shrine_CheapSpell_02);
			break;
		case 1002:
			yield return PlayLineOnlyOnce(enemyActor, VO_TRLA_206h_Female_Troll_Shrine_General_01);
			break;
		case 1003:
			yield return PlayLineOnlyOnce(enemyActor, VO_TRLA_206h_Female_Troll_Shrine_BounceDamage_03);
			break;
		case 1004:
			yield return PlayAndRemoveRandomLineOnlyOnce(enemyActor, m_BounceLines);
			break;
		default:
	...
	protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()))
		{
			...
			if (cardID == "TRL_541")
			{
				yield return PlayLineOnlyOnce(enemyActor, VO_TRLA_206h_Female_Troll_HakkarReponse_01);
			}
		}
	}
	...
	protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()))
		{
			...
			{
			case "TRLA_181":
				yield return PlayLineOnlyOnce(enemyActor, VO_TRLA_206h_Female_Troll_Shrine_CheapSpell_01);
				break;
			case "ICC_841":
				yield return PlayLineOnlyOnce(enemyActor, VO_TRLA_206h_Female_Troll_Play_Lanathel_01);
				break;
			case "TRL_253":
				yield return PlayLineOnlyOnce(enemyActor, VO_TRLA_206h_Female_Troll_Play_Hireek_01);
				break;
			case "TRL_251":
				yield return PlayLineOnlyOnce(enemyActor, VO_TRLA_206h_Female_Troll_Play_SpiritofBat_01);
				break;
			}
		}
	}
