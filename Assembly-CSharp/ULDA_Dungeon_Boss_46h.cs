...
public class ULDA_Dungeon_Boss_46h : ULDA_Dungeon
{
	...
	{
		base.PreloadAssets();
		List<string> soundFiles = new List<string> { VO_ULDA_BOSS_46h_Wildtooth_Death_01, VO_ULDA_BOSS_46h_Wildtooth_Defeat_01, VO_ULDA_BOSS_46h_Wildtooth_EmoteResponse_01, VO_ULDA_BOSS_46h_Wildtooth_Intro_01 };
