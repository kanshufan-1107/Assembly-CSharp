...
public class GIL_Dungeon_Boss_25h : GIL_Dungeon
{
	...
	protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
	{
		...
		if (emoteType == EmoteType.START)
		{
			...
			{
			case "GILA_500h3":
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_GILA_BOSS_25h_Male_Dwarf_IntroTess_02.prefab:2a09b2d6d36724349a8cfbfd91013e76", Notification.SpeechBubbleDirection.TopRight, enemyActor));
				break;
			case "GILA_600h":
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_GILA_BOSS_25h_Male_Dwarf_IntroDarius_01.prefab:c8db45a57afef7145baceddc90bbc63c", Notification.SpeechBubbleDirection.TopRight, enemyActor));
				break;
			case "GILA_900h":
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_GILA_BOSS_25h_Male_Dwarf_IntroToki_01.prefab:9adeab1320171c243a65489f14926936", Notification.SpeechBubbleDirection.TopRight, enemyActor));
				break;
			case "GILA_400h":
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_GILA_BOSS_25h_Male_Dwarf_IntroShaw_01.prefab:ae89e24b92f8f6c4abb9574f5cb88065", Notification.SpeechBubbleDirection.TopRight, enemyActor));
				break;
			default:
				Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_GILA_BOSS_25h_Male_Dwarf_Intro_01.prefab:77d5c0517d85a3946b7fc790529b757d", Notification.SpeechBubbleDirection.TopRight, enemyActor));
				break;
			}
		}
		else if (MissionEntity.STANDARD_EMOTE_RESPONSE_TRIGGERS.Contains(emoteType))
		{
			Gameplay.Get().StartCoroutine(PlaySoundAndBlockSpeech("VO_GILA_BOSS_25h_Male_Dwarf_EmoteResponse_01.prefab:ee61b254aa4f2d64eb3539ad2ec8171f", Notification.SpeechBubbleDirection.TopRight, enemyActor));
		}
	}
	...
	protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
	{
		...
		if (missionEvent == 101)
		{
			string randomLine = PopRandomLineWithChance(m_PlayerSecret);
			if (randomLine != null)
			{
	...
	protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()))
		{
			...
			{
			case "GILA_509":
				yield return PlayEasterEggLine(enemyActor, "VO_GILA_BOSS_25h_Male_Dwarf_EventPlayTrapper_01.prefab:e95606488e23ac447b5c8e9452755f76");
				break;
			case "GILA_853b":
				yield return PlayEasterEggLine(enemyActor, "VO_GILA_BOSS_25h_Male_Dwarf_EventPlayCompass_01.prefab:6f67f38e3d94c9641b379d77336fe177");
				break;
			case "GILA_510":
				yield return PlayEasterEggLine(enemyActor, "VO_GILA_BOSS_25h_Male_Dwarf_EventPlayToolsOfTheTrade_01.prefab:f6223a5550a2a90429b49a372c5fcffd");
				break;
			}
		}
	}
	...
	protected override IEnumerator RespondToResetGameFinishedWithTiming(Entity entity)
	{
		...
		if (!m_playedLines.Contains(entity.GetCardId()))
		{
			...
			if (cardId == "GILA_900p")
			{
				yield return PlayEasterEggLine(enemyActor, "VO_GILA_BOSS_25h_Male_Dwarf_EventTokiAbility_01.prefab:d844029587e1094419abaa128505e224");
			}
		}
	}
}
